...
class Apartment extends ParentModel {
	...
	public function relations() {
		...
		if (issetModule('seasonalprices')) {
			if(isset(Yii::app()->controller) && isset(Yii::app()->controller->apType) && Yii::app()->controller->apType && in_array(Yii::app()->controller->apType, array(Apartment::PRICE_PER_DAY, Apartment::PRICE_PER_HOUR, Apartment::PRICE_PER_MONTH, Apartment::PRICE_PER_WEEK))) {
    ...
    public function getRowCssClass()
    {
        ...
        if (!empty($this->date_up_search) && !is_null($this->date_up_search)) {
            return 'up_in_search';
        }
        return '';
    }
