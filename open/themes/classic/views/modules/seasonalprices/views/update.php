...
if(/*param('useBootstrap')*/ Yii::app()->user->checkAccess('backend_access')) { # admin panel
	...
	echo '<h1 class="title highlight-left-right">'.tt('Update seasonal price', 'seasonalprices').'</h1>';
}
?>
...
<div class="form form-seasonalprices-update">
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		'htmlOptions'=>array('class'=>'white_noborder form-disable-button-after-submit'),
	)); ?>
