		...
		<?php
			if($data->is_special_offer){
				...
				<div class="big-special-offer">
					...
					if(!empty($data->is_free_to) && !is_null($data->is_free_to)){
						echo '<p>';
						echo Yii::t('common','Is avaliable');
						echo ' '.Yii::t('module_apartments', 'to');
						echo ' '.Booking::getDate($data->is_free_to, 1);
						echo '</p>';
					}
					?>
				</div>
		...
		<div class="viewapartment-left">
			<div class="viewapartment-main-photo">
				...
				<?php
					...
					$imgAlt = (isset($res['alt']) && $res['alt']) ? $res['alt'] : CHtml::encode($data->getStrByLang('title'));
