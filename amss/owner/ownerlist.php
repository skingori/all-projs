    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
				$result = mysql_query("Select * from tbl_add_owner where branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . " order by ownid desc",$link);
            ...
            <tr>
              ...
              <td><?php
				 $i=1;
				 $result_sp = mysql_query("Select u.unit_no from tbl_add_owner_unit_relation owr inner join tbl_add_unit u on owr.unit_id = u.uid where owr.owner_id = '". $row['ownid'] . "' order by u.unit_no ASC",$link);
