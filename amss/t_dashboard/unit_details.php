...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <?php
		$result = mysql_query("Select f.floor_no,u.unit_no,u.uid,r.r_name,r.r_email,r.r_contact,r.r_address,r.r_nid,r.r_floor_no,r.r_unit_no,r.r_advance,r.r_rent_pm,r.r_date,r.image as r_image from tbl_add_unit u inner join tbl_add_floor f on f.fid = u.floor_no inner join tbl_add_rent r on r.r_unit_no = u.uid where r.rid = '". (int)$_SESSION['objLogin']['rid'] . "' order by u.uid desc",$link);
