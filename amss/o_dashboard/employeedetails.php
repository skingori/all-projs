    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        	<?php
				$result = mysql_query("SELECT *,mt.member_type FROM tbl_add_employee e inner join tbl_add_member_type mt where mt.member_id = e.e_designation",$link);
			...
			<td><?php echo $row['e_pre_address']; ?></td>
