        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
            <?php
			$result = mysql_query("Select *,m.month_name from tbl_add_complain c inner join tbl_add_month_setup m on m.m_id = c.c_month where c.c_date='".$_GET['vid']."' and c.c_month='".$_GET['mid']."' and c.branch_id = '" . (int)$_SESSION['objLogin']['branch_id'] . "'",$link);
