...
<section class="content-header">
  <h1>Fair Collection Report </h1>
  <ol class="breadcrumb">
    <li><a href="<?php echo WEB_URL?>dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active"><a href="<?php echo WEB_URL?>report/fair_report.php">Report</a></li>
    <li class="active">Fair Collection Report</li>
  </ol>
</section>
<!-- Main content -->
  ...
  <div class="col-md-12">
    ...
    <div class="box box-info">
      <div class="box-header">
        <h3 class="box-title">Fair Collection Report Form</h3>
      </div>
