    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        	<?php
				 $result = mysql_query("Select u.unit_no,fl.floor_no as fl_floor_no from tbl_add_owner_unit_relation owr inner join tbl_add_unit u on owr.unit_id = u.uid inner join tbl_add_floor fl on fl.fid = u.floor_no where owr.owner_id = '". (int)$_SESSION['objLogin']['ownid'] . "' order by u.unit_no ASC",$link);
