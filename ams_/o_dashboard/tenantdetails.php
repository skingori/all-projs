    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
			<?php	
				$result = mysql_query("Select *,our.unit_id,fl.floor_no as fl_floor_no,u.unit_no as u_unit_no from tbl_add_rent r inner join tbl_add_owner_unit_relation our on r.r_unit_no = our.unit_id inner join tbl_add_floor fl on fl.fid = r.r_floor_no inner join tbl_add_unit u on u.uid = r.r_unit_no where our.owner_id = '". (int)$_SESSION['objLogin']['ownid'] . "' order by r.rid desc",$link);
