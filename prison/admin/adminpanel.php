...
<body >
	<table align='center' border='0' bgcolor='red' width='1030' cellpadding='10' cellspacing='1' height='100%'>
		  <tr>
          ...
          <tr>
            ...
            <td width='4%' bgcolor='red' valign='top'>
<h3 align='center'  title='You should be online'>&nbsp;</h3></td>

            <td width='71%' valign='top' bgcolor="#FFFFFF" >

            <h2> <b>KAMITI MAXIMUM PRISON</b></h2>

<img src="banner.png" width="100%" height=""  alt=""/>
	...
	<li><a href='viewtransfer.php'><b>Prisoners Transfer Information</b></a></li>
          ...
          <tr>
            <td colspan='3' align='center' bgcolor='#FF0000' height='1'>
					&copy; <strong>
                &nbsp;2014 KENYA PRISONS SERVICE BY MAKENA</strong></td>
          </tr>
	</table>
</body>
</head>
