...
$this->html_out .= "<item><label>"._COM_APER."</label><value>".number_format(($P*0.01),0,_DEC_POINT,_THOUSANDS_SEP)." "._CURRENCY."</value></item>\n";
$this->html_out .= "<item><label>"._IMP_ACTOS."</label><value>".number_format(($P*0.0106),0,_DEC_POINT,_THOUSANDS_SEP)." "._CURRENCY."</value></item>\n";
...
$this->html_out .= "<total><label>"._TOTAL."</label><value>".number_format((($P*0.01)+($P*0.0106)+500+300),0,_DEC_POINT,_THOUSANDS_SEP)." "._CURRENCY."</value></total>\n";
$this->html_out .= "</gst>\n";

$this->html_out .= "<gst>\n";

$this->html_out .= "<title>"._GST_COMPRA."</title>\n";
$this->html_out .= "<item><label>"._IMP_COMPRA."</label><value>".number_format(($valor*0.07),0,_DEC_POINT,_THOUSANDS_SEP)." "._CURRENCY."</value></item>\n";
$this->html_out .= "<item><label>"._GAST_GEST."</label><value>".(500)." "._CURRENCY."</value></item>\n";
$this->html_out .= "<total><label>"._TOTAL."</label><value>".number_format((($valor*0.07)+500),0,_DEC_POINT,_THOUSANDS_SEP)." "._CURRENCY."</value></total>\n";
$this->html_out .= "</gst>\n";
