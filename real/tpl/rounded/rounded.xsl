...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="head">
		<head>
			<link rel="StyleSheet"
				href="{//html/page/@path}/tpl/rounded/style/style.css"
				type="text/css" />
			<xsl:apply-templates />
	...
	<!-- TEMPLATE EMPTIES -->
	<xsl:template
		match="titlespecial|titlesubs|titleisearch|title_home|subs_title">
	</xsl:template>
	...
	<xsl:template match="central">
		<td class="pcentral">
			<xsl:if test="boolean(/html/page/central/loginform)">
				<div style="width:20px">
					<img
						src="{//html/page/@path}/tpl/rounded/images/square.jpg" alt="" />
				</div>
			</xsl:if>
		...
		<table>
			<xsl:for-each select="*"><!-- *[not(name()='ofis')][not(name()='bguide') ] -->
				<tr class="mnu_item">
					<td class="mnu_itimg">
						<img class="mnu"
							src="{//html/page/@path}/tpl/rounded/images/arrow.gif" alt="" />
					</td>
					<td class="mnu_item">
	...
	<xsl:template match="headers">
		<table class="head">
			<tr class="head">
				<td class="head"
					style="height:37px;background-image: url({//html/page/@path}/tpl/rounded/images/head.jpg);background-repeat:repeat-x;background-position:left;">
					Real Estate Agency
				</td>
			</tr>
		</table>
	...
	<xsl:template match="cities">
		<table class="box">
			<tr class="hbox">
				<td style="background-image: url({//html/page/@path}/tpl/rounded/images/titcircle.jpg)" class="hbox">
					<xsl:value-of select="title" />
				</td>
			</tr>
			<tr class="box">
	...
	<xsl:template match="footers">
		<table class="square">
			<tr class="square">
				...
				<td class="squareb">
					<img class="squareb"
						src="{//html/page/@path}/tpl/rounded/images/squarebottom.jpg"
						alt="" />
				</td>
			</tr>
		</table>
		<table class="piecentral">
			<tr>
				<td
					style="background-image: url({//html/page/@path}/tpl/rounded/images/footer.jpg);"
					class="piecentral">
	...
	<xsl:template match="pgtitle">
		<table class="pgtitle">
			<tr>
				<td style="background-image: url({//html/page/@path}/tpl/rounded/images/titup.jpg)" class="titup" colspan="2"></td>
			</tr>
			<tr>
							...
							<tr>
								<td class="pgoptions">
									<a class="boton"
										...
										<img class="boton"
											src="{//html/page/@path}/tpl/rounded/images/blue_butt_left.gif"
											alt="" />
										<xsl:text> </xsl:text>
										<xsl:value-of
											select="options/back" />
							...
							<tr>
								<td class="pgoptions">
									<a class="boton" href="{@href}"
										onclick="{@onclick}">
										<img class="boton"
											src="{//html/page/@path}/tpl/rounded/images/blue_butt.gif"
											alt="" />
										<xsl:text> </xsl:text>
										<xsl:value-of select="." />
									</a>
			...
			<tr>
				<td style="background-image: url({//html/page/@path}/tpl/rounded/images/titdown.jpg)" class="titdown" colspan="2"></td>
			</tr>
		</table>
	</xsl:template>
	...
	<xsl:template match="tp_property">
		<table class="box">
			<tr class="hbox">
				<td	style="background-image: url({//html/page/@path}/tpl/rounded/images/titcircle.jpg)"
					class="hbox">
...
<xsl:value-of select="count(item)" />
			...
			<tr class="box">
				<xsl:for-each select="item">
					<td class="box">
						<a class="box" href="{@href}">
							<img
								src="{//html/page/@path}/tpl/rounded/images/tp{@id}.gif" alt="" />
							<br />
							<xsl:value-of select="." />
							(
							<xsl:value-of select="@num" />
	...
	<xsl:template match="thumb">
		<script type="text/javascript" src="{//html/page/@path}/tpl/rounded/jscripts/lightbox.js">
			<xsl:text> </xsl:text>
		</script>
	    <link rel="StyleSheet" href="{//html/page/@path}/tpl/rounded/style/lightbox.css"
				type="text/css" />
	...
	<xsl:template match="formdef">
		<table class="forms_border">
			<tr>
				<td style="background-image: url({//html/page/@path}/tpl/rounded/images/formup.jpg)" class="formup"></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="form_button">
					<a class="boton"
						...
						<img class="boton"
							src="{//html/page/@path}/tpl/rounded/images/form_butt.gif"
							alt="" />
			...
			<tr>
				<td style="background-image: url({//html/page/@path}/tpl/rounded/images/formdown.jpg)" class="formdown"></td>
			</tr>
		</table>
	</xsl:template>
	...
	<xsl:template match="loginform">
		<div class="loginform">
			<xsl:apply-templates />
			<div
			style="font: bold 12px arial ;color:#525f89;margin: 0.2cm 0cm 0.2cm 0.2cm">
	...
	<xsl:template match="prefered">
		<div
			style="font: bold 18px arial ;color:#525f89;margin: 0.2cm 0cm 0.2cm 0.2cm">
			<xsl:value-of select="." />
		</div>
