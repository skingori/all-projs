...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "view_purchases_outstandingslist.php", "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Page object
var view_purchases_outstandings_search = new ew_Page("view_purchases_outstandings_search");
view_purchases_outstandings_search.PageID = "search"; // Page ID
var EW_PAGE_ID = view_purchases_outstandings_search.PageID; // For backward compatibility

// Form object
var fview_purchases_outstandingssearch = new ew_Form("fview_purchases_outstandingssearch");
...
fview_purchases_outstandingssearch.Lists["x_Supplier_ID"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fview_purchases_outstandingssearch" id="fview_purchases_outstandingssearch" class="form-horizontal ewForm ewSearchForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($view_purchases_outstandings->Purchase_ID->Visible) { // Purchase_ID ?>
	<div id="r_Purchase_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Purchase_ID" id="z_Purchase_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_purchases_outstandings->Purchase_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_outstandings_Purchase_ID">
<input type="text" data-field="x_Purchase_ID" name="x_Purchase_ID" id="x_Purchase_ID" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Purchase_ID->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Purchase_ID->EditValue ?>"<?php echo $view_purchases_outstandings->Purchase_ID->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Purchase_ID" name="y_Purchase_ID" id="y_Purchase_ID" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Purchase_ID->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Purchase_ID->EditValue2 ?>"<?php echo $view_purchases_outstandings->Purchase_ID->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($view_purchases_outstandings->Purchase_Number->Visible) { // Purchase_Number ?>
	<div id="r_Purchase_Number" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Purchase_Number" id="z_Purchase_Number" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($view_purchases_outstandings->Purchase_Number->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_outstandings_Purchase_Number">
<input type="text" data-field="x_Purchase_Number" name="x_Purchase_Number" id="x_Purchase_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Purchase_Number->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Purchase_Number->EditValue ?>"<?php echo $view_purchases_outstandings->Purchase_Number->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Purchase_Number" name="y_Purchase_Number" id="y_Purchase_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Purchase_Number->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Purchase_Number->EditValue2 ?>"<?php echo $view_purchases_outstandings->Purchase_Number->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($view_purchases_outstandings->Purchase_Date->Visible) { // Purchase_Date ?>
	<div id="r_Purchase_Date" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Purchase_Date" id="z_Purchase_Date" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_outstandings->Purchase_Date->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_outstandings->Purchase_Date->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_outstandings->Purchase_Date->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_outstandings->Purchase_Date->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_outstandings->Purchase_Date->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_outstandings->Purchase_Date->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($view_purchases_outstandings->Purchase_Date->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_outstandings_Purchase_Date">
<input type="text" data-field="x_Purchase_Date" name="x_Purchase_Date" id="x_Purchase_Date" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Purchase_Date->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Purchase_Date->EditValue ?>"<?php echo $view_purchases_outstandings->Purchase_Date->EditAttributes() ?>>
<?php if (!$view_purchases_outstandings->Purchase_Date->ReadOnly && !$view_purchases_outstandings->Purchase_Date->Disabled && @$view_purchases_outstandings->Purchase_Date->EditAttrs["readonly"] == "" && @$view_purchases_outstandings->Purchase_Date->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Purchase_Date" name="y_Purchase_Date" id="y_Purchase_Date" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Purchase_Date->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Purchase_Date->EditValue2 ?>"<?php echo $view_purchases_outstandings->Purchase_Date->EditAttributes() ?>>
<?php if (!$view_purchases_outstandings->Purchase_Date->ReadOnly && !$view_purchases_outstandings->Purchase_Date->Disabled && @$view_purchases_outstandings->Purchase_Date->EditAttrs["readonly"] == "" && @$view_purchases_outstandings->Purchase_Date->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_purchases_outstandings->Supplier_ID->Visible) { // Supplier_ID ?>
	<div id="r_Supplier_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Supplier_ID" id="z_Supplier_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_outstandings_Supplier_ID">
<select data-field="x_Supplier_ID" id="x_Supplier_ID" name="x_Supplier_ID"<?php echo $view_purchases_outstandings->Supplier_ID->EditAttributes() ?>>
<?php
if (is_array($view_purchases_outstandings->Supplier_ID->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fview_purchases_outstandingssearch.Lists["x_Supplier_ID"].Options = <?php echo (is_array($view_purchases_outstandings->Supplier_ID->EditValue)) ? ew_ArrayToJson($view_purchases_outstandings->Supplier_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Supplier_ID" id="y_Supplier_ID" name="y_Supplier_ID"<?php echo $view_purchases_outstandings->Supplier_ID->EditAttributes() ?>>
<?php
if (is_array($view_purchases_outstandings->Supplier_ID->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_purchases_outstandings->Supplier_ID->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fview_purchases_outstandingssearch.Lists["x_Supplier_ID"].Options = <?php echo (is_array($view_purchases_outstandings->Supplier_ID->EditValue2)) ? ew_ArrayToJson($view_purchases_outstandings->Supplier_ID->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($view_purchases_outstandings->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Notes" id="z_Notes" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_purchases_outstandings->Notes->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_outstandings_Notes">
<input type="text" data-field="x_Notes" name="x_Notes" id="x_Notes" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Notes->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Notes->EditValue ?>"<?php echo $view_purchases_outstandings->Notes->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Notes" name="y_Notes" id="y_Notes" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Notes->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Notes->EditValue2 ?>"<?php echo $view_purchases_outstandings->Notes->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($view_purchases_outstandings->Total_Amount->Visible) { // Total_Amount ?>
	<div id="r_Total_Amount" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Total_Amount" id="z_Total_Amount" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_purchases_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_outstandings_Total_Amount">
<input type="text" data-field="x_Total_Amount" name="x_Total_Amount" id="x_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Total_Amount->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Total_Amount->EditValue ?>"<?php echo $view_purchases_outstandings->Total_Amount->EditAttributes() ?>>
...
<input type="text" data-field="x_Total_Amount" name="y_Total_Amount" id="y_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Total_Amount->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Total_Amount->EditValue2 ?>"<?php echo $view_purchases_outstandings->Total_Amount->EditAttributes() ?>>
<?php if (!$view_purchases_outstandings->Total_Amount->ReadOnly && !$view_purchases_outstandings->Total_Amount->Disabled && @$view_purchases_outstandings->Total_Amount->EditAttrs["readonly"] == "" && @$view_purchases_outstandings->Total_Amount->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_purchases_outstandings->Total_Payment->Visible) { // Total_Payment ?>
	<div id="r_Total_Payment" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Total_Payment" id="z_Total_Payment" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_purchases_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_outstandings_Total_Payment">
<input type="text" data-field="x_Total_Payment" name="x_Total_Payment" id="x_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Total_Payment->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Total_Payment->EditValue ?>"<?php echo $view_purchases_outstandings->Total_Payment->EditAttributes() ?>>
...
<input type="text" data-field="x_Total_Payment" name="y_Total_Payment" id="y_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_outstandings->Total_Payment->PlaceHolder) ?>" value="<?php echo $view_purchases_outstandings->Total_Payment->EditValue2 ?>"<?php echo $view_purchases_outstandings->Total_Payment->EditAttributes() ?>>
<?php if (!$view_purchases_outstandings->Total_Payment->ReadOnly && !$view_purchases_outstandings->Total_Payment->Disabled && @$view_purchases_outstandings->Total_Payment->EditAttrs["readonly"] == "" && @$view_purchases_outstandings->Total_Payment->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
