		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "a_stock_itemsview.php")
...
// Page object
var a_stock_items_add = new ew_Page("a_stock_items_add");
a_stock_items_add.PageID = "add"; // Page ID
var EW_PAGE_ID = a_stock_items_add.PageID; // For backward compatibility

// Form object
var fa_stock_itemsadd = new ew_Form("fa_stock_itemsadd");
...
fa_stock_itemsadd.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemsadd.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemsadd.Lists["x_Unit_Of_Measurement"] = {"LinkField":"x_UOM_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_UOM_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fa_stock_itemsadd" id="fa_stock_itemsadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php } ?>
<script type="text/javascript">
fa_stock_itemsadd.Lists["x_Category"].Options = <?php echo (is_array($a_stock_items->Category->EditValue)) ? ew_ArrayToJson($a_stock_items->Category->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fa_stock_itemsadd.Lists["x_Supplier_Number"].Options = <?php echo (is_array($a_stock_items->Supplier_Number->EditValue)) ? ew_ArrayToJson($a_stock_items->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
<?php } ?>
<script type="text/javascript">
fa_stock_itemsadd.Lists["x_Unit_Of_Measurement"].Options = <?php echo (is_array($a_stock_items->Unit_Of_Measurement->EditValue)) ? ew_ArrayToJson($a_stock_items->Unit_Of_Measurement->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyAdd(this)'); function alertifyAdd(obj) { <?php global $Language; ?> if (fa_stock_itemsadd.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyAddConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyAdd'); ?>"); $("#fa_stock_itemsadd").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
