...
// Form object
var fannouncementdelete = new ew_Form("fannouncementdelete");
...
fannouncementdelete.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fannouncementdelete.Lists["x_Translated_ID"] = {"LinkField":"x_Announcement_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Topic","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el<?php echo $announcement_delete->RowCnt ?>_announcement_Announcement_ID" class="form-group announcement_Announcement_ID">
...
<span id="el<?php echo $announcement_delete->RowCnt ?>_announcement_Is_Active" class="form-group announcement_Is_Active">
...
<span id="el<?php echo $announcement_delete->RowCnt ?>_announcement_Topic" class="form-group announcement_Topic">
...
<span id="el<?php echo $announcement_delete->RowCnt ?>_announcement__Language" class="form-group announcement__Language">
...
<span id="el<?php echo $announcement_delete->RowCnt ?>_announcement_Auto_Publish" class="form-group announcement_Auto_Publish">
...
<span id="el<?php echo $announcement_delete->RowCnt ?>_announcement_Date_Start" class="form-group announcement_Date_Start">
...
<span id="el<?php echo $announcement_delete->RowCnt ?>_announcement_Date_End" class="form-group announcement_Date_End">
...
<span id="el<?php echo $announcement_delete->RowCnt ?>_announcement_Translated_ID" class="form-group announcement_Translated_ID">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fannouncementdelete.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fannouncementdelete").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
