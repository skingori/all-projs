...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Sales_ID
		$this->Sales_ID = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Sales_ID', 'Sales_ID', '`Sales_ID`', '`Sales_ID`', 3, -1, FALSE, '`Sales_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sales_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sales_ID'] = &$this->Sales_ID;

		// Sales_Number
		$this->Sales_Number = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Sales_Number', 'Sales_Number', '`Sales_Number`', '`Sales_Number`', 200, -1, FALSE, '`Sales_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sales_Number'] = &$this->Sales_Number;

		// Sales_Date
		$this->Sales_Date = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Sales_Date', 'Sales_Date', '`Sales_Date`', 'DATE_FORMAT(`Sales_Date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Sales_Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sales_Date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['Sales_Date'] = &$this->Sales_Date;

		// Customer_ID
		$this->Customer_ID = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Customer_ID', 'Customer_ID', '`Customer_ID`', '`Customer_ID`', 200, -1, FALSE, '`Customer_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Customer_ID'] = &$this->Customer_ID;

		// Notes
		$this->Notes = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 200, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Notes'] = &$this->Notes;

		// Total_Amount
		$this->Total_Amount = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Total_Amount', 'Total_Amount', '`Total_Amount`', '`Total_Amount`', 5, -1, FALSE, '`Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Total_Amount'] = &$this->Total_Amount;

		// Final_Total_Amount
		$this->Final_Total_Amount = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Final_Total_Amount', 'Final_Total_Amount', '`Final_Total_Amount`', '`Final_Total_Amount`', 5, -1, FALSE, '`Final_Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Total_Payment
		$this->Total_Payment = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Total_Payment', 'Total_Payment', '`Total_Payment`', '`Total_Payment`', 5, -1, FALSE, '`Total_Payment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Total_Balance
		$this->Total_Balance = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Total_Balance', 'Total_Balance', '`Total_Balance`', '`Total_Balance`', 5, -1, FALSE, '`Total_Balance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Total_Balance'] = &$this->Total_Balance;

		// Discount_Type
		$this->Discount_Type = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Discount_Type', 'Discount_Type', '`Discount_Type`', '`Discount_Type`', 200, -1, FALSE, '`Discount_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Discount_Type'] = &$this->Discount_Type;

		// Discount_Percentage
		$this->Discount_Percentage = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Discount_Percentage', 'Discount_Percentage', '`Discount_Percentage`', '`Discount_Percentage`', 5, -1, FALSE, '`Discount_Percentage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Discount_Amount
		$this->Discount_Amount = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Discount_Amount', 'Discount_Amount', '`Discount_Amount`', '`Discount_Amount`', 5, -1, FALSE, '`Discount_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Discount_Amount'] = &$this->Discount_Amount;

		// Tax_Percentage
		$this->Tax_Percentage = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Tax_Percentage', 'Tax_Percentage', '`Tax_Percentage`', '`Tax_Percentage`', 5, -1, FALSE, '`Tax_Percentage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Tax_Description
		$this->Tax_Description = new cField('view_sales_outstandings', 'view_sales_outstandings', 'x_Tax_Description', 'Tax_Description', '`Tax_Description`', '`Tax_Description`', 200, -1, FALSE, '`Tax_Description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "a_payment_transactions") {
			$sDetailUrl = $GLOBALS["a_payment_transactions"]->GetListUrl() . "?showmaster=" . $this->TableVar;
	...
	// Update Table
	var $UpdateTable = "`view_sales_outstandings`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_sales_outstandingsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_sales_outstandingsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_sales_outstandingsadd.php?" . $this->UrlParm($parm);
		else
			return "view_sales_outstandingsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_sales_outstandingsedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_sales_outstandingsedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_sales_outstandingsadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_sales_outstandingsadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
