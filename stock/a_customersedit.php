...
// Page object
var a_customers_edit = new ew_Page("a_customers_edit");
a_customers_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = a_customers_edit.PageID; // For backward compatibility

// Form object
var fa_customersedit = new ew_Form("fa_customersedit");
...
<form name="fa_customersedit" id="fa_customersedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Customer_ID" name="x_Customer_ID" id="x_Customer_ID" value="<?php echo ew_HtmlEncode($a_customers->Customer_ID->CurrentValue) ?>">
...
<input type="hidden" data-field="x_Date_Added" name="x_Date_Added" id="x_Date_Added" value="<?php echo ew_HtmlEncode($a_customers->Date_Added->CurrentValue) ?>">
</span>
<span id="el_a_customers_Added_By">
<input type="hidden" data-field="x_Added_By" name="x_Added_By" id="x_Added_By" value="<?php echo ew_HtmlEncode($a_customers->Added_By->CurrentValue) ?>">
</span>
<?php
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fa_customersedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fa_customersedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
