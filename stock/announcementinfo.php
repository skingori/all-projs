...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Announcement_ID
		$this->Announcement_ID = new cField('announcement', 'announcement', 'x_Announcement_ID', 'Announcement_ID', '`Announcement_ID`', '`Announcement_ID`', 19, -1, FALSE, '`Announcement_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Announcement_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Announcement_ID'] = &$this->Announcement_ID;

		// Is_Active
		$this->Is_Active = new cField('announcement', 'announcement', 'x_Is_Active', 'Is_Active', '`Is_Active`', '`Is_Active`', 202, -1, FALSE, '`Is_Active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Topic
		$this->Topic = new cField('announcement', 'announcement', 'x_Topic', 'Topic', '`Topic`', '`Topic`', 200, -1, FALSE, '`Topic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Topic'] = &$this->Topic;

		// Message
		$this->Message = new cField('announcement', 'announcement', 'x_Message', 'Message', '`Message`', '`Message`', 201, -1, FALSE, '`Message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Message'] = &$this->Message;

		// Date_LastUpdate
		$this->Date_LastUpdate = new cField('announcement', 'announcement', 'x_Date_LastUpdate', 'Date_LastUpdate', '`Date_LastUpdate`', 'DATE_FORMAT(`Date_LastUpdate`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Date_LastUpdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Language
		$this->_Language = new cField('announcement', 'announcement', 'x__Language', 'Language', '`Language`', '`Language`', 200, -1, FALSE, '`Language`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Language'] = &$this->_Language;

		// Auto_Publish
		$this->Auto_Publish = new cField('announcement', 'announcement', 'x_Auto_Publish', 'Auto_Publish', '`Auto_Publish`', '`Auto_Publish`', 202, -1, FALSE, '`Auto_Publish`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Date_Start
		$this->Date_Start = new cField('announcement', 'announcement', 'x_Date_Start', 'Date_Start', '`Date_Start`', 'DATE_FORMAT(`Date_Start`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Date_Start`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Date_Start->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['Date_Start'] = &$this->Date_Start;

		// Date_End
		$this->Date_End = new cField('announcement', 'announcement', 'x_Date_End', 'Date_End', '`Date_End`', 'DATE_FORMAT(`Date_End`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Date_End`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Date_End->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['Date_End'] = &$this->Date_End;

		// Date_Created
		$this->Date_Created = new cField('announcement', 'announcement', 'x_Date_Created', 'Date_Created', '`Date_Created`', 'DATE_FORMAT(`Date_Created`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Date_Created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Date_Created->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['Date_Created'] = &$this->Date_Created;

		// Created_By
		$this->Created_By = new cField('announcement', 'announcement', 'x_Created_By', 'Created_By', '`Created_By`', '`Created_By`', 200, -1, FALSE, '`Created_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Created_By'] = &$this->Created_By;

		// Translated_ID
		$this->Translated_ID = new cField('announcement', 'announcement', 'x_Translated_ID', 'Translated_ID', '`Translated_ID`', '`Translated_ID`', 3, -1, FALSE, '`Translated_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('Announcement_ID', $rs))
				ew_AddFilter($where, ew_QuotedName('Announcement_ID') . '=' . ew_QuotedValue($rs['Announcement_ID'], $this->Announcement_ID->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function KeyFilter() {
		...
		$sKeyFilter = str_replace("@Announcement_ID@", ew_AdjustSql($this->Announcement_ID->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("announcementview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("announcementview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "announcementadd.php?" . $this->UrlParm($parm);
		else
			return "announcementadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("announcementedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("announcementadd.php", $this->UrlParm($parm));
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["Announcement_ID"]; // Announcement_ID
