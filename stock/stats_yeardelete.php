...
// Page object
var stats_year_delete = new ew_Page("stats_year_delete");
stats_year_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = stats_year_delete.PageID; // For backward compatibility

// Form object
var fstats_yeardelete = new ew_Form("fstats_yeardelete");
...
<span id="el<?php echo $stats_year_delete->RowCnt ?>_stats_year_Year" class="form-group stats_year_Year">
...
<span id="el<?php echo $stats_year_delete->RowCnt ?>_stats_year_Hits" class="form-group stats_year_Hits">
