		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "announcementview.php")
...
// Form object
var fannouncementadd = new ew_Form("fannouncementadd");
...
fannouncementadd.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fannouncementadd.Lists["x_Translated_ID"] = {"LinkField":"x_Announcement_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Topic","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fannouncementadd" id="fannouncementadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<script type="text/javascript">
fannouncementadd.Lists["x__Language"].Options = <?php echo (is_array($announcement->_Language->EditValue)) ? ew_ArrayToJson($announcement->_Language->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fannouncementadd.Lists["x_Translated_ID"].Options = <?php echo (is_array($announcement->Translated_ID->EditValue)) ? ew_ArrayToJson($announcement->Translated_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyAdd(this)'); function alertifyAdd(obj) { <?php global $Language; ?> if (fannouncementadd.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyAddConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyAdd'); ?>"); $("#fannouncementadd").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
