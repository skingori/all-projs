...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Language_Code
		$this->Language_Code = new cField('languages', 'languages', 'x_Language_Code', 'Language_Code', '`Language_Code`', '`Language_Code`', 200, -1, FALSE, '`Language_Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Language_Code'] = &$this->Language_Code;

		// Language_Name
		$this->Language_Name = new cField('languages', 'languages', 'x_Language_Name', 'Language_Name', '`Language_Name`', '`Language_Name`', 200, -1, FALSE, '`Language_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Language_Name'] = &$this->Language_Name;

		// Default
		$this->_Default = new cField('languages', 'languages', 'x__Default', 'Default', '`Default`', '`Default`', 202, -1, FALSE, '`Default`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Site_Logo
		$this->Site_Logo = new cField('languages', 'languages', 'x_Site_Logo', 'Site_Logo', '`Site_Logo`', '`Site_Logo`', 200, -1, FALSE, '`Site_Logo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Site_Logo'] = &$this->Site_Logo;

		// Site_Title
		$this->Site_Title = new cField('languages', 'languages', 'x_Site_Title', 'Site_Title', '`Site_Title`', '`Site_Title`', 200, -1, FALSE, '`Site_Title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Site_Title'] = &$this->Site_Title;

		// Default_Thousands_Separator
		$this->Default_Thousands_Separator = new cField('languages', 'languages', 'x_Default_Thousands_Separator', 'Default_Thousands_Separator', '`Default_Thousands_Separator`', '`Default_Thousands_Separator`', 200, -1, FALSE, '`Default_Thousands_Separator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Thousands_Separator'] = &$this->Default_Thousands_Separator;

		// Default_Decimal_Point
		$this->Default_Decimal_Point = new cField('languages', 'languages', 'x_Default_Decimal_Point', 'Default_Decimal_Point', '`Default_Decimal_Point`', '`Default_Decimal_Point`', 200, -1, FALSE, '`Default_Decimal_Point`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Decimal_Point'] = &$this->Default_Decimal_Point;

		// Default_Currency_Symbol
		$this->Default_Currency_Symbol = new cField('languages', 'languages', 'x_Default_Currency_Symbol', 'Default_Currency_Symbol', '`Default_Currency_Symbol`', '`Default_Currency_Symbol`', 200, -1, FALSE, '`Default_Currency_Symbol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Currency_Symbol'] = &$this->Default_Currency_Symbol;

		// Default_Money_Thousands_Separator
		$this->Default_Money_Thousands_Separator = new cField('languages', 'languages', 'x_Default_Money_Thousands_Separator', 'Default_Money_Thousands_Separator', '`Default_Money_Thousands_Separator`', '`Default_Money_Thousands_Separator`', 200, -1, FALSE, '`Default_Money_Thousands_Separator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Money_Thousands_Separator'] = &$this->Default_Money_Thousands_Separator;

		// Default_Money_Decimal_Point
		$this->Default_Money_Decimal_Point = new cField('languages', 'languages', 'x_Default_Money_Decimal_Point', 'Default_Money_Decimal_Point', '`Default_Money_Decimal_Point`', '`Default_Money_Decimal_Point`', 200, -1, FALSE, '`Default_Money_Decimal_Point`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Money_Decimal_Point'] = &$this->Default_Money_Decimal_Point;

		// Terms_And_Condition_Text
		$this->Terms_And_Condition_Text = new cField('languages', 'languages', 'x_Terms_And_Condition_Text', 'Terms_And_Condition_Text', '`Terms_And_Condition_Text`', '`Terms_And_Condition_Text`', 201, -1, FALSE, '`Terms_And_Condition_Text`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Terms_And_Condition_Text'] = &$this->Terms_And_Condition_Text;

		// Announcement_Text
		$this->Announcement_Text = new cField('languages', 'languages', 'x_Announcement_Text', 'Announcement_Text', '`Announcement_Text`', '`Announcement_Text`', 201, -1, FALSE, '`Announcement_Text`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Announcement_Text'] = &$this->Announcement_Text;

		// About_Text
		$this->About_Text = new cField('languages', 'languages', 'x_About_Text', 'About_Text', '`About_Text`', '`About_Text`', 201, -1, FALSE, '`About_Text`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('Language_Code', $rs))
				ew_AddFilter($where, ew_QuotedName('Language_Code') . '=' . ew_QuotedValue($rs['Language_Code'], $this->Language_Code->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function KeyFilter() {
		...
		$sKeyFilter = str_replace("@Language_Code@", ew_AdjustSql($this->Language_Code->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("languagesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("languagesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "languagesadd.php?" . $this->UrlParm($parm);
		else
			return "languagesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("languagesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("languagesadd.php", $this->UrlParm($parm));
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["Language_Code"]; // Language_Code
