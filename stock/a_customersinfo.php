...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Customer_ID
		$this->Customer_ID = new cField('a_customers', 'a_customers', 'x_Customer_ID', 'Customer_ID', '`Customer_ID`', '`Customer_ID`', 3, -1, FALSE, '`Customer_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Customer_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Customer_ID'] = &$this->Customer_ID;

		// Customer_Number
		$this->Customer_Number = new cField('a_customers', 'a_customers', 'x_Customer_Number', 'Customer_Number', '`Customer_Number`', '`Customer_Number`', 200, -1, FALSE, '`Customer_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Customer_Number'] = &$this->Customer_Number;

		// Customer_Name
		$this->Customer_Name = new cField('a_customers', 'a_customers', 'x_Customer_Name', 'Customer_Name', '`Customer_Name`', '`Customer_Name`', 200, -1, FALSE, '`Customer_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Customer_Name'] = &$this->Customer_Name;

		// Address
		$this->Address = new cField('a_customers', 'a_customers', 'x_Address', 'Address', '`Address`', '`Address`', 201, -1, FALSE, '`Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Address'] = &$this->Address;

		// City
		$this->City = new cField('a_customers', 'a_customers', 'x_City', 'City', '`City`', '`City`', 200, -1, FALSE, '`City`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['City'] = &$this->City;

		// Country
		$this->Country = new cField('a_customers', 'a_customers', 'x_Country', 'Country', '`Country`', '`Country`', 200, -1, FALSE, '`Country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Country'] = &$this->Country;

		// Contact_Person
		$this->Contact_Person = new cField('a_customers', 'a_customers', 'x_Contact_Person', 'Contact_Person', '`Contact_Person`', '`Contact_Person`', 200, -1, FALSE, '`Contact_Person`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Contact_Person'] = &$this->Contact_Person;

		// Phone_Number
		$this->Phone_Number = new cField('a_customers', 'a_customers', 'x_Phone_Number', 'Phone_Number', '`Phone_Number`', '`Phone_Number`', 200, -1, FALSE, '`Phone_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Phone_Number'] = &$this->Phone_Number;

		// Email
		$this->_Email = new cField('a_customers', 'a_customers', 'x__Email', 'Email', '`Email`', '`Email`', 200, -1, FALSE, '`Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Email'] = &$this->_Email;

		// Mobile_Number
		$this->Mobile_Number = new cField('a_customers', 'a_customers', 'x_Mobile_Number', 'Mobile_Number', '`Mobile_Number`', '`Mobile_Number`', 200, -1, FALSE, '`Mobile_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Mobile_Number'] = &$this->Mobile_Number;

		// Notes
		$this->Notes = new cField('a_customers', 'a_customers', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 200, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Notes'] = &$this->Notes;

		// Balance
		$this->Balance = new cField('a_customers', 'a_customers', 'x_Balance', 'Balance', '`Balance`', '`Balance`', 5, -1, FALSE, '`Balance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Balance'] = &$this->Balance;

		// Date_Added
		$this->Date_Added = new cField('a_customers', 'a_customers', 'x_Date_Added', 'Date_Added', '`Date_Added`', 'DATE_FORMAT(`Date_Added`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Added`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Added'] = &$this->Date_Added;

		// Added_By
		$this->Added_By = new cField('a_customers', 'a_customers', 'x_Added_By', 'Added_By', '`Added_By`', '`Added_By`', 200, -1, FALSE, '`Added_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Added_By'] = &$this->Added_By;

		// Date_Updated
		$this->Date_Updated = new cField('a_customers', 'a_customers', 'x_Date_Updated', 'Date_Updated', '`Date_Updated`', 'DATE_FORMAT(`Date_Updated`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Updated'] = &$this->Date_Updated;

		// Updated_By
		$this->Updated_By = new cField('a_customers', 'a_customers', 'x_Updated_By', 'Updated_By', '`Updated_By`', '`Updated_By`', 200, -1, FALSE, '`Updated_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "a_sales") {
			$sDetailUrl = $GLOBALS["a_sales"]->GetListUrl() . "?showmaster=" . $this->TableVar;
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_customersview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_customersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "a_customersadd.php?" . $this->UrlParm($parm);
		else
			return "a_customersadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_customersedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_customersedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_customersadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_customersadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
