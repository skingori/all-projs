...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Option_ID
		$this->Option_ID = new cField('settings', 'settings', 'x_Option_ID', 'Option_ID', '`Option_ID`', '`Option_ID`', 19, -1, FALSE, '`Option_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Option_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Option_ID'] = &$this->Option_ID;

		// Option_Default
		$this->Option_Default = new cField('settings', 'settings', 'x_Option_Default', 'Option_Default', '`Option_Default`', '`Option_Default`', 202, -1, FALSE, '`Option_Default`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Default_Theme
		$this->Default_Theme = new cField('settings', 'settings', 'x_Default_Theme', 'Default_Theme', '`Default_Theme`', '`Default_Theme`', 200, -1, FALSE, '`Default_Theme`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Theme'] = &$this->Default_Theme;

		// Font_Name
		$this->Font_Name = new cField('settings', 'settings', 'x_Font_Name', 'Font_Name', '`Font_Name`', '`Font_Name`', 200, -1, FALSE, '`Font_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Font_Name'] = &$this->Font_Name;

		// Font_Size
		$this->Font_Size = new cField('settings', 'settings', 'x_Font_Size', 'Font_Size', '`Font_Size`', '`Font_Size`', 200, -1, FALSE, '`Font_Size`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Font_Size'] = &$this->Font_Size;

		// Show_Border_Layout
		$this->Show_Border_Layout = new cField('settings', 'settings', 'x_Show_Border_Layout', 'Show_Border_Layout', '`Show_Border_Layout`', '`Show_Border_Layout`', 202, -1, FALSE, '`Show_Border_Layout`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Show_Shadow_Layout
		$this->Show_Shadow_Layout = new cField('settings', 'settings', 'x_Show_Shadow_Layout', 'Show_Shadow_Layout', '`Show_Shadow_Layout`', '`Show_Shadow_Layout`', 202, -1, FALSE, '`Show_Shadow_Layout`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Menu_Horizontal
		$this->Menu_Horizontal = new cField('settings', 'settings', 'x_Menu_Horizontal', 'Menu_Horizontal', '`Menu_Horizontal`', '`Menu_Horizontal`', 202, -1, FALSE, '`Menu_Horizontal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Vertical_Menu_Width
		$this->Vertical_Menu_Width = new cField('settings', 'settings', 'x_Vertical_Menu_Width', 'Vertical_Menu_Width', '`Vertical_Menu_Width`', '`Vertical_Menu_Width`', 3, -1, FALSE, '`Vertical_Menu_Width`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Show_Announcement
		$this->Show_Announcement = new cField('settings', 'settings', 'x_Show_Announcement', 'Show_Announcement', '`Show_Announcement`', '`Show_Announcement`', 202, -1, FALSE, '`Show_Announcement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Demo_Mode
		$this->Demo_Mode = new cField('settings', 'settings', 'x_Demo_Mode', 'Demo_Mode', '`Demo_Mode`', '`Demo_Mode`', 202, -1, FALSE, '`Demo_Mode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Page_Processing_Time = new cField('settings', 'settings', 'x_Show_Page_Processing_Time', 'Show_Page_Processing_Time', '`Show_Page_Processing_Time`', '`Show_Page_Processing_Time`', 202, -1, FALSE, '`Show_Page_Processing_Time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Allow_User_Preferences = new cField('settings', 'settings', 'x_Allow_User_Preferences', 'Allow_User_Preferences', '`Allow_User_Preferences`', '`Allow_User_Preferences`', 202, -1, FALSE, '`Allow_User_Preferences`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// SMTP_Server
		$this->SMTP_Server = new cField('settings', 'settings', 'x_SMTP_Server', 'SMTP_Server', '`SMTP_Server`', '`SMTP_Server`', 200, -1, FALSE, '`SMTP_Server`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['SMTP_Server'] = &$this->SMTP_Server;

		// SMTP_Server_Port
		$this->SMTP_Server_Port = new cField('settings', 'settings', 'x_SMTP_Server_Port', 'SMTP_Server_Port', '`SMTP_Server_Port`', '`SMTP_Server_Port`', 200, -1, FALSE, '`SMTP_Server_Port`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['SMTP_Server_Port'] = &$this->SMTP_Server_Port;

		// SMTP_Server_Username
		$this->SMTP_Server_Username = new cField('settings', 'settings', 'x_SMTP_Server_Username', 'SMTP_Server_Username', '`SMTP_Server_Username`', '`SMTP_Server_Username`', 200, -1, FALSE, '`SMTP_Server_Username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['SMTP_Server_Username'] = &$this->SMTP_Server_Username;

		// SMTP_Server_Password
		$this->SMTP_Server_Password = new cField('settings', 'settings', 'x_SMTP_Server_Password', 'SMTP_Server_Password', '`SMTP_Server_Password`', '`SMTP_Server_Password`', 200, -1, FALSE, '`SMTP_Server_Password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['SMTP_Server_Password'] = &$this->SMTP_Server_Password;

		// Sender_Email
		$this->Sender_Email = new cField('settings', 'settings', 'x_Sender_Email', 'Sender_Email', '`Sender_Email`', '`Sender_Email`', 200, -1, FALSE, '`Sender_Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sender_Email'] = &$this->Sender_Email;

		// Recipient_Email
		$this->Recipient_Email = new cField('settings', 'settings', 'x_Recipient_Email', 'Recipient_Email', '`Recipient_Email`', '`Recipient_Email`', 200, -1, FALSE, '`Recipient_Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Recipient_Email'] = &$this->Recipient_Email;

		// Use_Default_Locale
		$this->Use_Default_Locale = new cField('settings', 'settings', 'x_Use_Default_Locale', 'Use_Default_Locale', '`Use_Default_Locale`', '`Use_Default_Locale`', 202, -1, FALSE, '`Use_Default_Locale`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Default_Language
		$this->Default_Language = new cField('settings', 'settings', 'x_Default_Language', 'Default_Language', '`Default_Language`', '`Default_Language`', 200, -1, FALSE, '`Default_Language`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Language'] = &$this->Default_Language;

		// Default_Timezone
		$this->Default_Timezone = new cField('settings', 'settings', 'x_Default_Timezone', 'Default_Timezone', '`Default_Timezone`', '`Default_Timezone`', 200, -1, FALSE, '`Default_Timezone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Timezone'] = &$this->Default_Timezone;

		// Default_Thousands_Separator
		$this->Default_Thousands_Separator = new cField('settings', 'settings', 'x_Default_Thousands_Separator', 'Default_Thousands_Separator', '`Default_Thousands_Separator`', '`Default_Thousands_Separator`', 200, -1, FALSE, '`Default_Thousands_Separator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Thousands_Separator'] = &$this->Default_Thousands_Separator;

		// Default_Decimal_Point
		$this->Default_Decimal_Point = new cField('settings', 'settings', 'x_Default_Decimal_Point', 'Default_Decimal_Point', '`Default_Decimal_Point`', '`Default_Decimal_Point`', 200, -1, FALSE, '`Default_Decimal_Point`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Decimal_Point'] = &$this->Default_Decimal_Point;

		// Default_Currency_Symbol
		$this->Default_Currency_Symbol = new cField('settings', 'settings', 'x_Default_Currency_Symbol', 'Default_Currency_Symbol', '`Default_Currency_Symbol`', '`Default_Currency_Symbol`', 200, -1, FALSE, '`Default_Currency_Symbol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Currency_Symbol'] = &$this->Default_Currency_Symbol;

		// Default_Money_Thousands_Separator
		$this->Default_Money_Thousands_Separator = new cField('settings', 'settings', 'x_Default_Money_Thousands_Separator', 'Default_Money_Thousands_Separator', '`Default_Money_Thousands_Separator`', '`Default_Money_Thousands_Separator`', 200, -1, FALSE, '`Default_Money_Thousands_Separator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Money_Thousands_Separator'] = &$this->Default_Money_Thousands_Separator;

		// Default_Money_Decimal_Point
		$this->Default_Money_Decimal_Point = new cField('settings', 'settings', 'x_Default_Money_Decimal_Point', 'Default_Money_Decimal_Point', '`Default_Money_Decimal_Point`', '`Default_Money_Decimal_Point`', 200, -1, FALSE, '`Default_Money_Decimal_Point`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Default_Money_Decimal_Point'] = &$this->Default_Money_Decimal_Point;

		// Maintenance_Mode
		$this->Maintenance_Mode = new cField('settings', 'settings', 'x_Maintenance_Mode', 'Maintenance_Mode', '`Maintenance_Mode`', '`Maintenance_Mode`', 202, -1, FALSE, '`Maintenance_Mode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Maintenance_Finish_DateTime = new cField('settings', 'settings', 'x_Maintenance_Finish_DateTime', 'Maintenance_Finish_DateTime', '`Maintenance_Finish_DateTime`', 'DATE_FORMAT(`Maintenance_Finish_DateTime`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Maintenance_Finish_DateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Auto_Normal_After_Maintenance = new cField('settings', 'settings', 'x_Auto_Normal_After_Maintenance', 'Auto_Normal_After_Maintenance', '`Auto_Normal_After_Maintenance`', '`Auto_Normal_After_Maintenance`', 202, -1, FALSE, '`Auto_Normal_After_Maintenance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Allow_User_To_Register = new cField('settings', 'settings', 'x_Allow_User_To_Register', 'Allow_User_To_Register', '`Allow_User_To_Register`', '`Allow_User_To_Register`', 202, -1, FALSE, '`Allow_User_To_Register`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Suspend_New_User_Account = new cField('settings', 'settings', 'x_Suspend_New_User_Account', 'Suspend_New_User_Account', '`Suspend_New_User_Account`', '`Suspend_New_User_Account`', 202, -1, FALSE, '`Suspend_New_User_Account`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->User_Need_Activation_After_Registered = new cField('settings', 'settings', 'x_User_Need_Activation_After_Registered', 'User_Need_Activation_After_Registered', '`User_Need_Activation_After_Registered`', '`User_Need_Activation_After_Registered`', 202, -1, FALSE, '`User_Need_Activation_After_Registered`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Captcha_On_Registration_Page = new cField('settings', 'settings', 'x_Show_Captcha_On_Registration_Page', 'Show_Captcha_On_Registration_Page', '`Show_Captcha_On_Registration_Page`', '`Show_Captcha_On_Registration_Page`', 202, -1, FALSE, '`Show_Captcha_On_Registration_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Captcha_On_Login_Page = new cField('settings', 'settings', 'x_Show_Captcha_On_Login_Page', 'Show_Captcha_On_Login_Page', '`Show_Captcha_On_Login_Page`', '`Show_Captcha_On_Login_Page`', 202, -1, FALSE, '`Show_Captcha_On_Login_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Captcha_On_Forgot_Password_Page = new cField('settings', 'settings', 'x_Show_Captcha_On_Forgot_Password_Page', 'Show_Captcha_On_Forgot_Password_Page', '`Show_Captcha_On_Forgot_Password_Page`', '`Show_Captcha_On_Forgot_Password_Page`', 202, -1, FALSE, '`Show_Captcha_On_Forgot_Password_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Captcha_On_Change_Password_Page = new cField('settings', 'settings', 'x_Show_Captcha_On_Change_Password_Page', 'Show_Captcha_On_Change_Password_Page', '`Show_Captcha_On_Change_Password_Page`', '`Show_Captcha_On_Change_Password_Page`', 202, -1, FALSE, '`Show_Captcha_On_Change_Password_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->User_Auto_Logout_After_Idle_In_Minutes = new cField('settings', 'settings', 'x_User_Auto_Logout_After_Idle_In_Minutes', 'User_Auto_Logout_After_Idle_In_Minutes', '`User_Auto_Logout_After_Idle_In_Minutes`', '`User_Auto_Logout_After_Idle_In_Minutes`', 3, -1, FALSE, '`User_Auto_Logout_After_Idle_In_Minutes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->User_Login_Maximum_Retry = new cField('settings', 'settings', 'x_User_Login_Maximum_Retry', 'User_Login_Maximum_Retry', '`User_Login_Maximum_Retry`', '`User_Login_Maximum_Retry`', 3, -1, FALSE, '`User_Login_Maximum_Retry`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->User_Login_Retry_Lockout = new cField('settings', 'settings', 'x_User_Login_Retry_Lockout', 'User_Login_Retry_Lockout', '`User_Login_Retry_Lockout`', '`User_Login_Retry_Lockout`', 3, -1, FALSE, '`User_Login_Retry_Lockout`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Enable_Password_Expiry = new cField('settings', 'settings', 'x_Enable_Password_Expiry', 'Enable_Password_Expiry', '`Enable_Password_Expiry`', '`Enable_Password_Expiry`', 202, -1, FALSE, '`Enable_Password_Expiry`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Password_Expiry_In_Days = new cField('settings', 'settings', 'x_Password_Expiry_In_Days', 'Password_Expiry_In_Days', '`Password_Expiry_In_Days`', '`Password_Expiry_In_Days`', 3, -1, FALSE, '`Password_Expiry_In_Days`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Show_Entire_Header
		$this->Show_Entire_Header = new cField('settings', 'settings', 'x_Show_Entire_Header', 'Show_Entire_Header', '`Show_Entire_Header`', '`Show_Entire_Header`', 202, -1, FALSE, '`Show_Entire_Header`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Logo_Width
		$this->Logo_Width = new cField('settings', 'settings', 'x_Logo_Width', 'Logo_Width', '`Logo_Width`', '`Logo_Width`', 3, -1, FALSE, '`Logo_Width`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Site_Title_In_Header = new cField('settings', 'settings', 'x_Show_Site_Title_In_Header', 'Show_Site_Title_In_Header', '`Show_Site_Title_In_Header`', '`Show_Site_Title_In_Header`', 202, -1, FALSE, '`Show_Site_Title_In_Header`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Current_User_In_Header = new cField('settings', 'settings', 'x_Show_Current_User_In_Header', 'Show_Current_User_In_Header', '`Show_Current_User_In_Header`', '`Show_Current_User_In_Header`', 202, -1, FALSE, '`Show_Current_User_In_Header`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Text_Align_In_Header = new cField('settings', 'settings', 'x_Text_Align_In_Header', 'Text_Align_In_Header', '`Text_Align_In_Header`', '`Text_Align_In_Header`', 202, -1, FALSE, '`Text_Align_In_Header`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Text_Align_In_Header'] = &$this->Text_Align_In_Header;

		// Site_Title_Text_Style
		$this->Site_Title_Text_Style = new cField('settings', 'settings', 'x_Site_Title_Text_Style', 'Site_Title_Text_Style', '`Site_Title_Text_Style`', '`Site_Title_Text_Style`', 202, -1, FALSE, '`Site_Title_Text_Style`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Site_Title_Text_Style'] = &$this->Site_Title_Text_Style;

		// Language_Selector_Visibility
		$this->Language_Selector_Visibility = new cField('settings', 'settings', 'x_Language_Selector_Visibility', 'Language_Selector_Visibility', '`Language_Selector_Visibility`', '`Language_Selector_Visibility`', 202, -1, FALSE, '`Language_Selector_Visibility`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Language_Selector_Visibility'] = &$this->Language_Selector_Visibility;

		// Language_Selector_Align
		$this->Language_Selector_Align = new cField('settings', 'settings', 'x_Language_Selector_Align', 'Language_Selector_Align', '`Language_Selector_Align`', '`Language_Selector_Align`', 202, -1, FALSE, '`Language_Selector_Align`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Language_Selector_Align'] = &$this->Language_Selector_Align;

		// Show_Entire_Footer
		$this->Show_Entire_Footer = new cField('settings', 'settings', 'x_Show_Entire_Footer', 'Show_Entire_Footer', '`Show_Entire_Footer`', '`Show_Entire_Footer`', 202, -1, FALSE, '`Show_Entire_Footer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Show_Text_In_Footer
		$this->Show_Text_In_Footer = new cField('settings', 'settings', 'x_Show_Text_In_Footer', 'Show_Text_In_Footer', '`Show_Text_In_Footer`', '`Show_Text_In_Footer`', 202, -1, FALSE, '`Show_Text_In_Footer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Back_To_Top_On_Footer = new cField('settings', 'settings', 'x_Show_Back_To_Top_On_Footer', 'Show_Back_To_Top_On_Footer', '`Show_Back_To_Top_On_Footer`', '`Show_Back_To_Top_On_Footer`', 202, -1, FALSE, '`Show_Back_To_Top_On_Footer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Terms_And_Conditions_On_Footer = new cField('settings', 'settings', 'x_Show_Terms_And_Conditions_On_Footer', 'Show_Terms_And_Conditions_On_Footer', '`Show_Terms_And_Conditions_On_Footer`', '`Show_Terms_And_Conditions_On_Footer`', 202, -1, FALSE, '`Show_Terms_And_Conditions_On_Footer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_About_Us_On_Footer = new cField('settings', 'settings', 'x_Show_About_Us_On_Footer', 'Show_About_Us_On_Footer', '`Show_About_Us_On_Footer`', '`Show_About_Us_On_Footer`', 202, -1, FALSE, '`Show_About_Us_On_Footer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Pagination_Position
		$this->Pagination_Position = new cField('settings', 'settings', 'x_Pagination_Position', 'Pagination_Position', '`Pagination_Position`', '`Pagination_Position`', 202, -1, FALSE, '`Pagination_Position`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Pagination_Position'] = &$this->Pagination_Position;

		// Pagination_Style
		$this->Pagination_Style = new cField('settings', 'settings', 'x_Pagination_Style', 'Pagination_Style', '`Pagination_Style`', '`Pagination_Style`', 202, -1, FALSE, '`Pagination_Style`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Pagination_Style'] = &$this->Pagination_Style;

		// Selectable_Records_Per_Page
		$this->Selectable_Records_Per_Page = new cField('settings', 'settings', 'x_Selectable_Records_Per_Page', 'Selectable_Records_Per_Page', '`Selectable_Records_Per_Page`', '`Selectable_Records_Per_Page`', 200, -1, FALSE, '`Selectable_Records_Per_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Selectable_Records_Per_Page'] = &$this->Selectable_Records_Per_Page;

		// Selectable_Groups_Per_Page
		$this->Selectable_Groups_Per_Page = new cField('settings', 'settings', 'x_Selectable_Groups_Per_Page', 'Selectable_Groups_Per_Page', '`Selectable_Groups_Per_Page`', '`Selectable_Groups_Per_Page`', 200, -1, FALSE, '`Selectable_Groups_Per_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Selectable_Groups_Per_Page'] = &$this->Selectable_Groups_Per_Page;

		// Default_Record_Per_Page
		$this->Default_Record_Per_Page = new cField('settings', 'settings', 'x_Default_Record_Per_Page', 'Default_Record_Per_Page', '`Default_Record_Per_Page`', '`Default_Record_Per_Page`', 3, -1, FALSE, '`Default_Record_Per_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Default_Group_Per_Page = new cField('settings', 'settings', 'x_Default_Group_Per_Page', 'Default_Group_Per_Page', '`Default_Group_Per_Page`', '`Default_Group_Per_Page`', 3, -1, FALSE, '`Default_Group_Per_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Maximum_Selected_Records = new cField('settings', 'settings', 'x_Maximum_Selected_Records', 'Maximum_Selected_Records', '`Maximum_Selected_Records`', '`Maximum_Selected_Records`', 3, -1, FALSE, '`Maximum_Selected_Records`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Maximum_Selected_Groups = new cField('settings', 'settings', 'x_Maximum_Selected_Groups', 'Maximum_Selected_Groups', '`Maximum_Selected_Groups`', '`Maximum_Selected_Groups`', 3, -1, FALSE, '`Maximum_Selected_Groups`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Table_Width_Style
		$this->Table_Width_Style = new cField('settings', 'settings', 'x_Table_Width_Style', 'Table_Width_Style', '`Table_Width_Style`', '`Table_Width_Style`', 202, -1, FALSE, '`Table_Width_Style`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Table_Width_Style'] = &$this->Table_Width_Style;

		// Scroll_Table_Width
		$this->Scroll_Table_Width = new cField('settings', 'settings', 'x_Scroll_Table_Width', 'Scroll_Table_Width', '`Scroll_Table_Width`', '`Scroll_Table_Width`', 3, -1, FALSE, '`Scroll_Table_Width`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Scroll_Table_Height
		$this->Scroll_Table_Height = new cField('settings', 'settings', 'x_Scroll_Table_Height', 'Scroll_Table_Height', '`Scroll_Table_Height`', '`Scroll_Table_Height`', 3, -1, FALSE, '`Scroll_Table_Height`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Search_Panel_Collapsed = new cField('settings', 'settings', 'x_Search_Panel_Collapsed', 'Search_Panel_Collapsed', '`Search_Panel_Collapsed`', '`Search_Panel_Collapsed`', 202, -1, FALSE, '`Search_Panel_Collapsed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Filter_Panel_Collapsed = new cField('settings', 'settings', 'x_Filter_Panel_Collapsed', 'Filter_Panel_Collapsed', '`Filter_Panel_Collapsed`', '`Filter_Panel_Collapsed`', 202, -1, FALSE, '`Filter_Panel_Collapsed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Record_Number_On_List_Page = new cField('settings', 'settings', 'x_Show_Record_Number_On_List_Page', 'Show_Record_Number_On_List_Page', '`Show_Record_Number_On_List_Page`', '`Show_Record_Number_On_List_Page`', 202, -1, FALSE, '`Show_Record_Number_On_List_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Empty_Table_On_List_Page = new cField('settings', 'settings', 'x_Show_Empty_Table_On_List_Page', 'Show_Empty_Table_On_List_Page', '`Show_Empty_Table_On_List_Page`', '`Show_Empty_Table_On_List_Page`', 202, -1, FALSE, '`Show_Empty_Table_On_List_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Rows_Vertical_Align_Top = new cField('settings', 'settings', 'x_Rows_Vertical_Align_Top', 'Rows_Vertical_Align_Top', '`Rows_Vertical_Align_Top`', '`Rows_Vertical_Align_Top`', 202, -1, FALSE, '`Rows_Vertical_Align_Top`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Action_Button_Alignment = new cField('settings', 'settings', 'x_Action_Button_Alignment', 'Action_Button_Alignment', '`Action_Button_Alignment`', '`Action_Button_Alignment`', 202, -1, FALSE, '`Action_Button_Alignment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Action_Button_Alignment'] = &$this->Action_Button_Alignment;

		// Show_Add_Success_Message
		$this->Show_Add_Success_Message = new cField('settings', 'settings', 'x_Show_Add_Success_Message', 'Show_Add_Success_Message', '`Show_Add_Success_Message`', '`Show_Add_Success_Message`', 202, -1, FALSE, '`Show_Add_Success_Message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Edit_Success_Message = new cField('settings', 'settings', 'x_Show_Edit_Success_Message', 'Show_Edit_Success_Message', '`Show_Edit_Success_Message`', '`Show_Edit_Success_Message`', 202, -1, FALSE, '`Show_Edit_Success_Message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->jQuery_Auto_Hide_Success_Message = new cField('settings', 'settings', 'x_jQuery_Auto_Hide_Success_Message', 'jQuery_Auto_Hide_Success_Message', '`jQuery_Auto_Hide_Success_Message`', '`jQuery_Auto_Hide_Success_Message`', 202, -1, FALSE, '`jQuery_Auto_Hide_Success_Message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Use_Javascript_Message = new cField('settings', 'settings', 'x_Use_Javascript_Message', 'Use_Javascript_Message', '`Use_Javascript_Message`', '`Use_Javascript_Message`', 202, -1, FALSE, '`Use_Javascript_Message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Login_Window_Type
		$this->Login_Window_Type = new cField('settings', 'settings', 'x_Login_Window_Type', 'Login_Window_Type', '`Login_Window_Type`', '`Login_Window_Type`', 202, -1, FALSE, '`Login_Window_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Login_Window_Type'] = &$this->Login_Window_Type;

		// Forgot_Password_Window_Type
		$this->Forgot_Password_Window_Type = new cField('settings', 'settings', 'x_Forgot_Password_Window_Type', 'Forgot_Password_Window_Type', '`Forgot_Password_Window_Type`', '`Forgot_Password_Window_Type`', 202, -1, FALSE, '`Forgot_Password_Window_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Forgot_Password_Window_Type'] = &$this->Forgot_Password_Window_Type;

		// Change_Password_Window_Type
		$this->Change_Password_Window_Type = new cField('settings', 'settings', 'x_Change_Password_Window_Type', 'Change_Password_Window_Type', '`Change_Password_Window_Type`', '`Change_Password_Window_Type`', 202, -1, FALSE, '`Change_Password_Window_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Change_Password_Window_Type'] = &$this->Change_Password_Window_Type;

		// Registration_Window_Type
		$this->Registration_Window_Type = new cField('settings', 'settings', 'x_Registration_Window_Type', 'Registration_Window_Type', '`Registration_Window_Type`', '`Registration_Window_Type`', 202, -1, FALSE, '`Registration_Window_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Show_Empty_Table_In_Detail_Preview = new cField('settings', 'settings', 'x_Show_Empty_Table_In_Detail_Preview', 'Show_Empty_Table_In_Detail_Preview', '`Show_Empty_Table_In_Detail_Preview`', '`Show_Empty_Table_In_Detail_Preview`', 202, -1, FALSE, '`Show_Empty_Table_In_Detail_Preview`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Detail_Preview_Table_Width = new cField('settings', 'settings', 'x_Detail_Preview_Table_Width', 'Detail_Preview_Table_Width', '`Detail_Preview_Table_Width`', '`Detail_Preview_Table_Width`', 3, -1, FALSE, '`Detail_Preview_Table_Width`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Password_Minimum_Length = new cField('settings', 'settings', 'x_Password_Minimum_Length', 'Password_Minimum_Length', '`Password_Minimum_Length`', '`Password_Minimum_Length`', 3, -1, FALSE, '`Password_Minimum_Length`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Password_Maximum_Length = new cField('settings', 'settings', 'x_Password_Maximum_Length', 'Password_Maximum_Length', '`Password_Maximum_Length`', '`Password_Maximum_Length`', 3, -1, FALSE, '`Password_Maximum_Length`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Password_Must_Contain_At_Least_One_Lower_Case = new cField('settings', 'settings', 'x_Password_Must_Contain_At_Least_One_Lower_Case', 'Password_Must_Contain_At_Least_One_Lower_Case', '`Password_Must_Contain_At_Least_One_Lower_Case`', '`Password_Must_Contain_At_Least_One_Lower_Case`', 202, -1, FALSE, '`Password_Must_Contain_At_Least_One_Lower_Case`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Password_Must_Comply_With_Minumum_Length = new cField('settings', 'settings', 'x_Password_Must_Comply_With_Minumum_Length', 'Password_Must_Comply_With_Minumum_Length', '`Password_Must_Comply_With_Minumum_Length`', '`Password_Must_Comply_With_Minumum_Length`', 202, -1, FALSE, '`Password_Must_Comply_With_Minumum_Length`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Password_Must_Comply_With_Maximum_Length = new cField('settings', 'settings', 'x_Password_Must_Comply_With_Maximum_Length', 'Password_Must_Comply_With_Maximum_Length', '`Password_Must_Comply_With_Maximum_Length`', '`Password_Must_Comply_With_Maximum_Length`', 202, -1, FALSE, '`Password_Must_Comply_With_Maximum_Length`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Password_Must_Contain_At_Least_One_Numeric = new cField('settings', 'settings', 'x_Password_Must_Contain_At_Least_One_Numeric', 'Password_Must_Contain_At_Least_One_Numeric', '`Password_Must_Contain_At_Least_One_Numeric`', '`Password_Must_Contain_At_Least_One_Numeric`', 202, -1, FALSE, '`Password_Must_Contain_At_Least_One_Numeric`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Reset_Password_Field_Options = new cField('settings', 'settings', 'x_Reset_Password_Field_Options', 'Reset_Password_Field_Options', '`Reset_Password_Field_Options`', '`Reset_Password_Field_Options`', 202, -1, FALSE, '`Reset_Password_Field_Options`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Reset_Password_Field_Options'] = &$this->Reset_Password_Field_Options;

		// Export_Record_Options
		$this->Export_Record_Options = new cField('settings', 'settings', 'x_Export_Record_Options', 'Export_Record_Options', '`Export_Record_Options`', '`Export_Record_Options`', 202, -1, FALSE, '`Export_Record_Options`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Export_Record_Options'] = &$this->Export_Record_Options;

		// Show_Record_Number_On_Exported_List_Page
		$this->Show_Record_Number_On_Exported_List_Page = new cField('settings', 'settings', 'x_Show_Record_Number_On_Exported_List_Page', 'Show_Record_Number_On_Exported_List_Page', '`Show_Record_Number_On_Exported_List_Page`', '`Show_Record_Number_On_Exported_List_Page`', 202, -1, FALSE, '`Show_Record_Number_On_Exported_List_Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Use_Table_Setting_For_Export_Original_Value = new cField('settings', 'settings', 'x_Use_Table_Setting_For_Export_Original_Value', 'Use_Table_Setting_For_Export_Original_Value', '`Use_Table_Setting_For_Export_Original_Value`', '`Use_Table_Setting_For_Export_Original_Value`', 202, -1, FALSE, '`Use_Table_Setting_For_Export_Original_Value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('Option_ID', $rs))
				ew_AddFilter($where, ew_QuotedName('Option_ID') . '=' . ew_QuotedValue($rs['Option_ID'], $this->Option_ID->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function KeyFilter() {
		...
		$sKeyFilter = str_replace("@Option_ID@", ew_AdjustSql($this->Option_ID->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("settingsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("settingsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "settingsadd.php?" . $this->UrlParm($parm);
		else
			return "settingsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("settingsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("settingsadd.php", $this->UrlParm($parm));
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["Option_ID"]; // Option_ID
