...
<span id="el_view_purchases_outstandings_Purchase_Number" class="form-group">
...
<span id="el_view_purchases_outstandings_Purchase_Date" class="form-group">
...
<span id="el_view_purchases_outstandings_Supplier_ID" class="form-group">
...
<span id="el_view_purchases_outstandings_Notes" class="form-group">
...
<span id="el_view_purchases_outstandings_Total_Amount" class="form-group">
...
<span id="el_view_purchases_outstandings_Total_Payment" class="form-group">
...
<span id="el_view_purchases_outstandings_Total_Balance" class="form-group">
