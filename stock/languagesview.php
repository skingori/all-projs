...
class clanguages_view extends clanguages {
	...
	function __construct() {
		...
		if (@$_GET["Language_Code"] <> "") {
			$this->RecKey["Language_Code"] = $_GET["Language_Code"];
			$KeyUrl .= "&amp;Language_Code=" . urlencode($this->RecKey["Language_Code"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["Language_Code"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Language_Code"]);
		}
...
// Begin of modification Permission Access for Export To Feature, by Masino Sinaga, May 5, 2012
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "languageslist.php", "", $this->TableVar, TRUE);
		$PageId = "view";
...
// Page object
var languages_view = new ew_Page("languages_view");
languages_view.PageID = "view"; // Page ID
var EW_PAGE_ID = languages_view.PageID; // For backward compatibility

// Form object
var flanguagesview = new ew_Form("flanguagesview");
...
flanguagesview.ValidateRequired = true;
<?php } else { ?>
flanguagesview.ValidateRequired = false; 
<?php } ?>
...
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
	<?php if (MS_PAGINATION_STYLE==1) { // link ?>
		<?php if (!isset($languages_view->Pager)) $languages_view->Pager = new cNumericPager($languages_view->StartRec, $languages_view->DisplayRecs, $languages_view->TotalRecs, $languages_view->RecRange) ?>
		<?php if ($languages_view->Pager->RecordCount > 0) { ?>
				<?php if (($languages_view->Pager->PageCount==1) && ($languages_view->Pager->CurrentPage == 1) && (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE)  ) { ?>
				<div class="ewPager ewRec">
					<span><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $languages_view->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $languages_view->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $languages_view->Pager->RecordCount ?></span>
				</div>
				...
				<div class="ewNumericPage"><ul class="pagination">
					...
					<li><a href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
					<?php if ($languages_view->Pager->PrevButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
					<?php } else { // else of rtl { ?>
					<li><a href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
					<?php } // end of rtl { ?>
					<?php } ?>
					<?php foreach ($languages_view->Pager->Items as $PagerItem) { ?>
						<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $languages_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
					<?php } ?>
					<?php if ($languages_view->Pager->NextButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
					<?php if ($languages_view->Pager->LastButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
				</ul></div>
				</div>
	...
	<?php } elseif (MS_PAGINATION_STYLE==2) { // button ?>
		<?php if (!isset($languages_view->Pager)) $languages_view->Pager = new cPrevNextPager($languages_view->StartRec, $languages_view->DisplayRecs, $languages_view->TotalRecs) ?>
		<?php if ($languages_view->Pager->RecordCount > 0) { ?>
				<?php if (($languages_view->Pager->PageCount==1) && ($languages_view->Pager->CurrentPage == 1) && (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE)  ) { ?>
						<div class="ewPager ewRec">
							<span><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $languages_view->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $languages_view->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $languages_view->Pager->RecordCount ?></span>
				...
				<!--first page button-->
					<?php if ($languages_view->Pager->FirstButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->FirstButton->Start ?>"><span class="icon-last ewIcon"></span></a>
					<?php } else { // else of rtl ?>
				...
				<!--previous page button-->
					<?php if ($languages_view->Pager->PrevButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->PrevButton->Start ?>"><span class="icon-next ewIcon"></span></a>
					<?php } else { // else of rtl ?>
				...
				<!--next page button-->
					<?php if ($languages_view->Pager->NextButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->NextButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
					<?php } else { // else of rtl ?>
				...
				<!--last page button-->
					<?php if ($languages_view->Pager->LastButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $languages_view->PageUrl() ?>start=<?php echo $languages_view->Pager->LastButton->Start ?>"><span class="icon-first ewIcon"></span></a>
					<?php } else { // else of rtl ?>
...
<?php if ($languages->Language_Code->Visible) { // Language_Code ?>
	<tr id="r_Language_Code">
		<td><span id="elh_languages_Language_Code"><?php echo $languages->Language_Code->FldCaption() ?></span></td>
		<td<?php echo $languages->Language_Code->CellAttributes() ?>>
<span id="el_languages_Language_Code" class="form-group">
<span<?php echo $languages->Language_Code->ViewAttributes() ?>>
<?php echo $languages->Language_Code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Language_Name->Visible) { // Language_Name ?>
	<tr id="r_Language_Name">
		<td><span id="elh_languages_Language_Name"><?php echo $languages->Language_Name->FldCaption() ?></span></td>
		<td<?php echo $languages->Language_Name->CellAttributes() ?>>
<span id="el_languages_Language_Name" class="form-group">
<span<?php echo $languages->Language_Name->ViewAttributes() ?>>
<?php echo $languages->Language_Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->_Default->Visible) { // Default ?>
	<tr id="r__Default">
		<td><span id="elh_languages__Default"><?php echo $languages->_Default->FldCaption() ?></span></td>
		<td<?php echo $languages->_Default->CellAttributes() ?>>
<span id="el_languages__Default" class="form-group">
<span<?php echo $languages->_Default->ViewAttributes() ?>>
<?php if (ew_ConvertToBool($languages->_Default->CurrentValue)) { ?>
<input type="checkbox" value="<?php echo $languages->_Default->ViewValue ?>" checked="checked" disabled="disabled">
<?php } else { ?>
<input type="checkbox" value="<?php echo $languages->_Default->ViewValue ?>" disabled="disabled">
<?php } ?>
</span>
</span>
</td>
...
<?php if ($languages->Site_Logo->Visible) { // Site_Logo ?>
	<tr id="r_Site_Logo">
		<td><span id="elh_languages_Site_Logo"><?php echo $languages->Site_Logo->FldCaption() ?></span></td>
		<td<?php echo $languages->Site_Logo->CellAttributes() ?>>
<span id="el_languages_Site_Logo" class="form-group">
<span<?php echo $languages->Site_Logo->ViewAttributes() ?>>
<?php echo $languages->Site_Logo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Site_Title->Visible) { // Site_Title ?>
	<tr id="r_Site_Title">
		<td><span id="elh_languages_Site_Title"><?php echo $languages->Site_Title->FldCaption() ?></span></td>
		<td<?php echo $languages->Site_Title->CellAttributes() ?>>
<span id="el_languages_Site_Title" class="form-group">
<span<?php echo $languages->Site_Title->ViewAttributes() ?>>
<?php echo $languages->Site_Title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Default_Thousands_Separator->Visible) { // Default_Thousands_Separator ?>
	<tr id="r_Default_Thousands_Separator">
		<td><span id="elh_languages_Default_Thousands_Separator"><?php echo $languages->Default_Thousands_Separator->FldCaption() ?></span></td>
		<td<?php echo $languages->Default_Thousands_Separator->CellAttributes() ?>>
<span id="el_languages_Default_Thousands_Separator" class="form-group">
<span<?php echo $languages->Default_Thousands_Separator->ViewAttributes() ?>>
<?php echo $languages->Default_Thousands_Separator->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Default_Decimal_Point->Visible) { // Default_Decimal_Point ?>
	<tr id="r_Default_Decimal_Point">
		<td><span id="elh_languages_Default_Decimal_Point"><?php echo $languages->Default_Decimal_Point->FldCaption() ?></span></td>
		<td<?php echo $languages->Default_Decimal_Point->CellAttributes() ?>>
<span id="el_languages_Default_Decimal_Point" class="form-group">
<span<?php echo $languages->Default_Decimal_Point->ViewAttributes() ?>>
<?php echo $languages->Default_Decimal_Point->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Default_Currency_Symbol->Visible) { // Default_Currency_Symbol ?>
	<tr id="r_Default_Currency_Symbol">
		<td><span id="elh_languages_Default_Currency_Symbol"><?php echo $languages->Default_Currency_Symbol->FldCaption() ?></span></td>
		<td<?php echo $languages->Default_Currency_Symbol->CellAttributes() ?>>
<span id="el_languages_Default_Currency_Symbol" class="form-group">
<span<?php echo $languages->Default_Currency_Symbol->ViewAttributes() ?>>
<?php echo $languages->Default_Currency_Symbol->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Default_Money_Thousands_Separator->Visible) { // Default_Money_Thousands_Separator ?>
	<tr id="r_Default_Money_Thousands_Separator">
		<td><span id="elh_languages_Default_Money_Thousands_Separator"><?php echo $languages->Default_Money_Thousands_Separator->FldCaption() ?></span></td>
		<td<?php echo $languages->Default_Money_Thousands_Separator->CellAttributes() ?>>
<span id="el_languages_Default_Money_Thousands_Separator" class="form-group">
<span<?php echo $languages->Default_Money_Thousands_Separator->ViewAttributes() ?>>
<?php echo $languages->Default_Money_Thousands_Separator->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Default_Money_Decimal_Point->Visible) { // Default_Money_Decimal_Point ?>
	<tr id="r_Default_Money_Decimal_Point">
		<td><span id="elh_languages_Default_Money_Decimal_Point"><?php echo $languages->Default_Money_Decimal_Point->FldCaption() ?></span></td>
		<td<?php echo $languages->Default_Money_Decimal_Point->CellAttributes() ?>>
<span id="el_languages_Default_Money_Decimal_Point" class="form-group">
<span<?php echo $languages->Default_Money_Decimal_Point->ViewAttributes() ?>>
<?php echo $languages->Default_Money_Decimal_Point->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Terms_And_Condition_Text->Visible) { // Terms_And_Condition_Text ?>
	<tr id="r_Terms_And_Condition_Text">
		<td><span id="elh_languages_Terms_And_Condition_Text"><?php echo $languages->Terms_And_Condition_Text->FldCaption() ?></span></td>
		<td<?php echo $languages->Terms_And_Condition_Text->CellAttributes() ?>>
<span id="el_languages_Terms_And_Condition_Text" class="form-group">
<span<?php echo $languages->Terms_And_Condition_Text->ViewAttributes() ?>>
<?php echo $languages->Terms_And_Condition_Text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->Announcement_Text->Visible) { // Announcement_Text ?>
	<tr id="r_Announcement_Text">
		<td><span id="elh_languages_Announcement_Text"><?php echo $languages->Announcement_Text->FldCaption() ?></span></td>
		<td<?php echo $languages->Announcement_Text->CellAttributes() ?>>
<span id="el_languages_Announcement_Text" class="form-group">
<span<?php echo $languages->Announcement_Text->ViewAttributes() ?>>
<?php echo $languages->Announcement_Text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($languages->About_Text->Visible) { // About_Text ?>
	<tr id="r_About_Text">
		<td><span id="elh_languages_About_Text"><?php echo $languages->About_Text->FldCaption() ?></span></td>
		<td<?php echo $languages->About_Text->CellAttributes() ?>>
<span id="el_languages_About_Text" class="form-group">
<span<?php echo $languages->About_Text->ViewAttributes() ?>>
<?php echo $languages->About_Text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
