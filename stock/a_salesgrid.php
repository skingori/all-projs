...
// Page object
var a_sales_grid = new ew_Page("a_sales_grid");
a_sales_grid.PageID = "grid"; // Page ID
var EW_PAGE_ID = a_sales_grid.PageID; // For backward compatibility

// Form object
var fa_salesgrid = new ew_Form("fa_salesgrid");
...
fa_salesgrid.Lists["x_Customer_ID"] = {"LinkField":"x_Customer_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<input type="text" data-field="x_Sales_Number" name="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Number" id="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_Number->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_Number->EditValue ?>"<?php echo $a_sales->Sales_Number->EditAttributes() ?>>
</span>
<input type="hidden" data-field="x_Sales_Number" name="o<?php echo $a_sales_grid->RowIndex ?>_Sales_Number" id="o<?php echo $a_sales_grid->RowIndex ?>_Sales_Number" value="<?php echo ew_HtmlEncode($a_sales->Sales_Number->OldValue) ?>">
<?php } ?>
...
<input type="hidden" data-field="x_Sales_Number" name="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Number" id="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Number" value="<?php echo ew_HtmlEncode($a_sales->Sales_Number->FormValue) ?>">
<input type="hidden" data-field="x_Sales_Number" name="o<?php echo $a_sales_grid->RowIndex ?>_Sales_Number" id="o<?php echo $a_sales_grid->RowIndex ?>_Sales_Number" value="<?php echo ew_HtmlEncode($a_sales->Sales_Number->OldValue) ?>">
<?php } ?>
<a id="<?php echo $a_sales_grid->PageObjName . "_row_" . $a_sales_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-field="x_Sales_ID" name="x<?php echo $a_sales_grid->RowIndex ?>_Sales_ID" id="x<?php echo $a_sales_grid->RowIndex ?>_Sales_ID" value="<?php echo ew_HtmlEncode($a_sales->Sales_ID->CurrentValue) ?>">
<input type="hidden" data-field="x_Sales_ID" name="o<?php echo $a_sales_grid->RowIndex ?>_Sales_ID" id="o<?php echo $a_sales_grid->RowIndex ?>_Sales_ID" value="<?php echo ew_HtmlEncode($a_sales->Sales_ID->OldValue) ?>">
<?php } ?>
...
<input type="text" data-field="x_Sales_Date" name="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" id="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_Date->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_Date->EditValue ?>"<?php echo $a_sales->Sales_Date->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sales_Date" name="o<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" id="o<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" value="<?php echo ew_HtmlEncode($a_sales->Sales_Date->OldValue) ?>">
<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Sales_Date" class="form-group a_sales_Sales_Date">
<input type="text" data-field="x_Sales_Date" name="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" id="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_Date->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_Date->EditValue ?>"<?php echo $a_sales->Sales_Date->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sales_Date" name="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" id="x<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" value="<?php echo ew_HtmlEncode($a_sales->Sales_Date->FormValue) ?>">
<input type="hidden" data-field="x_Sales_Date" name="o<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" id="o<?php echo $a_sales_grid->RowIndex ?>_Sales_Date" value="<?php echo ew_HtmlEncode($a_sales->Sales_Date->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php } else { ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Customer_ID" class="form-group a_sales_Customer_ID">
<select data-field="x_Customer_ID" id="x<?php echo $a_sales_grid->RowIndex ?>_Customer_ID" name="x<?php echo $a_sales_grid->RowIndex ?>_Customer_ID"<?php echo $a_sales->Customer_ID->EditAttributes() ?>>
<?php
...
<script type="text/javascript">
fa_salesgrid.Lists["x_Customer_ID"].Options = <?php echo (is_array($a_sales->Customer_ID->EditValue)) ? ew_ArrayToJson($a_sales->Customer_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
<input type="hidden" data-field="x_Customer_ID" name="o<?php echo $a_sales_grid->RowIndex ?>_Customer_ID" id="o<?php echo $a_sales_grid->RowIndex ?>_Customer_ID" value="<?php echo ew_HtmlEncode($a_sales->Customer_ID->OldValue) ?>">
<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<?php if ($a_sales->Customer_ID->getSessionValue() <> "") { ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Customer_ID" class="form-group a_sales_Customer_ID">
...
<input type="hidden" data-field="x_Customer_ID" name="x<?php echo $a_sales_grid->RowIndex ?>_Customer_ID" id="x<?php echo $a_sales_grid->RowIndex ?>_Customer_ID" value="<?php echo ew_HtmlEncode($a_sales->Customer_ID->FormValue) ?>">
<input type="hidden" data-field="x_Customer_ID" name="o<?php echo $a_sales_grid->RowIndex ?>_Customer_ID" id="o<?php echo $a_sales_grid->RowIndex ?>_Customer_ID" value="<?php echo ew_HtmlEncode($a_sales->Customer_ID->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-field="x_Total_Amount" name="o<?php echo $a_sales_grid->RowIndex ?>_Total_Amount" id="o<?php echo $a_sales_grid->RowIndex ?>_Total_Amount" value="<?php echo ew_HtmlEncode($a_sales->Total_Amount->OldValue) ?>">
<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Total_Amount" class="form-group a_sales_Total_Amount">
<input type="text" data-field="x_Total_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Total_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Amount->EditValue ?>"<?php echo $a_sales->Total_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Total_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Total_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Total_Amount" value="<?php echo ew_HtmlEncode($a_sales->Total_Amount->FormValue) ?>">
<input type="hidden" data-field="x_Total_Amount" name="o<?php echo $a_sales_grid->RowIndex ?>_Total_Amount" id="o<?php echo $a_sales_grid->RowIndex ?>_Total_Amount" value="<?php echo ew_HtmlEncode($a_sales->Total_Amount->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-field="x_Discount_Amount" name="o<?php echo $a_sales_grid->RowIndex ?>_Discount_Amount" id="o<?php echo $a_sales_grid->RowIndex ?>_Discount_Amount" value="<?php echo ew_HtmlEncode($a_sales->Discount_Amount->OldValue) ?>">
<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Discount_Amount" class="form-group a_sales_Discount_Amount">
<input type="text" data-field="x_Discount_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Discount_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Discount_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Discount_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Discount_Amount->EditValue ?>"<?php echo $a_sales->Discount_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Discount_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Discount_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Discount_Amount" value="<?php echo ew_HtmlEncode($a_sales->Discount_Amount->FormValue) ?>">
<input type="hidden" data-field="x_Discount_Amount" name="o<?php echo $a_sales_grid->RowIndex ?>_Discount_Amount" id="o<?php echo $a_sales_grid->RowIndex ?>_Discount_Amount" value="<?php echo ew_HtmlEncode($a_sales->Discount_Amount->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Tax_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Tax_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Tax_Amount->EditValue ?>"<?php echo $a_sales->Tax_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Tax_Amount" name="o<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" id="o<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" value="<?php echo ew_HtmlEncode($a_sales->Tax_Amount->OldValue) ?>">
<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Tax_Amount" class="form-group a_sales_Tax_Amount">
<input type="text" data-field="x_Tax_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Tax_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Tax_Amount->EditValue ?>"<?php echo $a_sales->Tax_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Tax_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" value="<?php echo ew_HtmlEncode($a_sales->Tax_Amount->FormValue) ?>">
<input type="hidden" data-field="x_Tax_Amount" name="o<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" id="o<?php echo $a_sales_grid->RowIndex ?>_Tax_Amount" value="<?php echo ew_HtmlEncode($a_sales->Tax_Amount->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-field="x_Final_Total_Amount" name="o<?php echo $a_sales_grid->RowIndex ?>_Final_Total_Amount" id="o<?php echo $a_sales_grid->RowIndex ?>_Final_Total_Amount" value="<?php echo ew_HtmlEncode($a_sales->Final_Total_Amount->OldValue) ?>">
<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Final_Total_Amount" class="form-group a_sales_Final_Total_Amount">
<input type="text" data-field="x_Final_Total_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Final_Total_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Final_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Final_Total_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Final_Total_Amount->EditValue ?>"<?php echo $a_sales->Final_Total_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Final_Total_Amount" name="x<?php echo $a_sales_grid->RowIndex ?>_Final_Total_Amount" id="x<?php echo $a_sales_grid->RowIndex ?>_Final_Total_Amount" value="<?php echo ew_HtmlEncode($a_sales->Final_Total_Amount->FormValue) ?>">
<input type="hidden" data-field="x_Final_Total_Amount" name="o<?php echo $a_sales_grid->RowIndex ?>_Final_Total_Amount" id="o<?php echo $a_sales_grid->RowIndex ?>_Final_Total_Amount" value="<?php echo ew_HtmlEncode($a_sales->Final_Total_Amount->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-field="x_Total_Payment" name="o<?php echo $a_sales_grid->RowIndex ?>_Total_Payment" id="o<?php echo $a_sales_grid->RowIndex ?>_Total_Payment" value="<?php echo ew_HtmlEncode($a_sales->Total_Payment->OldValue) ?>">
<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Total_Payment" class="form-group a_sales_Total_Payment">
<input type="text" data-field="x_Total_Payment" name="x<?php echo $a_sales_grid->RowIndex ?>_Total_Payment" id="x<?php echo $a_sales_grid->RowIndex ?>_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Payment->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Payment->EditValue ?>"<?php echo $a_sales->Total_Payment->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Total_Payment" name="x<?php echo $a_sales_grid->RowIndex ?>_Total_Payment" id="x<?php echo $a_sales_grid->RowIndex ?>_Total_Payment" value="<?php echo ew_HtmlEncode($a_sales->Total_Payment->FormValue) ?>">
<input type="hidden" data-field="x_Total_Payment" name="o<?php echo $a_sales_grid->RowIndex ?>_Total_Payment" id="o<?php echo $a_sales_grid->RowIndex ?>_Total_Payment" value="<?php echo ew_HtmlEncode($a_sales->Total_Payment->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-field="x_Total_Balance" name="o<?php echo $a_sales_grid->RowIndex ?>_Total_Balance" id="o<?php echo $a_sales_grid->RowIndex ?>_Total_Balance" value="<?php echo ew_HtmlEncode($a_sales->Total_Balance->OldValue) ?>">
<?php } ?>
<?php if ($a_sales->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_sales_grid->RowCnt ?>_a_sales_Total_Balance" class="form-group a_sales_Total_Balance">
<input type="text" data-field="x_Total_Balance" name="x<?php echo $a_sales_grid->RowIndex ?>_Total_Balance" id="x<?php echo $a_sales_grid->RowIndex ?>_Total_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Balance->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Balance->EditValue ?>"<?php echo $a_sales->Total_Balance->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Total_Balance" name="x<?php echo $a_sales_grid->RowIndex ?>_Total_Balance" id="x<?php echo $a_sales_grid->RowIndex ?>_Total_Balance" value="<?php echo ew_HtmlEncode($a_sales->Total_Balance->FormValue) ?>">
<input type="hidden" data-field="x_Total_Balance" name="o<?php echo $a_sales_grid->RowIndex ?>_Total_Balance" id="o<?php echo $a_sales_grid->RowIndex ?>_Total_Balance" value="<?php echo ew_HtmlEncode($a_sales->Total_Balance->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
