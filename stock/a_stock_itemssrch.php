...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			// Call Lookup selecting
			$this->Lookup_Selecting($this->Unit_Of_Measurement, $sWhereWrk);
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$this->Unit_Of_Measurement->ViewValue = $rswrk->fields('DispFld');
					$rswrk->Close();
				} else {
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "a_stock_itemslist.php", "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Page object
var a_stock_items_search = new ew_Page("a_stock_items_search");
a_stock_items_search.PageID = "search"; // Page ID
var EW_PAGE_ID = a_stock_items_search.PageID; // For backward compatibility

// Form object
var fa_stock_itemssearch = new ew_Form("fa_stock_itemssearch");
...
fa_stock_itemssearch.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemssearch.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemssearch.Lists["x_Unit_Of_Measurement"] = {"LinkField":"x_UOM_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_UOM_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fa_stock_itemssearch" id="fa_stock_itemssearch" class="form-horizontal ewForm ewSearchForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($a_stock_items->Stock_ID->Visible) { // Stock_ID ?>
	<div id="r_Stock_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Stock_ID" id="z_Stock_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Stock_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Stock_ID">
<input type="text" data-field="x_Stock_ID" name="x_Stock_ID" id="x_Stock_ID" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_ID->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_ID->EditValue ?>"<?php echo $a_stock_items->Stock_ID->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Stock_ID" name="y_Stock_ID" id="y_Stock_ID" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_ID->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_ID->EditValue2 ?>"<?php echo $a_stock_items->Stock_ID->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_stock_items->Category->Visible) { // Category ?>
	<div id="r_Category" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Category" id="z_Category" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Category->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Category->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Category->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Category->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Category->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Category->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Category->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Category">
<select data-field="x_Category" id="x_Category" name="x_Category"<?php echo $a_stock_items->Category->EditAttributes() ?>>
<?php
if (is_array($a_stock_items->Category->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Category->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fa_stock_itemssearch.Lists["x_Category"].Options = <?php echo (is_array($a_stock_items->Category->EditValue)) ? ew_ArrayToJson($a_stock_items->Category->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Category" id="y_Category" name="y_Category"<?php echo $a_stock_items->Category->EditAttributes() ?>>
<?php
if (is_array($a_stock_items->Category->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Category->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_stock_itemssearch.Lists["x_Category"].Options = <?php echo (is_array($a_stock_items->Category->EditValue2)) ? ew_ArrayToJson($a_stock_items->Category->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($a_stock_items->Supplier_Number->Visible) { // Supplier_Number ?>
	<div id="r_Supplier_Number" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Supplier_Number" id="z_Supplier_Number" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Supplier_Number->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Supplier_Number">
<select data-field="x_Supplier_Number" id="x_Supplier_Number" name="x_Supplier_Number"<?php echo $a_stock_items->Supplier_Number->EditAttributes() ?>>
<?php
if (is_array($a_stock_items->Supplier_Number->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Supplier_Number->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_stock_itemssearch.Lists["x_Supplier_Number"].Options = <?php echo (is_array($a_stock_items->Supplier_Number->EditValue)) ? ew_ArrayToJson($a_stock_items->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Supplier_Number" id="y_Supplier_Number" name="y_Supplier_Number"<?php echo $a_stock_items->Supplier_Number->EditAttributes() ?>>
<?php
if (is_array($a_stock_items->Supplier_Number->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Supplier_Number->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_stock_itemssearch.Lists["x_Supplier_Number"].Options = <?php echo (is_array($a_stock_items->Supplier_Number->EditValue2)) ? ew_ArrayToJson($a_stock_items->Supplier_Number->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($a_stock_items->Stock_Number->Visible) { // Stock_Number ?>
	<div id="r_Stock_Number" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Stock_Number" id="z_Stock_Number" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Stock_Number->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Stock_Number">
<input type="text" data-field="x_Stock_Number" name="x_Stock_Number" id="x_Stock_Number" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_Number->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_Number->EditValue ?>"<?php echo $a_stock_items->Stock_Number->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Stock_Number" name="y_Stock_Number" id="y_Stock_Number" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_Number->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_Number->EditValue2 ?>"<?php echo $a_stock_items->Stock_Number->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_stock_items->Stock_Name->Visible) { // Stock_Name ?>
	<div id="r_Stock_Name" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Stock_Name" id="z_Stock_Name" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Stock_Name->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Stock_Name">
<input type="text" data-field="x_Stock_Name" name="x_Stock_Name" id="x_Stock_Name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_Name->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_Name->EditValue ?>"<?php echo $a_stock_items->Stock_Name->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Stock_Name" name="y_Stock_Name" id="y_Stock_Name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_Name->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_Name->EditValue2 ?>"<?php echo $a_stock_items->Stock_Name->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_stock_items->Unit_Of_Measurement->Visible) { // Unit_Of_Measurement ?>
	<div id="r_Unit_Of_Measurement" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Unit_Of_Measurement" id="z_Unit_Of_Measurement" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Unit_Of_Measurement">
<select data-field="x_Unit_Of_Measurement" id="x_Unit_Of_Measurement" name="x_Unit_Of_Measurement"<?php echo $a_stock_items->Unit_Of_Measurement->EditAttributes() ?>>
<?php
if (is_array($a_stock_items->Unit_Of_Measurement->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_stock_itemssearch.Lists["x_Unit_Of_Measurement"].Options = <?php echo (is_array($a_stock_items->Unit_Of_Measurement->EditValue)) ? ew_ArrayToJson($a_stock_items->Unit_Of_Measurement->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Unit_Of_Measurement" id="y_Unit_Of_Measurement" name="y_Unit_Of_Measurement"<?php echo $a_stock_items->Unit_Of_Measurement->EditAttributes() ?>>
<?php
if (is_array($a_stock_items->Unit_Of_Measurement->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Unit_Of_Measurement->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_stock_itemssearch.Lists["x_Unit_Of_Measurement"].Options = <?php echo (is_array($a_stock_items->Unit_Of_Measurement->EditValue2)) ? ew_ArrayToJson($a_stock_items->Unit_Of_Measurement->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($a_stock_items->Purchasing_Price->Visible) { // Purchasing_Price ?>
	<div id="r_Purchasing_Price" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Purchasing_Price" id="z_Purchasing_Price" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Purchasing_Price->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Purchasing_Price->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Purchasing_Price->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Purchasing_Price->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Purchasing_Price->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Purchasing_Price->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Purchasing_Price->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Purchasing_Price">
<input type="text" data-field="x_Purchasing_Price" name="x_Purchasing_Price" id="x_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $a_stock_items->Purchasing_Price->EditValue ?>"<?php echo $a_stock_items->Purchasing_Price->EditAttributes() ?>>
...
<input type="text" data-field="x_Purchasing_Price" name="y_Purchasing_Price" id="y_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $a_stock_items->Purchasing_Price->EditValue2 ?>"<?php echo $a_stock_items->Purchasing_Price->EditAttributes() ?>>
<?php if (!$a_stock_items->Purchasing_Price->ReadOnly && !$a_stock_items->Purchasing_Price->Disabled && @$a_stock_items->Purchasing_Price->EditAttrs["readonly"] == "" && @$a_stock_items->Purchasing_Price->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_stock_items->Selling_Price->Visible) { // Selling_Price ?>
	<div id="r_Selling_Price" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Selling_Price" id="z_Selling_Price" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Selling_Price->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Selling_Price->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Selling_Price->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Selling_Price->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Selling_Price->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Selling_Price->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Selling_Price->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Selling_Price">
<input type="text" data-field="x_Selling_Price" name="x_Selling_Price" id="x_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Selling_Price->PlaceHolder) ?>" value="<?php echo $a_stock_items->Selling_Price->EditValue ?>"<?php echo $a_stock_items->Selling_Price->EditAttributes() ?>>
...
<input type="text" data-field="x_Selling_Price" name="y_Selling_Price" id="y_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Selling_Price->PlaceHolder) ?>" value="<?php echo $a_stock_items->Selling_Price->EditValue2 ?>"<?php echo $a_stock_items->Selling_Price->EditAttributes() ?>>
<?php if (!$a_stock_items->Selling_Price->ReadOnly && !$a_stock_items->Selling_Price->Disabled && @$a_stock_items->Selling_Price->EditAttrs["readonly"] == "" && @$a_stock_items->Selling_Price->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_stock_items->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Quantity" id="z_Quantity" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Quantity->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Quantity->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Quantity->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Quantity->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Quantity->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Quantity->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Quantity->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Quantity">
<input type="text" data-field="x_Quantity" name="x_Quantity" id="x_Quantity" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Quantity->PlaceHolder) ?>" value="<?php echo $a_stock_items->Quantity->EditValue ?>"<?php echo $a_stock_items->Quantity->EditAttributes() ?>>
...
<input type="text" data-field="x_Quantity" name="y_Quantity" id="y_Quantity" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Quantity->PlaceHolder) ?>" value="<?php echo $a_stock_items->Quantity->EditValue2 ?>"<?php echo $a_stock_items->Quantity->EditAttributes() ?>>
<?php if (!$a_stock_items->Quantity->ReadOnly && !$a_stock_items->Quantity->Disabled && @$a_stock_items->Quantity->EditAttrs["readonly"] == "" && @$a_stock_items->Quantity->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_stock_items->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Notes" id="z_Notes" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Notes->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Notes">
<input type="text" data-field="x_Notes" name="x_Notes" id="x_Notes" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Notes->PlaceHolder) ?>" value="<?php echo $a_stock_items->Notes->EditValue ?>"<?php echo $a_stock_items->Notes->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Notes" name="y_Notes" id="y_Notes" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Notes->PlaceHolder) ?>" value="<?php echo $a_stock_items->Notes->EditValue2 ?>"<?php echo $a_stock_items->Notes->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_stock_items->Date_Added->Visible) { // Date_Added ?>
	<div id="r_Date_Added" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Date_Added" id="z_Date_Added" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Date_Added->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Date_Added">
<input type="text" data-field="x_Date_Added" name="x_Date_Added" id="x_Date_Added" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Date_Added->PlaceHolder) ?>" value="<?php echo $a_stock_items->Date_Added->EditValue ?>"<?php echo $a_stock_items->Date_Added->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Date_Added" name="y_Date_Added" id="y_Date_Added" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Date_Added->PlaceHolder) ?>" value="<?php echo $a_stock_items->Date_Added->EditValue2 ?>"<?php echo $a_stock_items->Date_Added->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_stock_items->Added_By->Visible) { // Added_By ?>
	<div id="r_Added_By" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Added_By" id="z_Added_By" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Added_By->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Added_By">
<input type="text" data-field="x_Added_By" name="x_Added_By" id="x_Added_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Added_By->PlaceHolder) ?>" value="<?php echo $a_stock_items->Added_By->EditValue ?>"<?php echo $a_stock_items->Added_By->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Added_By" name="y_Added_By" id="y_Added_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Added_By->PlaceHolder) ?>" value="<?php echo $a_stock_items->Added_By->EditValue2 ?>"<?php echo $a_stock_items->Added_By->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_stock_items->Date_Updated->Visible) { // Date_Updated ?>
	<div id="r_Date_Updated" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Date_Updated" id="z_Date_Updated" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Date_Updated->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Date_Updated">
<input type="text" data-field="x_Date_Updated" name="x_Date_Updated" id="x_Date_Updated" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Date_Updated->PlaceHolder) ?>" value="<?php echo $a_stock_items->Date_Updated->EditValue ?>"<?php echo $a_stock_items->Date_Updated->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Date_Updated" name="y_Date_Updated" id="y_Date_Updated" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Date_Updated->PlaceHolder) ?>" value="<?php echo $a_stock_items->Date_Updated->EditValue2 ?>"<?php echo $a_stock_items->Date_Updated->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_stock_items->Updated_By->Visible) { // Updated_By ?>
	<div id="r_Updated_By" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Updated_By" id="z_Updated_By" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_stock_items->Updated_By->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_stock_items_Updated_By">
<input type="text" data-field="x_Updated_By" name="x_Updated_By" id="x_Updated_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Updated_By->PlaceHolder) ?>" value="<?php echo $a_stock_items->Updated_By->EditValue ?>"<?php echo $a_stock_items->Updated_By->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Updated_By" name="y_Updated_By" id="y_Updated_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Updated_By->PlaceHolder) ?>" value="<?php echo $a_stock_items->Updated_By->EditValue2 ?>"<?php echo $a_stock_items->Updated_By->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
