...
<span id="el<?php echo $users_delete->RowCnt ?>_users_Username" class="form-group users_Username">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_First_Name" class="form-group users_First_Name">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_Last_Name" class="form-group users_Last_Name">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users__Email" class="form-group users__Email">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_Activated" class="form-group users_Activated">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_Locked" class="form-group users_Locked">
...
<?php if ($users->Export == "") { ?>
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fusersdelete.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fusersdelete").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
