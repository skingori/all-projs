...
// Page object
var a_purchases_delete = new ew_Page("a_purchases_delete");
a_purchases_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = a_purchases_delete.PageID; // For backward compatibility

// Form object
var fa_purchasesdelete = new ew_Form("fa_purchasesdelete");
...
fa_purchasesdelete.Lists["x_Supplier_ID"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el<?php echo $a_purchases_delete->RowCnt ?>_a_purchases_Purchase_Number" class="form-group a_purchases_Purchase_Number">
...
<span id="el<?php echo $a_purchases_delete->RowCnt ?>_a_purchases_Purchase_Date" class="form-group a_purchases_Purchase_Date">
...
<span id="el<?php echo $a_purchases_delete->RowCnt ?>_a_purchases_Supplier_ID" class="form-group a_purchases_Supplier_ID">
...
<span id="el<?php echo $a_purchases_delete->RowCnt ?>_a_purchases_Total_Amount" class="form-group a_purchases_Total_Amount">
...
<span id="el<?php echo $a_purchases_delete->RowCnt ?>_a_purchases_Total_Payment" class="form-group a_purchases_Total_Payment">
...
<span id="el<?php echo $a_purchases_delete->RowCnt ?>_a_purchases_Total_Balance" class="form-group a_purchases_Total_Balance">
