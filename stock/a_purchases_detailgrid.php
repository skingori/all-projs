...
// Page object
var a_purchases_detail_grid = new ew_Page("a_purchases_detail_grid");
a_purchases_detail_grid.PageID = "grid"; // Page ID
var EW_PAGE_ID = a_purchases_detail_grid.PageID; // For backward compatibility

// Form object
var fa_purchases_detailgrid = new ew_Form("fa_purchases_detailgrid");
...
fa_purchases_detailgrid.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_purchases_detailgrid.Lists["x_Stock_Item"] = {"LinkField":"x_Stock_Number","Ajax":null,"AutoFill":true,"DisplayFields":["x_Stock_Name","","",""],"ParentFields":["x_Supplier_Number"],"FilterFields":["x_Supplier_Number"],"Options":[]};
...
<?php if ($a_purchases_detail->Purchase_Number->Visible) { // Purchase_Number ?>
	<?php if ($a_purchases_detail->SortUrl($a_purchases_detail->Purchase_Number) == "") { ?>
		<th data-name="Purchase_Number"><div id="elh_a_purchases_detail_Purchase_Number" class="a_purchases_detail_Purchase_Number"><div class="ewTableHeaderCaption"><?php echo $a_purchases_detail->Purchase_Number->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Purchase_Number"><div><div id="elh_a_purchases_detail_Purchase_Number" class="a_purchases_detail_Purchase_Number">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $a_purchases_detail->Purchase_Number->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($a_purchases_detail->Purchase_Number->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($a_purchases_detail->Purchase_Number->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
?>
	<?php if ($a_purchases_detail->Purchase_Number->Visible) { // Purchase_Number ?>
		<td data-name="Purchase_Number"<?php echo $a_purchases_detail->Purchase_Number->CellAttributes() ?>>
<?php if ($a_purchases_detail->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<?php if ($a_purchases_detail->Purchase_Number->getSessionValue() <> "") { ?>
<span id="el<?php echo $a_purchases_detail_grid->RowCnt ?>_a_purchases_detail_Purchase_Number" class="form-group a_purchases_detail_Purchase_Number">
...
<input type="hidden" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_Number->CurrentValue) ?>">
<?php } else { ?>
<span id="el<?php echo $a_purchases_detail_grid->RowCnt ?>_a_purchases_detail_Purchase_Number" class="form-group a_purchases_detail_Purchase_Number">
<input type="text" data-field="x_Purchase_Number" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_Number->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchase_Number->EditValue ?>"<?php echo $a_purchases_detail->Purchase_Number->EditAttributes() ?>>
</span>
<?php } ?>
<input type="hidden" data-field="x_Purchase_Number" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_Number->OldValue) ?>">
<?php } ?>
...
<span<?php echo $a_purchases_detail->Purchase_Number->ViewAttributes() ?>>
<?php echo $a_purchases_detail->Purchase_Number->ListViewValue() ?></span>
<input type="hidden" data-field="x_Purchase_Number" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_Number->FormValue) ?>">
<input type="hidden" data-field="x_Purchase_Number" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_Number->OldValue) ?>">
<?php } ?>
<a id="<?php echo $a_purchases_detail_grid->PageObjName . "_row_" . $a_purchases_detail_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($a_purchases_detail->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-field="x_Purchase_ID" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_ID" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_ID" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_ID->CurrentValue) ?>">
<input type="hidden" data-field="x_Purchase_ID" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_ID" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_ID" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_ID->OldValue) ?>">
<?php } ?>
...
<?php $a_purchases_detail->Supplier_Number->EditAttrs["onchange"] = "ew_UpdateOpt.call(this, ['x" . $a_purchases_detail_grid->RowIndex . "_Stock_Item']); " . @$a_purchases_detail->Supplier_Number->EditAttrs["onchange"]; ?>
<select data-field="x_Supplier_Number" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Supplier_Number" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Supplier_Number"<?php echo $a_purchases_detail->Supplier_Number->EditAttributes() ?>>
<?php
if (is_array($a_purchases_detail->Supplier_Number->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_purchases_detail->Supplier_Number->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fa_purchases_detailgrid.Lists["x_Supplier_Number"].Options = <?php echo (is_array($a_purchases_detail->Supplier_Number->EditValue)) ? ew_ArrayToJson($a_purchases_detail->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
<input type="hidden" data-field="x_Supplier_Number" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Supplier_Number" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($a_purchases_detail->Supplier_Number->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases_detail->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_detail_grid->RowCnt ?>_a_purchases_detail_Supplier_Number" class="form-group a_purchases_detail_Supplier_Number">
<?php $a_purchases_detail->Supplier_Number->EditAttrs["onchange"] = "ew_UpdateOpt.call(this, ['x" . $a_purchases_detail_grid->RowIndex . "_Stock_Item']); " . @$a_purchases_detail->Supplier_Number->EditAttrs["onchange"]; ?>
...
<input type="hidden" data-field="x_Supplier_Number" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Supplier_Number" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($a_purchases_detail->Supplier_Number->FormValue) ?>">
<input type="hidden" data-field="x_Supplier_Number" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Supplier_Number" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($a_purchases_detail->Supplier_Number->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<select data-field="x_Stock_Item" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Stock_Item" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Stock_Item"<?php echo $a_purchases_detail->Stock_Item->EditAttributes() ?>>
<?php
if (is_array($a_purchases_detail->Stock_Item->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_purchases_detail->Stock_Item->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_purchases_detailgrid.Lists["x_Stock_Item"].Options = <?php echo (is_array($a_purchases_detail->Stock_Item->EditValue)) ? ew_ArrayToJson($a_purchases_detail->Stock_Item->EditValue, 1) : "[]" ?>;
</script>
...
<input type="hidden" data-field="x_Stock_Item" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Stock_Item" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Stock_Item" value="<?php echo ew_HtmlEncode($a_purchases_detail->Stock_Item->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases_detail->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_detail_grid->RowCnt ?>_a_purchases_detail_Stock_Item" class="form-group a_purchases_detail_Stock_Item">
<?php $a_purchases_detail->Stock_Item->EditAttrs["onchange"] = "ew_AutoFill(this); " . @$a_purchases_detail->Stock_Item->EditAttrs["onchange"]; ?>
...
<input type="hidden" data-field="x_Stock_Item" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Stock_Item" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Stock_Item" value="<?php echo ew_HtmlEncode($a_purchases_detail->Stock_Item->FormValue) ?>">
<input type="hidden" data-field="x_Stock_Item" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Stock_Item" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Stock_Item" value="<?php echo ew_HtmlEncode($a_purchases_detail->Stock_Item->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Purchasing_Quantity" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Quantity->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchasing_Quantity->EditValue ?>"<?php echo $a_purchases_detail->Purchasing_Quantity->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Quantity" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Quantity->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases_detail->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_detail_grid->RowCnt ?>_a_purchases_detail_Purchasing_Quantity" class="form-group a_purchases_detail_Purchasing_Quantity">
<input type="text" data-field="x_Purchasing_Quantity" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Quantity->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchasing_Quantity->EditValue ?>"<?php echo $a_purchases_detail->Purchasing_Quantity->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Quantity" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Quantity->FormValue) ?>">
<input type="hidden" data-field="x_Purchasing_Quantity" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Quantity" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Quantity->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Purchasing_Price" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchasing_Price->EditValue ?>"<?php echo $a_purchases_detail->Purchasing_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Price" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Price->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases_detail->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_detail_grid->RowCnt ?>_a_purchases_detail_Purchasing_Price" class="form-group a_purchases_detail_Purchasing_Price">
<input type="text" data-field="x_Purchasing_Price" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchasing_Price->EditValue ?>"<?php echo $a_purchases_detail->Purchasing_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Price" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Price->FormValue) ?>">
<input type="hidden" data-field="x_Purchasing_Price" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Price->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Selling_Price" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Selling_Price->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Selling_Price->EditValue ?>"<?php echo $a_purchases_detail->Selling_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Selling_Price" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" value="<?php echo ew_HtmlEncode($a_purchases_detail->Selling_Price->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases_detail->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_detail_grid->RowCnt ?>_a_purchases_detail_Selling_Price" class="form-group a_purchases_detail_Selling_Price">
<input type="text" data-field="x_Selling_Price" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Selling_Price->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Selling_Price->EditValue ?>"<?php echo $a_purchases_detail->Selling_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Selling_Price" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" value="<?php echo ew_HtmlEncode($a_purchases_detail->Selling_Price->FormValue) ?>">
<input type="hidden" data-field="x_Selling_Price" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Selling_Price" value="<?php echo ew_HtmlEncode($a_purchases_detail->Selling_Price->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Purchasing_Total_Amount" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Total_Amount->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchasing_Total_Amount->EditValue ?>"<?php echo $a_purchases_detail->Purchasing_Total_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Total_Amount" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Total_Amount->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases_detail->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_detail_grid->RowCnt ?>_a_purchases_detail_Purchasing_Total_Amount" class="form-group a_purchases_detail_Purchasing_Total_Amount">
<input type="text" data-field="x_Purchasing_Total_Amount" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Total_Amount->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchasing_Total_Amount->EditValue ?>"<?php echo $a_purchases_detail->Purchasing_Total_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Total_Amount" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Total_Amount->FormValue) ?>">
<input type="hidden" data-field="x_Purchasing_Total_Amount" name="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" id="o<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchasing_Total_Amount" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Total_Amount->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($a_purchases_detail->Purchase_Number->getSessionValue() <> "") { ?>
<span id="el$rowindex$_a_purchases_detail_Purchase_Number" class="form-group a_purchases_detail_Purchase_Number">
<span<?php echo $a_purchases_detail->Purchase_Number->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $a_purchases_detail->Purchase_Number->ViewValue ?></p></span>
</span>
<input type="hidden" id="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" name="x<?php echo $a_purchases_detail_grid->RowIndex ?>_Purchase_Number" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_Number->CurrentValue) ?>">
