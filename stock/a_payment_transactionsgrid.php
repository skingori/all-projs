...
// Page object
var a_payment_transactions_grid = new ew_Page("a_payment_transactions_grid");
a_payment_transactions_grid.PageID = "grid"; // Page ID
var EW_PAGE_ID = a_payment_transactions_grid.PageID; // For backward compatibility

// Form object
var fa_payment_transactionsgrid = new ew_Form("fa_payment_transactionsgrid");
...
fa_payment_transactionsgrid.Lists["x_Customer"] = {"LinkField":"x_Customer_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_payment_transactionsgrid.Lists["x_Supplier"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } else { ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Ref_ID" class="form-group a_payment_transactions_Ref_ID">
<input type="text" data-field="x_Ref_ID" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Ref_ID" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Ref_ID" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Ref_ID->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Ref_ID->EditValue ?>"<?php echo $a_payment_transactions->Ref_ID->EditAttributes() ?>>
</span>
<?php } ?>
<input type="hidden" data-field="x_Ref_ID" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Ref_ID" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Ref_ID" value="<?php echo ew_HtmlEncode($a_payment_transactions->Ref_ID->OldValue) ?>">
<?php } ?>
...
<input type="hidden" data-field="x_Ref_ID" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Ref_ID" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Ref_ID" value="<?php echo ew_HtmlEncode($a_payment_transactions->Ref_ID->FormValue) ?>">
<input type="hidden" data-field="x_Ref_ID" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Ref_ID" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Ref_ID" value="<?php echo ew_HtmlEncode($a_payment_transactions->Ref_ID->OldValue) ?>">
<?php } ?>
<a id="<?php echo $a_payment_transactions_grid->PageObjName . "_row_" . $a_payment_transactions_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-field="x_Payment_ID" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment_ID" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment_ID" value="<?php echo ew_HtmlEncode($a_payment_transactions->Payment_ID->CurrentValue) ?>">
<input type="hidden" data-field="x_Payment_ID" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment_ID" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment_ID" value="<?php echo ew_HtmlEncode($a_payment_transactions->Payment_ID->OldValue) ?>">
<?php } ?>
...
<div id="tp_x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" value="{value}"<?php echo $a_payment_transactions->Type->EditAttributes() ?>></div>
<div id="dsl_x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" data-repeatcolumn="5" class="ewItemList">
<?php
...
<input type="hidden" data-field="x_Type" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" value="<?php echo ew_HtmlEncode($a_payment_transactions->Type->OldValue) ?>">
<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Type" class="form-group a_payment_transactions_Type">
<div id="tp_x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" value="{value}"<?php echo $a_payment_transactions->Type->EditAttributes() ?>></div>
...
<input type="hidden" data-field="x_Type" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" value="<?php echo ew_HtmlEncode($a_payment_transactions->Type->FormValue) ?>">
<input type="hidden" data-field="x_Type" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Type" value="<?php echo ew_HtmlEncode($a_payment_transactions->Type->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<select data-field="x_Customer" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer"<?php echo $a_payment_transactions->Customer->EditAttributes() ?>>
<?php
if (is_array($a_payment_transactions->Customer->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_payment_transactions->Customer->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
...
<script type="text/javascript">
fa_payment_transactionsgrid.Lists["x_Customer"].Options = <?php echo (is_array($a_payment_transactions->Customer->EditValue)) ? ew_ArrayToJson($a_payment_transactions->Customer->EditValue, 1) : "[]" ?>;
</script>
</span>
<input type="hidden" data-field="x_Customer" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer" value="<?php echo ew_HtmlEncode($a_payment_transactions->Customer->OldValue) ?>">
<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Customer" class="form-group a_payment_transactions_Customer">
<select data-field="x_Customer" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer"<?php echo $a_payment_transactions->Customer->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Customer" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer" value="<?php echo ew_HtmlEncode($a_payment_transactions->Customer->FormValue) ?>">
<input type="hidden" data-field="x_Customer" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Customer" value="<?php echo ew_HtmlEncode($a_payment_transactions->Customer->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<select data-field="x_Supplier" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier"<?php echo $a_payment_transactions->Supplier->EditAttributes() ?>>
<?php
if (is_array($a_payment_transactions->Supplier->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_payment_transactions->Supplier->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_payment_transactionsgrid.Lists["x_Supplier"].Options = <?php echo (is_array($a_payment_transactions->Supplier->EditValue)) ? ew_ArrayToJson($a_payment_transactions->Supplier->EditValue, 1) : "[]" ?>;
</script>
</span>
<input type="hidden" data-field="x_Supplier" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier" value="<?php echo ew_HtmlEncode($a_payment_transactions->Supplier->OldValue) ?>">
<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Supplier" class="form-group a_payment_transactions_Supplier">
<select data-field="x_Supplier" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier"<?php echo $a_payment_transactions->Supplier->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Supplier" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier" value="<?php echo ew_HtmlEncode($a_payment_transactions->Supplier->FormValue) ?>">
<input type="hidden" data-field="x_Supplier" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Supplier" value="<?php echo ew_HtmlEncode($a_payment_transactions->Supplier->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Sub_Total" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Sub_Total->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Sub_Total->EditValue ?>"<?php echo $a_payment_transactions->Sub_Total->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sub_Total" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" value="<?php echo ew_HtmlEncode($a_payment_transactions->Sub_Total->OldValue) ?>">
<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Sub_Total" class="form-group a_payment_transactions_Sub_Total">
<input type="text" data-field="x_Sub_Total" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Sub_Total->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Sub_Total->EditValue ?>"<?php echo $a_payment_transactions->Sub_Total->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sub_Total" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" value="<?php echo ew_HtmlEncode($a_payment_transactions->Sub_Total->FormValue) ?>">
<input type="hidden" data-field="x_Sub_Total" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Sub_Total" value="<?php echo ew_HtmlEncode($a_payment_transactions->Sub_Total->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Payment" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Payment->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Payment->EditValue ?>"<?php echo $a_payment_transactions->Payment->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Payment" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" value="<?php echo ew_HtmlEncode($a_payment_transactions->Payment->OldValue) ?>">
<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Payment" class="form-group a_payment_transactions_Payment">
<input type="text" data-field="x_Payment" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Payment->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Payment->EditValue ?>"<?php echo $a_payment_transactions->Payment->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Payment" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" value="<?php echo ew_HtmlEncode($a_payment_transactions->Payment->FormValue) ?>">
<input type="hidden" data-field="x_Payment" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Payment" value="<?php echo ew_HtmlEncode($a_payment_transactions->Payment->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Balance" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Balance->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Balance->EditValue ?>"<?php echo $a_payment_transactions->Balance->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Balance" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" value="<?php echo ew_HtmlEncode($a_payment_transactions->Balance->OldValue) ?>">
<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Balance" class="form-group a_payment_transactions_Balance">
<input type="text" data-field="x_Balance" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Balance->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Balance->EditValue ?>"<?php echo $a_payment_transactions->Balance->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Balance" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" value="<?php echo ew_HtmlEncode($a_payment_transactions->Balance->FormValue) ?>">
<input type="hidden" data-field="x_Balance" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Balance" value="<?php echo ew_HtmlEncode($a_payment_transactions->Balance->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Due_Date" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Due_Date->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Due_Date->EditValue ?>"<?php echo $a_payment_transactions->Due_Date->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Due_Date" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" value="<?php echo ew_HtmlEncode($a_payment_transactions->Due_Date->OldValue) ?>">
<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Due_Date" class="form-group a_payment_transactions_Due_Date">
<input type="text" data-field="x_Due_Date" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Due_Date->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Due_Date->EditValue ?>"<?php echo $a_payment_transactions->Due_Date->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Due_Date" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" value="<?php echo ew_HtmlEncode($a_payment_transactions->Due_Date->FormValue) ?>">
<input type="hidden" data-field="x_Due_Date" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Due_Date" value="<?php echo ew_HtmlEncode($a_payment_transactions->Due_Date->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Date_Transaction" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Transaction->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Date_Transaction->EditValue ?>"<?php echo $a_payment_transactions->Date_Transaction->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Date_Transaction" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" value="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Transaction->OldValue) ?>">
<?php } ?>
<?php if ($a_payment_transactions->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_payment_transactions_grid->RowCnt ?>_a_payment_transactions_Date_Transaction" class="form-group a_payment_transactions_Date_Transaction">
<input type="text" data-field="x_Date_Transaction" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Transaction->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Date_Transaction->EditValue ?>"<?php echo $a_payment_transactions->Date_Transaction->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Date_Transaction" name="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" id="x<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" value="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Transaction->FormValue) ?>">
<input type="hidden" data-field="x_Date_Transaction" name="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" id="o<?php echo $a_payment_transactions_grid->RowIndex ?>_Date_Transaction" value="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Transaction->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
