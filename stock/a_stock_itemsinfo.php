...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Stock_ID
		$this->Stock_ID = new cField('a_stock_items', 'a_stock_items', 'x_Stock_ID', 'Stock_ID', '`Stock_ID`', '`Stock_ID`', 3, -1, FALSE, '`Stock_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Stock_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Stock_ID'] = &$this->Stock_ID;

		// Category
		$this->Category = new cField('a_stock_items', 'a_stock_items', 'x_Category', 'Category', '`Category`', '`Category`', 3, -1, FALSE, '`Category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Category->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Category'] = &$this->Category;

		// Supplier_Number
		$this->Supplier_Number = new cField('a_stock_items', 'a_stock_items', 'x_Supplier_Number', 'Supplier_Number', '`Supplier_Number`', '`Supplier_Number`', 200, -1, FALSE, '`Supplier_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Supplier_Number'] = &$this->Supplier_Number;

		// Stock_Number
		$this->Stock_Number = new cField('a_stock_items', 'a_stock_items', 'x_Stock_Number', 'Stock_Number', '`Stock_Number`', '`Stock_Number`', 200, -1, FALSE, '`Stock_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Stock_Number'] = &$this->Stock_Number;

		// Stock_Name
		$this->Stock_Name = new cField('a_stock_items', 'a_stock_items', 'x_Stock_Name', 'Stock_Name', '`Stock_Name`', '`Stock_Name`', 200, -1, FALSE, '`Stock_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Stock_Name'] = &$this->Stock_Name;

		// Unit_Of_Measurement
		$this->Unit_Of_Measurement = new cField('a_stock_items', 'a_stock_items', 'x_Unit_Of_Measurement', 'Unit_Of_Measurement', '`Unit_Of_Measurement`', '`Unit_Of_Measurement`', 200, -1, FALSE, '`Unit_Of_Measurement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Unit_Of_Measurement'] = &$this->Unit_Of_Measurement;

		// Purchasing_Price
		$this->Purchasing_Price = new cField('a_stock_items', 'a_stock_items', 'x_Purchasing_Price', 'Purchasing_Price', '`Purchasing_Price`', '`Purchasing_Price`', 5, -1, FALSE, '`Purchasing_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Purchasing_Price'] = &$this->Purchasing_Price;

		// Selling_Price
		$this->Selling_Price = new cField('a_stock_items', 'a_stock_items', 'x_Selling_Price', 'Selling_Price', '`Selling_Price`', '`Selling_Price`', 5, -1, FALSE, '`Selling_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Selling_Price'] = &$this->Selling_Price;

		// Quantity
		$this->Quantity = new cField('a_stock_items', 'a_stock_items', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 5, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Quantity'] = &$this->Quantity;

		// Notes
		$this->Notes = new cField('a_stock_items', 'a_stock_items', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 200, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Notes'] = &$this->Notes;

		// Date_Added
		$this->Date_Added = new cField('a_stock_items', 'a_stock_items', 'x_Date_Added', 'Date_Added', '`Date_Added`', 'DATE_FORMAT(`Date_Added`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Added`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Added'] = &$this->Date_Added;

		// Added_By
		$this->Added_By = new cField('a_stock_items', 'a_stock_items', 'x_Added_By', 'Added_By', '`Added_By`', '`Added_By`', 200, -1, FALSE, '`Added_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Added_By'] = &$this->Added_By;

		// Date_Updated
		$this->Date_Updated = new cField('a_stock_items', 'a_stock_items', 'x_Date_Updated', 'Date_Updated', '`Date_Updated`', 'DATE_FORMAT(`Date_Updated`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Updated'] = &$this->Date_Updated;

		// Updated_By
		$this->Updated_By = new cField('a_stock_items', 'a_stock_items', 'x_Updated_By', 'Updated_By', '`Updated_By`', '`Updated_By`', 200, -1, FALSE, '`Updated_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		if ($this->getCurrentMasterTable() == "a_suppliers") {
			if ($this->Supplier_Number->getSessionValue() <> "")
				$sMasterFilter .= "`Supplier_Number`=" . ew_QuotedValue($this->Supplier_Number->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "a_suppliers") {
			if ($this->Supplier_Number->getSessionValue() <> "")
				$sDetailFilter .= "`Supplier_Number`=" . ew_QuotedValue($this->Supplier_Number->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "view_sales_details") {
			$sDetailUrl = $GLOBALS["view_sales_details"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_Stock_Number=" . urlencode($this->Stock_Number->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "view_purchases_details") {
			$sDetailUrl = $GLOBALS["view_purchases_details"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_Stock_Number=" . urlencode($this->Stock_Number->CurrentValue);
		}
		if ($sDetailUrl == "") {
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('Stock_ID', $rs))
				ew_AddFilter($where, ew_QuotedName('Stock_ID') . '=' . ew_QuotedValue($rs['Stock_ID'], $this->Stock_ID->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function KeyFilter() {
		...
		$sKeyFilter = str_replace("@Stock_ID@", ew_AdjustSql($this->Stock_ID->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_stock_itemsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_stock_itemsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "a_stock_itemsadd.php?" . $this->UrlParm($parm);
		else
			return "a_stock_itemsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_stock_itemsedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_stock_itemsedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_stock_itemsadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_stock_itemsadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
