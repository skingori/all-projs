...
define("EW_RANDOM_KEY", 'bbm6VVgxddfM850y', TRUE); // Random key for encryption
...
define("EW_SELECT_LIMIT", (EW_IS_MYSQL || EW_IS_POSTGRESQL || EW_IS_ORACLE), TRUE); // Modification (20140916) http://www.hkvforums.com/viewtopic.php?f=4&t=35486&p=102440#p102440
...
// Begin of modification Empty Table in Detail Preview List Pages, by Masino Sinaga, November 29, 2012
define("MS_SHOW_RECORD_NUMBER_COLUMN_ON_DETAIL_PREVIEW", TRUE, TRUE);
define("MS_RECORD_NUMBER_PREVIEW_VERTICAL_ALIGN_TOP", FALSE, TRUE);
define("MS_RECORD_NUMBER_PREVIEW_LONG_CAPTION_COLUMN_TABLE", FALSE, TRUE);
define("MS_SHOW_EMPTY_TABLE_IN_DETAIL_PREVIEW", TRUE, TRUE);
define("MS_PREVIEW_TABLE_WIDTH", 100, TRUE); // in percentage, set to 0 for auto adjusted width to max content

// End of modification Empty Table Detail Preview List Pages, by Masino Sinaga, November 29, 2012
?>
<?php
define("EW_CAPTCHA_FONT", "DejaVuSans", TRUE);
?>
<?php
...
?>
<?php
define("MS_ENABLE_VISITOR_STATS", TRUE, TRUE);
...
define("MS_AUTO_LOGOUT_AFTER_IDLE_IN_MINUTES", 20, TRUE); // default idle = 20 minutes!
...
?>
<?php
define("MS_USE_TABLE_SETTING_FOR_SEARCH_PANEL_COLLAPSED", FALSE, TRUE);
...
define("MS_SHOW_BORDER_LAYOUT", TRUE, TRUE); // Whether to show border layout
define("MS_SHOW_SHADOW_LAYOUT", TRUE, TRUE); // Whether to show shadow layout
...
if (@MS_MENU_HORIZONTAL) {
  define("MS_TOTAL_WIDTH", MS_SCROLL_TABLE_WIDTH + 35, TRUE);
} else {
  define("MS_TOTAL_WIDTH", MS_SCROLL_TABLE_WIDTH + MS_VERTICAL_MENU_WIDTH + 35, TRUE);
}
...
define("MS_USE_TABLE_SETTING_FOR_DROPUP_LISTOPTIONS", FALSE, TRUE);
...
define("MS_ALERTIFY_TRANSITION_STYLE", "zoom", TRUE); // Alertify transition style, available: "fade" or "zoom"
...
define("MS_DETECT_CHANGES_ON_SEARCH_FORM", FALSE, TRUE); 
