...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Supplier_ID
		$this->Supplier_ID = new cField('a_suppliers', 'a_suppliers', 'x_Supplier_ID', 'Supplier_ID', '`Supplier_ID`', '`Supplier_ID`', 3, -1, FALSE, '`Supplier_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Supplier_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Supplier_ID'] = &$this->Supplier_ID;

		// Supplier_Number
		$this->Supplier_Number = new cField('a_suppliers', 'a_suppliers', 'x_Supplier_Number', 'Supplier_Number', '`Supplier_Number`', '`Supplier_Number`', 200, -1, FALSE, '`Supplier_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Supplier_Number'] = &$this->Supplier_Number;

		// Supplier_Name
		$this->Supplier_Name = new cField('a_suppliers', 'a_suppliers', 'x_Supplier_Name', 'Supplier_Name', '`Supplier_Name`', '`Supplier_Name`', 200, -1, FALSE, '`Supplier_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Supplier_Name'] = &$this->Supplier_Name;

		// Address
		$this->Address = new cField('a_suppliers', 'a_suppliers', 'x_Address', 'Address', '`Address`', '`Address`', 201, -1, FALSE, '`Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Address'] = &$this->Address;

		// City
		$this->City = new cField('a_suppliers', 'a_suppliers', 'x_City', 'City', '`City`', '`City`', 200, -1, FALSE, '`City`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['City'] = &$this->City;

		// Country
		$this->Country = new cField('a_suppliers', 'a_suppliers', 'x_Country', 'Country', '`Country`', '`Country`', 200, -1, FALSE, '`Country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Country'] = &$this->Country;

		// Contact_Person
		$this->Contact_Person = new cField('a_suppliers', 'a_suppliers', 'x_Contact_Person', 'Contact_Person', '`Contact_Person`', '`Contact_Person`', 200, -1, FALSE, '`Contact_Person`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Contact_Person'] = &$this->Contact_Person;

		// Phone_Number
		$this->Phone_Number = new cField('a_suppliers', 'a_suppliers', 'x_Phone_Number', 'Phone_Number', '`Phone_Number`', '`Phone_Number`', 200, -1, FALSE, '`Phone_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Phone_Number'] = &$this->Phone_Number;

		// Email
		$this->_Email = new cField('a_suppliers', 'a_suppliers', 'x__Email', 'Email', '`Email`', '`Email`', 200, -1, FALSE, '`Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Email'] = &$this->_Email;

		// Mobile_Number
		$this->Mobile_Number = new cField('a_suppliers', 'a_suppliers', 'x_Mobile_Number', 'Mobile_Number', '`Mobile_Number`', '`Mobile_Number`', 200, -1, FALSE, '`Mobile_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Mobile_Number'] = &$this->Mobile_Number;

		// Notes
		$this->Notes = new cField('a_suppliers', 'a_suppliers', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 201, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Notes'] = &$this->Notes;

		// Balance
		$this->Balance = new cField('a_suppliers', 'a_suppliers', 'x_Balance', 'Balance', '`Balance`', '`Balance`', 5, -1, FALSE, '`Balance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Balance'] = &$this->Balance;

		// Is_Stock_Available
		$this->Is_Stock_Available = new cField('a_suppliers', 'a_suppliers', 'x_Is_Stock_Available', 'Is_Stock_Available', '`Is_Stock_Available`', '`Is_Stock_Available`', 202, -1, FALSE, '`Is_Stock_Available`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Date_Added
		$this->Date_Added = new cField('a_suppliers', 'a_suppliers', 'x_Date_Added', 'Date_Added', '`Date_Added`', 'DATE_FORMAT(`Date_Added`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Added`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Added'] = &$this->Date_Added;

		// Added_By
		$this->Added_By = new cField('a_suppliers', 'a_suppliers', 'x_Added_By', 'Added_By', '`Added_By`', '`Added_By`', 200, -1, FALSE, '`Added_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Added_By'] = &$this->Added_By;

		// Date_Updated
		$this->Date_Updated = new cField('a_suppliers', 'a_suppliers', 'x_Date_Updated', 'Date_Updated', '`Date_Updated`', 'DATE_FORMAT(`Date_Updated`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Updated'] = &$this->Date_Updated;

		// Updated_By
		$this->Updated_By = new cField('a_suppliers', 'a_suppliers', 'x_Updated_By', 'Updated_By', '`Updated_By`', '`Updated_By`', 200, -1, FALSE, '`Updated_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "a_purchases") {
			$sDetailUrl = $GLOBALS["a_purchases"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_Supplier_Number=" . urlencode($this->Supplier_Number->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "a_stock_items") {
			$sDetailUrl = $GLOBALS["a_stock_items"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_Supplier_Number=" . urlencode($this->Supplier_Number->CurrentValue);
		}
		if ($sDetailUrl == "") {
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('Supplier_ID', $rs))
				ew_AddFilter($where, ew_QuotedName('Supplier_ID') . '=' . ew_QuotedValue($rs['Supplier_ID'], $this->Supplier_ID->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function KeyFilter() {
		...
		$sKeyFilter = str_replace("@Supplier_ID@", ew_AdjustSql($this->Supplier_ID->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_suppliersview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_suppliersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "a_suppliersadd.php?" . $this->UrlParm($parm);
		else
			return "a_suppliersadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_suppliersedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_suppliersedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_suppliersadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_suppliersadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["Supplier_ID"]; // Supplier_ID
