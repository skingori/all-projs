		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "stats_counterlogview.php")
...
// Page object
var stats_counterlog_add = new ew_Page("stats_counterlog_add");
stats_counterlog_add.PageID = "add"; // Page ID
var EW_PAGE_ID = stats_counterlog_add.PageID; // For backward compatibility

// Form object
var fstats_counterlogadd = new ew_Form("fstats_counterlogadd");
...
?>
<form name="fstats_counterlogadd" id="fstats_counterlogadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="text" data-field="x_IP_Address" name="x_IP_Address" id="x_IP_Address" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($stats_counterlog->IP_Address->PlaceHolder) ?>" value="<?php echo $stats_counterlog->IP_Address->EditValue ?>"<?php echo $stats_counterlog->IP_Address->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyAdd(this)'); function alertifyAdd(obj) { <?php global $Language; ?> if (fstats_counterlogadd.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyAddConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyAdd'); ?>"); $("#fstats_counterlogadd").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
