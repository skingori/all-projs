		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "a_purchasesview.php")
...
// Page object
var a_purchases_add = new ew_Page("a_purchases_add");
a_purchases_add.PageID = "add"; // Page ID
var EW_PAGE_ID = a_purchases_add.PageID; // For backward compatibility

// Form object
var fa_purchasesadd = new ew_Form("fa_purchasesadd");
...
fa_purchasesadd.Lists["x_Supplier_ID"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fa_purchasesadd" id="fa_purchasesadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<script type="text/javascript">
fa_purchasesadd.Lists["x_Supplier_ID"].Options = <?php echo (is_array($a_purchases->Supplier_ID->EditValue)) ? ew_ArrayToJson($a_purchases->Supplier_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyAdd(this)'); function alertifyAdd(obj) { <?php global $Language; ?> if (fa_purchasesadd.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyAddConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyAdd'); ?>"); $("#fa_purchasesadd").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
