...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["Option_ID"] != "") {
				...
				$this->setKey("Option_ID", $this->Option_ID->CurrentValue); // Set up key
			} else {
				$this->setKey("Option_ID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "settingsview.php")
	...
	function LoadDefaultValues() {
		$this->Option_Default->CurrentValue = "N";
		$this->Default_Theme->CurrentValue = NULL;
		$this->Default_Theme->OldValue = $this->Default_Theme->CurrentValue;
		$this->Font_Name->CurrentValue = "tahoma";
		$this->Font_Size->CurrentValue = "11px";
		$this->Show_Border_Layout->CurrentValue = "Y";
		$this->Show_Shadow_Layout->CurrentValue = "Y";
		$this->Menu_Horizontal->CurrentValue = "Y";
		$this->Vertical_Menu_Width->CurrentValue = 150;
		$this->Show_Announcement->CurrentValue = "N";
		$this->Demo_Mode->CurrentValue = "N";
		$this->Show_Page_Processing_Time->CurrentValue = "N";
		$this->Allow_User_Preferences->CurrentValue = "Y";
		$this->SMTP_Server->CurrentValue = NULL;
		$this->SMTP_Server->OldValue = $this->SMTP_Server->CurrentValue;
		$this->SMTP_Server_Port->CurrentValue = NULL;
		$this->SMTP_Server_Port->OldValue = $this->SMTP_Server_Port->CurrentValue;
		$this->SMTP_Server_Username->CurrentValue = NULL;
		$this->SMTP_Server_Username->OldValue = $this->SMTP_Server_Username->CurrentValue;
		$this->SMTP_Server_Password->CurrentValue = NULL;
		$this->SMTP_Server_Password->OldValue = $this->SMTP_Server_Password->CurrentValue;
		$this->Sender_Email->CurrentValue = NULL;
		$this->Sender_Email->OldValue = $this->Sender_Email->CurrentValue;
		$this->Recipient_Email->CurrentValue = NULL;
		$this->Recipient_Email->OldValue = $this->Recipient_Email->CurrentValue;
		$this->Use_Default_Locale->CurrentValue = "Y";
		$this->Default_Language->CurrentValue = NULL;
		$this->Default_Language->OldValue = $this->Default_Language->CurrentValue;
		$this->Default_Timezone->CurrentValue = NULL;
		$this->Default_Timezone->OldValue = $this->Default_Timezone->CurrentValue;
		...
		$this->Maintenance_Mode->CurrentValue = "N";
		$this->Maintenance_Finish_DateTime->CurrentValue = NULL;
		$this->Maintenance_Finish_DateTime->OldValue = $this->Maintenance_Finish_DateTime->CurrentValue;
		$this->Auto_Normal_After_Maintenance->CurrentValue = "Y";
		$this->Allow_User_To_Register->CurrentValue = "Y";
		$this->Suspend_New_User_Account->CurrentValue = "N";
		$this->User_Need_Activation_After_Registered->CurrentValue = "Y";
		$this->Show_Captcha_On_Registration_Page->CurrentValue = "N";
		$this->Show_Terms_And_Conditions_On_Registration_Page->CurrentValue = "Y";
		$this->User_Auto_Login_After_Activation_Or_Registration->CurrentValue = "Y";
		$this->Show_Captcha_On_Login_Page->CurrentValue = "N";
		$this->Show_Captcha_On_Forgot_Password_Page->CurrentValue = "N";
		$this->Show_Captcha_On_Change_Password_Page->CurrentValue = "N";
		$this->User_Auto_Logout_After_Idle_In_Minutes->CurrentValue = 20;
		$this->User_Login_Maximum_Retry->CurrentValue = 3;
		$this->User_Login_Retry_Lockout->CurrentValue = 5;
		$this->Redirect_To_Last_Visited_Page_After_Login->CurrentValue = "Y";
		$this->Enable_Password_Expiry->CurrentValue = "Y";
		$this->Password_Expiry_In_Days->CurrentValue = 90;
		$this->Show_Entire_Header->CurrentValue = "Y";
		$this->Logo_Width->CurrentValue = 170;
		$this->Show_Site_Title_In_Header->CurrentValue = "Y";
		$this->Show_Current_User_In_Header->CurrentValue = "Y";
		$this->Text_Align_In_Header->CurrentValue = "left";
		$this->Site_Title_Text_Style->CurrentValue = "normal";
		$this->Language_Selector_Visibility->CurrentValue = "inheader";
		$this->Language_Selector_Align->CurrentValue = "autoadjust";
		$this->Show_Entire_Footer->CurrentValue = "Y";
		$this->Show_Text_In_Footer->CurrentValue = "Y";
		$this->Show_Back_To_Top_On_Footer->CurrentValue = "Y";
		$this->Show_Terms_And_Conditions_On_Footer->CurrentValue = "Y";
		$this->Show_About_Us_On_Footer->CurrentValue = "Y";
		$this->Pagination_Position->CurrentValue = "3";
		$this->Pagination_Style->CurrentValue = "2";
		$this->Selectable_Records_Per_Page->CurrentValue = "1,2,3,5,10,15,20,50";
		$this->Selectable_Groups_Per_Page->CurrentValue = "1,2,3,5,10";
		$this->Default_Record_Per_Page->CurrentValue = 10;
		$this->Default_Group_Per_Page->CurrentValue = 3;
		$this->Maximum_Selected_Records->CurrentValue = 50;
		$this->Maximum_Selected_Groups->CurrentValue = 50;
		$this->Show_PageNum_If_Record_Not_Over_Pagesize->CurrentValue = "Y";
		$this->Table_Width_Style->CurrentValue = "2";
		$this->Scroll_Table_Width->CurrentValue = 800;
		$this->Scroll_Table_Height->CurrentValue = 300;
		$this->Search_Panel_Collapsed->CurrentValue = "Y";
		$this->Filter_Panel_Collapsed->CurrentValue = "Y";
		$this->Show_Record_Number_On_List_Page->CurrentValue = "Y";
		$this->Show_Empty_Table_On_List_Page->CurrentValue = "Y";
		$this->Rows_Vertical_Align_Top->CurrentValue = "Y";
		$this->Action_Button_Alignment->CurrentValue = "Right";
		$this->Show_Add_Success_Message->CurrentValue = "Y";
		$this->Show_Edit_Success_Message->CurrentValue = "Y";
		$this->jQuery_Auto_Hide_Success_Message->CurrentValue = "N";
		$this->Use_Javascript_Message->CurrentValue = "1";
		$this->Login_Window_Type->CurrentValue = "popup";
		$this->Forgot_Password_Window_Type->CurrentValue = "popup";
		$this->Change_Password_Window_Type->CurrentValue = "popup";
		$this->Registration_Window_Type->CurrentValue = "popup";
		$this->Show_Record_Number_On_Detail_Preview->CurrentValue = "Y";
		$this->Show_Empty_Table_In_Detail_Preview->CurrentValue = "Y";
		$this->Detail_Preview_Table_Width->CurrentValue = 100;
		$this->Password_Minimum_Length->CurrentValue = 6;
		$this->Password_Maximum_Length->CurrentValue = 20;
		$this->Password_Must_Contain_At_Least_One_Lower_Case->CurrentValue = "Y";
		$this->Password_Must_Comply_With_Minumum_Length->CurrentValue = "Y";
		$this->Password_Must_Comply_With_Maximum_Length->CurrentValue = "Y";
		$this->Password_Must_Contain_At_Least_One_Upper_Case->CurrentValue = "Y";
		$this->Password_Must_Contain_At_Least_One_Numeric->CurrentValue = "Y";
		$this->Password_Must_Contain_At_Least_One_Symbol->CurrentValue = "Y";
		$this->Password_Must_Be_Difference_Between_Old_And_New->CurrentValue = "Y";
		$this->Reset_Password_Field_Options->CurrentValue = "EmailOrUsername";
		$this->Export_Record_Options->CurrentValue = "selectedrecords";
		$this->Show_Record_Number_On_Exported_List_Page->CurrentValue = "Y";
		$this->Use_Table_Setting_For_Export_Field_Caption->CurrentValue = "Y";
		$this->Use_Table_Setting_For_Export_Original_Value->CurrentValue = "Y";
	}
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->Lookup_Selecting($this->Default_Theme, $sWhereWrk);
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			$sSqlWrk .= " ORDER BY `Theme_ID`";
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$this->Default_Theme->ViewValue = $rswrk->fields('DispFld');
					$rswrk->Close();
				} else {
			...
			// Call Lookup selecting
			$this->Lookup_Selecting($this->Default_Language, $sWhereWrk);
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$this->Default_Language->ViewValue = $rswrk->fields('DispFld');
					$rswrk->Close();
				} else {
			...
			// Call Lookup selecting
			$this->Lookup_Selecting($this->Default_Timezone, $sWhereWrk);
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$this->Default_Timezone->ViewValue = $rswrk->fields('DispFld');
					$rswrk->Close();
				} else {
			...
			if (strval($this->Text_Align_In_Header->CurrentValue) <> "") {
				switch ($this->Text_Align_In_Header->CurrentValue) {
					case $this->Text_Align_In_Header->FldTagValue(1):
						$this->Text_Align_In_Header->ViewValue = $this->Text_Align_In_Header->FldTagCaption(1) <> "" ? $this->Text_Align_In_Header->FldTagCaption(1) : $this->Text_Align_In_Header->CurrentValue;
						break;
					case $this->Text_Align_In_Header->FldTagValue(2):
						$this->Text_Align_In_Header->ViewValue = $this->Text_Align_In_Header->FldTagCaption(2) <> "" ? $this->Text_Align_In_Header->FldTagCaption(2) : $this->Text_Align_In_Header->CurrentValue;
						break;
					case $this->Text_Align_In_Header->FldTagValue(3):
						$this->Text_Align_In_Header->ViewValue = $this->Text_Align_In_Header->FldTagCaption(3) <> "" ? $this->Text_Align_In_Header->FldTagCaption(3) : $this->Text_Align_In_Header->CurrentValue;
						break;
					default:
						$this->Text_Align_In_Header->ViewValue = $this->Text_Align_In_Header->CurrentValue;
				}
			} else {
			...
			if (strval($this->Site_Title_Text_Style->CurrentValue) <> "") {
				switch ($this->Site_Title_Text_Style->CurrentValue) {
					case $this->Site_Title_Text_Style->FldTagValue(1):
						$this->Site_Title_Text_Style->ViewValue = $this->Site_Title_Text_Style->FldTagCaption(1) <> "" ? $this->Site_Title_Text_Style->FldTagCaption(1) : $this->Site_Title_Text_Style->CurrentValue;
						break;
					case $this->Site_Title_Text_Style->FldTagValue(2):
						$this->Site_Title_Text_Style->ViewValue = $this->Site_Title_Text_Style->FldTagCaption(2) <> "" ? $this->Site_Title_Text_Style->FldTagCaption(2) : $this->Site_Title_Text_Style->CurrentValue;
						break;
					case $this->Site_Title_Text_Style->FldTagValue(3):
						$this->Site_Title_Text_Style->ViewValue = $this->Site_Title_Text_Style->FldTagCaption(3) <> "" ? $this->Site_Title_Text_Style->FldTagCaption(3) : $this->Site_Title_Text_Style->CurrentValue;
						break;
					default:
						$this->Site_Title_Text_Style->ViewValue = $this->Site_Title_Text_Style->CurrentValue;
				}
			} else {
			...
			if (strval($this->Language_Selector_Visibility->CurrentValue) <> "") {
				switch ($this->Language_Selector_Visibility->CurrentValue) {
					case $this->Language_Selector_Visibility->FldTagValue(1):
						$this->Language_Selector_Visibility->ViewValue = $this->Language_Selector_Visibility->FldTagCaption(1) <> "" ? $this->Language_Selector_Visibility->FldTagCaption(1) : $this->Language_Selector_Visibility->CurrentValue;
						break;
					case $this->Language_Selector_Visibility->FldTagValue(2):
						$this->Language_Selector_Visibility->ViewValue = $this->Language_Selector_Visibility->FldTagCaption(2) <> "" ? $this->Language_Selector_Visibility->FldTagCaption(2) : $this->Language_Selector_Visibility->CurrentValue;
						break;
					case $this->Language_Selector_Visibility->FldTagValue(3):
						$this->Language_Selector_Visibility->ViewValue = $this->Language_Selector_Visibility->FldTagCaption(3) <> "" ? $this->Language_Selector_Visibility->FldTagCaption(3) : $this->Language_Selector_Visibility->CurrentValue;
						break;
					default:
						$this->Language_Selector_Visibility->ViewValue = $this->Language_Selector_Visibility->CurrentValue;
				}
			} else {
			...
			if (strval($this->Language_Selector_Align->CurrentValue) <> "") {
				switch ($this->Language_Selector_Align->CurrentValue) {
					case $this->Language_Selector_Align->FldTagValue(1):
						$this->Language_Selector_Align->ViewValue = $this->Language_Selector_Align->FldTagCaption(1) <> "" ? $this->Language_Selector_Align->FldTagCaption(1) : $this->Language_Selector_Align->CurrentValue;
						break;
					case $this->Language_Selector_Align->FldTagValue(2):
						$this->Language_Selector_Align->ViewValue = $this->Language_Selector_Align->FldTagCaption(2) <> "" ? $this->Language_Selector_Align->FldTagCaption(2) : $this->Language_Selector_Align->CurrentValue;
						break;
					case $this->Language_Selector_Align->FldTagValue(3):
						$this->Language_Selector_Align->ViewValue = $this->Language_Selector_Align->FldTagCaption(3) <> "" ? $this->Language_Selector_Align->FldTagCaption(3) : $this->Language_Selector_Align->CurrentValue;
						break;
					case $this->Language_Selector_Align->FldTagValue(4):
						$this->Language_Selector_Align->ViewValue = $this->Language_Selector_Align->FldTagCaption(4) <> "" ? $this->Language_Selector_Align->FldTagCaption(4) : $this->Language_Selector_Align->CurrentValue;
						break;
					default:
						$this->Language_Selector_Align->ViewValue = $this->Language_Selector_Align->CurrentValue;
				}
			} else {
			...
			if (strval($this->Pagination_Position->CurrentValue) <> "") {
				switch ($this->Pagination_Position->CurrentValue) {
					case $this->Pagination_Position->FldTagValue(1):
						$this->Pagination_Position->ViewValue = $this->Pagination_Position->FldTagCaption(1) <> "" ? $this->Pagination_Position->FldTagCaption(1) : $this->Pagination_Position->CurrentValue;
						break;
					case $this->Pagination_Position->FldTagValue(2):
						$this->Pagination_Position->ViewValue = $this->Pagination_Position->FldTagCaption(2) <> "" ? $this->Pagination_Position->FldTagCaption(2) : $this->Pagination_Position->CurrentValue;
						break;
					case $this->Pagination_Position->FldTagValue(3):
						$this->Pagination_Position->ViewValue = $this->Pagination_Position->FldTagCaption(3) <> "" ? $this->Pagination_Position->FldTagCaption(3) : $this->Pagination_Position->CurrentValue;
						break;
					default:
						$this->Pagination_Position->ViewValue = $this->Pagination_Position->CurrentValue;
				}
			} else {
			...
			if (strval($this->Pagination_Style->CurrentValue) <> "") {
				switch ($this->Pagination_Style->CurrentValue) {
					case $this->Pagination_Style->FldTagValue(1):
						$this->Pagination_Style->ViewValue = $this->Pagination_Style->FldTagCaption(1) <> "" ? $this->Pagination_Style->FldTagCaption(1) : $this->Pagination_Style->CurrentValue;
						break;
					case $this->Pagination_Style->FldTagValue(2):
						$this->Pagination_Style->ViewValue = $this->Pagination_Style->FldTagCaption(2) <> "" ? $this->Pagination_Style->FldTagCaption(2) : $this->Pagination_Style->CurrentValue;
						break;
					default:
						$this->Pagination_Style->ViewValue = $this->Pagination_Style->CurrentValue;
				}
			} else {
			...
			if (strval($this->Action_Button_Alignment->CurrentValue) <> "") {
				switch ($this->Action_Button_Alignment->CurrentValue) {
					case $this->Action_Button_Alignment->FldTagValue(1):
						$this->Action_Button_Alignment->ViewValue = $this->Action_Button_Alignment->FldTagCaption(1) <> "" ? $this->Action_Button_Alignment->FldTagCaption(1) : $this->Action_Button_Alignment->CurrentValue;
						break;
					case $this->Action_Button_Alignment->FldTagValue(2):
						$this->Action_Button_Alignment->ViewValue = $this->Action_Button_Alignment->FldTagCaption(2) <> "" ? $this->Action_Button_Alignment->FldTagCaption(2) : $this->Action_Button_Alignment->CurrentValue;
						break;
					default:
						$this->Action_Button_Alignment->ViewValue = $this->Action_Button_Alignment->CurrentValue;
				}
			} else {
			...
			if (strval($this->Login_Window_Type->CurrentValue) <> "") {
				switch ($this->Login_Window_Type->CurrentValue) {
					case $this->Login_Window_Type->FldTagValue(1):
						$this->Login_Window_Type->ViewValue = $this->Login_Window_Type->FldTagCaption(1) <> "" ? $this->Login_Window_Type->FldTagCaption(1) : $this->Login_Window_Type->CurrentValue;
						break;
					case $this->Login_Window_Type->FldTagValue(2):
						$this->Login_Window_Type->ViewValue = $this->Login_Window_Type->FldTagCaption(2) <> "" ? $this->Login_Window_Type->FldTagCaption(2) : $this->Login_Window_Type->CurrentValue;
						break;
					default:
						$this->Login_Window_Type->ViewValue = $this->Login_Window_Type->CurrentValue;
				}
			} else {
			...
			if (strval($this->Forgot_Password_Window_Type->CurrentValue) <> "") {
				switch ($this->Forgot_Password_Window_Type->CurrentValue) {
					case $this->Forgot_Password_Window_Type->FldTagValue(1):
						$this->Forgot_Password_Window_Type->ViewValue = $this->Forgot_Password_Window_Type->FldTagCaption(1) <> "" ? $this->Forgot_Password_Window_Type->FldTagCaption(1) : $this->Forgot_Password_Window_Type->CurrentValue;
						break;
					case $this->Forgot_Password_Window_Type->FldTagValue(2):
						$this->Forgot_Password_Window_Type->ViewValue = $this->Forgot_Password_Window_Type->FldTagCaption(2) <> "" ? $this->Forgot_Password_Window_Type->FldTagCaption(2) : $this->Forgot_Password_Window_Type->CurrentValue;
						break;
					default:
						$this->Forgot_Password_Window_Type->ViewValue = $this->Forgot_Password_Window_Type->CurrentValue;
				}
			} else {
			...
			if (strval($this->Change_Password_Window_Type->CurrentValue) <> "") {
				switch ($this->Change_Password_Window_Type->CurrentValue) {
					case $this->Change_Password_Window_Type->FldTagValue(1):
						$this->Change_Password_Window_Type->ViewValue = $this->Change_Password_Window_Type->FldTagCaption(1) <> "" ? $this->Change_Password_Window_Type->FldTagCaption(1) : $this->Change_Password_Window_Type->CurrentValue;
						break;
					case $this->Change_Password_Window_Type->FldTagValue(2):
						$this->Change_Password_Window_Type->ViewValue = $this->Change_Password_Window_Type->FldTagCaption(2) <> "" ? $this->Change_Password_Window_Type->FldTagCaption(2) : $this->Change_Password_Window_Type->CurrentValue;
						break;
					default:
						$this->Change_Password_Window_Type->ViewValue = $this->Change_Password_Window_Type->CurrentValue;
				}
			} else {
			...
			if (strval($this->Registration_Window_Type->CurrentValue) <> "") {
				switch ($this->Registration_Window_Type->CurrentValue) {
					case $this->Registration_Window_Type->FldTagValue(1):
						$this->Registration_Window_Type->ViewValue = $this->Registration_Window_Type->FldTagCaption(1) <> "" ? $this->Registration_Window_Type->FldTagCaption(1) : $this->Registration_Window_Type->CurrentValue;
						break;
					case $this->Registration_Window_Type->FldTagValue(2):
						$this->Registration_Window_Type->ViewValue = $this->Registration_Window_Type->FldTagCaption(2) <> "" ? $this->Registration_Window_Type->FldTagCaption(2) : $this->Registration_Window_Type->CurrentValue;
						break;
					default:
						$this->Registration_Window_Type->ViewValue = $this->Registration_Window_Type->CurrentValue;
				}
			} else {
			...
			if (strval($this->Reset_Password_Field_Options->CurrentValue) <> "") {
				switch ($this->Reset_Password_Field_Options->CurrentValue) {
					case $this->Reset_Password_Field_Options->FldTagValue(1):
						$this->Reset_Password_Field_Options->ViewValue = $this->Reset_Password_Field_Options->FldTagCaption(1) <> "" ? $this->Reset_Password_Field_Options->FldTagCaption(1) : $this->Reset_Password_Field_Options->CurrentValue;
						break;
					case $this->Reset_Password_Field_Options->FldTagValue(2):
						$this->Reset_Password_Field_Options->ViewValue = $this->Reset_Password_Field_Options->FldTagCaption(2) <> "" ? $this->Reset_Password_Field_Options->FldTagCaption(2) : $this->Reset_Password_Field_Options->CurrentValue;
						break;
					case $this->Reset_Password_Field_Options->FldTagValue(3):
						$this->Reset_Password_Field_Options->ViewValue = $this->Reset_Password_Field_Options->FldTagCaption(3) <> "" ? $this->Reset_Password_Field_Options->FldTagCaption(3) : $this->Reset_Password_Field_Options->CurrentValue;
						break;
					default:
						$this->Reset_Password_Field_Options->ViewValue = $this->Reset_Password_Field_Options->CurrentValue;
				}
			} else {
			...
			if (strval($this->Export_Record_Options->CurrentValue) <> "") {
				switch ($this->Export_Record_Options->CurrentValue) {
					case $this->Export_Record_Options->FldTagValue(1):
						$this->Export_Record_Options->ViewValue = $this->Export_Record_Options->FldTagCaption(1) <> "" ? $this->Export_Record_Options->FldTagCaption(1) : $this->Export_Record_Options->CurrentValue;
						break;
					case $this->Export_Record_Options->FldTagValue(2):
						$this->Export_Record_Options->ViewValue = $this->Export_Record_Options->FldTagCaption(2) <> "" ? $this->Export_Record_Options->FldTagCaption(2) : $this->Export_Record_Options->CurrentValue;
						break;
					case $this->Export_Record_Options->FldTagValue(3):
						$this->Export_Record_Options->ViewValue = $this->Export_Record_Options->FldTagCaption(3) <> "" ? $this->Export_Record_Options->FldTagCaption(3) : $this->Export_Record_Options->CurrentValue;
						break;
					default:
						$this->Export_Record_Options->ViewValue = $this->Export_Record_Options->CurrentValue;
				}
			} else {
			...
			$arwrk = array();
			$arwrk[] = array($this->Option_Default->FldTagValue(1), $this->Option_Default->FldTagCaption(1) <> "" ? $this->Option_Default->FldTagCaption(1) : $this->Option_Default->FldTagValue(1));
			$arwrk[] = array($this->Option_Default->FldTagValue(2), $this->Option_Default->FldTagCaption(2) <> "" ? $this->Option_Default->FldTagCaption(2) : $this->Option_Default->FldTagValue(2));
			$this->Option_Default->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Show_Border_Layout->FldTagValue(1), $this->Show_Border_Layout->FldTagCaption(1) <> "" ? $this->Show_Border_Layout->FldTagCaption(1) : $this->Show_Border_Layout->FldTagValue(1));
			$arwrk[] = array($this->Show_Border_Layout->FldTagValue(2), $this->Show_Border_Layout->FldTagCaption(2) <> "" ? $this->Show_Border_Layout->FldTagCaption(2) : $this->Show_Border_Layout->FldTagValue(2));
			$this->Show_Border_Layout->EditValue = $arwrk;

			// Show_Shadow_Layout
			$this->Show_Shadow_Layout->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Shadow_Layout->FldTagValue(1), $this->Show_Shadow_Layout->FldTagCaption(1) <> "" ? $this->Show_Shadow_Layout->FldTagCaption(1) : $this->Show_Shadow_Layout->FldTagValue(1));
			$arwrk[] = array($this->Show_Shadow_Layout->FldTagValue(2), $this->Show_Shadow_Layout->FldTagCaption(2) <> "" ? $this->Show_Shadow_Layout->FldTagCaption(2) : $this->Show_Shadow_Layout->FldTagValue(2));
			$this->Show_Shadow_Layout->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Show_Announcement->FldTagValue(1), $this->Show_Announcement->FldTagCaption(1) <> "" ? $this->Show_Announcement->FldTagCaption(1) : $this->Show_Announcement->FldTagValue(1));
			$arwrk[] = array($this->Show_Announcement->FldTagValue(2), $this->Show_Announcement->FldTagCaption(2) <> "" ? $this->Show_Announcement->FldTagCaption(2) : $this->Show_Announcement->FldTagValue(2));
			array_unshift($arwrk, array("", $Language->Phrase("PleaseSelect")));
			$this->Show_Announcement->EditValue = $arwrk;

			// Demo_Mode
			$this->Demo_Mode->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Demo_Mode->FldTagValue(1), $this->Demo_Mode->FldTagCaption(1) <> "" ? $this->Demo_Mode->FldTagCaption(1) : $this->Demo_Mode->FldTagValue(1));
			$arwrk[] = array($this->Demo_Mode->FldTagValue(2), $this->Demo_Mode->FldTagCaption(2) <> "" ? $this->Demo_Mode->FldTagCaption(2) : $this->Demo_Mode->FldTagValue(2));
			$this->Demo_Mode->EditValue = $arwrk;

			// Show_Page_Processing_Time
			$this->Show_Page_Processing_Time->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Page_Processing_Time->FldTagValue(1), $this->Show_Page_Processing_Time->FldTagCaption(1) <> "" ? $this->Show_Page_Processing_Time->FldTagCaption(1) : $this->Show_Page_Processing_Time->FldTagValue(1));
			$arwrk[] = array($this->Show_Page_Processing_Time->FldTagValue(2), $this->Show_Page_Processing_Time->FldTagCaption(2) <> "" ? $this->Show_Page_Processing_Time->FldTagCaption(2) : $this->Show_Page_Processing_Time->FldTagValue(2));
			$this->Show_Page_Processing_Time->EditValue = $arwrk;

			// Allow_User_Preferences
			$this->Allow_User_Preferences->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Allow_User_Preferences->FldTagValue(1), $this->Allow_User_Preferences->FldTagCaption(1) <> "" ? $this->Allow_User_Preferences->FldTagCaption(1) : $this->Allow_User_Preferences->FldTagValue(1));
			$arwrk[] = array($this->Allow_User_Preferences->FldTagValue(2), $this->Allow_User_Preferences->FldTagCaption(2) <> "" ? $this->Allow_User_Preferences->FldTagCaption(2) : $this->Allow_User_Preferences->FldTagValue(2));
			$this->Allow_User_Preferences->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Use_Default_Locale->FldTagValue(1), $this->Use_Default_Locale->FldTagCaption(1) <> "" ? $this->Use_Default_Locale->FldTagCaption(1) : $this->Use_Default_Locale->FldTagValue(1));
			$arwrk[] = array($this->Use_Default_Locale->FldTagValue(2), $this->Use_Default_Locale->FldTagCaption(2) <> "" ? $this->Use_Default_Locale->FldTagCaption(2) : $this->Use_Default_Locale->FldTagValue(2));
			$this->Use_Default_Locale->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Maintenance_Mode->FldTagValue(1), $this->Maintenance_Mode->FldTagCaption(1) <> "" ? $this->Maintenance_Mode->FldTagCaption(1) : $this->Maintenance_Mode->FldTagValue(1));
			$arwrk[] = array($this->Maintenance_Mode->FldTagValue(2), $this->Maintenance_Mode->FldTagCaption(2) <> "" ? $this->Maintenance_Mode->FldTagCaption(2) : $this->Maintenance_Mode->FldTagValue(2));
			$this->Maintenance_Mode->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Auto_Normal_After_Maintenance->FldTagValue(1), $this->Auto_Normal_After_Maintenance->FldTagCaption(1) <> "" ? $this->Auto_Normal_After_Maintenance->FldTagCaption(1) : $this->Auto_Normal_After_Maintenance->FldTagValue(1));
			$arwrk[] = array($this->Auto_Normal_After_Maintenance->FldTagValue(2), $this->Auto_Normal_After_Maintenance->FldTagCaption(2) <> "" ? $this->Auto_Normal_After_Maintenance->FldTagCaption(2) : $this->Auto_Normal_After_Maintenance->FldTagValue(2));
			$this->Auto_Normal_After_Maintenance->EditValue = $arwrk;

			// Allow_User_To_Register
			$this->Allow_User_To_Register->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Allow_User_To_Register->FldTagValue(1), $this->Allow_User_To_Register->FldTagCaption(1) <> "" ? $this->Allow_User_To_Register->FldTagCaption(1) : $this->Allow_User_To_Register->FldTagValue(1));
			$arwrk[] = array($this->Allow_User_To_Register->FldTagValue(2), $this->Allow_User_To_Register->FldTagCaption(2) <> "" ? $this->Allow_User_To_Register->FldTagCaption(2) : $this->Allow_User_To_Register->FldTagValue(2));
			$this->Allow_User_To_Register->EditValue = $arwrk;

			// Suspend_New_User_Account
			$this->Suspend_New_User_Account->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Suspend_New_User_Account->FldTagValue(1), $this->Suspend_New_User_Account->FldTagCaption(1) <> "" ? $this->Suspend_New_User_Account->FldTagCaption(1) : $this->Suspend_New_User_Account->FldTagValue(1));
			$arwrk[] = array($this->Suspend_New_User_Account->FldTagValue(2), $this->Suspend_New_User_Account->FldTagCaption(2) <> "" ? $this->Suspend_New_User_Account->FldTagCaption(2) : $this->Suspend_New_User_Account->FldTagValue(2));
			$this->Suspend_New_User_Account->EditValue = $arwrk;

			// User_Need_Activation_After_Registered
			$this->User_Need_Activation_After_Registered->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->User_Need_Activation_After_Registered->FldTagValue(1), $this->User_Need_Activation_After_Registered->FldTagCaption(1) <> "" ? $this->User_Need_Activation_After_Registered->FldTagCaption(1) : $this->User_Need_Activation_After_Registered->FldTagValue(1));
			$arwrk[] = array($this->User_Need_Activation_After_Registered->FldTagValue(2), $this->User_Need_Activation_After_Registered->FldTagCaption(2) <> "" ? $this->User_Need_Activation_After_Registered->FldTagCaption(2) : $this->User_Need_Activation_After_Registered->FldTagValue(2));
			$this->User_Need_Activation_After_Registered->EditValue = $arwrk;

			// Show_Captcha_On_Registration_Page
			$this->Show_Captcha_On_Registration_Page->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Captcha_On_Registration_Page->FldTagValue(1), $this->Show_Captcha_On_Registration_Page->FldTagCaption(1) <> "" ? $this->Show_Captcha_On_Registration_Page->FldTagCaption(1) : $this->Show_Captcha_On_Registration_Page->FldTagValue(1));
			$arwrk[] = array($this->Show_Captcha_On_Registration_Page->FldTagValue(2), $this->Show_Captcha_On_Registration_Page->FldTagCaption(2) <> "" ? $this->Show_Captcha_On_Registration_Page->FldTagCaption(2) : $this->Show_Captcha_On_Registration_Page->FldTagValue(2));
			$this->Show_Captcha_On_Registration_Page->EditValue = $arwrk;

			// Show_Terms_And_Conditions_On_Registration_Page
			$this->Show_Terms_And_Conditions_On_Registration_Page->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Terms_And_Conditions_On_Registration_Page->FldTagValue(1), $this->Show_Terms_And_Conditions_On_Registration_Page->FldTagCaption(1) <> "" ? $this->Show_Terms_And_Conditions_On_Registration_Page->FldTagCaption(1) : $this->Show_Terms_And_Conditions_On_Registration_Page->FldTagValue(1));
			$arwrk[] = array($this->Show_Terms_And_Conditions_On_Registration_Page->FldTagValue(2), $this->Show_Terms_And_Conditions_On_Registration_Page->FldTagCaption(2) <> "" ? $this->Show_Terms_And_Conditions_On_Registration_Page->FldTagCaption(2) : $this->Show_Terms_And_Conditions_On_Registration_Page->FldTagValue(2));
			$this->Show_Terms_And_Conditions_On_Registration_Page->EditValue = $arwrk;

			// User_Auto_Login_After_Activation_Or_Registration
			$this->User_Auto_Login_After_Activation_Or_Registration->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->User_Auto_Login_After_Activation_Or_Registration->FldTagValue(1), $this->User_Auto_Login_After_Activation_Or_Registration->FldTagCaption(1) <> "" ? $this->User_Auto_Login_After_Activation_Or_Registration->FldTagCaption(1) : $this->User_Auto_Login_After_Activation_Or_Registration->FldTagValue(1));
			$arwrk[] = array($this->User_Auto_Login_After_Activation_Or_Registration->FldTagValue(2), $this->User_Auto_Login_After_Activation_Or_Registration->FldTagCaption(2) <> "" ? $this->User_Auto_Login_After_Activation_Or_Registration->FldTagCaption(2) : $this->User_Auto_Login_After_Activation_Or_Registration->FldTagValue(2));
			$this->User_Auto_Login_After_Activation_Or_Registration->EditValue = $arwrk;

			// Show_Captcha_On_Login_Page
			$this->Show_Captcha_On_Login_Page->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Captcha_On_Login_Page->FldTagValue(1), $this->Show_Captcha_On_Login_Page->FldTagCaption(1) <> "" ? $this->Show_Captcha_On_Login_Page->FldTagCaption(1) : $this->Show_Captcha_On_Login_Page->FldTagValue(1));
			$arwrk[] = array($this->Show_Captcha_On_Login_Page->FldTagValue(2), $this->Show_Captcha_On_Login_Page->FldTagCaption(2) <> "" ? $this->Show_Captcha_On_Login_Page->FldTagCaption(2) : $this->Show_Captcha_On_Login_Page->FldTagValue(2));
			$this->Show_Captcha_On_Login_Page->EditValue = $arwrk;

			// Show_Captcha_On_Forgot_Password_Page
			$this->Show_Captcha_On_Forgot_Password_Page->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Captcha_On_Forgot_Password_Page->FldTagValue(1), $this->Show_Captcha_On_Forgot_Password_Page->FldTagCaption(1) <> "" ? $this->Show_Captcha_On_Forgot_Password_Page->FldTagCaption(1) : $this->Show_Captcha_On_Forgot_Password_Page->FldTagValue(1));
			$arwrk[] = array($this->Show_Captcha_On_Forgot_Password_Page->FldTagValue(2), $this->Show_Captcha_On_Forgot_Password_Page->FldTagCaption(2) <> "" ? $this->Show_Captcha_On_Forgot_Password_Page->FldTagCaption(2) : $this->Show_Captcha_On_Forgot_Password_Page->FldTagValue(2));
			$this->Show_Captcha_On_Forgot_Password_Page->EditValue = $arwrk;

			// Show_Captcha_On_Change_Password_Page
			$this->Show_Captcha_On_Change_Password_Page->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Captcha_On_Change_Password_Page->FldTagValue(1), $this->Show_Captcha_On_Change_Password_Page->FldTagCaption(1) <> "" ? $this->Show_Captcha_On_Change_Password_Page->FldTagCaption(1) : $this->Show_Captcha_On_Change_Password_Page->FldTagValue(1));
			$arwrk[] = array($this->Show_Captcha_On_Change_Password_Page->FldTagValue(2), $this->Show_Captcha_On_Change_Password_Page->FldTagCaption(2) <> "" ? $this->Show_Captcha_On_Change_Password_Page->FldTagCaption(2) : $this->Show_Captcha_On_Change_Password_Page->FldTagValue(2));
			$this->Show_Captcha_On_Change_Password_Page->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Enable_Password_Expiry->FldTagValue(1), $this->Enable_Password_Expiry->FldTagCaption(1) <> "" ? $this->Enable_Password_Expiry->FldTagCaption(1) : $this->Enable_Password_Expiry->FldTagValue(1));
			$arwrk[] = array($this->Enable_Password_Expiry->FldTagValue(2), $this->Enable_Password_Expiry->FldTagCaption(2) <> "" ? $this->Enable_Password_Expiry->FldTagCaption(2) : $this->Enable_Password_Expiry->FldTagValue(2));
			$this->Enable_Password_Expiry->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Show_Entire_Header->FldTagValue(1), $this->Show_Entire_Header->FldTagCaption(1) <> "" ? $this->Show_Entire_Header->FldTagCaption(1) : $this->Show_Entire_Header->FldTagValue(1));
			$arwrk[] = array($this->Show_Entire_Header->FldTagValue(2), $this->Show_Entire_Header->FldTagCaption(2) <> "" ? $this->Show_Entire_Header->FldTagCaption(2) : $this->Show_Entire_Header->FldTagValue(2));
			$this->Show_Entire_Header->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Show_Site_Title_In_Header->FldTagValue(1), $this->Show_Site_Title_In_Header->FldTagCaption(1) <> "" ? $this->Show_Site_Title_In_Header->FldTagCaption(1) : $this->Show_Site_Title_In_Header->FldTagValue(1));
			$arwrk[] = array($this->Show_Site_Title_In_Header->FldTagValue(2), $this->Show_Site_Title_In_Header->FldTagCaption(2) <> "" ? $this->Show_Site_Title_In_Header->FldTagCaption(2) : $this->Show_Site_Title_In_Header->FldTagValue(2));
			$this->Show_Site_Title_In_Header->EditValue = $arwrk;

			// Show_Current_User_In_Header
			$this->Show_Current_User_In_Header->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Current_User_In_Header->FldTagValue(1), $this->Show_Current_User_In_Header->FldTagCaption(1) <> "" ? $this->Show_Current_User_In_Header->FldTagCaption(1) : $this->Show_Current_User_In_Header->FldTagValue(1));
			$arwrk[] = array($this->Show_Current_User_In_Header->FldTagValue(2), $this->Show_Current_User_In_Header->FldTagCaption(2) <> "" ? $this->Show_Current_User_In_Header->FldTagCaption(2) : $this->Show_Current_User_In_Header->FldTagValue(2));
			$this->Show_Current_User_In_Header->EditValue = $arwrk;

			// Text_Align_In_Header
			$this->Text_Align_In_Header->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Text_Align_In_Header->FldTagValue(1), $this->Text_Align_In_Header->FldTagCaption(1) <> "" ? $this->Text_Align_In_Header->FldTagCaption(1) : $this->Text_Align_In_Header->FldTagValue(1));
			$arwrk[] = array($this->Text_Align_In_Header->FldTagValue(2), $this->Text_Align_In_Header->FldTagCaption(2) <> "" ? $this->Text_Align_In_Header->FldTagCaption(2) : $this->Text_Align_In_Header->FldTagValue(2));
			$arwrk[] = array($this->Text_Align_In_Header->FldTagValue(3), $this->Text_Align_In_Header->FldTagCaption(3) <> "" ? $this->Text_Align_In_Header->FldTagCaption(3) : $this->Text_Align_In_Header->FldTagValue(3));
			$this->Text_Align_In_Header->EditValue = $arwrk;

			// Site_Title_Text_Style
			$this->Site_Title_Text_Style->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Site_Title_Text_Style->FldTagValue(1), $this->Site_Title_Text_Style->FldTagCaption(1) <> "" ? $this->Site_Title_Text_Style->FldTagCaption(1) : $this->Site_Title_Text_Style->FldTagValue(1));
			$arwrk[] = array($this->Site_Title_Text_Style->FldTagValue(2), $this->Site_Title_Text_Style->FldTagCaption(2) <> "" ? $this->Site_Title_Text_Style->FldTagCaption(2) : $this->Site_Title_Text_Style->FldTagValue(2));
			$arwrk[] = array($this->Site_Title_Text_Style->FldTagValue(3), $this->Site_Title_Text_Style->FldTagCaption(3) <> "" ? $this->Site_Title_Text_Style->FldTagCaption(3) : $this->Site_Title_Text_Style->FldTagValue(3));
			$this->Site_Title_Text_Style->EditValue = $arwrk;

			// Language_Selector_Visibility
			$this->Language_Selector_Visibility->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Language_Selector_Visibility->FldTagValue(1), $this->Language_Selector_Visibility->FldTagCaption(1) <> "" ? $this->Language_Selector_Visibility->FldTagCaption(1) : $this->Language_Selector_Visibility->FldTagValue(1));
			$arwrk[] = array($this->Language_Selector_Visibility->FldTagValue(2), $this->Language_Selector_Visibility->FldTagCaption(2) <> "" ? $this->Language_Selector_Visibility->FldTagCaption(2) : $this->Language_Selector_Visibility->FldTagValue(2));
			$arwrk[] = array($this->Language_Selector_Visibility->FldTagValue(3), $this->Language_Selector_Visibility->FldTagCaption(3) <> "" ? $this->Language_Selector_Visibility->FldTagCaption(3) : $this->Language_Selector_Visibility->FldTagValue(3));
			$this->Language_Selector_Visibility->EditValue = $arwrk;

			// Language_Selector_Align
			$this->Language_Selector_Align->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Language_Selector_Align->FldTagValue(1), $this->Language_Selector_Align->FldTagCaption(1) <> "" ? $this->Language_Selector_Align->FldTagCaption(1) : $this->Language_Selector_Align->FldTagValue(1));
			$arwrk[] = array($this->Language_Selector_Align->FldTagValue(2), $this->Language_Selector_Align->FldTagCaption(2) <> "" ? $this->Language_Selector_Align->FldTagCaption(2) : $this->Language_Selector_Align->FldTagValue(2));
			$arwrk[] = array($this->Language_Selector_Align->FldTagValue(3), $this->Language_Selector_Align->FldTagCaption(3) <> "" ? $this->Language_Selector_Align->FldTagCaption(3) : $this->Language_Selector_Align->FldTagValue(3));
			$arwrk[] = array($this->Language_Selector_Align->FldTagValue(4), $this->Language_Selector_Align->FldTagCaption(4) <> "" ? $this->Language_Selector_Align->FldTagCaption(4) : $this->Language_Selector_Align->FldTagValue(4));
			$this->Language_Selector_Align->EditValue = $arwrk;

			// Show_Entire_Footer
			$this->Show_Entire_Footer->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Entire_Footer->FldTagValue(1), $this->Show_Entire_Footer->FldTagCaption(1) <> "" ? $this->Show_Entire_Footer->FldTagCaption(1) : $this->Show_Entire_Footer->FldTagValue(1));
			$arwrk[] = array($this->Show_Entire_Footer->FldTagValue(2), $this->Show_Entire_Footer->FldTagCaption(2) <> "" ? $this->Show_Entire_Footer->FldTagCaption(2) : $this->Show_Entire_Footer->FldTagValue(2));
			$this->Show_Entire_Footer->EditValue = $arwrk;

			// Show_Text_In_Footer
			$this->Show_Text_In_Footer->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Text_In_Footer->FldTagValue(1), $this->Show_Text_In_Footer->FldTagCaption(1) <> "" ? $this->Show_Text_In_Footer->FldTagCaption(1) : $this->Show_Text_In_Footer->FldTagValue(1));
			$arwrk[] = array($this->Show_Text_In_Footer->FldTagValue(2), $this->Show_Text_In_Footer->FldTagCaption(2) <> "" ? $this->Show_Text_In_Footer->FldTagCaption(2) : $this->Show_Text_In_Footer->FldTagValue(2));
			$this->Show_Text_In_Footer->EditValue = $arwrk;

			// Show_Back_To_Top_On_Footer
			$this->Show_Back_To_Top_On_Footer->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Back_To_Top_On_Footer->FldTagValue(1), $this->Show_Back_To_Top_On_Footer->FldTagCaption(1) <> "" ? $this->Show_Back_To_Top_On_Footer->FldTagCaption(1) : $this->Show_Back_To_Top_On_Footer->FldTagValue(1));
			$arwrk[] = array($this->Show_Back_To_Top_On_Footer->FldTagValue(2), $this->Show_Back_To_Top_On_Footer->FldTagCaption(2) <> "" ? $this->Show_Back_To_Top_On_Footer->FldTagCaption(2) : $this->Show_Back_To_Top_On_Footer->FldTagValue(2));
			$this->Show_Back_To_Top_On_Footer->EditValue = $arwrk;

			// Show_Terms_And_Conditions_On_Footer
			$this->Show_Terms_And_Conditions_On_Footer->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Terms_And_Conditions_On_Footer->FldTagValue(1), $this->Show_Terms_And_Conditions_On_Footer->FldTagCaption(1) <> "" ? $this->Show_Terms_And_Conditions_On_Footer->FldTagCaption(1) : $this->Show_Terms_And_Conditions_On_Footer->FldTagValue(1));
			$arwrk[] = array($this->Show_Terms_And_Conditions_On_Footer->FldTagValue(2), $this->Show_Terms_And_Conditions_On_Footer->FldTagCaption(2) <> "" ? $this->Show_Terms_And_Conditions_On_Footer->FldTagCaption(2) : $this->Show_Terms_And_Conditions_On_Footer->FldTagValue(2));
			$this->Show_Terms_And_Conditions_On_Footer->EditValue = $arwrk;

			// Show_About_Us_On_Footer
			$this->Show_About_Us_On_Footer->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_About_Us_On_Footer->FldTagValue(1), $this->Show_About_Us_On_Footer->FldTagCaption(1) <> "" ? $this->Show_About_Us_On_Footer->FldTagCaption(1) : $this->Show_About_Us_On_Footer->FldTagValue(1));
			$arwrk[] = array($this->Show_About_Us_On_Footer->FldTagValue(2), $this->Show_About_Us_On_Footer->FldTagCaption(2) <> "" ? $this->Show_About_Us_On_Footer->FldTagCaption(2) : $this->Show_About_Us_On_Footer->FldTagValue(2));
			$this->Show_About_Us_On_Footer->EditValue = $arwrk;

			// Pagination_Position
			$this->Pagination_Position->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Pagination_Position->FldTagValue(1), $this->Pagination_Position->FldTagCaption(1) <> "" ? $this->Pagination_Position->FldTagCaption(1) : $this->Pagination_Position->FldTagValue(1));
			$arwrk[] = array($this->Pagination_Position->FldTagValue(2), $this->Pagination_Position->FldTagCaption(2) <> "" ? $this->Pagination_Position->FldTagCaption(2) : $this->Pagination_Position->FldTagValue(2));
			$arwrk[] = array($this->Pagination_Position->FldTagValue(3), $this->Pagination_Position->FldTagCaption(3) <> "" ? $this->Pagination_Position->FldTagCaption(3) : $this->Pagination_Position->FldTagValue(3));
			$this->Pagination_Position->EditValue = $arwrk;

			// Pagination_Style
			$this->Pagination_Style->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Pagination_Style->FldTagValue(1), $this->Pagination_Style->FldTagCaption(1) <> "" ? $this->Pagination_Style->FldTagCaption(1) : $this->Pagination_Style->FldTagValue(1));
			$arwrk[] = array($this->Pagination_Style->FldTagValue(2), $this->Pagination_Style->FldTagCaption(2) <> "" ? $this->Pagination_Style->FldTagCaption(2) : $this->Pagination_Style->FldTagValue(2));
			$this->Pagination_Style->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Show_PageNum_If_Record_Not_Over_Pagesize->FldTagValue(1), $this->Show_PageNum_If_Record_Not_Over_Pagesize->FldTagCaption(1) <> "" ? $this->Show_PageNum_If_Record_Not_Over_Pagesize->FldTagCaption(1) : $this->Show_PageNum_If_Record_Not_Over_Pagesize->FldTagValue(1));
			$arwrk[] = array($this->Show_PageNum_If_Record_Not_Over_Pagesize->FldTagValue(2), $this->Show_PageNum_If_Record_Not_Over_Pagesize->FldTagCaption(2) <> "" ? $this->Show_PageNum_If_Record_Not_Over_Pagesize->FldTagCaption(2) : $this->Show_PageNum_If_Record_Not_Over_Pagesize->FldTagValue(2));
			$this->Show_PageNum_If_Record_Not_Over_Pagesize->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Search_Panel_Collapsed->FldTagValue(1), $this->Search_Panel_Collapsed->FldTagCaption(1) <> "" ? $this->Search_Panel_Collapsed->FldTagCaption(1) : $this->Search_Panel_Collapsed->FldTagValue(1));
			$arwrk[] = array($this->Search_Panel_Collapsed->FldTagValue(2), $this->Search_Panel_Collapsed->FldTagCaption(2) <> "" ? $this->Search_Panel_Collapsed->FldTagCaption(2) : $this->Search_Panel_Collapsed->FldTagValue(2));
			$this->Search_Panel_Collapsed->EditValue = $arwrk;

			// Filter_Panel_Collapsed
			$this->Filter_Panel_Collapsed->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Filter_Panel_Collapsed->FldTagValue(1), $this->Filter_Panel_Collapsed->FldTagCaption(1) <> "" ? $this->Filter_Panel_Collapsed->FldTagCaption(1) : $this->Filter_Panel_Collapsed->FldTagValue(1));
			$arwrk[] = array($this->Filter_Panel_Collapsed->FldTagValue(2), $this->Filter_Panel_Collapsed->FldTagCaption(2) <> "" ? $this->Filter_Panel_Collapsed->FldTagCaption(2) : $this->Filter_Panel_Collapsed->FldTagValue(2));
			$this->Filter_Panel_Collapsed->EditValue = $arwrk;

			// Show_Record_Number_On_List_Page
			$this->Show_Record_Number_On_List_Page->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Record_Number_On_List_Page->FldTagValue(1), $this->Show_Record_Number_On_List_Page->FldTagCaption(1) <> "" ? $this->Show_Record_Number_On_List_Page->FldTagCaption(1) : $this->Show_Record_Number_On_List_Page->FldTagValue(1));
			$arwrk[] = array($this->Show_Record_Number_On_List_Page->FldTagValue(2), $this->Show_Record_Number_On_List_Page->FldTagCaption(2) <> "" ? $this->Show_Record_Number_On_List_Page->FldTagCaption(2) : $this->Show_Record_Number_On_List_Page->FldTagValue(2));
			$this->Show_Record_Number_On_List_Page->EditValue = $arwrk;

			// Show_Empty_Table_On_List_Page
			$this->Show_Empty_Table_On_List_Page->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Empty_Table_On_List_Page->FldTagValue(1), $this->Show_Empty_Table_On_List_Page->FldTagCaption(1) <> "" ? $this->Show_Empty_Table_On_List_Page->FldTagCaption(1) : $this->Show_Empty_Table_On_List_Page->FldTagValue(1));
			$arwrk[] = array($this->Show_Empty_Table_On_List_Page->FldTagValue(2), $this->Show_Empty_Table_On_List_Page->FldTagCaption(2) <> "" ? $this->Show_Empty_Table_On_List_Page->FldTagCaption(2) : $this->Show_Empty_Table_On_List_Page->FldTagValue(2));
			$this->Show_Empty_Table_On_List_Page->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Action_Button_Alignment->FldTagValue(1), $this->Action_Button_Alignment->FldTagCaption(1) <> "" ? $this->Action_Button_Alignment->FldTagCaption(1) : $this->Action_Button_Alignment->FldTagValue(1));
			$arwrk[] = array($this->Action_Button_Alignment->FldTagValue(2), $this->Action_Button_Alignment->FldTagCaption(2) <> "" ? $this->Action_Button_Alignment->FldTagCaption(2) : $this->Action_Button_Alignment->FldTagValue(2));
			$this->Action_Button_Alignment->EditValue = $arwrk;

			// Show_Add_Success_Message
			$this->Show_Add_Success_Message->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Add_Success_Message->FldTagValue(1), $this->Show_Add_Success_Message->FldTagCaption(1) <> "" ? $this->Show_Add_Success_Message->FldTagCaption(1) : $this->Show_Add_Success_Message->FldTagValue(1));
			$arwrk[] = array($this->Show_Add_Success_Message->FldTagValue(2), $this->Show_Add_Success_Message->FldTagCaption(2) <> "" ? $this->Show_Add_Success_Message->FldTagCaption(2) : $this->Show_Add_Success_Message->FldTagValue(2));
			$this->Show_Add_Success_Message->EditValue = $arwrk;

			// Show_Edit_Success_Message
			$this->Show_Edit_Success_Message->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Edit_Success_Message->FldTagValue(1), $this->Show_Edit_Success_Message->FldTagCaption(1) <> "" ? $this->Show_Edit_Success_Message->FldTagCaption(1) : $this->Show_Edit_Success_Message->FldTagValue(1));
			$arwrk[] = array($this->Show_Edit_Success_Message->FldTagValue(2), $this->Show_Edit_Success_Message->FldTagCaption(2) <> "" ? $this->Show_Edit_Success_Message->FldTagCaption(2) : $this->Show_Edit_Success_Message->FldTagValue(2));
			$this->Show_Edit_Success_Message->EditValue = $arwrk;

			// jQuery_Auto_Hide_Success_Message
			$this->jQuery_Auto_Hide_Success_Message->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->jQuery_Auto_Hide_Success_Message->FldTagValue(1), $this->jQuery_Auto_Hide_Success_Message->FldTagCaption(1) <> "" ? $this->jQuery_Auto_Hide_Success_Message->FldTagCaption(1) : $this->jQuery_Auto_Hide_Success_Message->FldTagValue(1));
			$arwrk[] = array($this->jQuery_Auto_Hide_Success_Message->FldTagValue(2), $this->jQuery_Auto_Hide_Success_Message->FldTagCaption(2) <> "" ? $this->jQuery_Auto_Hide_Success_Message->FldTagCaption(2) : $this->jQuery_Auto_Hide_Success_Message->FldTagValue(2));
			$this->jQuery_Auto_Hide_Success_Message->EditValue = $arwrk;

			// Use_Javascript_Message
			$this->Use_Javascript_Message->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Use_Javascript_Message->FldTagValue(1), $this->Use_Javascript_Message->FldTagCaption(1) <> "" ? $this->Use_Javascript_Message->FldTagCaption(1) : $this->Use_Javascript_Message->FldTagValue(1));
			$arwrk[] = array($this->Use_Javascript_Message->FldTagValue(2), $this->Use_Javascript_Message->FldTagCaption(2) <> "" ? $this->Use_Javascript_Message->FldTagCaption(2) : $this->Use_Javascript_Message->FldTagValue(2));
			$this->Use_Javascript_Message->EditValue = $arwrk;

			// Login_Window_Type
			$this->Login_Window_Type->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Login_Window_Type->FldTagValue(1), $this->Login_Window_Type->FldTagCaption(1) <> "" ? $this->Login_Window_Type->FldTagCaption(1) : $this->Login_Window_Type->FldTagValue(1));
			$arwrk[] = array($this->Login_Window_Type->FldTagValue(2), $this->Login_Window_Type->FldTagCaption(2) <> "" ? $this->Login_Window_Type->FldTagCaption(2) : $this->Login_Window_Type->FldTagValue(2));
			$this->Login_Window_Type->EditValue = $arwrk;

			// Forgot_Password_Window_Type
			$this->Forgot_Password_Window_Type->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Forgot_Password_Window_Type->FldTagValue(1), $this->Forgot_Password_Window_Type->FldTagCaption(1) <> "" ? $this->Forgot_Password_Window_Type->FldTagCaption(1) : $this->Forgot_Password_Window_Type->FldTagValue(1));
			$arwrk[] = array($this->Forgot_Password_Window_Type->FldTagValue(2), $this->Forgot_Password_Window_Type->FldTagCaption(2) <> "" ? $this->Forgot_Password_Window_Type->FldTagCaption(2) : $this->Forgot_Password_Window_Type->FldTagValue(2));
			$this->Forgot_Password_Window_Type->EditValue = $arwrk;

			// Change_Password_Window_Type
			$this->Change_Password_Window_Type->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Change_Password_Window_Type->FldTagValue(1), $this->Change_Password_Window_Type->FldTagCaption(1) <> "" ? $this->Change_Password_Window_Type->FldTagCaption(1) : $this->Change_Password_Window_Type->FldTagValue(1));
			$arwrk[] = array($this->Change_Password_Window_Type->FldTagValue(2), $this->Change_Password_Window_Type->FldTagCaption(2) <> "" ? $this->Change_Password_Window_Type->FldTagCaption(2) : $this->Change_Password_Window_Type->FldTagValue(2));
			$this->Change_Password_Window_Type->EditValue = $arwrk;

			// Registration_Window_Type
			$this->Registration_Window_Type->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Registration_Window_Type->FldTagValue(1), $this->Registration_Window_Type->FldTagCaption(1) <> "" ? $this->Registration_Window_Type->FldTagCaption(1) : $this->Registration_Window_Type->FldTagValue(1));
			$arwrk[] = array($this->Registration_Window_Type->FldTagValue(2), $this->Registration_Window_Type->FldTagCaption(2) <> "" ? $this->Registration_Window_Type->FldTagCaption(2) : $this->Registration_Window_Type->FldTagValue(2));
			$this->Registration_Window_Type->EditValue = $arwrk;

			// Show_Record_Number_On_Detail_Preview
			$this->Show_Record_Number_On_Detail_Preview->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Record_Number_On_Detail_Preview->FldTagValue(1), $this->Show_Record_Number_On_Detail_Preview->FldTagCaption(1) <> "" ? $this->Show_Record_Number_On_Detail_Preview->FldTagCaption(1) : $this->Show_Record_Number_On_Detail_Preview->FldTagValue(1));
			$arwrk[] = array($this->Show_Record_Number_On_Detail_Preview->FldTagValue(2), $this->Show_Record_Number_On_Detail_Preview->FldTagCaption(2) <> "" ? $this->Show_Record_Number_On_Detail_Preview->FldTagCaption(2) : $this->Show_Record_Number_On_Detail_Preview->FldTagValue(2));
			$this->Show_Record_Number_On_Detail_Preview->EditValue = $arwrk;

			// Show_Empty_Table_In_Detail_Preview
			$this->Show_Empty_Table_In_Detail_Preview->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Empty_Table_In_Detail_Preview->FldTagValue(1), $this->Show_Empty_Table_In_Detail_Preview->FldTagCaption(1) <> "" ? $this->Show_Empty_Table_In_Detail_Preview->FldTagCaption(1) : $this->Show_Empty_Table_In_Detail_Preview->FldTagValue(1));
			$arwrk[] = array($this->Show_Empty_Table_In_Detail_Preview->FldTagValue(2), $this->Show_Empty_Table_In_Detail_Preview->FldTagCaption(2) <> "" ? $this->Show_Empty_Table_In_Detail_Preview->FldTagCaption(2) : $this->Show_Empty_Table_In_Detail_Preview->FldTagValue(2));
			$this->Show_Empty_Table_In_Detail_Preview->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Password_Must_Contain_At_Least_One_Lower_Case->FldTagValue(1), $this->Password_Must_Contain_At_Least_One_Lower_Case->FldTagCaption(1) <> "" ? $this->Password_Must_Contain_At_Least_One_Lower_Case->FldTagCaption(1) : $this->Password_Must_Contain_At_Least_One_Lower_Case->FldTagValue(1));
			$arwrk[] = array($this->Password_Must_Contain_At_Least_One_Lower_Case->FldTagValue(2), $this->Password_Must_Contain_At_Least_One_Lower_Case->FldTagCaption(2) <> "" ? $this->Password_Must_Contain_At_Least_One_Lower_Case->FldTagCaption(2) : $this->Password_Must_Contain_At_Least_One_Lower_Case->FldTagValue(2));
			$this->Password_Must_Contain_At_Least_One_Lower_Case->EditValue = $arwrk;

			// Password_Must_Comply_With_Minumum_Length
			$this->Password_Must_Comply_With_Minumum_Length->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Password_Must_Comply_With_Minumum_Length->FldTagValue(1), $this->Password_Must_Comply_With_Minumum_Length->FldTagCaption(1) <> "" ? $this->Password_Must_Comply_With_Minumum_Length->FldTagCaption(1) : $this->Password_Must_Comply_With_Minumum_Length->FldTagValue(1));
			$arwrk[] = array($this->Password_Must_Comply_With_Minumum_Length->FldTagValue(2), $this->Password_Must_Comply_With_Minumum_Length->FldTagCaption(2) <> "" ? $this->Password_Must_Comply_With_Minumum_Length->FldTagCaption(2) : $this->Password_Must_Comply_With_Minumum_Length->FldTagValue(2));
			$this->Password_Must_Comply_With_Minumum_Length->EditValue = $arwrk;

			// Password_Must_Comply_With_Maximum_Length
			$this->Password_Must_Comply_With_Maximum_Length->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Password_Must_Comply_With_Maximum_Length->FldTagValue(1), $this->Password_Must_Comply_With_Maximum_Length->FldTagCaption(1) <> "" ? $this->Password_Must_Comply_With_Maximum_Length->FldTagCaption(1) : $this->Password_Must_Comply_With_Maximum_Length->FldTagValue(1));
			$arwrk[] = array($this->Password_Must_Comply_With_Maximum_Length->FldTagValue(2), $this->Password_Must_Comply_With_Maximum_Length->FldTagCaption(2) <> "" ? $this->Password_Must_Comply_With_Maximum_Length->FldTagCaption(2) : $this->Password_Must_Comply_With_Maximum_Length->FldTagValue(2));
			$this->Password_Must_Comply_With_Maximum_Length->EditValue = $arwrk;

			// Password_Must_Contain_At_Least_One_Upper_Case
			$this->Password_Must_Contain_At_Least_One_Upper_Case->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Password_Must_Contain_At_Least_One_Upper_Case->FldTagValue(1), $this->Password_Must_Contain_At_Least_One_Upper_Case->FldTagCaption(1) <> "" ? $this->Password_Must_Contain_At_Least_One_Upper_Case->FldTagCaption(1) : $this->Password_Must_Contain_At_Least_One_Upper_Case->FldTagValue(1));
			$arwrk[] = array($this->Password_Must_Contain_At_Least_One_Upper_Case->FldTagValue(2), $this->Password_Must_Contain_At_Least_One_Upper_Case->FldTagCaption(2) <> "" ? $this->Password_Must_Contain_At_Least_One_Upper_Case->FldTagCaption(2) : $this->Password_Must_Contain_At_Least_One_Upper_Case->FldTagValue(2));
			$this->Password_Must_Contain_At_Least_One_Upper_Case->EditValue = $arwrk;

			// Password_Must_Contain_At_Least_One_Numeric
			$this->Password_Must_Contain_At_Least_One_Numeric->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Password_Must_Contain_At_Least_One_Numeric->FldTagValue(1), $this->Password_Must_Contain_At_Least_One_Numeric->FldTagCaption(1) <> "" ? $this->Password_Must_Contain_At_Least_One_Numeric->FldTagCaption(1) : $this->Password_Must_Contain_At_Least_One_Numeric->FldTagValue(1));
			$arwrk[] = array($this->Password_Must_Contain_At_Least_One_Numeric->FldTagValue(2), $this->Password_Must_Contain_At_Least_One_Numeric->FldTagCaption(2) <> "" ? $this->Password_Must_Contain_At_Least_One_Numeric->FldTagCaption(2) : $this->Password_Must_Contain_At_Least_One_Numeric->FldTagValue(2));
			$this->Password_Must_Contain_At_Least_One_Numeric->EditValue = $arwrk;

			// Password_Must_Contain_At_Least_One_Symbol
			$this->Password_Must_Contain_At_Least_One_Symbol->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Password_Must_Contain_At_Least_One_Symbol->FldTagValue(1), $this->Password_Must_Contain_At_Least_One_Symbol->FldTagCaption(1) <> "" ? $this->Password_Must_Contain_At_Least_One_Symbol->FldTagCaption(1) : $this->Password_Must_Contain_At_Least_One_Symbol->FldTagValue(1));
			$arwrk[] = array($this->Password_Must_Contain_At_Least_One_Symbol->FldTagValue(2), $this->Password_Must_Contain_At_Least_One_Symbol->FldTagCaption(2) <> "" ? $this->Password_Must_Contain_At_Least_One_Symbol->FldTagCaption(2) : $this->Password_Must_Contain_At_Least_One_Symbol->FldTagValue(2));
			$this->Password_Must_Contain_At_Least_One_Symbol->EditValue = $arwrk;

			// Password_Must_Be_Difference_Between_Old_And_New
			$this->Password_Must_Be_Difference_Between_Old_And_New->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Password_Must_Be_Difference_Between_Old_And_New->FldTagValue(1), $this->Password_Must_Be_Difference_Between_Old_And_New->FldTagCaption(1) <> "" ? $this->Password_Must_Be_Difference_Between_Old_And_New->FldTagCaption(1) : $this->Password_Must_Be_Difference_Between_Old_And_New->FldTagValue(1));
			$arwrk[] = array($this->Password_Must_Be_Difference_Between_Old_And_New->FldTagValue(2), $this->Password_Must_Be_Difference_Between_Old_And_New->FldTagCaption(2) <> "" ? $this->Password_Must_Be_Difference_Between_Old_And_New->FldTagCaption(2) : $this->Password_Must_Be_Difference_Between_Old_And_New->FldTagValue(2));
			$this->Password_Must_Be_Difference_Between_Old_And_New->EditValue = $arwrk;

			// Reset_Password_Field_Options
			$this->Reset_Password_Field_Options->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Reset_Password_Field_Options->FldTagValue(1), $this->Reset_Password_Field_Options->FldTagCaption(1) <> "" ? $this->Reset_Password_Field_Options->FldTagCaption(1) : $this->Reset_Password_Field_Options->FldTagValue(1));
			$arwrk[] = array($this->Reset_Password_Field_Options->FldTagValue(2), $this->Reset_Password_Field_Options->FldTagCaption(2) <> "" ? $this->Reset_Password_Field_Options->FldTagCaption(2) : $this->Reset_Password_Field_Options->FldTagValue(2));
			$arwrk[] = array($this->Reset_Password_Field_Options->FldTagValue(3), $this->Reset_Password_Field_Options->FldTagCaption(3) <> "" ? $this->Reset_Password_Field_Options->FldTagCaption(3) : $this->Reset_Password_Field_Options->FldTagValue(3));
			$this->Reset_Password_Field_Options->EditValue = $arwrk;

			// Export_Record_Options
			$this->Export_Record_Options->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Export_Record_Options->FldTagValue(1), $this->Export_Record_Options->FldTagCaption(1) <> "" ? $this->Export_Record_Options->FldTagCaption(1) : $this->Export_Record_Options->FldTagValue(1));
			$arwrk[] = array($this->Export_Record_Options->FldTagValue(2), $this->Export_Record_Options->FldTagCaption(2) <> "" ? $this->Export_Record_Options->FldTagCaption(2) : $this->Export_Record_Options->FldTagValue(2));
			$arwrk[] = array($this->Export_Record_Options->FldTagValue(3), $this->Export_Record_Options->FldTagCaption(3) <> "" ? $this->Export_Record_Options->FldTagCaption(3) : $this->Export_Record_Options->FldTagValue(3));
			$this->Export_Record_Options->EditValue = $arwrk;

			// Show_Record_Number_On_Exported_List_Page
			$this->Show_Record_Number_On_Exported_List_Page->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Show_Record_Number_On_Exported_List_Page->FldTagValue(1), $this->Show_Record_Number_On_Exported_List_Page->FldTagCaption(1) <> "" ? $this->Show_Record_Number_On_Exported_List_Page->FldTagCaption(1) : $this->Show_Record_Number_On_Exported_List_Page->FldTagValue(1));
			$arwrk[] = array($this->Show_Record_Number_On_Exported_List_Page->FldTagValue(2), $this->Show_Record_Number_On_Exported_List_Page->FldTagCaption(2) <> "" ? $this->Show_Record_Number_On_Exported_List_Page->FldTagCaption(2) : $this->Show_Record_Number_On_Exported_List_Page->FldTagValue(2));
			$this->Show_Record_Number_On_Exported_List_Page->EditValue = $arwrk;

			// Use_Table_Setting_For_Export_Field_Caption
			$this->Use_Table_Setting_For_Export_Field_Caption->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Use_Table_Setting_For_Export_Field_Caption->FldTagValue(1), $this->Use_Table_Setting_For_Export_Field_Caption->FldTagCaption(1) <> "" ? $this->Use_Table_Setting_For_Export_Field_Caption->FldTagCaption(1) : $this->Use_Table_Setting_For_Export_Field_Caption->FldTagValue(1));
			$arwrk[] = array($this->Use_Table_Setting_For_Export_Field_Caption->FldTagValue(2), $this->Use_Table_Setting_For_Export_Field_Caption->FldTagCaption(2) <> "" ? $this->Use_Table_Setting_For_Export_Field_Caption->FldTagCaption(2) : $this->Use_Table_Setting_For_Export_Field_Caption->FldTagValue(2));
			$this->Use_Table_Setting_For_Export_Field_Caption->EditValue = $arwrk;

			// Use_Table_Setting_For_Export_Original_Value
			$this->Use_Table_Setting_For_Export_Original_Value->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Use_Table_Setting_For_Export_Original_Value->FldTagValue(1), $this->Use_Table_Setting_For_Export_Original_Value->FldTagCaption(1) <> "" ? $this->Use_Table_Setting_For_Export_Original_Value->FldTagCaption(1) : $this->Use_Table_Setting_For_Export_Original_Value->FldTagValue(1));
			$arwrk[] = array($this->Use_Table_Setting_For_Export_Original_Value->FldTagValue(2), $this->Use_Table_Setting_For_Export_Original_Value->FldTagCaption(2) <> "" ? $this->Use_Table_Setting_For_Export_Original_Value->FldTagCaption(2) : $this->Use_Table_Setting_For_Export_Original_Value->FldTagValue(2));
			$this->Use_Table_Setting_For_Export_Original_Value->EditValue = $arwrk;
	...
	function AddRow($rsold = NULL) {
		...
		$this->Option_Default->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Option_Default->CurrentValue) == "");

		// Default_Theme
		$this->Default_Theme->SetDbValueDef($rsnew, $this->Default_Theme->CurrentValue, NULL, FALSE);

		// Font_Name
		$this->Font_Name->SetDbValueDef($rsnew, $this->Font_Name->CurrentValue, NULL, strval($this->Font_Name->CurrentValue) == "");

		// Font_Size
		$this->Font_Size->SetDbValueDef($rsnew, $this->Font_Size->CurrentValue, NULL, strval($this->Font_Size->CurrentValue) == "");

		// Show_Border_Layout
		$tmpBool = $this->Show_Border_Layout->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Border_Layout->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Border_Layout->CurrentValue) == "");

		// Show_Shadow_Layout
		$tmpBool = $this->Show_Shadow_Layout->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Shadow_Layout->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Shadow_Layout->CurrentValue) == "");

		// Menu_Horizontal
		$tmpBool = $this->Menu_Horizontal->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Menu_Horizontal->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Menu_Horizontal->CurrentValue) == "");

		// Vertical_Menu_Width
		$this->Vertical_Menu_Width->SetDbValueDef($rsnew, $this->Vertical_Menu_Width->CurrentValue, NULL, strval($this->Vertical_Menu_Width->CurrentValue) == "");

		// Show_Announcement
		$this->Show_Announcement->SetDbValueDef($rsnew, ((strval($this->Show_Announcement->CurrentValue) == "Y") ? "Y" : "N"), NULL, strval($this->Show_Announcement->CurrentValue) == "");

		// Demo_Mode
		$tmpBool = $this->Demo_Mode->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Demo_Mode->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Demo_Mode->CurrentValue) == "");

		// Show_Page_Processing_Time
		$tmpBool = $this->Show_Page_Processing_Time->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Page_Processing_Time->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Page_Processing_Time->CurrentValue) == "");

		// Allow_User_Preferences
		$tmpBool = $this->Allow_User_Preferences->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Allow_User_Preferences->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Allow_User_Preferences->CurrentValue) == "");

		// SMTP_Server
		$this->SMTP_Server->SetDbValueDef($rsnew, $this->SMTP_Server->CurrentValue, NULL, FALSE);

		// SMTP_Server_Port
		$this->SMTP_Server_Port->SetDbValueDef($rsnew, $this->SMTP_Server_Port->CurrentValue, NULL, FALSE);

		// SMTP_Server_Username
		$this->SMTP_Server_Username->SetDbValueDef($rsnew, $this->SMTP_Server_Username->CurrentValue, NULL, FALSE);

		// SMTP_Server_Password
		$this->SMTP_Server_Password->SetDbValueDef($rsnew, $this->SMTP_Server_Password->CurrentValue, NULL, FALSE);

		// Sender_Email
		$this->Sender_Email->SetDbValueDef($rsnew, $this->Sender_Email->CurrentValue, NULL, FALSE);

		// Recipient_Email
		$this->Recipient_Email->SetDbValueDef($rsnew, $this->Recipient_Email->CurrentValue, NULL, FALSE);

		// Use_Default_Locale
		$tmpBool = $this->Use_Default_Locale->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Use_Default_Locale->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Use_Default_Locale->CurrentValue) == "");

		// Default_Language
		$this->Default_Language->SetDbValueDef($rsnew, $this->Default_Language->CurrentValue, NULL, FALSE);

		// Default_Timezone
		$this->Default_Timezone->SetDbValueDef($rsnew, $this->Default_Timezone->CurrentValue, NULL, FALSE);
		...
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Maintenance_Mode->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Maintenance_Mode->CurrentValue) == "");

		// Maintenance_Finish_DateTime
		$this->Maintenance_Finish_DateTime->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->Maintenance_Finish_DateTime->CurrentValue, 9), NULL, FALSE);

		// Auto_Normal_After_Maintenance
		$tmpBool = $this->Auto_Normal_After_Maintenance->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Auto_Normal_After_Maintenance->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Auto_Normal_After_Maintenance->CurrentValue) == "");

		// Allow_User_To_Register
		$tmpBool = $this->Allow_User_To_Register->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Allow_User_To_Register->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Allow_User_To_Register->CurrentValue) == "");

		// Suspend_New_User_Account
		$tmpBool = $this->Suspend_New_User_Account->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Suspend_New_User_Account->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Suspend_New_User_Account->CurrentValue) == "");

		// User_Need_Activation_After_Registered
		$tmpBool = $this->User_Need_Activation_After_Registered->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->User_Need_Activation_After_Registered->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->User_Need_Activation_After_Registered->CurrentValue) == "");

		// Show_Captcha_On_Registration_Page
		$tmpBool = $this->Show_Captcha_On_Registration_Page->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Captcha_On_Registration_Page->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Captcha_On_Registration_Page->CurrentValue) == "");

		// Show_Terms_And_Conditions_On_Registration_Page
		$tmpBool = $this->Show_Terms_And_Conditions_On_Registration_Page->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Terms_And_Conditions_On_Registration_Page->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Terms_And_Conditions_On_Registration_Page->CurrentValue) == "");

		// User_Auto_Login_After_Activation_Or_Registration
		$tmpBool = $this->User_Auto_Login_After_Activation_Or_Registration->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->User_Auto_Login_After_Activation_Or_Registration->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->User_Auto_Login_After_Activation_Or_Registration->CurrentValue) == "");

		// Show_Captcha_On_Login_Page
		$tmpBool = $this->Show_Captcha_On_Login_Page->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Captcha_On_Login_Page->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Captcha_On_Login_Page->CurrentValue) == "");

		// Show_Captcha_On_Forgot_Password_Page
		$tmpBool = $this->Show_Captcha_On_Forgot_Password_Page->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Captcha_On_Forgot_Password_Page->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Captcha_On_Forgot_Password_Page->CurrentValue) == "");

		// Show_Captcha_On_Change_Password_Page
		$tmpBool = $this->Show_Captcha_On_Change_Password_Page->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Captcha_On_Change_Password_Page->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Captcha_On_Change_Password_Page->CurrentValue) == "");

		// User_Auto_Logout_After_Idle_In_Minutes
		$this->User_Auto_Logout_After_Idle_In_Minutes->SetDbValueDef($rsnew, $this->User_Auto_Logout_After_Idle_In_Minutes->CurrentValue, NULL, strval($this->User_Auto_Logout_After_Idle_In_Minutes->CurrentValue) == "");

		// User_Login_Maximum_Retry
		$this->User_Login_Maximum_Retry->SetDbValueDef($rsnew, $this->User_Login_Maximum_Retry->CurrentValue, NULL, strval($this->User_Login_Maximum_Retry->CurrentValue) == "");

		// User_Login_Retry_Lockout
		$this->User_Login_Retry_Lockout->SetDbValueDef($rsnew, $this->User_Login_Retry_Lockout->CurrentValue, NULL, strval($this->User_Login_Retry_Lockout->CurrentValue) == "");

		// Redirect_To_Last_Visited_Page_After_Login
		$tmpBool = $this->Redirect_To_Last_Visited_Page_After_Login->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Redirect_To_Last_Visited_Page_After_Login->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Redirect_To_Last_Visited_Page_After_Login->CurrentValue) == "");

		// Enable_Password_Expiry
		$tmpBool = $this->Enable_Password_Expiry->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Enable_Password_Expiry->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Enable_Password_Expiry->CurrentValue) == "");

		// Password_Expiry_In_Days
		$this->Password_Expiry_In_Days->SetDbValueDef($rsnew, $this->Password_Expiry_In_Days->CurrentValue, NULL, strval($this->Password_Expiry_In_Days->CurrentValue) == "");

		// Show_Entire_Header
		$tmpBool = $this->Show_Entire_Header->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Entire_Header->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Entire_Header->CurrentValue) == "");

		// Logo_Width
		$this->Logo_Width->SetDbValueDef($rsnew, $this->Logo_Width->CurrentValue, NULL, strval($this->Logo_Width->CurrentValue) == "");

		// Show_Site_Title_In_Header
		$tmpBool = $this->Show_Site_Title_In_Header->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Site_Title_In_Header->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Site_Title_In_Header->CurrentValue) == "");

		// Show_Current_User_In_Header
		$tmpBool = $this->Show_Current_User_In_Header->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Current_User_In_Header->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Current_User_In_Header->CurrentValue) == "");

		// Text_Align_In_Header
		$this->Text_Align_In_Header->SetDbValueDef($rsnew, $this->Text_Align_In_Header->CurrentValue, NULL, strval($this->Text_Align_In_Header->CurrentValue) == "");

		// Site_Title_Text_Style
		$this->Site_Title_Text_Style->SetDbValueDef($rsnew, $this->Site_Title_Text_Style->CurrentValue, NULL, strval($this->Site_Title_Text_Style->CurrentValue) == "");

		// Language_Selector_Visibility
		$this->Language_Selector_Visibility->SetDbValueDef($rsnew, $this->Language_Selector_Visibility->CurrentValue, NULL, strval($this->Language_Selector_Visibility->CurrentValue) == "");

		// Language_Selector_Align
		$this->Language_Selector_Align->SetDbValueDef($rsnew, $this->Language_Selector_Align->CurrentValue, NULL, strval($this->Language_Selector_Align->CurrentValue) == "");

		// Show_Entire_Footer
		$tmpBool = $this->Show_Entire_Footer->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Entire_Footer->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Entire_Footer->CurrentValue) == "");

		// Show_Text_In_Footer
		$tmpBool = $this->Show_Text_In_Footer->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Text_In_Footer->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Text_In_Footer->CurrentValue) == "");

		// Show_Back_To_Top_On_Footer
		$tmpBool = $this->Show_Back_To_Top_On_Footer->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Back_To_Top_On_Footer->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Back_To_Top_On_Footer->CurrentValue) == "");

		// Show_Terms_And_Conditions_On_Footer
		$tmpBool = $this->Show_Terms_And_Conditions_On_Footer->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Terms_And_Conditions_On_Footer->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Terms_And_Conditions_On_Footer->CurrentValue) == "");

		// Show_About_Us_On_Footer
		$tmpBool = $this->Show_About_Us_On_Footer->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_About_Us_On_Footer->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_About_Us_On_Footer->CurrentValue) == "");

		// Pagination_Position
		$this->Pagination_Position->SetDbValueDef($rsnew, $this->Pagination_Position->CurrentValue, NULL, strval($this->Pagination_Position->CurrentValue) == "");

		// Pagination_Style
		$this->Pagination_Style->SetDbValueDef($rsnew, $this->Pagination_Style->CurrentValue, NULL, strval($this->Pagination_Style->CurrentValue) == "");

		// Selectable_Records_Per_Page
		$this->Selectable_Records_Per_Page->SetDbValueDef($rsnew, $this->Selectable_Records_Per_Page->CurrentValue, NULL, strval($this->Selectable_Records_Per_Page->CurrentValue) == "");

		// Selectable_Groups_Per_Page
		$this->Selectable_Groups_Per_Page->SetDbValueDef($rsnew, $this->Selectable_Groups_Per_Page->CurrentValue, NULL, strval($this->Selectable_Groups_Per_Page->CurrentValue) == "");

		// Default_Record_Per_Page
		$this->Default_Record_Per_Page->SetDbValueDef($rsnew, $this->Default_Record_Per_Page->CurrentValue, NULL, strval($this->Default_Record_Per_Page->CurrentValue) == "");

		// Default_Group_Per_Page
		$this->Default_Group_Per_Page->SetDbValueDef($rsnew, $this->Default_Group_Per_Page->CurrentValue, NULL, strval($this->Default_Group_Per_Page->CurrentValue) == "");

		// Maximum_Selected_Records
		$this->Maximum_Selected_Records->SetDbValueDef($rsnew, $this->Maximum_Selected_Records->CurrentValue, NULL, strval($this->Maximum_Selected_Records->CurrentValue) == "");

		// Maximum_Selected_Groups
		$this->Maximum_Selected_Groups->SetDbValueDef($rsnew, $this->Maximum_Selected_Groups->CurrentValue, NULL, strval($this->Maximum_Selected_Groups->CurrentValue) == "");

		// Show_PageNum_If_Record_Not_Over_Pagesize
		$tmpBool = $this->Show_PageNum_If_Record_Not_Over_Pagesize->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_PageNum_If_Record_Not_Over_Pagesize->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_PageNum_If_Record_Not_Over_Pagesize->CurrentValue) == "");

		// Table_Width_Style
		$this->Table_Width_Style->SetDbValueDef($rsnew, $this->Table_Width_Style->CurrentValue, NULL, strval($this->Table_Width_Style->CurrentValue) == "");

		// Scroll_Table_Width
		$this->Scroll_Table_Width->SetDbValueDef($rsnew, $this->Scroll_Table_Width->CurrentValue, NULL, strval($this->Scroll_Table_Width->CurrentValue) == "");

		// Scroll_Table_Height
		$this->Scroll_Table_Height->SetDbValueDef($rsnew, $this->Scroll_Table_Height->CurrentValue, NULL, strval($this->Scroll_Table_Height->CurrentValue) == "");

		// Search_Panel_Collapsed
		$tmpBool = $this->Search_Panel_Collapsed->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Search_Panel_Collapsed->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Search_Panel_Collapsed->CurrentValue) == "");

		// Filter_Panel_Collapsed
		$tmpBool = $this->Filter_Panel_Collapsed->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Filter_Panel_Collapsed->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Filter_Panel_Collapsed->CurrentValue) == "");

		// Show_Record_Number_On_List_Page
		$tmpBool = $this->Show_Record_Number_On_List_Page->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Record_Number_On_List_Page->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Record_Number_On_List_Page->CurrentValue) == "");

		// Show_Empty_Table_On_List_Page
		$tmpBool = $this->Show_Empty_Table_On_List_Page->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Empty_Table_On_List_Page->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Empty_Table_On_List_Page->CurrentValue) == "");

		// Rows_Vertical_Align_Top
		$tmpBool = $this->Rows_Vertical_Align_Top->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Rows_Vertical_Align_Top->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Rows_Vertical_Align_Top->CurrentValue) == "");

		// Action_Button_Alignment
		$this->Action_Button_Alignment->SetDbValueDef($rsnew, $this->Action_Button_Alignment->CurrentValue, NULL, strval($this->Action_Button_Alignment->CurrentValue) == "");

		// Show_Add_Success_Message
		$tmpBool = $this->Show_Add_Success_Message->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Add_Success_Message->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Add_Success_Message->CurrentValue) == "");

		// Show_Edit_Success_Message
		$tmpBool = $this->Show_Edit_Success_Message->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Edit_Success_Message->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Edit_Success_Message->CurrentValue) == "");

		// jQuery_Auto_Hide_Success_Message
		$tmpBool = $this->jQuery_Auto_Hide_Success_Message->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->jQuery_Auto_Hide_Success_Message->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->jQuery_Auto_Hide_Success_Message->CurrentValue) == "");

		// Use_Javascript_Message
		$tmpBool = $this->Use_Javascript_Message->CurrentValue;
		if ($tmpBool <> "1" && $tmpBool <> "0")
			$tmpBool = (!empty($tmpBool)) ? "1" : "0";
		$this->Use_Javascript_Message->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Use_Javascript_Message->CurrentValue) == "");

		// Login_Window_Type
		$this->Login_Window_Type->SetDbValueDef($rsnew, $this->Login_Window_Type->CurrentValue, NULL, strval($this->Login_Window_Type->CurrentValue) == "");

		// Forgot_Password_Window_Type
		$this->Forgot_Password_Window_Type->SetDbValueDef($rsnew, $this->Forgot_Password_Window_Type->CurrentValue, NULL, strval($this->Forgot_Password_Window_Type->CurrentValue) == "");

		// Change_Password_Window_Type
		$this->Change_Password_Window_Type->SetDbValueDef($rsnew, $this->Change_Password_Window_Type->CurrentValue, NULL, strval($this->Change_Password_Window_Type->CurrentValue) == "");

		// Registration_Window_Type
		$this->Registration_Window_Type->SetDbValueDef($rsnew, $this->Registration_Window_Type->CurrentValue, NULL, strval($this->Registration_Window_Type->CurrentValue) == "");

		// Show_Record_Number_On_Detail_Preview
		$tmpBool = $this->Show_Record_Number_On_Detail_Preview->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Record_Number_On_Detail_Preview->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Record_Number_On_Detail_Preview->CurrentValue) == "");

		// Show_Empty_Table_In_Detail_Preview
		$tmpBool = $this->Show_Empty_Table_In_Detail_Preview->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Empty_Table_In_Detail_Preview->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Empty_Table_In_Detail_Preview->CurrentValue) == "");

		// Detail_Preview_Table_Width
		$this->Detail_Preview_Table_Width->SetDbValueDef($rsnew, $this->Detail_Preview_Table_Width->CurrentValue, NULL, strval($this->Detail_Preview_Table_Width->CurrentValue) == "");

		// Password_Minimum_Length
		$this->Password_Minimum_Length->SetDbValueDef($rsnew, $this->Password_Minimum_Length->CurrentValue, NULL, strval($this->Password_Minimum_Length->CurrentValue) == "");

		// Password_Maximum_Length
		$this->Password_Maximum_Length->SetDbValueDef($rsnew, $this->Password_Maximum_Length->CurrentValue, NULL, strval($this->Password_Maximum_Length->CurrentValue) == "");

		// Password_Must_Contain_At_Least_One_Lower_Case
		$tmpBool = $this->Password_Must_Contain_At_Least_One_Lower_Case->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Password_Must_Contain_At_Least_One_Lower_Case->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Password_Must_Contain_At_Least_One_Lower_Case->CurrentValue) == "");

		// Password_Must_Comply_With_Minumum_Length
		$tmpBool = $this->Password_Must_Comply_With_Minumum_Length->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Password_Must_Comply_With_Minumum_Length->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Password_Must_Comply_With_Minumum_Length->CurrentValue) == "");

		// Password_Must_Comply_With_Maximum_Length
		$tmpBool = $this->Password_Must_Comply_With_Maximum_Length->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Password_Must_Comply_With_Maximum_Length->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Password_Must_Comply_With_Maximum_Length->CurrentValue) == "");

		// Password_Must_Contain_At_Least_One_Upper_Case
		$tmpBool = $this->Password_Must_Contain_At_Least_One_Upper_Case->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Password_Must_Contain_At_Least_One_Upper_Case->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Password_Must_Contain_At_Least_One_Upper_Case->CurrentValue) == "");

		// Password_Must_Contain_At_Least_One_Numeric
		$tmpBool = $this->Password_Must_Contain_At_Least_One_Numeric->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Password_Must_Contain_At_Least_One_Numeric->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Password_Must_Contain_At_Least_One_Numeric->CurrentValue) == "");

		// Password_Must_Contain_At_Least_One_Symbol
		$tmpBool = $this->Password_Must_Contain_At_Least_One_Symbol->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Password_Must_Contain_At_Least_One_Symbol->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Password_Must_Contain_At_Least_One_Symbol->CurrentValue) == "");

		// Password_Must_Be_Difference_Between_Old_And_New
		$tmpBool = $this->Password_Must_Be_Difference_Between_Old_And_New->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Password_Must_Be_Difference_Between_Old_And_New->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Password_Must_Be_Difference_Between_Old_And_New->CurrentValue) == "");

		// Reset_Password_Field_Options
		$this->Reset_Password_Field_Options->SetDbValueDef($rsnew, $this->Reset_Password_Field_Options->CurrentValue, NULL, strval($this->Reset_Password_Field_Options->CurrentValue) == "");

		// Export_Record_Options
		$this->Export_Record_Options->SetDbValueDef($rsnew, $this->Export_Record_Options->CurrentValue, NULL, strval($this->Export_Record_Options->CurrentValue) == "");

		// Show_Record_Number_On_Exported_List_Page
		$tmpBool = $this->Show_Record_Number_On_Exported_List_Page->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Show_Record_Number_On_Exported_List_Page->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Show_Record_Number_On_Exported_List_Page->CurrentValue) == "");

		// Use_Table_Setting_For_Export_Field_Caption
		$tmpBool = $this->Use_Table_Setting_For_Export_Field_Caption->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Use_Table_Setting_For_Export_Field_Caption->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Use_Table_Setting_For_Export_Field_Caption->CurrentValue) == "");

		// Use_Table_Setting_For_Export_Original_Value
		$tmpBool = $this->Use_Table_Setting_For_Export_Original_Value->CurrentValue;
		if ($tmpBool <> "Y" && $tmpBool <> "N")
			$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
		$this->Use_Table_Setting_For_Export_Original_Value->SetDbValueDef($rsnew, $tmpBool, NULL, strval($this->Use_Table_Setting_For_Export_Original_Value->CurrentValue) == "");
		...
		if ($AddRow) {
			$this->Option_ID->setDbValue($conn->Insert_ID());
			$rsnew['Option_ID'] = $this->Option_ID->DbValue;
		}
		if ($AddRow) {
...
// Page object
var settings_add = new ew_Page("settings_add");
settings_add.PageID = "add"; // Page ID
var EW_PAGE_ID = settings_add.PageID; // For backward compatibility

// Form object
var fsettingsadd = new ew_Form("fsettingsadd");
...
fsettingsadd.MultiPage = new ew_MultiPage("fsettingsadd",
	[["x_Option_Default",1],["x_Default_Theme",1],["x_Font_Name",1],["x_Font_Size",1],["x_Show_Border_Layout",1],["x_Show_Shadow_Layout",1],["x_Menu_Horizontal",1],["x_Vertical_Menu_Width",1],["x_Show_Announcement",1],["x_Demo_Mode",1],["x_Show_Page_Processing_Time",1],["x_Allow_User_Preferences",1],["x_SMTP_Server",2],["x_SMTP_Server_Port",2],["x_SMTP_Server_Username",2],["x_SMTP_Server_Password",2],["x_Sender_Email",2],["x_Recipient_Email",2],["x_Use_Default_Locale",3],["x_Default_Language",3],["x_Default_Timezone",3],["x_Default_Thousands_Separator",3],["x_Default_Decimal_Point",3],["x_Default_Currency_Symbol",3],["x_Default_Money_Thousands_Separator",3],["x_Default_Money_Decimal_Point",3],["x_Maintenance_Mode",4],["x_Maintenance_Finish_DateTime",4],["x_Auto_Normal_After_Maintenance",4],["x_Allow_User_To_Register",5],["x_Suspend_New_User_Account",5],["x_User_Need_Activation_After_Registered",5],["x_Show_Captcha_On_Registration_Page",5],["x_Show_Terms_And_Conditions_On_Registration_Page",5],["x_User_Auto_Login_After_Activation_Or_Registration",5],["x_Show_Captcha_On_Login_Page",6],["x_Show_Captcha_On_Forgot_Password_Page",6],["x_Show_Captcha_On_Change_Password_Page",6],["x_User_Auto_Logout_After_Idle_In_Minutes",6],["x_User_Login_Maximum_Retry",6],["x_User_Login_Retry_Lockout",6],["x_Redirect_To_Last_Visited_Page_After_Login",6],["x_Enable_Password_Expiry",6],["x_Password_Expiry_In_Days",6],["x_Show_Entire_Header",7],["x_Logo_Width",7],["x_Show_Site_Title_In_Header",7],["x_Show_Current_User_In_Header",7],["x_Text_Align_In_Header",7],["x_Site_Title_Text_Style",7],["x_Language_Selector_Visibility",7],["x_Language_Selector_Align",7],["x_Show_Entire_Footer",8],["x_Show_Text_In_Footer",8],["x_Show_Back_To_Top_On_Footer",8],["x_Show_Terms_And_Conditions_On_Footer",8],["x_Show_About_Us_On_Footer",8],["x_Pagination_Position",9],["x_Pagination_Style",9],["x_Selectable_Records_Per_Page",9],["x_Selectable_Groups_Per_Page",9],["x_Default_Record_Per_Page",9],["x_Default_Group_Per_Page",9],["x_Maximum_Selected_Records",9],["x_Maximum_Selected_Groups",9],["x_Show_PageNum_If_Record_Not_Over_Pagesize",9],["x_Table_Width_Style",10],["x_Scroll_Table_Width",10],["x_Scroll_Table_Height",10],["x_Search_Panel_Collapsed",10],["x_Filter_Panel_Collapsed",10],["x_Show_Record_Number_On_List_Page",10],["x_Show_Empty_Table_On_List_Page",10],["x_Rows_Vertical_Align_Top",10],["x_Action_Button_Alignment",10],["x_Show_Add_Success_Message",11],["x_Show_Edit_Success_Message",11],["x_jQuery_Auto_Hide_Success_Message",11],["x_Use_Javascript_Message",11],["x_Login_Window_Type",11],["x_Forgot_Password_Window_Type",11],["x_Change_Password_Window_Type",11],["x_Registration_Window_Type",11],["x_Show_Record_Number_On_Detail_Preview",12],["x_Show_Empty_Table_In_Detail_Preview",12],["x_Detail_Preview_Table_Width",12],["x_Password_Minimum_Length",13],["x_Password_Maximum_Length",13],["x_Password_Must_Contain_At_Least_One_Lower_Case",13],["x_Password_Must_Comply_With_Minumum_Length",13],["x_Password_Must_Comply_With_Maximum_Length",13],["x_Password_Must_Contain_At_Least_One_Upper_Case",13],["x_Password_Must_Contain_At_Least_One_Numeric",13],["x_Password_Must_Contain_At_Least_One_Symbol",13],["x_Password_Must_Be_Difference_Between_Old_And_New",13],["x_Reset_Password_Field_Options",13],["x_Export_Record_Options",14],["x_Show_Record_Number_On_Exported_List_Page",14],["x_Use_Table_Setting_For_Export_Field_Caption",14],["x_Use_Table_Setting_For_Export_Original_Value",14]]
);

// Dynamic selection lists
fsettingsadd.Lists["x_Default_Theme"] = {"LinkField":"x_Theme_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Theme_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fsettingsadd.Lists["x_Default_Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fsettingsadd.Lists["x_Default_Timezone"] = {"LinkField":"x_Timezone","Ajax":null,"AutoFill":false,"DisplayFields":["x_Timezone","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fsettingsadd" id="fsettingsadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<div>
<div class="tabbable" id="settings_add">
	<ul class="nav nav-tabs">
		<li class="active"><a href="#tab_settings1" data-toggle="tab"><?php echo $settings->PageCaption(1) ?></a></li>
		<li><a href="#tab_settings2" data-toggle="tab"><?php echo $settings->PageCaption(2) ?></a></li>
		<li><a href="#tab_settings3" data-toggle="tab"><?php echo $settings->PageCaption(3) ?></a></li>
		<li><a href="#tab_settings4" data-toggle="tab"><?php echo $settings->PageCaption(4) ?></a></li>
		<li><a href="#tab_settings5" data-toggle="tab"><?php echo $settings->PageCaption(5) ?></a></li>
		<li><a href="#tab_settings6" data-toggle="tab"><?php echo $settings->PageCaption(6) ?></a></li>
		<li><a href="#tab_settings7" data-toggle="tab"><?php echo $settings->PageCaption(7) ?></a></li>
		<li><a href="#tab_settings8" data-toggle="tab"><?php echo $settings->PageCaption(8) ?></a></li>
		<li><a href="#tab_settings9" data-toggle="tab"><?php echo $settings->PageCaption(9) ?></a></li>
		<li><a href="#tab_settings10" data-toggle="tab"><?php echo $settings->PageCaption(10) ?></a></li>
		<li><a href="#tab_settings11" data-toggle="tab"><?php echo $settings->PageCaption(11) ?></a></li>
		<li><a href="#tab_settings12" data-toggle="tab"><?php echo $settings->PageCaption(12) ?></a></li>
		<li><a href="#tab_settings13" data-toggle="tab"><?php echo $settings->PageCaption(13) ?></a></li>
		<li><a href="#tab_settings14" data-toggle="tab"><?php echo $settings->PageCaption(14) ?></a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane active" id="tab_settings1">
<div>
<?php if ($settings->Option_Default->Visible) { // Option_Default ?>
	<div id="r_Option_Default" class="form-group">
		<label id="elh_settings_Option_Default" class="col-sm-4 control-label ewLabel"><?php echo $settings->Option_Default->FldCaption() ?></label>
		<div class="col-sm-8"><div<?php echo $settings->Option_Default->CellAttributes() ?>>
<span id="el_settings_Option_Default">
<?php
$selwrk = (ew_ConvertToBool($settings->Option_Default->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Option_Default" name="x_Option_Default[]" id="x_Option_Default[]" value="1"<?php echo $selwrk ?><?php echo $settings->Option_Default->EditAttributes() ?>>
</span>
...
<?php if ($settings->Default_Theme->Visible) { // Default_Theme ?>
	<div id="r_Default_Theme" class="form-group">
		<label id="elh_settings_Default_Theme" for="x_Default_Theme" class="col-sm-4 control-label ewLabel"><?php echo $settings->Default_Theme->FldCaption() ?></label>
		<div class="col-sm-8"><div<?php echo $settings->Default_Theme->CellAttributes() ?>>
<span id="el_settings_Default_Theme">
<select data-field="x_Default_Theme" id="x_Default_Theme" name="x_Default_Theme"<?php echo $settings->Default_Theme->EditAttributes() ?>>
<?php
if (is_array($settings->Default_Theme->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Default_Theme->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fsettingsadd.Lists["x_Default_Theme"].Options = <?php echo (is_array($settings->Default_Theme->EditValue)) ? ew_ArrayToJson($settings->Default_Theme->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if ($settings->Font_Name->Visible) { // Font_Name ?>
	<div id="r_Font_Name" class="form-group">
		<label id="elh_settings_Font_Name" for="x_Font_Name" class="col-sm-4 control-label ewLabel"><?php echo $settings->Font_Name->FldCaption() ?></label>
		<div class="col-sm-8"><div<?php echo $settings->Font_Name->CellAttributes() ?>>
<span id="el_settings_Font_Name">
<select data-field="x_Font_Name" id="x_Font_Name" name="x_Font_Name"<?php echo $settings->Font_Name->EditAttributes() ?>>
<?php
if (is_array($settings->Font_Name->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Font_Name->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<?php if ($settings->Font_Size->Visible) { // Font_Size ?>
	<div id="r_Font_Size" class="form-group">
		<label id="elh_settings_Font_Size" for="x_Font_Size" class="col-sm-4 control-label ewLabel"><?php echo $settings->Font_Size->FldCaption() ?></label>
		<div class="col-sm-8"><div<?php echo $settings->Font_Size->CellAttributes() ?>>
<span id="el_settings_Font_Size">
<select data-field="x_Font_Size" id="x_Font_Size" name="x_Font_Size"<?php echo $settings->Font_Size->EditAttributes() ?>>
<?php
if (is_array($settings->Font_Size->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Font_Size->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Border_Layout->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Border_Layout" name="x_Show_Border_Layout[]" id="x_Show_Border_Layout[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Border_Layout->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Shadow_Layout->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Shadow_Layout" name="x_Show_Shadow_Layout[]" id="x_Show_Shadow_Layout[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Shadow_Layout->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Menu_Horizontal->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Menu_Horizontal" name="x_Menu_Horizontal[]" id="x_Menu_Horizontal[]" value="1"<?php echo $selwrk ?><?php echo $settings->Menu_Horizontal->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Vertical_Menu_Width" name="x_Vertical_Menu_Width" id="x_Vertical_Menu_Width" size="10" maxlength="5" placeholder="<?php echo ew_HtmlEncode($settings->Vertical_Menu_Width->PlaceHolder) ?>" value="<?php echo $settings->Vertical_Menu_Width->EditValue ?>"<?php echo $settings->Vertical_Menu_Width->EditAttributes() ?>>
</span>
...
<select data-field="x_Show_Announcement" id="x_Show_Announcement" name="x_Show_Announcement"<?php echo $settings->Show_Announcement->EditAttributes() ?>>
<?php
if (is_array($settings->Show_Announcement->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Show_Announcement->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Demo_Mode->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Demo_Mode" name="x_Demo_Mode[]" id="x_Demo_Mode[]" value="1"<?php echo $selwrk ?><?php echo $settings->Demo_Mode->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Page_Processing_Time->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Page_Processing_Time" name="x_Show_Page_Processing_Time[]" id="x_Show_Page_Processing_Time[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Page_Processing_Time->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Allow_User_Preferences->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Allow_User_Preferences" name="x_Allow_User_Preferences[]" id="x_Allow_User_Preferences[]" value="1"<?php echo $selwrk ?><?php echo $settings->Allow_User_Preferences->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings2">
<div>
...
<input type="text" data-field="x_SMTP_Server" name="x_SMTP_Server" id="x_SMTP_Server" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($settings->SMTP_Server->PlaceHolder) ?>" value="<?php echo $settings->SMTP_Server->EditValue ?>"<?php echo $settings->SMTP_Server->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_SMTP_Server_Port" name="x_SMTP_Server_Port" id="x_SMTP_Server_Port" size="30" maxlength="5" placeholder="<?php echo ew_HtmlEncode($settings->SMTP_Server_Port->PlaceHolder) ?>" value="<?php echo $settings->SMTP_Server_Port->EditValue ?>"<?php echo $settings->SMTP_Server_Port->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_SMTP_Server_Username" name="x_SMTP_Server_Username" id="x_SMTP_Server_Username" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($settings->SMTP_Server_Username->PlaceHolder) ?>" value="<?php echo $settings->SMTP_Server_Username->EditValue ?>"<?php echo $settings->SMTP_Server_Username->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_SMTP_Server_Password" name="x_SMTP_Server_Password" id="x_SMTP_Server_Password" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($settings->SMTP_Server_Password->PlaceHolder) ?>" value="<?php echo $settings->SMTP_Server_Password->EditValue ?>"<?php echo $settings->SMTP_Server_Password->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Sender_Email" name="x_Sender_Email" id="x_Sender_Email" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($settings->Sender_Email->PlaceHolder) ?>" value="<?php echo $settings->Sender_Email->EditValue ?>"<?php echo $settings->Sender_Email->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Recipient_Email" name="x_Recipient_Email" id="x_Recipient_Email" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($settings->Recipient_Email->PlaceHolder) ?>" value="<?php echo $settings->Recipient_Email->EditValue ?>"<?php echo $settings->Recipient_Email->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings3">
<div>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Use_Default_Locale->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Use_Default_Locale" name="x_Use_Default_Locale[]" id="x_Use_Default_Locale[]" value="1"<?php echo $selwrk ?><?php echo $settings->Use_Default_Locale->EditAttributes() ?>>
</span>
...
<select data-field="x_Default_Language" id="x_Default_Language" name="x_Default_Language"<?php echo $settings->Default_Language->EditAttributes() ?>>
<?php
if (is_array($settings->Default_Language->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Default_Language->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fsettingsadd.Lists["x_Default_Language"].Options = <?php echo (is_array($settings->Default_Language->EditValue)) ? ew_ArrayToJson($settings->Default_Language->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Default_Timezone" id="x_Default_Timezone" name="x_Default_Timezone"<?php echo $settings->Default_Timezone->EditAttributes() ?>>
<?php
if (is_array($settings->Default_Timezone->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Default_Timezone->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fsettingsadd.Lists["x_Default_Timezone"].Options = <?php echo (is_array($settings->Default_Timezone->EditValue)) ? ew_ArrayToJson($settings->Default_Timezone->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="text" data-field="x_Default_Thousands_Separator" name="x_Default_Thousands_Separator" id="x_Default_Thousands_Separator" size="10" maxlength="5" placeholder="<?php echo ew_HtmlEncode($settings->Default_Thousands_Separator->PlaceHolder) ?>" value="<?php echo $settings->Default_Thousands_Separator->EditValue ?>"<?php echo $settings->Default_Thousands_Separator->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Default_Currency_Symbol" name="x_Default_Currency_Symbol" id="x_Default_Currency_Symbol" size="10" maxlength="10" placeholder="<?php echo ew_HtmlEncode($settings->Default_Currency_Symbol->PlaceHolder) ?>" value="<?php echo $settings->Default_Currency_Symbol->EditValue ?>"<?php echo $settings->Default_Currency_Symbol->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Default_Money_Thousands_Separator" name="x_Default_Money_Thousands_Separator" id="x_Default_Money_Thousands_Separator" size="10" maxlength="5" placeholder="<?php echo ew_HtmlEncode($settings->Default_Money_Thousands_Separator->PlaceHolder) ?>" value="<?php echo $settings->Default_Money_Thousands_Separator->EditValue ?>"<?php echo $settings->Default_Money_Thousands_Separator->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Default_Money_Decimal_Point" name="x_Default_Money_Decimal_Point" id="x_Default_Money_Decimal_Point" size="10" maxlength="5" placeholder="<?php echo ew_HtmlEncode($settings->Default_Money_Decimal_Point->PlaceHolder) ?>" value="<?php echo $settings->Default_Money_Decimal_Point->EditValue ?>"<?php echo $settings->Default_Money_Decimal_Point->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings4">
<div>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Maintenance_Mode->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Maintenance_Mode" name="x_Maintenance_Mode[]" id="x_Maintenance_Mode[]" value="1"<?php echo $selwrk ?><?php echo $settings->Maintenance_Mode->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Maintenance_Finish_DateTime" name="x_Maintenance_Finish_DateTime" id="x_Maintenance_Finish_DateTime" placeholder="<?php echo ew_HtmlEncode($settings->Maintenance_Finish_DateTime->PlaceHolder) ?>" value="<?php echo $settings->Maintenance_Finish_DateTime->EditValue ?>"<?php echo $settings->Maintenance_Finish_DateTime->EditAttributes() ?>>
<?php if (!$settings->Maintenance_Finish_DateTime->ReadOnly && !$settings->Maintenance_Finish_DateTime->Disabled && @$settings->Maintenance_Finish_DateTime->EditAttrs["readonly"] == "" && @$settings->Maintenance_Finish_DateTime->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
ew_CreateCalendar("fsettingsadd", "x_Maintenance_Finish_DateTime", "%Y/%m/%d %H:%M:%S");
</script>
<?php } ?>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Auto_Normal_After_Maintenance->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Auto_Normal_After_Maintenance" name="x_Auto_Normal_After_Maintenance[]" id="x_Auto_Normal_After_Maintenance[]" value="1"<?php echo $selwrk ?><?php echo $settings->Auto_Normal_After_Maintenance->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings5">
<div>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Allow_User_To_Register->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Allow_User_To_Register" name="x_Allow_User_To_Register[]" id="x_Allow_User_To_Register[]" value="1"<?php echo $selwrk ?><?php echo $settings->Allow_User_To_Register->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Suspend_New_User_Account->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Suspend_New_User_Account" name="x_Suspend_New_User_Account[]" id="x_Suspend_New_User_Account[]" value="1"<?php echo $selwrk ?><?php echo $settings->Suspend_New_User_Account->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->User_Need_Activation_After_Registered->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_User_Need_Activation_After_Registered" name="x_User_Need_Activation_After_Registered[]" id="x_User_Need_Activation_After_Registered[]" value="1"<?php echo $selwrk ?><?php echo $settings->User_Need_Activation_After_Registered->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Captcha_On_Registration_Page->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Captcha_On_Registration_Page" name="x_Show_Captcha_On_Registration_Page[]" id="x_Show_Captcha_On_Registration_Page[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Captcha_On_Registration_Page->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Terms_And_Conditions_On_Registration_Page->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Terms_And_Conditions_On_Registration_Page" name="x_Show_Terms_And_Conditions_On_Registration_Page[]" id="x_Show_Terms_And_Conditions_On_Registration_Page[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Terms_And_Conditions_On_Registration_Page->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->User_Auto_Login_After_Activation_Or_Registration->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_User_Auto_Login_After_Activation_Or_Registration" name="x_User_Auto_Login_After_Activation_Or_Registration[]" id="x_User_Auto_Login_After_Activation_Or_Registration[]" value="1"<?php echo $selwrk ?><?php echo $settings->User_Auto_Login_After_Activation_Or_Registration->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings6">
<div>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Captcha_On_Login_Page->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Captcha_On_Login_Page" name="x_Show_Captcha_On_Login_Page[]" id="x_Show_Captcha_On_Login_Page[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Captcha_On_Login_Page->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Captcha_On_Forgot_Password_Page->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Captcha_On_Forgot_Password_Page" name="x_Show_Captcha_On_Forgot_Password_Page[]" id="x_Show_Captcha_On_Forgot_Password_Page[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Captcha_On_Forgot_Password_Page->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Captcha_On_Change_Password_Page->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Captcha_On_Change_Password_Page" name="x_Show_Captcha_On_Change_Password_Page[]" id="x_Show_Captcha_On_Change_Password_Page[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Captcha_On_Change_Password_Page->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_User_Auto_Logout_After_Idle_In_Minutes" name="x_User_Auto_Logout_After_Idle_In_Minutes" id="x_User_Auto_Logout_After_Idle_In_Minutes" size="30" placeholder="<?php echo ew_HtmlEncode($settings->User_Auto_Logout_After_Idle_In_Minutes->PlaceHolder) ?>" value="<?php echo $settings->User_Auto_Logout_After_Idle_In_Minutes->EditValue ?>"<?php echo $settings->User_Auto_Logout_After_Idle_In_Minutes->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_User_Login_Maximum_Retry" name="x_User_Login_Maximum_Retry" id="x_User_Login_Maximum_Retry" size="30" placeholder="<?php echo ew_HtmlEncode($settings->User_Login_Maximum_Retry->PlaceHolder) ?>" value="<?php echo $settings->User_Login_Maximum_Retry->EditValue ?>"<?php echo $settings->User_Login_Maximum_Retry->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_User_Login_Retry_Lockout" name="x_User_Login_Retry_Lockout" id="x_User_Login_Retry_Lockout" size="30" placeholder="<?php echo ew_HtmlEncode($settings->User_Login_Retry_Lockout->PlaceHolder) ?>" value="<?php echo $settings->User_Login_Retry_Lockout->EditValue ?>"<?php echo $settings->User_Login_Retry_Lockout->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Redirect_To_Last_Visited_Page_After_Login->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Redirect_To_Last_Visited_Page_After_Login" name="x_Redirect_To_Last_Visited_Page_After_Login[]" id="x_Redirect_To_Last_Visited_Page_After_Login[]" value="1"<?php echo $selwrk ?><?php echo $settings->Redirect_To_Last_Visited_Page_After_Login->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Enable_Password_Expiry->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Enable_Password_Expiry" name="x_Enable_Password_Expiry[]" id="x_Enable_Password_Expiry[]" value="1"<?php echo $selwrk ?><?php echo $settings->Enable_Password_Expiry->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Password_Expiry_In_Days" name="x_Password_Expiry_In_Days" id="x_Password_Expiry_In_Days" size="30" placeholder="<?php echo ew_HtmlEncode($settings->Password_Expiry_In_Days->PlaceHolder) ?>" value="<?php echo $settings->Password_Expiry_In_Days->EditValue ?>"<?php echo $settings->Password_Expiry_In_Days->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings7">
<div>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Entire_Header->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Entire_Header" name="x_Show_Entire_Header[]" id="x_Show_Entire_Header[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Entire_Header->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Logo_Width" name="x_Logo_Width" id="x_Logo_Width" size="30" placeholder="<?php echo ew_HtmlEncode($settings->Logo_Width->PlaceHolder) ?>" value="<?php echo $settings->Logo_Width->EditValue ?>"<?php echo $settings->Logo_Width->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Site_Title_In_Header->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Site_Title_In_Header" name="x_Show_Site_Title_In_Header[]" id="x_Show_Site_Title_In_Header[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Site_Title_In_Header->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Current_User_In_Header->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Current_User_In_Header" name="x_Show_Current_User_In_Header[]" id="x_Show_Current_User_In_Header[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Current_User_In_Header->EditAttributes() ?>>
</span>
...
<div id="tp_x_Text_Align_In_Header" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Text_Align_In_Header" id="x_Text_Align_In_Header" value="{value}"<?php echo $settings->Text_Align_In_Header->EditAttributes() ?>></div>
<div id="dsl_x_Text_Align_In_Header" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Text_Align_In_Header->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Text_Align_In_Header" name="x_Text_Align_In_Header" id="x_Text_Align_In_Header_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Text_Align_In_Header->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
...
<div id="tp_x_Site_Title_Text_Style" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Site_Title_Text_Style" id="x_Site_Title_Text_Style" value="{value}"<?php echo $settings->Site_Title_Text_Style->EditAttributes() ?>></div>
<div id="dsl_x_Site_Title_Text_Style" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Site_Title_Text_Style->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Site_Title_Text_Style" name="x_Site_Title_Text_Style" id="x_Site_Title_Text_Style_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Site_Title_Text_Style->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<div id="tp_x_Language_Selector_Visibility" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Language_Selector_Visibility" id="x_Language_Selector_Visibility" value="{value}"<?php echo $settings->Language_Selector_Visibility->EditAttributes() ?>></div>
<div id="dsl_x_Language_Selector_Visibility" data-repeatcolumn="5" class="ewItemList">
<?php
...
<div id="tp_x_Language_Selector_Align" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Language_Selector_Align" id="x_Language_Selector_Align" value="{value}"<?php echo $settings->Language_Selector_Align->EditAttributes() ?>></div>
<div id="dsl_x_Language_Selector_Align" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Language_Selector_Align->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Language_Selector_Align" name="x_Language_Selector_Align" id="x_Language_Selector_Align_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Language_Selector_Align->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings8">
<div>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Entire_Footer->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Entire_Footer" name="x_Show_Entire_Footer[]" id="x_Show_Entire_Footer[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Entire_Footer->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Text_In_Footer->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Text_In_Footer" name="x_Show_Text_In_Footer[]" id="x_Show_Text_In_Footer[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Text_In_Footer->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Back_To_Top_On_Footer->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Back_To_Top_On_Footer" name="x_Show_Back_To_Top_On_Footer[]" id="x_Show_Back_To_Top_On_Footer[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Back_To_Top_On_Footer->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Terms_And_Conditions_On_Footer->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Terms_And_Conditions_On_Footer" name="x_Show_Terms_And_Conditions_On_Footer[]" id="x_Show_Terms_And_Conditions_On_Footer[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Terms_And_Conditions_On_Footer->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_About_Us_On_Footer->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_About_Us_On_Footer" name="x_Show_About_Us_On_Footer[]" id="x_Show_About_Us_On_Footer[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_About_Us_On_Footer->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings9">
<div>
...
<div id="tp_x_Pagination_Position" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Pagination_Position" id="x_Pagination_Position" value="{value}"<?php echo $settings->Pagination_Position->EditAttributes() ?>></div>
<div id="dsl_x_Pagination_Position" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Pagination_Position->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Pagination_Position" name="x_Pagination_Position" id="x_Pagination_Position_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Pagination_Position->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<div id="tp_x_Pagination_Style" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Pagination_Style" id="x_Pagination_Style" value="{value}"<?php echo $settings->Pagination_Style->EditAttributes() ?>></div>
<div id="dsl_x_Pagination_Style" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Pagination_Style->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Pagination_Style" name="x_Pagination_Style" id="x_Pagination_Style_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Pagination_Style->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<input type="text" data-field="x_Selectable_Records_Per_Page" name="x_Selectable_Records_Per_Page" id="x_Selectable_Records_Per_Page" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($settings->Selectable_Records_Per_Page->PlaceHolder) ?>" value="<?php echo $settings->Selectable_Records_Per_Page->EditValue ?>"<?php echo $settings->Selectable_Records_Per_Page->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Selectable_Groups_Per_Page" name="x_Selectable_Groups_Per_Page" id="x_Selectable_Groups_Per_Page" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($settings->Selectable_Groups_Per_Page->PlaceHolder) ?>" value="<?php echo $settings->Selectable_Groups_Per_Page->EditValue ?>"<?php echo $settings->Selectable_Groups_Per_Page->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Default_Record_Per_Page" name="x_Default_Record_Per_Page" id="x_Default_Record_Per_Page" size="30" placeholder="<?php echo ew_HtmlEncode($settings->Default_Record_Per_Page->PlaceHolder) ?>" value="<?php echo $settings->Default_Record_Per_Page->EditValue ?>"<?php echo $settings->Default_Record_Per_Page->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Default_Group_Per_Page" name="x_Default_Group_Per_Page" id="x_Default_Group_Per_Page" size="30" placeholder="<?php echo ew_HtmlEncode($settings->Default_Group_Per_Page->PlaceHolder) ?>" value="<?php echo $settings->Default_Group_Per_Page->EditValue ?>"<?php echo $settings->Default_Group_Per_Page->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Maximum_Selected_Groups" name="x_Maximum_Selected_Groups" id="x_Maximum_Selected_Groups" size="30" placeholder="<?php echo ew_HtmlEncode($settings->Maximum_Selected_Groups->PlaceHolder) ?>" value="<?php echo $settings->Maximum_Selected_Groups->EditValue ?>"<?php echo $settings->Maximum_Selected_Groups->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_PageNum_If_Record_Not_Over_Pagesize->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_PageNum_If_Record_Not_Over_Pagesize" name="x_Show_PageNum_If_Record_Not_Over_Pagesize[]" id="x_Show_PageNum_If_Record_Not_Over_Pagesize[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_PageNum_If_Record_Not_Over_Pagesize->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings10">
<div>
...
<div id="tp_x_Table_Width_Style" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Table_Width_Style" id="x_Table_Width_Style" value="{value}"<?php echo $settings->Table_Width_Style->EditAttributes() ?>></div>
<div id="dsl_x_Table_Width_Style" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Table_Width_Style->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Table_Width_Style" name="x_Table_Width_Style" id="x_Table_Width_Style_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Table_Width_Style->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<input type="text" data-field="x_Scroll_Table_Width" name="x_Scroll_Table_Width" id="x_Scroll_Table_Width" size="10" maxlength="5" placeholder="<?php echo ew_HtmlEncode($settings->Scroll_Table_Width->PlaceHolder) ?>" value="<?php echo $settings->Scroll_Table_Width->EditValue ?>"<?php echo $settings->Scroll_Table_Width->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Scroll_Table_Height" name="x_Scroll_Table_Height" id="x_Scroll_Table_Height" size="10" maxlength="5" placeholder="<?php echo ew_HtmlEncode($settings->Scroll_Table_Height->PlaceHolder) ?>" value="<?php echo $settings->Scroll_Table_Height->EditValue ?>"<?php echo $settings->Scroll_Table_Height->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Search_Panel_Collapsed->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Search_Panel_Collapsed" name="x_Search_Panel_Collapsed[]" id="x_Search_Panel_Collapsed[]" value="1"<?php echo $selwrk ?><?php echo $settings->Search_Panel_Collapsed->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Filter_Panel_Collapsed->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Filter_Panel_Collapsed" name="x_Filter_Panel_Collapsed[]" id="x_Filter_Panel_Collapsed[]" value="1"<?php echo $selwrk ?><?php echo $settings->Filter_Panel_Collapsed->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Record_Number_On_List_Page->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Record_Number_On_List_Page" name="x_Show_Record_Number_On_List_Page[]" id="x_Show_Record_Number_On_List_Page[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Record_Number_On_List_Page->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Empty_Table_On_List_Page->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Empty_Table_On_List_Page" name="x_Show_Empty_Table_On_List_Page[]" id="x_Show_Empty_Table_On_List_Page[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Empty_Table_On_List_Page->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Rows_Vertical_Align_Top->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Rows_Vertical_Align_Top" name="x_Rows_Vertical_Align_Top[]" id="x_Rows_Vertical_Align_Top[]" value="1"<?php echo $selwrk ?><?php echo $settings->Rows_Vertical_Align_Top->EditAttributes() ?>>
</span>
...
<div id="tp_x_Action_Button_Alignment" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Action_Button_Alignment" id="x_Action_Button_Alignment" value="{value}"<?php echo $settings->Action_Button_Alignment->EditAttributes() ?>></div>
<div id="dsl_x_Action_Button_Alignment" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Action_Button_Alignment->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Action_Button_Alignment" name="x_Action_Button_Alignment" id="x_Action_Button_Alignment_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Action_Button_Alignment->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings11">
<div>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Add_Success_Message->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Add_Success_Message" name="x_Show_Add_Success_Message[]" id="x_Show_Add_Success_Message[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Add_Success_Message->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Edit_Success_Message->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Edit_Success_Message" name="x_Show_Edit_Success_Message[]" id="x_Show_Edit_Success_Message[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Edit_Success_Message->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->jQuery_Auto_Hide_Success_Message->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_jQuery_Auto_Hide_Success_Message" name="x_jQuery_Auto_Hide_Success_Message[]" id="x_jQuery_Auto_Hide_Success_Message[]" value="1"<?php echo $selwrk ?><?php echo $settings->jQuery_Auto_Hide_Success_Message->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Use_Javascript_Message->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Use_Javascript_Message" name="x_Use_Javascript_Message[]" id="x_Use_Javascript_Message[]" value="1"<?php echo $selwrk ?><?php echo $settings->Use_Javascript_Message->EditAttributes() ?>>
</span>
...
<div id="tp_x_Login_Window_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Login_Window_Type" id="x_Login_Window_Type" value="{value}"<?php echo $settings->Login_Window_Type->EditAttributes() ?>></div>
<div id="dsl_x_Login_Window_Type" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Login_Window_Type->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Login_Window_Type" name="x_Login_Window_Type" id="x_Login_Window_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Login_Window_Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<div id="tp_x_Forgot_Password_Window_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Forgot_Password_Window_Type" id="x_Forgot_Password_Window_Type" value="{value}"<?php echo $settings->Forgot_Password_Window_Type->EditAttributes() ?>></div>
<div id="dsl_x_Forgot_Password_Window_Type" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Forgot_Password_Window_Type->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Forgot_Password_Window_Type" name="x_Forgot_Password_Window_Type" id="x_Forgot_Password_Window_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Forgot_Password_Window_Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<div id="tp_x_Change_Password_Window_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Change_Password_Window_Type" id="x_Change_Password_Window_Type" value="{value}"<?php echo $settings->Change_Password_Window_Type->EditAttributes() ?>></div>
<div id="dsl_x_Change_Password_Window_Type" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Change_Password_Window_Type->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Change_Password_Window_Type" name="x_Change_Password_Window_Type" id="x_Change_Password_Window_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Change_Password_Window_Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<div id="tp_x_Registration_Window_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Registration_Window_Type" id="x_Registration_Window_Type" value="{value}"<?php echo $settings->Registration_Window_Type->EditAttributes() ?>></div>
<div id="dsl_x_Registration_Window_Type" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Registration_Window_Type->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Registration_Window_Type" name="x_Registration_Window_Type" id="x_Registration_Window_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Registration_Window_Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings12">
<div>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Record_Number_On_Detail_Preview->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Record_Number_On_Detail_Preview" name="x_Show_Record_Number_On_Detail_Preview[]" id="x_Show_Record_Number_On_Detail_Preview[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Record_Number_On_Detail_Preview->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Empty_Table_In_Detail_Preview->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Empty_Table_In_Detail_Preview" name="x_Show_Empty_Table_In_Detail_Preview[]" id="x_Show_Empty_Table_In_Detail_Preview[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Empty_Table_In_Detail_Preview->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Detail_Preview_Table_Width" name="x_Detail_Preview_Table_Width" id="x_Detail_Preview_Table_Width" size="30" placeholder="<?php echo ew_HtmlEncode($settings->Detail_Preview_Table_Width->PlaceHolder) ?>" value="<?php echo $settings->Detail_Preview_Table_Width->EditValue ?>"<?php echo $settings->Detail_Preview_Table_Width->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings13">
<div>
...
<input type="text" data-field="x_Password_Minimum_Length" name="x_Password_Minimum_Length" id="x_Password_Minimum_Length" size="30" placeholder="<?php echo ew_HtmlEncode($settings->Password_Minimum_Length->PlaceHolder) ?>" value="<?php echo $settings->Password_Minimum_Length->EditValue ?>"<?php echo $settings->Password_Minimum_Length->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Password_Maximum_Length" name="x_Password_Maximum_Length" id="x_Password_Maximum_Length" size="30" placeholder="<?php echo ew_HtmlEncode($settings->Password_Maximum_Length->PlaceHolder) ?>" value="<?php echo $settings->Password_Maximum_Length->EditValue ?>"<?php echo $settings->Password_Maximum_Length->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Password_Must_Contain_At_Least_One_Lower_Case->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Password_Must_Contain_At_Least_One_Lower_Case" name="x_Password_Must_Contain_At_Least_One_Lower_Case[]" id="x_Password_Must_Contain_At_Least_One_Lower_Case[]" value="1"<?php echo $selwrk ?><?php echo $settings->Password_Must_Contain_At_Least_One_Lower_Case->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Password_Must_Comply_With_Minumum_Length->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Password_Must_Comply_With_Minumum_Length" name="x_Password_Must_Comply_With_Minumum_Length[]" id="x_Password_Must_Comply_With_Minumum_Length[]" value="1"<?php echo $selwrk ?><?php echo $settings->Password_Must_Comply_With_Minumum_Length->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Password_Must_Comply_With_Maximum_Length->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Password_Must_Comply_With_Maximum_Length" name="x_Password_Must_Comply_With_Maximum_Length[]" id="x_Password_Must_Comply_With_Maximum_Length[]" value="1"<?php echo $selwrk ?><?php echo $settings->Password_Must_Comply_With_Maximum_Length->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Password_Must_Contain_At_Least_One_Upper_Case->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Password_Must_Contain_At_Least_One_Upper_Case" name="x_Password_Must_Contain_At_Least_One_Upper_Case[]" id="x_Password_Must_Contain_At_Least_One_Upper_Case[]" value="1"<?php echo $selwrk ?><?php echo $settings->Password_Must_Contain_At_Least_One_Upper_Case->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Password_Must_Contain_At_Least_One_Numeric->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Password_Must_Contain_At_Least_One_Numeric" name="x_Password_Must_Contain_At_Least_One_Numeric[]" id="x_Password_Must_Contain_At_Least_One_Numeric[]" value="1"<?php echo $selwrk ?><?php echo $settings->Password_Must_Contain_At_Least_One_Numeric->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Password_Must_Contain_At_Least_One_Symbol->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Password_Must_Contain_At_Least_One_Symbol" name="x_Password_Must_Contain_At_Least_One_Symbol[]" id="x_Password_Must_Contain_At_Least_One_Symbol[]" value="1"<?php echo $selwrk ?><?php echo $settings->Password_Must_Contain_At_Least_One_Symbol->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Password_Must_Be_Difference_Between_Old_And_New->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Password_Must_Be_Difference_Between_Old_And_New" name="x_Password_Must_Be_Difference_Between_Old_And_New[]" id="x_Password_Must_Be_Difference_Between_Old_And_New[]" value="1"<?php echo $selwrk ?><?php echo $settings->Password_Must_Be_Difference_Between_Old_And_New->EditAttributes() ?>>
</span>
...
<div id="tp_x_Reset_Password_Field_Options" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Reset_Password_Field_Options" id="x_Reset_Password_Field_Options" value="{value}"<?php echo $settings->Reset_Password_Field_Options->EditAttributes() ?>></div>
<div id="dsl_x_Reset_Password_Field_Options" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Reset_Password_Field_Options->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Reset_Password_Field_Options" name="x_Reset_Password_Field_Options" id="x_Reset_Password_Field_Options_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Reset_Password_Field_Options->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<?php } ?>
		...
		<div class="tab-pane" id="tab_settings14">
<div>
...
<div id="tp_x_Export_Record_Options" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Export_Record_Options" id="x_Export_Record_Options" value="{value}"<?php echo $settings->Export_Record_Options->EditAttributes() ?>></div>
<div id="dsl_x_Export_Record_Options" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($settings->Export_Record_Options->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Export_Record_Options" name="x_Export_Record_Options" id="x_Export_Record_Options_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $settings->Export_Record_Options->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<?php
$selwrk = (ew_ConvertToBool($settings->Show_Record_Number_On_Exported_List_Page->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Show_Record_Number_On_Exported_List_Page" name="x_Show_Record_Number_On_Exported_List_Page[]" id="x_Show_Record_Number_On_Exported_List_Page[]" value="1"<?php echo $selwrk ?><?php echo $settings->Show_Record_Number_On_Exported_List_Page->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Use_Table_Setting_For_Export_Field_Caption->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Use_Table_Setting_For_Export_Field_Caption" name="x_Use_Table_Setting_For_Export_Field_Caption[]" id="x_Use_Table_Setting_For_Export_Field_Caption[]" value="1"<?php echo $selwrk ?><?php echo $settings->Use_Table_Setting_For_Export_Field_Caption->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($settings->Use_Table_Setting_For_Export_Original_Value->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Use_Table_Setting_For_Export_Original_Value" name="x_Use_Table_Setting_For_Export_Original_Value[]" id="x_Use_Table_Setting_For_Export_Original_Value[]" value="1"<?php echo $selwrk ?><?php echo $settings->Use_Table_Setting_For_Export_Original_Value->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
$(document).ready(function(){$("#fsettingsadd:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()})});
</script>
<?php } ?>
<?php if ($settings->Export == "") { ?>
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyAdd(this)'); function alertifyAdd(obj) { <?php global $Language; ?> if (fsettingsadd.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyAddConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyAdd'); ?>"); $("#fsettingsadd").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
