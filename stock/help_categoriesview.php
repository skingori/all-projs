...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function SetupOtherOptions() {
		...
		$links = "";
		if ($GLOBALS["help_grid"] && $GLOBALS["help_grid"]->DetailView) {
...
// Page object
var help_categories_view = new ew_Page("help_categories_view");
help_categories_view.PageID = "view"; // Page ID
var EW_PAGE_ID = help_categories_view.PageID; // For backward compatibility

// Form object
var fhelp_categoriesview = new ew_Form("fhelp_categoriesview");
...
fhelp_categoriesview.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el_help_categories_Category_ID" class="form-group">
...
<?php if ($help_categories->_Language->Visible) { // Language ?>
	<tr id="r__Language">
		...
		<td<?php echo $help_categories->_Language->CellAttributes() ?>>
<span id="el_help_categories__Language" class="form-group">
...
<span id="el_help_categories_Category_Description" class="form-group">
