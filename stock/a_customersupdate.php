...
// Page object
var a_customers_update = new ew_Page("a_customers_update");
a_customers_update.PageID = "update"; // Page ID
var EW_PAGE_ID = a_customers_update.PageID; // For backward compatibility

// Form object
var fa_customersupdate = new ew_Form("fa_customersupdate");
...
?>
<form name="fa_customersupdate" id="fa_customersupdate" class="form-horizontal ewForm ewUpdateForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="checkbox" name="u_Customer_Number" id="u_Customer_Number" value="1"<?php echo ($a_customers->Customer_Number->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Customer_Name" id="u_Customer_Name" value="1"<?php echo ($a_customers->Customer_Name->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Address" id="u_Address" value="1"<?php echo ($a_customers->Address->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<textarea data-field="x_Address" name="x_Address" id="x_Address" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($a_customers->Address->PlaceHolder) ?>"<?php echo $a_customers->Address->EditAttributes() ?>><?php echo $a_customers->Address->EditValue ?></textarea>
</span>
...
<input type="checkbox" name="u_City" id="u_City" value="1"<?php echo ($a_customers->City->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Country" id="u_Country" value="1"<?php echo ($a_customers->Country->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Contact_Person" id="u_Contact_Person" value="1"<?php echo ($a_customers->Contact_Person->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Phone_Number" id="u_Phone_Number" value="1"<?php echo ($a_customers->Phone_Number->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u__Email" id="u__Email" value="1"<?php echo ($a_customers->_Email->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Mobile_Number" id="u_Mobile_Number" value="1"<?php echo ($a_customers->Mobile_Number->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Notes" id="u_Notes" value="1"<?php echo ($a_customers->Notes->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Balance" id="u_Balance" value="1"<?php echo ($a_customers->Balance->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyUpdate(this)'); function alertifyUpdate(obj) { <?php global $Language; ?> if (fa_customersupdate.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo  $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fa_customersupdate").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
