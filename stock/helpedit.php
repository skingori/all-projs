...
// Page object
var help_edit = new ew_Page("help_edit");
help_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = help_edit.PageID; // For backward compatibility

// Form object
var fhelpedit = new ew_Form("fhelpedit");
...
fhelpedit.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fhelpedit.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fhelpedit.Lists["x_Updated_By"] = {"LinkField":"x_Username","Ajax":null,"AutoFill":false,"DisplayFields":["x_First_Name","x_Last_Name","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<form name="fhelpedit" id="fhelpedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Help_ID" name="x_Help_ID" id="x_Help_ID" value="<?php echo ew_HtmlEncode($help->Help_ID->CurrentValue) ?>">
...
<script type="text/javascript">
fhelpedit.Lists["x__Language"].Options = <?php echo (is_array($help->_Language->EditValue)) ? ew_ArrayToJson($help->_Language->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fhelpedit.Lists["x_Category"].Options = <?php echo (is_array($help->Category->EditValue)) ? ew_ArrayToJson($help->Category->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
<?php if ($help->Export == "") { ?>
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fhelpedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fhelpedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
