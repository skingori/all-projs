...
// Page object
var languages_edit = new ew_Page("languages_edit");
languages_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = languages_edit.PageID; // For backward compatibility

// Form object
var flanguagesedit = new ew_Form("flanguagesedit");
...
<form name="flanguagesedit" id="flanguagesedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Language_Code" name="x_Language_Code" id="x_Language_Code" value="<?php echo ew_HtmlEncode($languages->Language_Code->CurrentValue) ?>">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (flanguagesedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#flanguagesedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
