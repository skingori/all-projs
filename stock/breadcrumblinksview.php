...
// Page object
var breadcrumblinks_view = new ew_Page("breadcrumblinks_view");
breadcrumblinks_view.PageID = "view"; // Page ID
var EW_PAGE_ID = breadcrumblinks_view.PageID; // For backward compatibility

// Form object
var fbreadcrumblinksview = new ew_Form("fbreadcrumblinksview");
...
<span id="el_breadcrumblinks_Page_Title" class="form-group">
...
<span id="el_breadcrumblinks_Page_URL" class="form-group">
...
<span id="el_breadcrumblinks_Lft" class="form-group">
...
<span id="el_breadcrumblinks_Rgt" class="form-group">
