...
// Page object
var a_sales_view = new ew_Page("a_sales_view");
a_sales_view.PageID = "view"; // Page ID
var EW_PAGE_ID = a_sales_view.PageID; // For backward compatibility

// Form object
var fa_salesview = new ew_Form("fa_salesview");
...
fa_salesview.Lists["x_Customer_ID"] = {"LinkField":"x_Customer_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($a_sales->Sales_ID->Visible) { // Sales_ID ?>
	<tr id="r_Sales_ID">
		...
		<td<?php echo $a_sales->Sales_ID->CellAttributes() ?>>
<span id="el_a_sales_Sales_ID" class="form-group">
...
<span id="el_a_sales_Sales_Number" class="form-group">
...
<span id="el_a_sales_Sales_Date" class="form-group">
...
<span id="el_a_sales_Customer_ID" class="form-group">
...
<?php if ($a_sales->Notes->Visible) { // Notes ?>
	<tr id="r_Notes">
		...
		<td<?php echo $a_sales->Notes->CellAttributes() ?>>
<span id="el_a_sales_Notes" class="form-group">
...
<span id="el_a_sales_Total_Amount" class="form-group">
...
<?php if ($a_sales->Discount_Type->Visible) { // Discount_Type ?>
	<tr id="r_Discount_Type">
		...
		<td<?php echo $a_sales->Discount_Type->CellAttributes() ?>>
<span id="el_a_sales_Discount_Type" class="form-group">
...
<?php if ($a_sales->Discount_Percentage->Visible) { // Discount_Percentage ?>
	<tr id="r_Discount_Percentage">
		...
		<td<?php echo $a_sales->Discount_Percentage->CellAttributes() ?>>
<span id="el_a_sales_Discount_Percentage" class="form-group">
...
<span id="el_a_sales_Discount_Amount" class="form-group">
...
<?php if ($a_sales->Tax_Percentage->Visible) { // Tax_Percentage ?>
	<tr id="r_Tax_Percentage">
		...
		<td<?php echo $a_sales->Tax_Percentage->CellAttributes() ?>>
<span id="el_a_sales_Tax_Percentage" class="form-group">
...
<span id="el_a_sales_Tax_Amount" class="form-group">
...
<?php if ($a_sales->Tax_Description->Visible) { // Tax_Description ?>
	<tr id="r_Tax_Description">
		...
		<td<?php echo $a_sales->Tax_Description->CellAttributes() ?>>
<span id="el_a_sales_Tax_Description" class="form-group">
...
<span id="el_a_sales_Final_Total_Amount" class="form-group">
...
<span id="el_a_sales_Total_Payment" class="form-group">
...
<span id="el_a_sales_Total_Balance" class="form-group">
...
<?php if ($a_sales->Date_Added->Visible) { // Date_Added ?>
	<tr id="r_Date_Added">
		...
		<td<?php echo $a_sales->Date_Added->CellAttributes() ?>>
<span id="el_a_sales_Date_Added" class="form-group">
...
<?php if ($a_sales->Added_By->Visible) { // Added_By ?>
	<tr id="r_Added_By">
		...
		<td<?php echo $a_sales->Added_By->CellAttributes() ?>>
<span id="el_a_sales_Added_By" class="form-group">
...
<?php if ($a_sales->Date_Updated->Visible) { // Date_Updated ?>
	<tr id="r_Date_Updated">
		...
		<td<?php echo $a_sales->Date_Updated->CellAttributes() ?>>
<span id="el_a_sales_Date_Updated" class="form-group">
...
<?php if ($a_sales->Updated_By->Visible) { // Updated_By ?>
	<tr id="r_Updated_By">
		...
		<td<?php echo $a_sales->Updated_By->CellAttributes() ?>>
<span id="el_a_sales_Updated_By" class="form-group">
