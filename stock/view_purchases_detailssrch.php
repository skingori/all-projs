...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "view_purchases_detailslist.php", "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Page object
var view_purchases_details_search = new ew_Page("view_purchases_details_search");
view_purchases_details_search.PageID = "search"; // Page ID
var EW_PAGE_ID = view_purchases_details_search.PageID; // For backward compatibility

// Form object
var fview_purchases_detailssearch = new ew_Form("fview_purchases_detailssearch");
...
fview_purchases_detailssearch.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fview_purchases_detailssearch.Lists["x_Stock_Item"] = {"LinkField":"x_Stock_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Stock_Name","","",""],"ParentFields":["x_Supplier_Number"],"FilterFields":["x_Supplier_Number"],"Options":[]};
...
?>
<form name="fview_purchases_detailssearch" id="fview_purchases_detailssearch" class="form-horizontal ewForm ewSearchForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="text" data-field="x_Purchase_ID" name="y_Purchase_ID" id="y_Purchase_ID" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Purchase_ID->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Purchase_ID->EditValue2 ?>"<?php echo $view_purchases_details->Purchase_ID->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($view_purchases_details->Purchase_Number->Visible) { // Purchase_Number ?>
	<div id="r_Purchase_Number" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Purchase_Number" id="z_Purchase_Number" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($view_purchases_details->Purchase_Number->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_details_Purchase_Number">
<input type="text" data-field="x_Purchase_Number" name="x_Purchase_Number" id="x_Purchase_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Purchase_Number->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Purchase_Number->EditValue ?>"<?php echo $view_purchases_details->Purchase_Number->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Purchase_Number" name="y_Purchase_Number" id="y_Purchase_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Purchase_Number->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Purchase_Number->EditValue2 ?>"<?php echo $view_purchases_details->Purchase_Number->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($view_purchases_details->Supplier_Number->Visible) { // Supplier_Number ?>
	<div id="r_Supplier_Number" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Supplier_Number" id="z_Supplier_Number" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($view_purchases_details->Supplier_Number->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_details_Supplier_Number">
<?php $view_purchases_details->Supplier_Number->EditAttrs["onchange"] = "ew_UpdateOpt.call(this, ['x_Stock_Item']); " . @$view_purchases_details->Supplier_Number->EditAttrs["onchange"]; ?>
<select data-field="x_Supplier_Number" id="x_Supplier_Number" name="x_Supplier_Number"<?php echo $view_purchases_details->Supplier_Number->EditAttributes() ?>>
<?php
if (is_array($view_purchases_details->Supplier_Number->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_purchases_details->Supplier_Number->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fview_purchases_detailssearch.Lists["x_Supplier_Number"].Options = <?php echo (is_array($view_purchases_details->Supplier_Number->EditValue)) ? ew_ArrayToJson($view_purchases_details->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Supplier_Number" id="y_Supplier_Number" name="y_Supplier_Number"<?php echo $view_purchases_details->Supplier_Number->EditAttributes() ?>>
<?php
if (is_array($view_purchases_details->Supplier_Number->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_purchases_details->Supplier_Number->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fview_purchases_detailssearch.Lists["x_Supplier_Number"].Options = <?php echo (is_array($view_purchases_details->Supplier_Number->EditValue2)) ? ew_ArrayToJson($view_purchases_details->Supplier_Number->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($view_purchases_details->Stock_Item->Visible) { // Stock_Item ?>
	<div id="r_Stock_Item" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Stock_Item" id="z_Stock_Item" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($view_purchases_details->Stock_Item->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_details_Stock_Item">
<select data-field="x_Stock_Item" id="x_Stock_Item" name="x_Stock_Item"<?php echo $view_purchases_details->Stock_Item->EditAttributes() ?>>
<?php
if (is_array($view_purchases_details->Stock_Item->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_purchases_details->Stock_Item->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fview_purchases_detailssearch.Lists["x_Stock_Item"].Options = <?php echo (is_array($view_purchases_details->Stock_Item->EditValue)) ? ew_ArrayToJson($view_purchases_details->Stock_Item->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Stock_Item" id="y_Stock_Item" name="y_Stock_Item"<?php echo $view_purchases_details->Stock_Item->EditAttributes() ?>>
<?php
if (is_array($view_purchases_details->Stock_Item->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_purchases_details->Stock_Item->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fview_purchases_detailssearch.Lists["x_Stock_Item"].Options = <?php echo (is_array($view_purchases_details->Stock_Item->EditValue2)) ? ew_ArrayToJson($view_purchases_details->Stock_Item->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($view_purchases_details->Purchasing_Price->Visible) { // Purchasing_Price ?>
	<div id="r_Purchasing_Price" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Purchasing_Price" id="z_Purchasing_Price" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_details->Purchasing_Price->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_details->Purchasing_Price->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_details->Purchasing_Price->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_details->Purchasing_Price->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_details->Purchasing_Price->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_details->Purchasing_Price->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($view_purchases_details->Purchasing_Price->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_details_Purchasing_Price">
<input type="text" data-field="x_Purchasing_Price" name="x_Purchasing_Price" id="x_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Purchasing_Price->EditValue ?>"<?php echo $view_purchases_details->Purchasing_Price->EditAttributes() ?>>
...
<input type="text" data-field="x_Purchasing_Price" name="y_Purchasing_Price" id="y_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Purchasing_Price->EditValue2 ?>"<?php echo $view_purchases_details->Purchasing_Price->EditAttributes() ?>>
<?php if (!$view_purchases_details->Purchasing_Price->ReadOnly && !$view_purchases_details->Purchasing_Price->Disabled && @$view_purchases_details->Purchasing_Price->EditAttrs["readonly"] == "" && @$view_purchases_details->Purchasing_Price->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_purchases_details->Selling_Price->Visible) { // Selling_Price ?>
	<div id="r_Selling_Price" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Selling_Price" id="z_Selling_Price" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_details->Selling_Price->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_details->Selling_Price->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_details->Selling_Price->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_details->Selling_Price->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_details->Selling_Price->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_details->Selling_Price->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($view_purchases_details->Selling_Price->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_details_Selling_Price">
<input type="text" data-field="x_Selling_Price" name="x_Selling_Price" id="x_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Selling_Price->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Selling_Price->EditValue ?>"<?php echo $view_purchases_details->Selling_Price->EditAttributes() ?>>
...
<input type="text" data-field="x_Selling_Price" name="y_Selling_Price" id="y_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Selling_Price->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Selling_Price->EditValue2 ?>"<?php echo $view_purchases_details->Selling_Price->EditAttributes() ?>>
<?php if (!$view_purchases_details->Selling_Price->ReadOnly && !$view_purchases_details->Selling_Price->Disabled && @$view_purchases_details->Selling_Price->EditAttrs["readonly"] == "" && @$view_purchases_details->Selling_Price->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_purchases_details->Purchasing_Total_Amount->Visible) { // Purchasing_Total_Amount ?>
	<div id="r_Purchasing_Total_Amount" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Purchasing_Total_Amount" id="z_Purchasing_Total_Amount" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_purchases_details->Purchasing_Total_Amount->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_purchases_details->Purchasing_Total_Amount->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_purchases_details->Purchasing_Total_Amount->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_purchases_details->Purchasing_Total_Amount->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_purchases_details->Purchasing_Total_Amount->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_purchases_details->Purchasing_Total_Amount->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($view_purchases_details->Purchasing_Total_Amount->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_purchases_details_Purchasing_Total_Amount">
<input type="text" data-field="x_Purchasing_Total_Amount" name="x_Purchasing_Total_Amount" id="x_Purchasing_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Purchasing_Total_Amount->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Purchasing_Total_Amount->EditValue ?>"<?php echo $view_purchases_details->Purchasing_Total_Amount->EditAttributes() ?>>
...
<input type="text" data-field="x_Purchasing_Total_Amount" name="y_Purchasing_Total_Amount" id="y_Purchasing_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_purchases_details->Purchasing_Total_Amount->PlaceHolder) ?>" value="<?php echo $view_purchases_details->Purchasing_Total_Amount->EditValue2 ?>"<?php echo $view_purchases_details->Purchasing_Total_Amount->EditAttributes() ?>>
<?php if (!$view_purchases_details->Purchasing_Total_Amount->ReadOnly && !$view_purchases_details->Purchasing_Total_Amount->Disabled && @$view_purchases_details->Purchasing_Total_Amount->EditAttrs["readonly"] == "" && @$view_purchases_details->Purchasing_Total_Amount->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
