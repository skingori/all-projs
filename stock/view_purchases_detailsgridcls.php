...
$view_purchases_details_grid = NULL; // Initialize page object first

class cview_purchases_details_grid extends cview_purchases_details {
	...
	// Page object name
	var $PageObjName = 'view_purchases_details_grid';

	// Grid form hidden field names
	var $FormName = 'fview_purchases_detailsgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["view_purchases_details"];
