...
<span id="el_view_sales_outstandings_Sales_Number" class="form-group">
...
<span id="el_view_sales_outstandings_Sales_Date" class="form-group">
...
<span id="el_view_sales_outstandings_Customer_ID" class="form-group">
...
<span id="el_view_sales_outstandings_Notes" class="form-group">
...
<span id="el_view_sales_outstandings_Total_Amount" class="form-group">
...
<span id="el_view_sales_outstandings_Final_Total_Amount" class="form-group">
...
<span id="el_view_sales_outstandings_Total_Payment" class="form-group">
...
<span id="el_view_sales_outstandings_Total_Balance" class="form-group">
