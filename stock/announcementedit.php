...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$arwrk = array();
			$arwrk[] = array($this->Is_Active->FldTagValue(1), $this->Is_Active->FldTagCaption(1) <> "" ? $this->Is_Active->FldTagCaption(1) : $this->Is_Active->FldTagValue(1));
			$arwrk[] = array($this->Is_Active->FldTagValue(2), $this->Is_Active->FldTagCaption(2) <> "" ? $this->Is_Active->FldTagCaption(2) : $this->Is_Active->FldTagValue(2));
			$this->Is_Active->EditValue = $arwrk;
			...
			$arwrk = array();
			$arwrk[] = array($this->Auto_Publish->FldTagValue(1), $this->Auto_Publish->FldTagCaption(1) <> "" ? $this->Auto_Publish->FldTagCaption(1) : $this->Auto_Publish->FldTagValue(1));
			$arwrk[] = array($this->Auto_Publish->FldTagValue(2), $this->Auto_Publish->FldTagCaption(2) <> "" ? $this->Auto_Publish->FldTagCaption(2) : $this->Auto_Publish->FldTagValue(2));
			$this->Auto_Publish->EditValue = $arwrk;
...
// Form object
var fannouncementedit = new ew_Form("fannouncementedit");
...
fannouncementedit.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fannouncementedit.Lists["x_Translated_ID"] = {"LinkField":"x_Announcement_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Topic","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<form name="fannouncementedit" id="fannouncementedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Announcement_ID" name="x_Announcement_ID" id="x_Announcement_ID" value="<?php echo ew_HtmlEncode($announcement->Announcement_ID->CurrentValue) ?>">
...
<?php
$selwrk = (ew_ConvertToBool($announcement->Is_Active->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Is_Active" name="x_Is_Active[]" id="x_Is_Active[]" value="1"<?php echo $selwrk ?><?php echo $announcement->Is_Active->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Topic" name="x_Topic" id="x_Topic" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($announcement->Topic->PlaceHolder) ?>" value="<?php echo $announcement->Topic->EditValue ?>"<?php echo $announcement->Topic->EditAttributes() ?>>
</span>
...
<textarea data-field="x_Message" class="editor" name="x_Message" id="x_Message" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($announcement->Message->PlaceHolder) ?>"<?php echo $announcement->Message->EditAttributes() ?>><?php echo $announcement->Message->EditValue ?></textarea>
<script type="text/javascript">
...
<input type="text" data-field="x_Date_LastUpdate" name="x_Date_LastUpdate" id="x_Date_LastUpdate" placeholder="<?php echo ew_HtmlEncode($announcement->Date_LastUpdate->PlaceHolder) ?>" value="<?php echo $announcement->Date_LastUpdate->EditValue ?>"<?php echo $announcement->Date_LastUpdate->EditAttributes() ?>>
</span>
...
<select data-field="x__Language" id="x__Language" name="x__Language"<?php echo $announcement->_Language->EditAttributes() ?>>
<?php
if (is_array($announcement->_Language->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($announcement->_Language->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fannouncementedit.Lists["x__Language"].Options = <?php echo (is_array($announcement->_Language->EditValue)) ? ew_ArrayToJson($announcement->_Language->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($announcement->Auto_Publish->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Auto_Publish" name="x_Auto_Publish[]" id="x_Auto_Publish[]" value="1"<?php echo $selwrk ?><?php echo $announcement->Auto_Publish->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Date_Start" name="x_Date_Start" id="x_Date_Start" placeholder="<?php echo ew_HtmlEncode($announcement->Date_Start->PlaceHolder) ?>" value="<?php echo $announcement->Date_Start->EditValue ?>"<?php echo $announcement->Date_Start->EditAttributes() ?>>
<?php if (!$announcement->Date_Start->ReadOnly && !$announcement->Date_Start->Disabled && @$announcement->Date_Start->EditAttrs["readonly"] == "" && @$announcement->Date_Start->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Date_End" name="x_Date_End" id="x_Date_End" placeholder="<?php echo ew_HtmlEncode($announcement->Date_End->PlaceHolder) ?>" value="<?php echo $announcement->Date_End->EditValue ?>"<?php echo $announcement->Date_End->EditAttributes() ?>>
<?php if (!$announcement->Date_End->ReadOnly && !$announcement->Date_End->Disabled && @$announcement->Date_End->EditAttrs["readonly"] == "" && @$announcement->Date_End->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Date_Created" name="x_Date_Created" id="x_Date_Created" placeholder="<?php echo ew_HtmlEncode($announcement->Date_Created->PlaceHolder) ?>" value="<?php echo $announcement->Date_Created->EditValue ?>"<?php echo $announcement->Date_Created->EditAttributes() ?>>
<?php if (!$announcement->Date_Created->ReadOnly && !$announcement->Date_Created->Disabled && @$announcement->Date_Created->EditAttrs["readonly"] == "" && @$announcement->Date_Created->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Created_By" name="x_Created_By" id="x_Created_By" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($announcement->Created_By->PlaceHolder) ?>" value="<?php echo $announcement->Created_By->EditValue ?>"<?php echo $announcement->Created_By->EditAttributes() ?>>
</span>
...
<select data-field="x_Translated_ID" id="x_Translated_ID" name="x_Translated_ID"<?php echo $announcement->Translated_ID->EditAttributes() ?>>
<?php
if (is_array($announcement->Translated_ID->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($announcement->Translated_ID->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fannouncementedit.Lists["x_Translated_ID"].Options = <?php echo (is_array($announcement->Translated_ID->EditValue)) ? ew_ArrayToJson($announcement->Translated_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fannouncementedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fannouncementedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
