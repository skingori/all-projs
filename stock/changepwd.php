...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function Page_Main() {
		...
		if ($bPwdUpdated) {
			...
			ew_WriteAuditTrail("log", ew_StdCurrentDateTime(), ew_ScriptName(), $sUsername, $Language->Phrase("LogChangePassword"), ew_CurrentUserIP(), "", "", "", "");
...
<?php if (MS_TERMS_AND_CONDITION_CHECKBOX_ON_CHANGEPWD_PAGE == TRUE) { ?>
	<div class="form-group">
		<label class="col-sm-4 control-label ewLabel" for="chktac"></label>
		<div class="col-sm-8">
			<div>
				<label class="checkbox-inline ewCheckBox" style="white-space: nowrap;">
				<?php $selwrk = (@isset($_POST["chktac"])) ? " checked='checked'" : ""; ?>
				<input type="checkbox" name="chktac" id="chktac" value="<?php echo @$_POST["chktac"]; ?>" <?php echo $selwrk; ?>>&nbsp;<?php echo $Language->Phrase("IAgreeWith"); ?>&nbsp;<a href="javascript:void(0);" id="tac" onclick="msTACDialogShow();return false;"><?php echo $Language->Phrase("TaCTitle"); ?></a>&nbsp;<a href="printtac.php"><?php echo Language()->Phrase("Print"); ?></a>
				</label>
			</div>
		</div>
	</div>
