...
fusersview.Lists["x_User_Level"] = {"LinkField":"x_User_Level_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_User_Level_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusersview.Lists["x_Theme"] = {"LinkField":"x_Theme_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Theme_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusersview.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el_users_Username" class="form-group">
...
<span id="el_users_Password" class="form-group">
...
<span id="el_users_First_Name" class="form-group">
...
<span id="el_users_Last_Name" class="form-group">
...
<span id="el_users__Email" class="form-group">
...
<span id="el_users_User_Level" class="form-group">
...
<?php if ($users->Report_To->Visible) { // Report_To ?>
	<tr id="r_Report_To">
		...
		<td<?php echo $users->Report_To->CellAttributes() ?>>
<span id="el_users_Report_To" class="form-group">
...
<span id="el_users_Activated" class="form-group">
...
<span id="el_users_Locked" class="form-group">
...
<span id="el_users_Profile" class="form-group">
...
<span id="el_users_Current_URL" class="form-group">
...
<span id="el_users_Theme" class="form-group">
...
<span id="el_users_Menu_Horizontal" class="form-group">
...
<?php if ($users->Table_Width_Style->Visible) { // Table_Width_Style ?>
	<tr id="r_Table_Width_Style">
		...
		<td<?php echo $users->Table_Width_Style->CellAttributes() ?>>
<span id="el_users_Table_Width_Style" class="form-group">
...
<?php if ($users->Scroll_Table_Width->Visible) { // Scroll_Table_Width ?>
	<tr id="r_Scroll_Table_Width">
		...
		<td<?php echo $users->Scroll_Table_Width->CellAttributes() ?>>
<span id="el_users_Scroll_Table_Width" class="form-group">
...
<?php if ($users->Scroll_Table_Height->Visible) { // Scroll_Table_Height ?>
	<tr id="r_Scroll_Table_Height">
		...
		<td<?php echo $users->Scroll_Table_Height->CellAttributes() ?>>
<span id="el_users_Scroll_Table_Height" class="form-group">
...
<?php if ($users->Rows_Vertical_Align_Top->Visible) { // Rows_Vertical_Align_Top ?>
	<tr id="r_Rows_Vertical_Align_Top">
		...
		<td<?php echo $users->Rows_Vertical_Align_Top->CellAttributes() ?>>
<span id="el_users_Rows_Vertical_Align_Top" class="form-group">
...
<span id="el_users__Language" class="form-group">
...
<?php if ($users->Redirect_To_Last_Visited_Page_After_Login->Visible) { // Redirect_To_Last_Visited_Page_After_Login ?>
	<tr id="r_Redirect_To_Last_Visited_Page_After_Login">
		...
		<td<?php echo $users->Redirect_To_Last_Visited_Page_After_Login->CellAttributes() ?>>
<span id="el_users_Redirect_To_Last_Visited_Page_After_Login" class="form-group">
...
<?php if ($users->Font_Name->Visible) { // Font_Name ?>
	<tr id="r_Font_Name">
		...
		<td<?php echo $users->Font_Name->CellAttributes() ?>>
<span id="el_users_Font_Name" class="form-group">
...
<?php if ($users->Font_Size->Visible) { // Font_Size ?>
	<tr id="r_Font_Size">
		...
		<td<?php echo $users->Font_Size->CellAttributes() ?>>
<span id="el_users_Font_Size" class="form-group">
