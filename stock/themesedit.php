...
// Page object
var themes_edit = new ew_Page("themes_edit");
themes_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = themes_edit.PageID; // For backward compatibility

// Form object
var fthemesedit = new ew_Form("fthemesedit");
...
<form name="fthemesedit" id="fthemesedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Theme_ID" name="x_Theme_ID" id="x_Theme_ID" value="<?php echo ew_HtmlEncode($themes->Theme_ID->CurrentValue) ?>">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fthemesedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fthemesedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
