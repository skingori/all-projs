...
// Page object
var a_purchases_edit = new ew_Page("a_purchases_edit");
a_purchases_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = a_purchases_edit.PageID; // For backward compatibility

// Form object
var fa_purchasesedit = new ew_Form("fa_purchasesedit");
...
fa_purchasesedit.Lists["x_Supplier_ID"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<form name="fa_purchasesedit" id="fa_purchasesedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Purchase_ID" name="x_Purchase_ID" id="x_Purchase_ID" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_ID->CurrentValue) ?>">
...
<script type="text/javascript">
fa_purchasesedit.Lists["x_Supplier_ID"].Options = <?php echo (is_array($a_purchases->Supplier_ID->EditValue)) ? ew_ArrayToJson($a_purchases->Supplier_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
<input type="hidden" data-field="x_Date_Added" name="x_Date_Added" id="x_Date_Added" value="<?php echo ew_HtmlEncode($a_purchases->Date_Added->CurrentValue) ?>">
</span>
<span id="el_a_purchases_Added_By">
<input type="hidden" data-field="x_Added_By" name="x_Added_By" id="x_Added_By" value="<?php echo ew_HtmlEncode($a_purchases->Added_By->CurrentValue) ?>">
</span>
<?php
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fa_purchasesedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fa_purchasesedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
