...
-- ----------------------------
INSERT INTO `languages` VALUES ('en', 'English', 'Y', '-', 'Inventory', ',', '.', '$', ',', '.', 'This is the terms and conditions text from database. You can edit this text from the languages table ...', 'This is the announcement text from database. You can edit this text from the languages table ...', '<span class=\'dialogtitle\' style=\'white-space: nowrap;\'>Stock Inventory Management</span><br><br>Tarclink for incredible<br><br><br><br><br>Web development<br></span>Samson Mwangi(infor.samson@gmail.com)<br>Website: <a href=\'http://www.tarclink.com\' title=\'for incredible\' target=\'_blank\'>http://www.tarclink.com</a><br><br><br>');
-- ----------------------------
