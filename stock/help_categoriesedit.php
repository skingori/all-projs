...
// Page object
var help_categories_edit = new ew_Page("help_categories_edit");
help_categories_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = help_categories_edit.PageID; // For backward compatibility

// Form object
var fhelp_categoriesedit = new ew_Form("fhelp_categoriesedit");
...
fhelp_categoriesedit.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<form name="fhelp_categoriesedit" id="fhelp_categoriesedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Category_ID" name="x_Category_ID" id="x_Category_ID" value="<?php echo ew_HtmlEncode($help_categories->Category_ID->CurrentValue) ?>">
...
<script type="text/javascript">
fhelp_categoriesedit.Lists["x__Language"].Options = <?php echo (is_array($help_categories->_Language->EditValue)) ? ew_ArrayToJson($help_categories->_Language->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fhelp_categoriesedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fhelp_categoriesedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
