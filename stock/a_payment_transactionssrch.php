...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->Lookup_Selecting($this->Customer, $sWhereWrk);
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$this->Customer->ViewValue = $rswrk->fields('DispFld');
					$rswrk->Close();
				} else {
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "a_payment_transactionslist.php", "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Page object
var a_payment_transactions_search = new ew_Page("a_payment_transactions_search");
a_payment_transactions_search.PageID = "search"; // Page ID
var EW_PAGE_ID = a_payment_transactions_search.PageID; // For backward compatibility

// Form object
var fa_payment_transactionssearch = new ew_Form("fa_payment_transactionssearch");
...
fa_payment_transactionssearch.Lists["x_Customer"] = {"LinkField":"x_Customer_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_payment_transactionssearch.Lists["x_Supplier"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fa_payment_transactionssearch" id="fa_payment_transactionssearch" class="form-horizontal ewForm ewSearchForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($a_payment_transactions->Payment_ID->Visible) { // Payment_ID ?>
	<div id="r_Payment_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Payment_ID" id="z_Payment_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Payment_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Payment_ID">
<input type="text" data-field="x_Payment_ID" name="x_Payment_ID" id="x_Payment_ID" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Payment_ID->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Payment_ID->EditValue ?>"<?php echo $a_payment_transactions->Payment_ID->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Payment_ID" name="y_Payment_ID" id="y_Payment_ID" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Payment_ID->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Payment_ID->EditValue2 ?>"<?php echo $a_payment_transactions->Payment_ID->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_payment_transactions->Ref_ID->Visible) { // Ref_ID ?>
	<div id="r_Ref_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Ref_ID" id="z_Ref_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Ref_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Ref_ID">
<input type="text" data-field="x_Ref_ID" name="x_Ref_ID" id="x_Ref_ID" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Ref_ID->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Ref_ID->EditValue ?>"<?php echo $a_payment_transactions->Ref_ID->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Ref_ID" name="y_Ref_ID" id="y_Ref_ID" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Ref_ID->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Ref_ID->EditValue2 ?>"<?php echo $a_payment_transactions->Ref_ID->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_payment_transactions->Type->Visible) { // Type ?>
	<div id="r_Type" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Type" id="z_Type" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Type->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Type">
<div id="tp_x_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Type" id="x_Type" value="{value}"<?php echo $a_payment_transactions->Type->EditAttributes() ?>></div>
...
if (is_array($arwrk)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_payment_transactions->Type->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Type" name="x_Type" id="x_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $a_payment_transactions->Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
...
<div id="tp_y_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="y_Type" id="y_Type" value="{value}"<?php echo $a_payment_transactions->Type->EditAttributes() ?>></div>
<div id="dsl_y_Type" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_payment_transactions->Type->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Type" name="y_Type" id="y_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $a_payment_transactions->Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<?php if ($a_payment_transactions->Customer->Visible) { // Customer ?>
	<div id="r_Customer" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Customer" id="z_Customer" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Customer->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Customer">
<select data-field="x_Customer" id="x_Customer" name="x_Customer"<?php echo $a_payment_transactions->Customer->EditAttributes() ?>>
<?php
if (is_array($a_payment_transactions->Customer->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_payment_transactions->Customer->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
...
<script type="text/javascript">
fa_payment_transactionssearch.Lists["x_Customer"].Options = <?php echo (is_array($a_payment_transactions->Customer->EditValue)) ? ew_ArrayToJson($a_payment_transactions->Customer->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Customer" id="y_Customer" name="y_Customer"<?php echo $a_payment_transactions->Customer->EditAttributes() ?>>
<?php
if (is_array($a_payment_transactions->Customer->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_payment_transactions->Customer->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_payment_transactionssearch.Lists["x_Customer"].Options = <?php echo (is_array($a_payment_transactions->Customer->EditValue2)) ? ew_ArrayToJson($a_payment_transactions->Customer->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($a_payment_transactions->Supplier->Visible) { // Supplier ?>
	<div id="r_Supplier" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Supplier" id="z_Supplier" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Supplier->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Supplier">
<select data-field="x_Supplier" id="x_Supplier" name="x_Supplier"<?php echo $a_payment_transactions->Supplier->EditAttributes() ?>>
<?php
if (is_array($a_payment_transactions->Supplier->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_payment_transactions->Supplier->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_payment_transactionssearch.Lists["x_Supplier"].Options = <?php echo (is_array($a_payment_transactions->Supplier->EditValue)) ? ew_ArrayToJson($a_payment_transactions->Supplier->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Supplier" id="y_Supplier" name="y_Supplier"<?php echo $a_payment_transactions->Supplier->EditAttributes() ?>>
<?php
if (is_array($a_payment_transactions->Supplier->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_payment_transactions->Supplier->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_payment_transactionssearch.Lists["x_Supplier"].Options = <?php echo (is_array($a_payment_transactions->Supplier->EditValue2)) ? ew_ArrayToJson($a_payment_transactions->Supplier->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($a_payment_transactions->Sub_Total->Visible) { // Sub_Total ?>
	<div id="r_Sub_Total" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Sub_Total" id="z_Sub_Total" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Sub_Total->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Sub_Total->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Sub_Total->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Sub_Total->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Sub_Total->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Sub_Total->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Sub_Total->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Sub_Total">
<input type="text" data-field="x_Sub_Total" name="x_Sub_Total" id="x_Sub_Total" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Sub_Total->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Sub_Total->EditValue ?>"<?php echo $a_payment_transactions->Sub_Total->EditAttributes() ?>>
...
<input type="text" data-field="x_Sub_Total" name="y_Sub_Total" id="y_Sub_Total" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Sub_Total->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Sub_Total->EditValue2 ?>"<?php echo $a_payment_transactions->Sub_Total->EditAttributes() ?>>
<?php if (!$a_payment_transactions->Sub_Total->ReadOnly && !$a_payment_transactions->Sub_Total->Disabled && @$a_payment_transactions->Sub_Total->EditAttrs["readonly"] == "" && @$a_payment_transactions->Sub_Total->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_payment_transactions->Payment->Visible) { // Payment ?>
	<div id="r_Payment" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Payment" id="z_Payment" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Payment->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Payment->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Payment->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Payment->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Payment->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Payment->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Payment->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Payment">
<input type="text" data-field="x_Payment" name="x_Payment" id="x_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Payment->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Payment->EditValue ?>"<?php echo $a_payment_transactions->Payment->EditAttributes() ?>>
...
<input type="text" data-field="x_Payment" name="y_Payment" id="y_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Payment->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Payment->EditValue2 ?>"<?php echo $a_payment_transactions->Payment->EditAttributes() ?>>
<?php if (!$a_payment_transactions->Payment->ReadOnly && !$a_payment_transactions->Payment->Disabled && @$a_payment_transactions->Payment->EditAttrs["readonly"] == "" && @$a_payment_transactions->Payment->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_payment_transactions->Balance->Visible) { // Balance ?>
	<div id="r_Balance" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Balance" id="z_Balance" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Balance->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Balance->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Balance->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Balance->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Balance->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Balance->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Balance->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Balance">
<input type="text" data-field="x_Balance" name="x_Balance" id="x_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Balance->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Balance->EditValue ?>"<?php echo $a_payment_transactions->Balance->EditAttributes() ?>>
...
<input type="text" data-field="x_Balance" name="y_Balance" id="y_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Balance->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Balance->EditValue2 ?>"<?php echo $a_payment_transactions->Balance->EditAttributes() ?>>
<?php if (!$a_payment_transactions->Balance->ReadOnly && !$a_payment_transactions->Balance->Disabled && @$a_payment_transactions->Balance->EditAttrs["readonly"] == "" && @$a_payment_transactions->Balance->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_payment_transactions->Due_Date->Visible) { // Due_Date ?>
	<div id="r_Due_Date" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Due_Date" id="z_Due_Date" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Due_Date->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Due_Date">
<input type="text" data-field="x_Due_Date" name="x_Due_Date" id="x_Due_Date" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Due_Date->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Due_Date->EditValue ?>"<?php echo $a_payment_transactions->Due_Date->EditAttributes() ?>>
<?php if (!$a_payment_transactions->Due_Date->ReadOnly && !$a_payment_transactions->Due_Date->Disabled && @$a_payment_transactions->Due_Date->EditAttrs["readonly"] == "" && @$a_payment_transactions->Due_Date->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Due_Date" name="y_Due_Date" id="y_Due_Date" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Due_Date->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Due_Date->EditValue2 ?>"<?php echo $a_payment_transactions->Due_Date->EditAttributes() ?>>
<?php if (!$a_payment_transactions->Due_Date->ReadOnly && !$a_payment_transactions->Due_Date->Disabled && @$a_payment_transactions->Due_Date->EditAttrs["readonly"] == "" && @$a_payment_transactions->Due_Date->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_payment_transactions->Date_Transaction->Visible) { // Date_Transaction ?>
	<div id="r_Date_Transaction" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Date_Transaction" id="z_Date_Transaction" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Date_Transaction->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Date_Transaction">
<input type="text" data-field="x_Date_Transaction" name="x_Date_Transaction" id="x_Date_Transaction" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Transaction->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Date_Transaction->EditValue ?>"<?php echo $a_payment_transactions->Date_Transaction->EditAttributes() ?>>
<?php if (!$a_payment_transactions->Date_Transaction->ReadOnly && !$a_payment_transactions->Date_Transaction->Disabled && @$a_payment_transactions->Date_Transaction->EditAttrs["readonly"] == "" && @$a_payment_transactions->Date_Transaction->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Date_Transaction" name="y_Date_Transaction" id="y_Date_Transaction" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Transaction->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Date_Transaction->EditValue2 ?>"<?php echo $a_payment_transactions->Date_Transaction->EditAttributes() ?>>
<?php if (!$a_payment_transactions->Date_Transaction->ReadOnly && !$a_payment_transactions->Date_Transaction->Disabled && @$a_payment_transactions->Date_Transaction->EditAttrs["readonly"] == "" && @$a_payment_transactions->Date_Transaction->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_payment_transactions->Date_Added->Visible) { // Date_Added ?>
	<div id="r_Date_Added" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Date_Added" id="z_Date_Added" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Date_Added->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Date_Added">
<input type="text" data-field="x_Date_Added" name="x_Date_Added" id="x_Date_Added" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Added->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Date_Added->EditValue ?>"<?php echo $a_payment_transactions->Date_Added->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Date_Added" name="y_Date_Added" id="y_Date_Added" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Added->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Date_Added->EditValue2 ?>"<?php echo $a_payment_transactions->Date_Added->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_payment_transactions->Added_By->Visible) { // Added_By ?>
	<div id="r_Added_By" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Added_By" id="z_Added_By" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Added_By->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Added_By">
<input type="text" data-field="x_Added_By" name="x_Added_By" id="x_Added_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Added_By->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Added_By->EditValue ?>"<?php echo $a_payment_transactions->Added_By->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Added_By" name="y_Added_By" id="y_Added_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Added_By->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Added_By->EditValue2 ?>"<?php echo $a_payment_transactions->Added_By->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_payment_transactions->Date_Updated->Visible) { // Date_Updated ?>
	<div id="r_Date_Updated" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Date_Updated" id="z_Date_Updated" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Date_Updated->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Date_Updated">
<input type="text" data-field="x_Date_Updated" name="x_Date_Updated" id="x_Date_Updated" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Updated->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Date_Updated->EditValue ?>"<?php echo $a_payment_transactions->Date_Updated->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Date_Updated" name="y_Date_Updated" id="y_Date_Updated" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Date_Updated->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Date_Updated->EditValue2 ?>"<?php echo $a_payment_transactions->Date_Updated->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_payment_transactions->Updated_By->Visible) { // Updated_By ?>
	<div id="r_Updated_By" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Updated_By" id="z_Updated_By" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_payment_transactions->Updated_By->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_payment_transactions_Updated_By">
<input type="text" data-field="x_Updated_By" name="x_Updated_By" id="x_Updated_By" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Updated_By->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Updated_By->EditValue ?>"<?php echo $a_payment_transactions->Updated_By->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Updated_By" name="y_Updated_By" id="y_Updated_By" placeholder="<?php echo ew_HtmlEncode($a_payment_transactions->Updated_By->PlaceHolder) ?>" value="<?php echo $a_payment_transactions->Updated_By->EditValue2 ?>"<?php echo $a_payment_transactions->Updated_By->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
