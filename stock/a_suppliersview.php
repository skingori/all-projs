...
// Page object
var a_suppliers_view = new ew_Page("a_suppliers_view");
a_suppliers_view.PageID = "view"; // Page ID
var EW_PAGE_ID = a_suppliers_view.PageID; // For backward compatibility

// Form object
var fa_suppliersview = new ew_Form("fa_suppliersview");
...
<?php if ($a_suppliers->Supplier_ID->Visible) { // Supplier_ID ?>
	<tr id="r_Supplier_ID">
		...
		<td<?php echo $a_suppliers->Supplier_ID->CellAttributes() ?>>
<span id="el_a_suppliers_Supplier_ID" class="form-group">
...
<span id="el_a_suppliers_Supplier_Number" class="form-group">
...
<span id="el_a_suppliers_Supplier_Name" class="form-group">
...
<?php if ($a_suppliers->Address->Visible) { // Address ?>
	<tr id="r_Address">
		...
		<td<?php echo $a_suppliers->Address->CellAttributes() ?>>
<span id="el_a_suppliers_Address" class="form-group">
...
<?php if ($a_suppliers->City->Visible) { // City ?>
	<tr id="r_City">
		...
		<td<?php echo $a_suppliers->City->CellAttributes() ?>>
<span id="el_a_suppliers_City" class="form-group">
...
<?php if ($a_suppliers->Country->Visible) { // Country ?>
	<tr id="r_Country">
		...
		<td<?php echo $a_suppliers->Country->CellAttributes() ?>>
<span id="el_a_suppliers_Country" class="form-group">
...
<span id="el_a_suppliers_Contact_Person" class="form-group">
...
<span id="el_a_suppliers_Phone_Number" class="form-group">
...
<?php if ($a_suppliers->_Email->Visible) { // Email ?>
	<tr id="r__Email">
		...
		<td<?php echo $a_suppliers->_Email->CellAttributes() ?>>
<span id="el_a_suppliers__Email" class="form-group">
...
<span id="el_a_suppliers_Mobile_Number" class="form-group">
...
<?php if ($a_suppliers->Notes->Visible) { // Notes ?>
	<tr id="r_Notes">
		...
		<td<?php echo $a_suppliers->Notes->CellAttributes() ?>>
<span id="el_a_suppliers_Notes" class="form-group">
...
<span id="el_a_suppliers_Balance" class="form-group">
...
<span id="el_a_suppliers_Is_Stock_Available" class="form-group">
...
<?php if ($a_suppliers->Date_Added->Visible) { // Date_Added ?>
	<tr id="r_Date_Added">
		...
		<td<?php echo $a_suppliers->Date_Added->CellAttributes() ?>>
<span id="el_a_suppliers_Date_Added" class="form-group">
...
<?php if ($a_suppliers->Added_By->Visible) { // Added_By ?>
	<tr id="r_Added_By">
		...
		<td<?php echo $a_suppliers->Added_By->CellAttributes() ?>>
<span id="el_a_suppliers_Added_By" class="form-group">
...
<?php if ($a_suppliers->Date_Updated->Visible) { // Date_Updated ?>
	<tr id="r_Date_Updated">
		...
		<td<?php echo $a_suppliers->Date_Updated->CellAttributes() ?>>
<span id="el_a_suppliers_Date_Updated" class="form-group">
...
<?php if ($a_suppliers->Updated_By->Visible) { // Updated_By ?>
	<tr id="r_Updated_By">
		...
		<td<?php echo $a_suppliers->Updated_By->CellAttributes() ?>>
<span id="el_a_suppliers_Updated_By" class="form-group">
