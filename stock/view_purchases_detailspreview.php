...
$view_purchases_details_preview = NULL; // Initialize page object first

class cview_purchases_details_preview extends cview_purchases_details {
	...
	// Page object name
	var $PageObjName = 'view_purchases_details_preview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'view_purchases_details');
...
// Create page object
if (!isset($view_purchases_details_preview)) $view_purchases_details_preview = new cview_purchases_details_preview();

// Page init
$view_purchases_details_preview->Page_Init();

// Page main
$view_purchases_details_preview->Page_Main();
...
$view_purchases_details_preview->Page_Render();
?>
<?php $view_purchases_details_preview->ShowPageHeader(); ?>
<?php if ($view_purchases_details_preview->TotalRecs > 0) { ?>
<div class="ewGrid">
...
// Render list options
$view_purchases_details_preview->RenderListOptions();
...
<?php if ($view_purchases_details->Purchase_Number->Visible) { // Purchase_Number ?>
			<th><?php echo $view_purchases_details->Purchase_Number->FldCaption() ?></th>
<?php } ?>
<?php if ($view_purchases_details->Supplier_Number->Visible) { // Supplier_Number ?>
			<th><?php echo $view_purchases_details->Supplier_Number->FldCaption() ?></th>
<?php } ?>
<?php if ($view_purchases_details->Stock_Item->Visible) { // Stock_Item ?>
			<th><?php echo $view_purchases_details->Stock_Item->FldCaption() ?></th>
<?php } ?>
<?php if ($view_purchases_details->Purchasing_Quantity->Visible) { // Purchasing_Quantity ?>
			<th><?php echo $view_purchases_details->Purchasing_Quantity->FldCaption() ?></th>
<?php } ?>
<?php if ($view_purchases_details->Purchasing_Price->Visible) { // Purchasing_Price ?>
			<th><?php echo $view_purchases_details->Purchasing_Price->FldCaption() ?></th>
<?php } ?>
<?php if ($view_purchases_details->Selling_Price->Visible) { // Selling_Price ?>
			<th><?php echo $view_purchases_details->Selling_Price->FldCaption() ?></th>
<?php } ?>
<?php if ($view_purchases_details->Purchasing_Total_Amount->Visible) { // Purchasing_Total_Amount ?>
			<th><?php echo $view_purchases_details->Purchasing_Total_Amount->FldCaption() ?></th>
<?php } ?>
<?php

// Render list options (header, right)
$view_purchases_details_preview->ListOptions->Render("header", "right");
?>
		</tr>
	</thead>
	<tbody><!-- Table body -->
<?php
$view_purchases_details_preview->RecCount = 0;
$view_purchases_details_preview->RowCnt = 0;
$rowNumber = 0;
while ($view_purchases_details_preview->Recordset && !$view_purchases_details_preview->Recordset->EOF) {
	$rowNumber++;

	// Init row class and style
	$view_purchases_details_preview->RecCount++;
	$view_purchases_details_preview->RowCnt++;
	$view_purchases_details_preview->CssStyle = "";
	$view_purchases_details_preview->LoadListRowValues($view_purchases_details_preview->Recordset);
	$view_purchases_details_preview->AggregateListRowValues(); // Aggregate row values

	// Render row
	$view_purchases_details_preview->RowType = EW_ROWTYPE_PREVIEW; // Preview record
	$view_purchases_details_preview->RenderListRow();
...
<?php if ($view_purchases_details->Purchase_Number->Visible) { // Purchase_Number ?>
		<!-- Purchase_Number -->
		<td<?php echo $view_purchases_details->Purchase_Number->CellAttributes() ?>>
...
<?php if ($view_purchases_details->Supplier_Number->Visible) { // Supplier_Number ?>
		<!-- Supplier_Number -->
		<td<?php echo $view_purchases_details->Supplier_Number->CellAttributes() ?>>
...
<?php if ($view_purchases_details->Stock_Item->Visible) { // Stock_Item ?>
		<!-- Stock_Item -->
		<td<?php echo $view_purchases_details->Stock_Item->CellAttributes() ?>>
...
<?php if ($view_purchases_details->Purchasing_Quantity->Visible) { // Purchasing_Quantity ?>
		<!-- Purchasing_Quantity -->
		<td<?php echo $view_purchases_details->Purchasing_Quantity->CellAttributes() ?>>
...
<?php if ($view_purchases_details->Purchasing_Price->Visible) { // Purchasing_Price ?>
		<!-- Purchasing_Price -->
		<td<?php echo $view_purchases_details->Purchasing_Price->CellAttributes() ?>>
...
<?php if ($view_purchases_details->Selling_Price->Visible) { // Selling_Price ?>
		<!-- Selling_Price -->
		<td<?php echo $view_purchases_details->Selling_Price->CellAttributes() ?>>
...
<?php if ($view_purchases_details->Purchasing_Total_Amount->Visible) { // Purchasing_Total_Amount ?>
		...
		<td<?php echo $view_purchases_details->Purchasing_Total_Amount->CellAttributes() ?>>
...
$view_purchases_details_preview->ListOptions->Render("body", "right", $view_purchases_details_preview->RowCnt);
?>
	</tr>
<?php
	$view_purchases_details_preview->Recordset->MoveNext();
}
?>
	</tbody>
<?php
	...
	$view_purchases_details_preview->AggregateListRow(); // Prepare aggregate row
...
$view_purchases_details_preview->ListOptions->Render("footer", "left");
?>
<?php if ($view_purchases_details->Purchase_Number->Visible) { // Purchase_Number ?>
		<!-- Purchase_Number -->
		<td>
...
$view_purchases_details_preview->ListOptions->Render("footer", "right");
?>
	</tr>
	</tfoot>
</table>
...
<?php if ($view_purchases_details_preview->TotalRecs > 0) { ?>
<div class="ewDetailCount"><?php echo $view_purchases_details_preview->TotalRecs ?>&nbsp;<?php echo $Language->Phrase("Record") ?></div>
<?php // } else { ?>
<?php // } ?>
<div class="ewPreviewOtherOptions">
<?php
	foreach ($view_purchases_details_preview->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
...
<?php
$view_purchases_details_preview->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php
if ($view_purchases_details_preview->Recordset)
	$view_purchases_details_preview->Recordset->Close(); 
?>
<?php } else { // if ($view_purchases_details_preview->TotalRecs > 0)  ?>
...
} // end if ($view_purchases_details_preview->TotalRecs > 0)
...
?>
<?php
$view_purchases_details_preview->Page_Terminate();
?>
