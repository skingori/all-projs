...
$stats_counter_edit = NULL; // Initialize page object first

class cstats_counter_edit extends cstats_counter {
	...
	// Page object name
	var $PageObjName = 'stats_counter_edit';
...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->Variable->EditValue = $this->Variable->CurrentValue;
			$this->Variable->ViewCustomAttributes = "";
...
// Create page object
if (!isset($stats_counter_edit)) $stats_counter_edit = new cstats_counter_edit();

// Page init
$stats_counter_edit->Page_Init();

// Page main
$stats_counter_edit->Page_Main();
...
$stats_counter_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var stats_counter_edit = new ew_Page("stats_counter_edit");
stats_counter_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = stats_counter_edit.PageID; // For backward compatibility

// Form object
var fstats_counteredit = new ew_Form("fstats_counteredit");

// Validate form
fstats_counteredit.Validate = function() {
...
fstats_counteredit.Form_CustomValidate = 
...
fstats_counteredit.ValidateRequired = true;
<?php } else { ?>
fstats_counteredit.ValidateRequired = false; 
<?php } ?>
...
<?php $stats_counter_edit->ShowPageHeader(); ?>
<?php
$stats_counter_edit->ShowMessage();
?>
...
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
	<?php if (MS_PAGINATION_STYLE==1) { // link ?>
		<?php if (!isset($stats_counter_edit->Pager)) $stats_counter_edit->Pager = new cNumericPager($stats_counter_edit->StartRec, $stats_counter_edit->DisplayRecs, $stats_counter_edit->TotalRecs, $stats_counter_edit->RecRange) ?>
		<?php if ($stats_counter_edit->Pager->RecordCount > 0) { ?>
				<?php if (($stats_counter_edit->Pager->PageCount==1) && ($stats_counter_edit->Pager->CurrentPage == 1) && (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE)  ) { ?>
				<?php } else { // MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE ?>
				<div class="ewPager">
				<div class="ewNumericPage"><ul class="pagination">
					<?php if ($stats_counter_edit->Pager->FirstButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
					<?php if ($stats_counter_edit->Pager->PrevButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
					<?php } else { // else of rtl { ?>
					<li><a href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
					<?php } // end of rtl { ?>
					<?php } ?>
					<?php foreach ($stats_counter_edit->Pager->Items as $PagerItem) { ?>
						<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $stats_counter_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
					<?php } ?>
					<?php if ($stats_counter_edit->Pager->NextButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
					<?php if ($stats_counter_edit->Pager->LastButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
				</ul></div>
				</div>
	...
	<?php } elseif (MS_PAGINATION_STYLE==2) { // button ?>
		<?php if (!isset($stats_counter_edit->Pager)) $stats_counter_edit->Pager = new cPrevNextPager($stats_counter_edit->StartRec, $stats_counter_edit->DisplayRecs, $stats_counter_edit->TotalRecs) ?>
		<?php if ($stats_counter_edit->Pager->RecordCount > 0) { ?>
				<?php if (($stats_counter_edit->Pager->PageCount==1) && ($stats_counter_edit->Pager->CurrentPage == 1) && (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE)  ) { ?>
				...
				<!--first page button-->
					<?php if ($stats_counter_edit->Pager->FirstButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->FirstButton->Start ?>"><span class="icon-last ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--previous page button-->
					<?php if ($stats_counter_edit->Pager->PrevButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->PrevButton->Start ?>"><span class="icon-next ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--current page number-->
					<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $stats_counter_edit->Pager->CurrentPage ?>">
				<div class="input-group-btn">
				<!--next page button-->
					<?php if ($stats_counter_edit->Pager->NextButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->NextButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--last page button-->
					<?php if ($stats_counter_edit->Pager->LastButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->LastButton->Start ?>"><span class="icon-first ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $stats_counter_edit->PageUrl() ?>start=<?php echo $stats_counter_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $stats_counter_edit->Pager->PageCount ?></span>
				</div>
...
<form name="fstats_counteredit" id="fstats_counteredit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($stats_counter_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $stats_counter_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $stats_counter->Type->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Type" name="x_Type" id="x_Type" value="<?php echo ew_HtmlEncode($stats_counter->Type->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $stats_counter->Variable->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Variable" name="x_Variable" id="x_Variable" value="<?php echo ew_HtmlEncode($stats_counter->Variable->CurrentValue) ?>">
...
<input type="text" data-field="x_Counter" name="x_Counter" id="x_Counter" size="30" placeholder="<?php echo ew_HtmlEncode($stats_counter->Counter->PlaceHolder) ?>" value="<?php echo $stats_counter->Counter->EditValue ?>"<?php echo $stats_counter->Counter->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
fstats_counteredit.Init();
</script>
<?php
$stats_counter_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<script type="text/javascript">
$(document).ready(function(){$("#fstats_counteredit:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()})});
</script>
<?php } ?>
<?php if ($stats_counter->Export == "") { ?>
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fstats_counteredit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fstats_counteredit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
<?php include_once "footer.php" ?>
<?php
$stats_counter_edit->Page_Terminate();
?>
