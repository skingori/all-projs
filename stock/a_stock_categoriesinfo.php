...
$a_stock_categories = NULL;

//
// Table class for a_stock_categories
//
class ca_stock_categories extends cTable {
	var $Category_ID;
	var $Category_Name;
	...
	function __construct() {
		...
		$this->TableVar = 'a_stock_categories';
		$this->TableName = 'a_stock_categories';
...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Category_ID
		$this->Category_ID = new cField('a_stock_categories', 'a_stock_categories', 'x_Category_ID', 'Category_ID', '`Category_ID`', '`Category_ID`', 3, -1, FALSE, '`Category_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Category_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Category_ID'] = &$this->Category_ID;

		// Category_Name
		$this->Category_Name = new cField('a_stock_categories', 'a_stock_categories', 'x_Category_Name', 'Category_Name', '`Category_Name`', '`Category_Name`', 200, -1, FALSE, '`Category_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`a_stock_categories`";
	}
	...
	// Update Table
	var $UpdateTable = "`a_stock_categories`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "a_stock_categorieslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_stock_categoriesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_stock_categoriesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "a_stock_categoriesadd.php?" . $this->UrlParm($parm);
		else
			return "a_stock_categoriesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("a_stock_categoriesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("a_stock_categoriesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("a_stock_categoriesdelete.php", $this->UrlParm());
	}
