...
// Page object
var languages_delete = new ew_Page("languages_delete");
languages_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = languages_delete.PageID; // For backward compatibility

// Form object
var flanguagesdelete = new ew_Form("flanguagesdelete");
...
flanguagesdelete.ValidateRequired = true;
<?php } else { ?>
flanguagesdelete.ValidateRequired = false; 
<?php } ?>
...
if ($languages_delete->Recordset = $languages_delete->LoadRecordset())
	$languages_deleteTotalRecs = $languages_delete->Recordset->RecordCount(); // Get record count
if ($languages_deleteTotalRecs <= 0) { // No record found, exit
	if ($languages_delete->Recordset)
		$languages_delete->Recordset->Close();
	$languages_delete->Page_Terminate("languageslist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($languages->Language_Code->Visible) { // Language_Code ?>
		<th><span id="elh_languages_Language_Code" class="languages_Language_Code"><?php echo $languages->Language_Code->FldCaption() ?></span></th>
<?php } ?>
<?php if ($languages->Language_Name->Visible) { // Language_Name ?>
		<th><span id="elh_languages_Language_Name" class="languages_Language_Name"><?php echo $languages->Language_Name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($languages->_Default->Visible) { // Default ?>
		<th><span id="elh_languages__Default" class="languages__Default"><?php echo $languages->_Default->FldCaption() ?></span></th>
<?php } ?>
<?php if ($languages->Site_Logo->Visible) { // Site_Logo ?>
		<th><span id="elh_languages_Site_Logo" class="languages_Site_Logo"><?php echo $languages->Site_Logo->FldCaption() ?></span></th>
<?php } ?>
<?php if ($languages->Site_Title->Visible) { // Site_Title ?>
		<th><span id="elh_languages_Site_Title" class="languages_Site_Title"><?php echo $languages->Site_Title->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages_Language_Code" class="form-group languages_Language_Code">
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages_Language_Name" class="form-group languages_Language_Name">
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages__Default" class="form-group languages__Default">
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages_Site_Logo" class="form-group languages_Site_Logo">
...
<span id="el<?php echo $languages_delete->RowCnt ?>_languages_Site_Title" class="form-group languages_Site_Title">
