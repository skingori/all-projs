...
// Page object
var a_payment_transactions_delete = new ew_Page("a_payment_transactions_delete");
a_payment_transactions_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = a_payment_transactions_delete.PageID; // For backward compatibility

// Form object
var fa_payment_transactionsdelete = new ew_Form("fa_payment_transactionsdelete");
...
fa_payment_transactionsdelete.Lists["x_Customer"] = {"LinkField":"x_Customer_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_payment_transactionsdelete.Lists["x_Supplier"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Ref_ID" class="form-group a_payment_transactions_Ref_ID">
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Type" class="form-group a_payment_transactions_Type">
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Customer" class="form-group a_payment_transactions_Customer">
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Supplier" class="form-group a_payment_transactions_Supplier">
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Sub_Total" class="form-group a_payment_transactions_Sub_Total">
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Payment" class="form-group a_payment_transactions_Payment">
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Balance" class="form-group a_payment_transactions_Balance">
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Due_Date" class="form-group a_payment_transactions_Due_Date">
...
<span id="el<?php echo $a_payment_transactions_delete->RowCnt ?>_a_payment_transactions_Date_Transaction" class="form-group a_payment_transactions_Date_Transaction">
