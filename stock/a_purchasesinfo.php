...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Purchase_ID
		$this->Purchase_ID = new cField('a_purchases', 'a_purchases', 'x_Purchase_ID', 'Purchase_ID', '`Purchase_ID`', '`Purchase_ID`', 3, -1, FALSE, '`Purchase_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Purchase_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Purchase_ID'] = &$this->Purchase_ID;

		// Purchase_Number
		$this->Purchase_Number = new cField('a_purchases', 'a_purchases', 'x_Purchase_Number', 'Purchase_Number', '`Purchase_Number`', '`Purchase_Number`', 200, -1, FALSE, '`Purchase_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Purchase_Number'] = &$this->Purchase_Number;

		// Purchase_Date
		$this->Purchase_Date = new cField('a_purchases', 'a_purchases', 'x_Purchase_Date', 'Purchase_Date', '`Purchase_Date`', 'DATE_FORMAT(`Purchase_Date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Purchase_Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Supplier_ID
		$this->Supplier_ID = new cField('a_purchases', 'a_purchases', 'x_Supplier_ID', 'Supplier_ID', '`Supplier_ID`', '`Supplier_ID`', 200, -1, FALSE, '`Supplier_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Supplier_ID'] = &$this->Supplier_ID;

		// Notes
		$this->Notes = new cField('a_purchases', 'a_purchases', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 200, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Notes'] = &$this->Notes;

		// Total_Amount
		$this->Total_Amount = new cField('a_purchases', 'a_purchases', 'x_Total_Amount', 'Total_Amount', '`Total_Amount`', '`Total_Amount`', 5, -1, FALSE, '`Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Total_Payment
		$this->Total_Payment = new cField('a_purchases', 'a_purchases', 'x_Total_Payment', 'Total_Payment', '`Total_Payment`', '`Total_Payment`', 5, -1, FALSE, '`Total_Payment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Total_Balance
		$this->Total_Balance = new cField('a_purchases', 'a_purchases', 'x_Total_Balance', 'Total_Balance', '`Total_Balance`', '`Total_Balance`', 5, -1, FALSE, '`Total_Balance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Date_Added
		$this->Date_Added = new cField('a_purchases', 'a_purchases', 'x_Date_Added', 'Date_Added', '`Date_Added`', 'DATE_FORMAT(`Date_Added`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Added`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Added'] = &$this->Date_Added;

		// Added_By
		$this->Added_By = new cField('a_purchases', 'a_purchases', 'x_Added_By', 'Added_By', '`Added_By`', '`Added_By`', 200, -1, FALSE, '`Added_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Added_By'] = &$this->Added_By;

		// Date_Updated
		$this->Date_Updated = new cField('a_purchases', 'a_purchases', 'x_Date_Updated', 'Date_Updated', '`Date_Updated`', 'DATE_FORMAT(`Date_Updated`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Updated'] = &$this->Date_Updated;

		// Updated_By
		$this->Updated_By = new cField('a_purchases', 'a_purchases', 'x_Updated_By', 'Updated_By', '`Updated_By`', '`Updated_By`', 200, -1, FALSE, '`Updated_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		if ($this->getCurrentMasterTable() == "a_suppliers") {
			if ($this->Supplier_ID->getSessionValue() <> "")
				$sMasterFilter .= "`Supplier_Number`=" . ew_QuotedValue($this->Supplier_ID->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "a_suppliers") {
			if ($this->Supplier_ID->getSessionValue() <> "")
				$sDetailFilter .= "`Supplier_ID`=" . ew_QuotedValue($this->Supplier_ID->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "a_purchases_detail") {
			$sDetailUrl = $GLOBALS["a_purchases_detail"]->GetListUrl() . "?showmaster=" . $this->TableVar;
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_purchasesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_purchasesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "a_purchasesadd.php?" . $this->UrlParm($parm);
		else
			return "a_purchasesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_purchasesedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_purchasesedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_purchasesadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_purchasesadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
