...
// Page object
var a_purchases_detail_delete = new ew_Page("a_purchases_detail_delete");
a_purchases_detail_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = a_purchases_detail_delete.PageID; // For backward compatibility

// Form object
var fa_purchases_detaildelete = new ew_Form("fa_purchases_detaildelete");
...
fa_purchases_detaildelete.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_purchases_detaildelete.Lists["x_Stock_Item"] = {"LinkField":"x_Stock_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Stock_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($a_purchases_detail->Purchase_Number->Visible) { // Purchase_Number ?>
		<th><span id="elh_a_purchases_detail_Purchase_Number" class="a_purchases_detail_Purchase_Number"><?php echo $a_purchases_detail->Purchase_Number->FldCaption() ?></span></th>
<?php } ?>
...
<span id="el<?php echo $a_purchases_detail_delete->RowCnt ?>_a_purchases_detail_Purchase_Number" class="form-group a_purchases_detail_Purchase_Number">
...
<span id="el<?php echo $a_purchases_detail_delete->RowCnt ?>_a_purchases_detail_Supplier_Number" class="form-group a_purchases_detail_Supplier_Number">
...
<span id="el<?php echo $a_purchases_detail_delete->RowCnt ?>_a_purchases_detail_Stock_Item" class="form-group a_purchases_detail_Stock_Item">
...
<span id="el<?php echo $a_purchases_detail_delete->RowCnt ?>_a_purchases_detail_Purchasing_Quantity" class="form-group a_purchases_detail_Purchasing_Quantity">
...
<span id="el<?php echo $a_purchases_detail_delete->RowCnt ?>_a_purchases_detail_Purchasing_Price" class="form-group a_purchases_detail_Purchasing_Price">
...
<span id="el<?php echo $a_purchases_detail_delete->RowCnt ?>_a_purchases_detail_Selling_Price" class="form-group a_purchases_detail_Selling_Price">
...
<span id="el<?php echo $a_purchases_detail_delete->RowCnt ?>_a_purchases_detail_Purchasing_Total_Amount" class="form-group a_purchases_detail_Purchasing_Total_Amount">
