		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "languagesview.php")
...
// Page object
var languages_add = new ew_Page("languages_add");
languages_add.PageID = "add"; // Page ID
var EW_PAGE_ID = languages_add.PageID; // For backward compatibility

// Form object
var flanguagesadd = new ew_Form("flanguagesadd");
...
?>
<form name="flanguagesadd" id="flanguagesadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="text" data-field="x_Language_Code" name="x_Language_Code" id="x_Language_Code" size="30" maxlength="2" placeholder="<?php echo ew_HtmlEncode($languages->Language_Code->PlaceHolder) ?>" value="<?php echo $languages->Language_Code->EditValue ?>"<?php echo $languages->Language_Code->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Language_Name" name="x_Language_Name" id="x_Language_Name" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($languages->Language_Name->PlaceHolder) ?>" value="<?php echo $languages->Language_Name->EditValue ?>"<?php echo $languages->Language_Name->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($languages->_Default->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x__Default" name="x__Default[]" id="x__Default[]" value="1"<?php echo $selwrk ?><?php echo $languages->_Default->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Site_Logo" name="x_Site_Logo" id="x_Site_Logo" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($languages->Site_Logo->PlaceHolder) ?>" value="<?php echo $languages->Site_Logo->EditValue ?>"<?php echo $languages->Site_Logo->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Site_Title" name="x_Site_Title" id="x_Site_Title" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($languages->Site_Title->PlaceHolder) ?>" value="<?php echo $languages->Site_Title->EditValue ?>"<?php echo $languages->Site_Title->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Default_Decimal_Point" name="x_Default_Decimal_Point" id="x_Default_Decimal_Point" size="30" maxlength="5" placeholder="<?php echo ew_HtmlEncode($languages->Default_Decimal_Point->PlaceHolder) ?>" value="<?php echo $languages->Default_Decimal_Point->EditValue ?>"<?php echo $languages->Default_Decimal_Point->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Default_Money_Decimal_Point" name="x_Default_Money_Decimal_Point" id="x_Default_Money_Decimal_Point" size="30" maxlength="5" placeholder="<?php echo ew_HtmlEncode($languages->Default_Money_Decimal_Point->PlaceHolder) ?>" value="<?php echo $languages->Default_Money_Decimal_Point->EditValue ?>"<?php echo $languages->Default_Money_Decimal_Point->EditAttributes() ?>>
</span>
...
<textarea data-field="x_Announcement_Text" name="x_Announcement_Text" id="x_Announcement_Text" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($languages->Announcement_Text->PlaceHolder) ?>"<?php echo $languages->Announcement_Text->EditAttributes() ?>><?php echo $languages->Announcement_Text->EditValue ?></textarea>
</span>
...
<textarea data-field="x_About_Text" name="x_About_Text" id="x_About_Text" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($languages->About_Text->PlaceHolder) ?>"<?php echo $languages->About_Text->EditAttributes() ?>><?php echo $languages->About_Text->EditValue ?></textarea>
</span>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyAdd(this)'); function alertifyAdd(obj) { <?php global $Language; ?> if (flanguagesadd.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyAddConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyAdd'); ?>"); $("#flanguagesadd").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
