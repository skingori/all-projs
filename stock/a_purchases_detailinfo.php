...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Purchase_ID
		$this->Purchase_ID = new cField('a_purchases_detail', 'a_purchases_detail', 'x_Purchase_ID', 'Purchase_ID', '`Purchase_ID`', '`Purchase_ID`', 3, -1, FALSE, '`Purchase_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Purchase_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Purchase_ID'] = &$this->Purchase_ID;

		// Purchase_Number
		$this->Purchase_Number = new cField('a_purchases_detail', 'a_purchases_detail', 'x_Purchase_Number', 'Purchase_Number', '`Purchase_Number`', '`Purchase_Number`', 200, -1, FALSE, '`Purchase_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Purchase_Number'] = &$this->Purchase_Number;

		// Supplier_Number
		$this->Supplier_Number = new cField('a_purchases_detail', 'a_purchases_detail', 'x_Supplier_Number', 'Supplier_Number', '`Supplier_Number`', '`Supplier_Number`', 200, -1, FALSE, '`Supplier_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Supplier_Number'] = &$this->Supplier_Number;

		// Stock_Item
		$this->Stock_Item = new cField('a_purchases_detail', 'a_purchases_detail', 'x_Stock_Item', 'Stock_Item', '`Stock_Item`', '`Stock_Item`', 200, -1, FALSE, '`Stock_Item`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Stock_Item'] = &$this->Stock_Item;

		// Purchasing_Quantity
		$this->Purchasing_Quantity = new cField('a_purchases_detail', 'a_purchases_detail', 'x_Purchasing_Quantity', 'Purchasing_Quantity', '`Purchasing_Quantity`', '`Purchasing_Quantity`', 5, -1, FALSE, '`Purchasing_Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Purchasing_Quantity'] = &$this->Purchasing_Quantity;

		// Purchasing_Price
		$this->Purchasing_Price = new cField('a_purchases_detail', 'a_purchases_detail', 'x_Purchasing_Price', 'Purchasing_Price', '`Purchasing_Price`', '`Purchasing_Price`', 5, -1, FALSE, '`Purchasing_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Purchasing_Price'] = &$this->Purchasing_Price;

		// Selling_Price
		$this->Selling_Price = new cField('a_purchases_detail', 'a_purchases_detail', 'x_Selling_Price', 'Selling_Price', '`Selling_Price`', '`Selling_Price`', 5, -1, FALSE, '`Selling_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Selling_Price'] = &$this->Selling_Price;

		// Purchasing_Total_Amount
		$this->Purchasing_Total_Amount = new cField('a_purchases_detail', 'a_purchases_detail', 'x_Purchasing_Total_Amount', 'Purchasing_Total_Amount', '`Purchasing_Total_Amount`', '`Purchasing_Total_Amount`', 5, -1, FALSE, '`Purchasing_Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		if ($this->getCurrentMasterTable() == "a_purchases") {
			if ($this->Purchase_Number->getSessionValue() <> "")
				$sMasterFilter .= "`Purchase_Number`=" . ew_QuotedValue($this->Purchase_Number->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "a_purchases") {
			if ($this->Purchase_Number->getSessionValue() <> "")
				$sDetailFilter .= "`Purchase_Number`=" . ew_QuotedValue($this->Purchase_Number->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	// Update Table
	var $UpdateTable = "`a_purchases_detail`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_purchases_detailview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_purchases_detailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "a_purchases_detailadd.php?" . $this->UrlParm($parm);
		else
			return "a_purchases_detailadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("a_purchases_detailedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("a_purchases_detailadd.php", $this->UrlParm($parm));
	}
