...
$RootMenu->AddMenuItem(4, "mi_help_categories", $Language->MenuPhrase("4", "MenuText"), "help_categorieslist.php", -1, "", TRUE, FALSE);
$RootMenu->AddMenuItem(3, "mi_help", $Language->MenuPhrase("3", "MenuText"), "helplist.php?cmd=resetall", 4, "", TRUE, FALSE);
