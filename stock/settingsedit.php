...
// Page object
var settings_edit = new ew_Page("settings_edit");
settings_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = settings_edit.PageID; // For backward compatibility

// Form object
var fsettingsedit = new ew_Form("fsettingsedit");
...
<form name="fsettingsedit" id="fsettingsedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Option_ID" name="x_Option_ID" id="x_Option_ID" value="<?php echo ew_HtmlEncode($settings->Option_ID->CurrentValue) ?>">
...
<script type="text/javascript">
fsettingsedit.Lists["x_Default_Theme"].Options = <?php echo (is_array($settings->Default_Theme->EditValue)) ? ew_ArrayToJson($settings->Default_Theme->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fsettingsedit.Lists["x_Default_Language"].Options = <?php echo (is_array($settings->Default_Language->EditValue)) ? ew_ArrayToJson($settings->Default_Language->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fsettingsedit.Lists["x_Default_Timezone"].Options = <?php echo (is_array($settings->Default_Timezone->EditValue)) ? ew_ArrayToJson($settings->Default_Timezone->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fsettingsedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fsettingsedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
