...
// Page object
var view_sales_details_grid = new ew_Page("view_sales_details_grid");
view_sales_details_grid.PageID = "grid"; // Page ID
var EW_PAGE_ID = view_sales_details_grid.PageID; // For backward compatibility

// Form object
var fview_sales_detailsgrid = new ew_Form("fview_sales_detailsgrid");
...
fview_sales_detailsgrid.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fview_sales_detailsgrid.Lists["x_Stock_Item"] = {"LinkField":"x_Stock_Number","Ajax":null,"AutoFill":true,"DisplayFields":["x_Stock_Name","","",""],"ParentFields":["x_Supplier_Number"],"FilterFields":["x_Supplier_Number"],"Options":[]};
...
<input type="text" data-field="x_Sales_Number" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Number" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($view_sales_details->Sales_Number->PlaceHolder) ?>" value="<?php echo $view_sales_details->Sales_Number->EditValue ?>"<?php echo $view_sales_details->Sales_Number->EditAttributes() ?>>
</span>
<input type="hidden" data-field="x_Sales_Number" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Number" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Number" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Number->OldValue) ?>">
<?php } ?>
...
<input type="hidden" data-field="x_Sales_Number" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Number" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Number" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Number->FormValue) ?>">
<input type="hidden" data-field="x_Sales_Number" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Number" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Number" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Number->OldValue) ?>">
<?php } ?>
<a id="<?php echo $view_sales_details_grid->PageObjName . "_row_" . $view_sales_details_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($view_sales_details->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-field="x_Sales_ID" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_ID" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_ID" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_ID->CurrentValue) ?>">
<input type="hidden" data-field="x_Sales_ID" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_ID" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_ID" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_ID->OldValue) ?>">
<?php } ?>
...
<?php $view_sales_details->Supplier_Number->EditAttrs["onchange"] = "ew_UpdateOpt.call(this, ['x" . $view_sales_details_grid->RowIndex . "_Stock_Item']); " . @$view_sales_details->Supplier_Number->EditAttrs["onchange"]; ?>
<select data-field="x_Supplier_Number" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Supplier_Number" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Supplier_Number"<?php echo $view_sales_details->Supplier_Number->EditAttributes() ?>>
<?php
if (is_array($view_sales_details->Supplier_Number->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_sales_details->Supplier_Number->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fview_sales_detailsgrid.Lists["x_Supplier_Number"].Options = <?php echo (is_array($view_sales_details->Supplier_Number->EditValue)) ? ew_ArrayToJson($view_sales_details->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
<input type="hidden" data-field="x_Supplier_Number" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Supplier_Number" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($view_sales_details->Supplier_Number->OldValue) ?>">
<?php } ?>
<?php if ($view_sales_details->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $view_sales_details_grid->RowCnt ?>_view_sales_details_Supplier_Number" class="form-group view_sales_details_Supplier_Number">
<?php $view_sales_details->Supplier_Number->EditAttrs["onchange"] = "ew_UpdateOpt.call(this, ['x" . $view_sales_details_grid->RowIndex . "_Stock_Item']); " . @$view_sales_details->Supplier_Number->EditAttrs["onchange"]; ?>
...
<input type="hidden" data-field="x_Supplier_Number" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Supplier_Number" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($view_sales_details->Supplier_Number->FormValue) ?>">
<input type="hidden" data-field="x_Supplier_Number" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Supplier_Number" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($view_sales_details->Supplier_Number->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<select data-field="x_Stock_Item" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Stock_Item" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Stock_Item"<?php echo $view_sales_details->Stock_Item->EditAttributes() ?>>
<?php
if (is_array($view_sales_details->Stock_Item->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_sales_details->Stock_Item->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fview_sales_detailsgrid.Lists["x_Stock_Item"].Options = <?php echo (is_array($view_sales_details->Stock_Item->EditValue)) ? ew_ArrayToJson($view_sales_details->Stock_Item->EditValue, 1) : "[]" ?>;
</script>
...
<?php } ?>
<input type="hidden" data-field="x_Stock_Item" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Stock_Item" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Stock_Item" value="<?php echo ew_HtmlEncode($view_sales_details->Stock_Item->OldValue) ?>">
<?php } ?>
<?php if ($view_sales_details->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<?php if ($view_sales_details->Stock_Item->getSessionValue() <> "") { ?>
<span id="el<?php echo $view_sales_details_grid->RowCnt ?>_view_sales_details_Stock_Item" class="form-group view_sales_details_Stock_Item">
...
<input type="hidden" data-field="x_Stock_Item" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Stock_Item" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Stock_Item" value="<?php echo ew_HtmlEncode($view_sales_details->Stock_Item->FormValue) ?>">
<input type="hidden" data-field="x_Stock_Item" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Stock_Item" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Stock_Item" value="<?php echo ew_HtmlEncode($view_sales_details->Stock_Item->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-field="x_Sales_Quantity" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Quantity" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Quantity" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Quantity->OldValue) ?>">
<?php } ?>
<?php if ($view_sales_details->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $view_sales_details_grid->RowCnt ?>_view_sales_details_Sales_Quantity" class="form-group view_sales_details_Sales_Quantity">
<input type="text" data-field="x_Sales_Quantity" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Quantity" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Quantity" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_details->Sales_Quantity->PlaceHolder) ?>" value="<?php echo $view_sales_details->Sales_Quantity->EditValue ?>"<?php echo $view_sales_details->Sales_Quantity->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sales_Quantity" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Quantity" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Quantity" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Quantity->FormValue) ?>">
<input type="hidden" data-field="x_Sales_Quantity" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Quantity" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Quantity" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Quantity->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Purchasing_Price" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_details->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $view_sales_details->Purchasing_Price->EditValue ?>"<?php echo $view_sales_details->Purchasing_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Price" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($view_sales_details->Purchasing_Price->OldValue) ?>">
<?php } ?>
<?php if ($view_sales_details->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $view_sales_details_grid->RowCnt ?>_view_sales_details_Purchasing_Price" class="form-group view_sales_details_Purchasing_Price">
<input type="text" data-field="x_Purchasing_Price" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_details->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $view_sales_details->Purchasing_Price->EditValue ?>"<?php echo $view_sales_details->Purchasing_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Price" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($view_sales_details->Purchasing_Price->FormValue) ?>">
<input type="hidden" data-field="x_Purchasing_Price" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($view_sales_details->Purchasing_Price->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Sales_Price" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_details->Sales_Price->PlaceHolder) ?>" value="<?php echo $view_sales_details->Sales_Price->EditValue ?>"<?php echo $view_sales_details->Sales_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sales_Price" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Price->OldValue) ?>">
<?php } ?>
<?php if ($view_sales_details->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $view_sales_details_grid->RowCnt ?>_view_sales_details_Sales_Price" class="form-group view_sales_details_Sales_Price">
<input type="text" data-field="x_Sales_Price" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_details->Sales_Price->PlaceHolder) ?>" value="<?php echo $view_sales_details->Sales_Price->EditValue ?>"<?php echo $view_sales_details->Sales_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sales_Price" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Price->FormValue) ?>">
<input type="hidden" data-field="x_Sales_Price" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Price" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Price->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Sales_Total_Amount" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_details->Sales_Total_Amount->PlaceHolder) ?>" value="<?php echo $view_sales_details->Sales_Total_Amount->EditValue ?>"<?php echo $view_sales_details->Sales_Total_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sales_Total_Amount" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Total_Amount->OldValue) ?>">
<?php } ?>
<?php if ($view_sales_details->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $view_sales_details_grid->RowCnt ?>_view_sales_details_Sales_Total_Amount" class="form-group view_sales_details_Sales_Total_Amount">
<input type="text" data-field="x_Sales_Total_Amount" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_details->Sales_Total_Amount->PlaceHolder) ?>" value="<?php echo $view_sales_details->Sales_Total_Amount->EditValue ?>"<?php echo $view_sales_details->Sales_Total_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Sales_Total_Amount" name="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" id="x<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Total_Amount->FormValue) ?>">
<input type="hidden" data-field="x_Sales_Total_Amount" name="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" id="o<?php echo $view_sales_details_grid->RowIndex ?>_Sales_Total_Amount" value="<?php echo ew_HtmlEncode($view_sales_details->Sales_Total_Amount->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
