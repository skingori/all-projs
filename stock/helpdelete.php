...
// Page object
var help_delete = new ew_Page("help_delete");
help_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = help_delete.PageID; // For backward compatibility

// Form object
var fhelpdelete = new ew_Form("fhelpdelete");
...
fhelpdelete.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el<?php echo $help_delete->RowCnt ?>_help_Topic" class="form-group help_Topic">
...
<span id="el<?php echo $help_delete->RowCnt ?>_help_Description" class="form-group help_Description">
...
<span id="el<?php echo $help_delete->RowCnt ?>_help_Category" class="form-group help_Category">
...
<?php if ($help->Export == "") { ?>
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fhelpdelete.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fhelpdelete").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
