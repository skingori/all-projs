...
//
// Table class for stats_year
//
class cstats_year extends cTable {
	var $Year;
	var $Hits;
	...
	function __construct() {
		...
		$this->TableVar = 'stats_year';
		$this->TableName = 'stats_year';
...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Year
		$this->Year = new cField('stats_year', 'stats_year', 'x_Year', 'Year', '`Year`', '`Year`', 2, -1, FALSE, '`Year`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Year->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Year'] = &$this->Year;

		// Hits
		$this->Hits = new cField('stats_year', 'stats_year', 'x_Hits', 'Hits', '`Hits`', '`Hits`', 20, -1, FALSE, '`Hits`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`stats_year`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("stats_yearview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("stats_yearview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "stats_yearadd.php?" . $this->UrlParm($parm);
		else
			return "stats_yearadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("stats_yearedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("stats_yearadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("stats_yeardelete.php", $this->UrlParm());
	}
