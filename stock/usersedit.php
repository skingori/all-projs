...
fusersedit.Lists["x_User_Level"] = {"LinkField":"x_User_Level_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_User_Level_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusersedit.Lists["x_Theme"] = {"LinkField":"x_Theme_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Theme_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusersedit.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<input type="hidden" data-field="x_Username" name="x_Username" id="x_Username" value="<?php echo ew_HtmlEncode($users->Username->CurrentValue) ?>">
...
<input type="password" data-field="x_Password" name="x_Password" id="x_Password" value="<?php echo $users->Password->EditValue ?>" size="30" maxlength="64" placeholder="<?php echo ew_HtmlEncode($users->Password->PlaceHolder) ?>"<?php echo $users->Password->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
fusersedit.Lists["x_User_Level"].Options = <?php echo (is_array($users->User_Level->EditValue)) ? ew_ArrayToJson($users->User_Level->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
<script type="text/javascript">
fusersedit.Lists["x_Theme"].Options = <?php echo (is_array($users->Theme->EditValue)) ? ew_ArrayToJson($users->Theme->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fusersedit.Lists["x__Language"].Options = <?php echo (is_array($users->_Language->EditValue)) ? ew_ArrayToJson($users->_Language->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if ($users->Export == "") { ?>
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fusersedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fusersedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
