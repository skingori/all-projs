...
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
	<?php if (MS_PAGINATION_STYLE==1) { // link ?>
		<?php if (!isset($userlevels_view->Pager)) $userlevels_view->Pager = new cNumericPager($userlevels_view->StartRec, $userlevels_view->DisplayRecs, $userlevels_view->TotalRecs, $userlevels_view->RecRange) ?>
		<?php if ($userlevels_view->Pager->RecordCount > 0) { ?>
				<?php if (($userlevels_view->Pager->PageCount==1) && ($userlevels_view->Pager->CurrentPage == 1) && (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE)  ) { ?>
				<div class="ewPager ewRec">
					<span><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $userlevels_view->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $userlevels_view->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $userlevels_view->Pager->RecordCount ?></span>
				</div>
				...
				<div class="ewNumericPage"><ul class="pagination">
					...
					<li><a href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
					<?php if ($userlevels_view->Pager->PrevButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
					<?php } else { // else of rtl { ?>
					<li><a href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
					<?php } // end of rtl { ?>
					<?php } ?>
					<?php foreach ($userlevels_view->Pager->Items as $PagerItem) { ?>
						<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $userlevels_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
					<?php } ?>
					<?php if ($userlevels_view->Pager->NextButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
					<?php if ($userlevels_view->Pager->LastButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
				</ul></div>
				</div>
	...
	<?php } elseif (MS_PAGINATION_STYLE==2) { // button ?>
		<?php if (!isset($userlevels_view->Pager)) $userlevels_view->Pager = new cPrevNextPager($userlevels_view->StartRec, $userlevels_view->DisplayRecs, $userlevels_view->TotalRecs) ?>
		<?php if ($userlevels_view->Pager->RecordCount > 0) { ?>
				<?php if (($userlevels_view->Pager->PageCount==1) && ($userlevels_view->Pager->CurrentPage == 1) && (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE)  ) { ?>
						<div class="ewPager ewRec">
							<span><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $userlevels_view->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $userlevels_view->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $userlevels_view->Pager->RecordCount ?></span>
				...
				<!--first page button-->
					<?php if ($userlevels_view->Pager->FirstButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->FirstButton->Start ?>"><span class="icon-last ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--previous page button-->
					<?php if ($userlevels_view->Pager->PrevButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->PrevButton->Start ?>"><span class="icon-next ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--current page number-->
					<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $userlevels_view->Pager->CurrentPage ?>">
				<div class="input-group-btn">
				<!--next page button-->
					<?php if ($userlevels_view->Pager->NextButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->NextButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--last page button-->
					<?php if ($userlevels_view->Pager->LastButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->LastButton->Start ?>"><span class="icon-first ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $userlevels_view->Pager->PageCount ?></span>
				</div>
...
<?php if ($userlevels->User_Level_ID->Visible) { // User_Level_ID ?>
	<tr id="r_User_Level_ID">
		<td><span id="elh_userlevels_User_Level_ID"><?php echo $userlevels->User_Level_ID->FldCaption() ?></span></td>
		<td<?php echo $userlevels->User_Level_ID->CellAttributes() ?>>
<span id="el_userlevels_User_Level_ID" class="form-group">
<span<?php echo $userlevels->User_Level_ID->ViewAttributes() ?>>
<?php echo $userlevels->User_Level_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($userlevels->User_Level_Name->Visible) { // User_Level_Name ?>
	<tr id="r_User_Level_Name">
		<td><span id="elh_userlevels_User_Level_Name"><?php echo $userlevels->User_Level_Name->FldCaption() ?></span></td>
		<td<?php echo $userlevels->User_Level_Name->CellAttributes() ?>>
<span id="el_userlevels_User_Level_Name" class="form-group">
<span<?php echo $userlevels->User_Level_Name->ViewAttributes() ?>>
<?php echo $userlevels->User_Level_Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
