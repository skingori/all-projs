...
// Page object
var settings_delete = new ew_Page("settings_delete");
settings_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = settings_delete.PageID; // For backward compatibility

// Form object
var fsettingsdelete = new ew_Form("fsettingsdelete");
...
fsettingsdelete.Lists["x_Default_Theme"] = {"LinkField":"x_Theme_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Theme_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_Option_ID" class="form-group settings_Option_ID">
...
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_Option_Default" class="form-group settings_Option_Default">
...
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_Default_Theme" class="form-group settings_Default_Theme">
...
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_Show_Border_Layout" class="form-group settings_Show_Border_Layout">
...
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_Show_Shadow_Layout" class="form-group settings_Show_Shadow_Layout">
...
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_Menu_Horizontal" class="form-group settings_Menu_Horizontal">
...
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_Show_Announcement" class="form-group settings_Show_Announcement">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fsettingsdelete.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fsettingsdelete").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
