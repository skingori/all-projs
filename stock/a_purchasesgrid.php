...
// Page object
var a_purchases_grid = new ew_Page("a_purchases_grid");
a_purchases_grid.PageID = "grid"; // Page ID
var EW_PAGE_ID = a_purchases_grid.PageID; // For backward compatibility

// Form object
var fa_purchasesgrid = new ew_Form("fa_purchasesgrid");
...
fa_purchasesgrid.Lists["x_Supplier_ID"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<input type="text" data-field="x_Purchase_Number" name="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Number" id="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_purchases->Purchase_Number->PlaceHolder) ?>" value="<?php echo $a_purchases->Purchase_Number->EditValue ?>"<?php echo $a_purchases->Purchase_Number->EditAttributes() ?>>
</span>
<input type="hidden" data-field="x_Purchase_Number" name="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Number" id="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Number" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_Number->OldValue) ?>">
<?php } ?>
...
<input type="hidden" data-field="x_Purchase_Number" name="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Number" id="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Number" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_Number->FormValue) ?>">
<input type="hidden" data-field="x_Purchase_Number" name="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Number" id="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Number" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_Number->OldValue) ?>">
<?php } ?>
<a id="<?php echo $a_purchases_grid->PageObjName . "_row_" . $a_purchases_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($a_purchases->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-field="x_Purchase_ID" name="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_ID" id="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_ID" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_ID->CurrentValue) ?>">
<input type="hidden" data-field="x_Purchase_ID" name="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_ID" id="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_ID" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_ID->OldValue) ?>">
<?php } ?>
...
<input type="text" data-field="x_Purchase_Date" name="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" id="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" placeholder="<?php echo ew_HtmlEncode($a_purchases->Purchase_Date->PlaceHolder) ?>" value="<?php echo $a_purchases->Purchase_Date->EditValue ?>"<?php echo $a_purchases->Purchase_Date->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchase_Date" name="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" id="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_Date->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_grid->RowCnt ?>_a_purchases_Purchase_Date" class="form-group a_purchases_Purchase_Date">
<input type="text" data-field="x_Purchase_Date" name="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" id="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" placeholder="<?php echo ew_HtmlEncode($a_purchases->Purchase_Date->PlaceHolder) ?>" value="<?php echo $a_purchases->Purchase_Date->EditValue ?>"<?php echo $a_purchases->Purchase_Date->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchase_Date" name="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" id="x<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_Date->FormValue) ?>">
<input type="hidden" data-field="x_Purchase_Date" name="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" id="o<?php echo $a_purchases_grid->RowIndex ?>_Purchase_Date" value="<?php echo ew_HtmlEncode($a_purchases->Purchase_Date->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php } else { ?>
<span id="el<?php echo $a_purchases_grid->RowCnt ?>_a_purchases_Supplier_ID" class="form-group a_purchases_Supplier_ID">
<select data-field="x_Supplier_ID" id="x<?php echo $a_purchases_grid->RowIndex ?>_Supplier_ID" name="x<?php echo $a_purchases_grid->RowIndex ?>_Supplier_ID"<?php echo $a_purchases->Supplier_ID->EditAttributes() ?>>
<?php
if (is_array($a_purchases->Supplier_ID->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_purchases->Supplier_ID->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fa_purchasesgrid.Lists["x_Supplier_ID"].Options = <?php echo (is_array($a_purchases->Supplier_ID->EditValue)) ? ew_ArrayToJson($a_purchases->Supplier_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
<input type="hidden" data-field="x_Supplier_ID" name="o<?php echo $a_purchases_grid->RowIndex ?>_Supplier_ID" id="o<?php echo $a_purchases_grid->RowIndex ?>_Supplier_ID" value="<?php echo ew_HtmlEncode($a_purchases->Supplier_ID->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<?php if ($a_purchases->Supplier_ID->getSessionValue() <> "") { ?>
<span id="el<?php echo $a_purchases_grid->RowCnt ?>_a_purchases_Supplier_ID" class="form-group a_purchases_Supplier_ID">
...
<input type="hidden" data-field="x_Supplier_ID" name="x<?php echo $a_purchases_grid->RowIndex ?>_Supplier_ID" id="x<?php echo $a_purchases_grid->RowIndex ?>_Supplier_ID" value="<?php echo ew_HtmlEncode($a_purchases->Supplier_ID->FormValue) ?>">
<input type="hidden" data-field="x_Supplier_ID" name="o<?php echo $a_purchases_grid->RowIndex ?>_Supplier_ID" id="o<?php echo $a_purchases_grid->RowIndex ?>_Supplier_ID" value="<?php echo ew_HtmlEncode($a_purchases->Supplier_ID->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-field="x_Total_Amount" name="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Amount" id="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Amount" value="<?php echo ew_HtmlEncode($a_purchases->Total_Amount->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_grid->RowCnt ?>_a_purchases_Total_Amount" class="form-group a_purchases_Total_Amount">
<input type="text" data-field="x_Total_Amount" name="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Amount" id="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases->Total_Amount->PlaceHolder) ?>" value="<?php echo $a_purchases->Total_Amount->EditValue ?>"<?php echo $a_purchases->Total_Amount->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Total_Amount" name="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Amount" id="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Amount" value="<?php echo ew_HtmlEncode($a_purchases->Total_Amount->FormValue) ?>">
<input type="hidden" data-field="x_Total_Amount" name="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Amount" id="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Amount" value="<?php echo ew_HtmlEncode($a_purchases->Total_Amount->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Total_Payment" name="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" id="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases->Total_Payment->PlaceHolder) ?>" value="<?php echo $a_purchases->Total_Payment->EditValue ?>"<?php echo $a_purchases->Total_Payment->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Total_Payment" name="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" id="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" value="<?php echo ew_HtmlEncode($a_purchases->Total_Payment->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_grid->RowCnt ?>_a_purchases_Total_Payment" class="form-group a_purchases_Total_Payment">
<input type="text" data-field="x_Total_Payment" name="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" id="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases->Total_Payment->PlaceHolder) ?>" value="<?php echo $a_purchases->Total_Payment->EditValue ?>"<?php echo $a_purchases->Total_Payment->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Total_Payment" name="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" id="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" value="<?php echo ew_HtmlEncode($a_purchases->Total_Payment->FormValue) ?>">
<input type="hidden" data-field="x_Total_Payment" name="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" id="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Payment" value="<?php echo ew_HtmlEncode($a_purchases->Total_Payment->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Total_Balance" name="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" id="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases->Total_Balance->PlaceHolder) ?>" value="<?php echo $a_purchases->Total_Balance->EditValue ?>"<?php echo $a_purchases->Total_Balance->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Total_Balance" name="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" id="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" value="<?php echo ew_HtmlEncode($a_purchases->Total_Balance->OldValue) ?>">
<?php } ?>
<?php if ($a_purchases->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_purchases_grid->RowCnt ?>_a_purchases_Total_Balance" class="form-group a_purchases_Total_Balance">
<input type="text" data-field="x_Total_Balance" name="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" id="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases->Total_Balance->PlaceHolder) ?>" value="<?php echo $a_purchases->Total_Balance->EditValue ?>"<?php echo $a_purchases->Total_Balance->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Total_Balance" name="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" id="x<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" value="<?php echo ew_HtmlEncode($a_purchases->Total_Balance->FormValue) ?>">
<input type="hidden" data-field="x_Total_Balance" name="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" id="o<?php echo $a_purchases_grid->RowIndex ?>_Total_Balance" value="<?php echo ew_HtmlEncode($a_purchases->Total_Balance->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
