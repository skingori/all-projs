...
// Page object
var help_view = new ew_Page("help_view");
help_view.PageID = "view"; // Page ID
var EW_PAGE_ID = help_view.PageID; // For backward compatibility

// Form object
var fhelpview = new ew_Form("fhelpview");
...
fhelpview.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fhelpview.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fhelpview.Lists["x_Updated_By"] = {"LinkField":"x_Username","Ajax":null,"AutoFill":false,"DisplayFields":["x_First_Name","x_Last_Name","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($help->Help_ID->Visible) { // Help_ID ?>
	<tr id="r_Help_ID">
		...
		<td<?php echo $help->Help_ID->CellAttributes() ?>>
<span id="el_help_Help_ID" class="form-group">
...
<?php if ($help->_Language->Visible) { // Language ?>
	<tr id="r__Language">
		...
		<td<?php echo $help->_Language->CellAttributes() ?>>
<span id="el_help__Language" class="form-group">
...
<span id="el_help_Topic" class="form-group">
...
<span id="el_help_Description" class="form-group">
...
<span id="el_help_Category" class="form-group">
...
<?php if ($help->Order->Visible) { // Order ?>
	<tr id="r_Order">
		...
		<td<?php echo $help->Order->CellAttributes() ?>>
<span id="el_help_Order" class="form-group">
...
<?php if ($help->Display_in_Page->Visible) { // Display_in_Page ?>
	<tr id="r_Display_in_Page">
		...
		<td<?php echo $help->Display_in_Page->CellAttributes() ?>>
<span id="el_help_Display_in_Page" class="form-group">
...
<?php if ($help->Updated_By->Visible) { // Updated_By ?>
	<tr id="r_Updated_By">
		...
		<td<?php echo $help->Updated_By->CellAttributes() ?>>
<span id="el_help_Updated_By" class="form-group">
...
<?php if ($help->Last_Updated->Visible) { // Last_Updated ?>
	<tr id="r_Last_Updated">
		...
		<td<?php echo $help->Last_Updated->CellAttributes() ?>>
<span id="el_help_Last_Updated" class="form-group">
