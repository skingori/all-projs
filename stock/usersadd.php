...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function LoadDefaultValues() {
		...
		$this->Locked->CurrentValue = "N";
		$this->Profile->CurrentValue = NULL;
		$this->Profile->OldValue = $this->Profile->CurrentValue;
		$this->Current_URL->CurrentValue = NULL;
		$this->Current_URL->OldValue = $this->Current_URL->CurrentValue;
		$this->Theme->CurrentValue = "theme-default.css";
		$this->Menu_Horizontal->CurrentValue = "Y";
		$this->Table_Width_Style->CurrentValue = "2";
		$this->Scroll_Table_Width->CurrentValue = 1100;
		$this->Scroll_Table_Height->CurrentValue = 300;
		$this->Rows_Vertical_Align_Top->CurrentValue = "Y";
		$this->_Language->CurrentValue = "en";
		$this->Redirect_To_Last_Visited_Page_After_Login->CurrentValue = "N";
		$this->Font_Name->CurrentValue = "arial";
		$this->Font_Size->CurrentValue = "13px";
	}
	...
	function AddRow($rsold = NULL) {
		...
		// Current_URL
		$this->Current_URL->SetDbValueDef($rsnew, $this->Current_URL->CurrentValue, NULL, FALSE);

		// Theme
		$this->Theme->SetDbValueDef($rsnew, $this->Theme->CurrentValue, NULL, strval($this->Theme->CurrentValue) == "");
		...
		// Language
		$this->_Language->SetDbValueDef($rsnew, $this->_Language->CurrentValue, NULL, strval($this->_Language->CurrentValue) == "");
...
fusersadd.Lists["x_User_Level"] = {"LinkField":"x_User_Level_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_User_Level_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusersadd.Lists["x_Theme"] = {"LinkField":"x_Theme_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Theme_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fusersadd.Lists["x__Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<input type="text" data-field="x_Username" name="x_Username" id="x_Username" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($users->Username->PlaceHolder) ?>" value="<?php echo $users->Username->EditValue ?>"<?php echo $users->Username->EditAttributes() ?>>
</span>
...
<input type="password" data-field="x_Password" name="x_Password" id="x_Password" size="30" maxlength="64" placeholder="<?php echo ew_HtmlEncode($users->Password->PlaceHolder) ?>"<?php echo $users->Password->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_First_Name" name="x_First_Name" id="x_First_Name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($users->First_Name->PlaceHolder) ?>" value="<?php echo $users->First_Name->EditValue ?>"<?php echo $users->First_Name->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Last_Name" name="x_Last_Name" id="x_Last_Name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($users->Last_Name->PlaceHolder) ?>" value="<?php echo $users->Last_Name->EditValue ?>"<?php echo $users->Last_Name->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
fusersadd.Lists["x_User_Level"].Options = <?php echo (is_array($users->User_Level->EditValue)) ? ew_ArrayToJson($users->User_Level->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
<input type="text" data-field="x_Report_To" name="x_Report_To" id="x_Report_To" size="30" placeholder="<?php echo ew_HtmlEncode($users->Report_To->PlaceHolder) ?>" value="<?php echo $users->Report_To->EditValue ?>"<?php echo $users->Report_To->EditAttributes() ?>>
</span>
...
<select data-field="x_Activated" id="x_Activated" name="x_Activated"<?php echo $users->Activated->EditAttributes() ?>>
<?php
if (is_array($users->Activated->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->Activated->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<?php
$selwrk = (ew_ConvertToBool($users->Locked->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Locked" name="x_Locked[]" id="x_Locked[]" value="1"<?php echo $selwrk ?><?php echo $users->Locked->EditAttributes() ?>>
</span>
...
<textarea data-field="x_Profile" name="x_Profile" id="x_Profile" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($users->Profile->PlaceHolder) ?>"<?php echo $users->Profile->EditAttributes() ?>><?php echo $users->Profile->EditValue ?></textarea>
</span>
...
<textarea data-field="x_Current_URL" name="x_Current_URL" id="x_Current_URL" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($users->Current_URL->PlaceHolder) ?>"<?php echo $users->Current_URL->EditAttributes() ?>><?php echo $users->Current_URL->EditValue ?></textarea>
</span>
...
<select data-field="x_Theme" id="x_Theme" name="x_Theme"<?php echo $users->Theme->EditAttributes() ?>>
<?php
if (is_array($users->Theme->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->Theme->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fusersadd.Lists["x_Theme"].Options = <?php echo (is_array($users->Theme->EditValue)) ? ew_ArrayToJson($users->Theme->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($users->Menu_Horizontal->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Menu_Horizontal" name="x_Menu_Horizontal[]" id="x_Menu_Horizontal[]" value="1"<?php echo $selwrk ?><?php echo $users->Menu_Horizontal->EditAttributes() ?>>
</span>
...
<div id="tp_x_Table_Width_Style" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Table_Width_Style" id="x_Table_Width_Style" value="{value}"<?php echo $users->Table_Width_Style->EditAttributes() ?>></div>
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->Table_Width_Style->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Table_Width_Style" name="x_Table_Width_Style" id="x_Table_Width_Style_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $users->Table_Width_Style->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
...
<input type="text" data-field="x_Scroll_Table_Width" name="x_Scroll_Table_Width" id="x_Scroll_Table_Width" size="30" placeholder="<?php echo ew_HtmlEncode($users->Scroll_Table_Width->PlaceHolder) ?>" value="<?php echo $users->Scroll_Table_Width->EditValue ?>"<?php echo $users->Scroll_Table_Width->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Scroll_Table_Height" name="x_Scroll_Table_Height" id="x_Scroll_Table_Height" size="30" placeholder="<?php echo ew_HtmlEncode($users->Scroll_Table_Height->PlaceHolder) ?>" value="<?php echo $users->Scroll_Table_Height->EditValue ?>"<?php echo $users->Scroll_Table_Height->EditAttributes() ?>>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($users->Rows_Vertical_Align_Top->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Rows_Vertical_Align_Top" name="x_Rows_Vertical_Align_Top[]" id="x_Rows_Vertical_Align_Top[]" value="1"<?php echo $selwrk ?><?php echo $users->Rows_Vertical_Align_Top->EditAttributes() ?>>
</span>
...
<select data-field="x__Language" id="x__Language" name="x__Language"<?php echo $users->_Language->EditAttributes() ?>>
<?php
if (is_array($users->_Language->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->_Language->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fusersadd.Lists["x__Language"].Options = <?php echo (is_array($users->_Language->EditValue)) ? ew_ArrayToJson($users->_Language->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php
$selwrk = (ew_ConvertToBool($users->Redirect_To_Last_Visited_Page_After_Login->CurrentValue)) ? " checked=\"checked\"" : "";
?>
<input type="checkbox" data-field="x_Redirect_To_Last_Visited_Page_After_Login" name="x_Redirect_To_Last_Visited_Page_After_Login[]" id="x_Redirect_To_Last_Visited_Page_After_Login[]" value="1"<?php echo $selwrk ?><?php echo $users->Redirect_To_Last_Visited_Page_After_Login->EditAttributes() ?>>
</span>
...
<select data-field="x_Font_Name" id="x_Font_Name" name="x_Font_Name"<?php echo $users->Font_Name->EditAttributes() ?>>
<?php
if (is_array($users->Font_Name->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->Font_Name->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<select data-field="x_Font_Size" id="x_Font_Size" name="x_Font_Size"<?php echo $users->Font_Size->EditAttributes() ?>>
<?php
if (is_array($users->Font_Size->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->Font_Size->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
$(document).ready(function(){$("#fusersadd:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btnAction").click()})});
</script>
<?php } ?>
<?php if ($users->Export == "") { ?>
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyAdd(this)'); function alertifyAdd(obj) { <?php global $Language; ?> if (fusersadd.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyAddConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyAdd'); ?>"); $("#fusersadd").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
