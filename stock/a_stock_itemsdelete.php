...
// Page object
var a_stock_items_delete = new ew_Page("a_stock_items_delete");
a_stock_items_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = a_stock_items_delete.PageID; // For backward compatibility

// Form object
var fa_stock_itemsdelete = new ew_Form("fa_stock_itemsdelete");
...
fa_stock_itemsdelete.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el<?php echo $a_stock_items_delete->RowCnt ?>_a_stock_items_Supplier_Number" class="form-group a_stock_items_Supplier_Number">
...
<span id="el<?php echo $a_stock_items_delete->RowCnt ?>_a_stock_items_Stock_Number" class="form-group a_stock_items_Stock_Number">
...
<span id="el<?php echo $a_stock_items_delete->RowCnt ?>_a_stock_items_Stock_Name" class="form-group a_stock_items_Stock_Name">
...
<span id="el<?php echo $a_stock_items_delete->RowCnt ?>_a_stock_items_Purchasing_Price" class="form-group a_stock_items_Purchasing_Price">
...
<span id="el<?php echo $a_stock_items_delete->RowCnt ?>_a_stock_items_Selling_Price" class="form-group a_stock_items_Selling_Price">
...
<span id="el<?php echo $a_stock_items_delete->RowCnt ?>_a_stock_items_Quantity" class="form-group a_stock_items_Quantity">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fa_stock_itemsdelete.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fa_stock_itemsdelete").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
