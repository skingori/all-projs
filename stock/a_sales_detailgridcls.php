...
$a_sales_detail_grid = NULL; // Initialize page object first

class ca_sales_detail_grid extends ca_sales_detail {
	...
	// Page object name
	var $PageObjName = 'a_sales_detail_grid';

	// Grid form hidden field names
	var $FormName = 'fa_sales_detailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["a_sales_detail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "a_sales") {
			$this->Sales_Number->Visible = FALSE;
			if ($GLOBALS["a_sales"]->EventCancelled) $this->EventCancelled = TRUE;
		}
