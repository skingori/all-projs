...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->Lookup_Selecting($this->Customer_ID, $sWhereWrk);
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$this->Customer_ID->ViewValue = $rswrk->fields('DispFld');
					$rswrk->Close();
				} else {
			...
			if (strval($this->Discount_Type->CurrentValue) <> "") {
				switch ($this->Discount_Type->CurrentValue) {
					case $this->Discount_Type->FldTagValue(1):
						$this->Discount_Type->ViewValue = $this->Discount_Type->FldTagCaption(1) <> "" ? $this->Discount_Type->FldTagCaption(1) : $this->Discount_Type->CurrentValue;
						break;
					case $this->Discount_Type->FldTagValue(2):
						$this->Discount_Type->ViewValue = $this->Discount_Type->FldTagCaption(2) <> "" ? $this->Discount_Type->FldTagCaption(2) : $this->Discount_Type->CurrentValue;
						break;
					default:
						$this->Discount_Type->ViewValue = $this->Discount_Type->CurrentValue;
				}
			} else {
			...
			$arwrk = array();
			$arwrk[] = array($this->Discount_Type->FldTagValue(1), $this->Discount_Type->FldTagCaption(1) <> "" ? $this->Discount_Type->FldTagCaption(1) : $this->Discount_Type->FldTagValue(1));
			$arwrk[] = array($this->Discount_Type->FldTagValue(2), $this->Discount_Type->FldTagCaption(2) <> "" ? $this->Discount_Type->FldTagCaption(2) : $this->Discount_Type->FldTagValue(2));
			$this->Discount_Type->EditValue = $arwrk;
			$this->Discount_Type->EditCustomAttributes = "";
			$arwrk = array();
			$arwrk[] = array($this->Discount_Type->FldTagValue(1), $this->Discount_Type->FldTagCaption(1) <> "" ? $this->Discount_Type->FldTagCaption(1) : $this->Discount_Type->FldTagValue(1));
			$arwrk[] = array($this->Discount_Type->FldTagValue(2), $this->Discount_Type->FldTagCaption(2) <> "" ? $this->Discount_Type->FldTagCaption(2) : $this->Discount_Type->FldTagValue(2));
			$this->Discount_Type->EditValue2 = $arwrk;
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "a_saleslist.php", "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Page object
var a_sales_search = new ew_Page("a_sales_search");
a_sales_search.PageID = "search"; // Page ID
var EW_PAGE_ID = a_sales_search.PageID; // For backward compatibility

// Form object
var fa_salessearch = new ew_Form("fa_salessearch");
...
fa_salessearch.Lists["x_Customer_ID"] = {"LinkField":"x_Customer_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fa_salessearch" id="fa_salessearch" class="form-horizontal ewForm ewSearchForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($a_sales->Sales_ID->Visible) { // Sales_ID ?>
	<div id="r_Sales_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Sales_ID" id="z_Sales_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Sales_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Sales_ID">
<input type="text" data-field="x_Sales_ID" name="x_Sales_ID" id="x_Sales_ID" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_ID->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_ID->EditValue ?>"<?php echo $a_sales->Sales_ID->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Sales_ID" name="y_Sales_ID" id="y_Sales_ID" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_ID->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_ID->EditValue2 ?>"<?php echo $a_sales->Sales_ID->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_sales->Sales_Number->Visible) { // Sales_Number ?>
	<div id="r_Sales_Number" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Sales_Number" id="z_Sales_Number" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($a_sales->Sales_Number->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Sales_Number">
<input type="text" data-field="x_Sales_Number" name="x_Sales_Number" id="x_Sales_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_Number->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_Number->EditValue ?>"<?php echo $a_sales->Sales_Number->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Sales_Number" name="y_Sales_Number" id="y_Sales_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_Number->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_Number->EditValue2 ?>"<?php echo $a_sales->Sales_Number->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_sales->Sales_Date->Visible) { // Sales_Date ?>
	<div id="r_Sales_Date" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Sales_Date" id="z_Sales_Date" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Sales_Date->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Sales_Date->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Sales_Date->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Sales_Date->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Sales_Date->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Sales_Date->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($a_sales->Sales_Date->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Sales_Date">
<input type="text" data-field="x_Sales_Date" name="x_Sales_Date" id="x_Sales_Date" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_Date->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_Date->EditValue ?>"<?php echo $a_sales->Sales_Date->EditAttributes() ?>>
<?php if (!$a_sales->Sales_Date->ReadOnly && !$a_sales->Sales_Date->Disabled && @$a_sales->Sales_Date->EditAttrs["readonly"] == "" && @$a_sales->Sales_Date->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Sales_Date" name="y_Sales_Date" id="y_Sales_Date" placeholder="<?php echo ew_HtmlEncode($a_sales->Sales_Date->PlaceHolder) ?>" value="<?php echo $a_sales->Sales_Date->EditValue2 ?>"<?php echo $a_sales->Sales_Date->EditAttributes() ?>>
<?php if (!$a_sales->Sales_Date->ReadOnly && !$a_sales->Sales_Date->Disabled && @$a_sales->Sales_Date->EditAttrs["readonly"] == "" && @$a_sales->Sales_Date->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_sales->Customer_ID->Visible) { // Customer_ID ?>
	<div id="r_Customer_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Customer_ID" id="z_Customer_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($a_sales->Customer_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Customer_ID">
<select data-field="x_Customer_ID" id="x_Customer_ID" name="x_Customer_ID"<?php echo $a_sales->Customer_ID->EditAttributes() ?>>
<?php
if (is_array($a_sales->Customer_ID->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_sales->Customer_ID->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fa_salessearch.Lists["x_Customer_ID"].Options = <?php echo (is_array($a_sales->Customer_ID->EditValue)) ? ew_ArrayToJson($a_sales->Customer_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Customer_ID" id="y_Customer_ID" name="y_Customer_ID"<?php echo $a_sales->Customer_ID->EditAttributes() ?>>
<?php
if (is_array($a_sales->Customer_ID->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_sales->Customer_ID->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_salessearch.Lists["x_Customer_ID"].Options = <?php echo (is_array($a_sales->Customer_ID->EditValue2)) ? ew_ArrayToJson($a_sales->Customer_ID->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($a_sales->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Notes" id="z_Notes" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Notes->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Notes">
<input type="text" data-field="x_Notes" name="x_Notes" id="x_Notes" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_sales->Notes->PlaceHolder) ?>" value="<?php echo $a_sales->Notes->EditValue ?>"<?php echo $a_sales->Notes->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Notes" name="y_Notes" id="y_Notes" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_sales->Notes->PlaceHolder) ?>" value="<?php echo $a_sales->Notes->EditValue2 ?>"<?php echo $a_sales->Notes->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_sales->Total_Amount->Visible) { // Total_Amount ?>
	<div id="r_Total_Amount" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Total_Amount" id="z_Total_Amount" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Total_Amount->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Total_Amount">
<input type="text" data-field="x_Total_Amount" name="x_Total_Amount" id="x_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Amount->EditValue ?>"<?php echo $a_sales->Total_Amount->EditAttributes() ?>>
...
<input type="text" data-field="x_Total_Amount" name="y_Total_Amount" id="y_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Amount->EditValue2 ?>"<?php echo $a_sales->Total_Amount->EditAttributes() ?>>
<?php if (!$a_sales->Total_Amount->ReadOnly && !$a_sales->Total_Amount->Disabled && @$a_sales->Total_Amount->EditAttrs["readonly"] == "" && @$a_sales->Total_Amount->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_sales->Discount_Type->Visible) { // Discount_Type ?>
	<div id="r_Discount_Type" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Discount_Type" id="z_Discount_Type" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Discount_Type->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Discount_Type">
<div id="tp_x_Discount_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Discount_Type" id="x_Discount_Type" value="{value}"<?php echo $a_sales->Discount_Type->EditAttributes() ?>></div>
<div id="dsl_x_Discount_Type" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_sales->Discount_Type->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Discount_Type" name="x_Discount_Type" id="x_Discount_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $a_sales->Discount_Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
...
<div id="tp_y_Discount_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="y_Discount_Type" id="y_Discount_Type" value="{value}"<?php echo $a_sales->Discount_Type->EditAttributes() ?>></div>
<div id="dsl_y_Discount_Type" data-repeatcolumn="5" class="ewItemList">
<?php
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_sales->Discount_Type->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Discount_Type" name="y_Discount_Type" id="y_Discount_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $a_sales->Discount_Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<?php if ($a_sales->Discount_Percentage->Visible) { // Discount_Percentage ?>
	<div id="r_Discount_Percentage" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Discount_Percentage" id="z_Discount_Percentage" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Discount_Percentage->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Discount_Percentage">
<input type="text" data-field="x_Discount_Percentage" name="x_Discount_Percentage" id="x_Discount_Percentage" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Discount_Percentage->PlaceHolder) ?>" value="<?php echo $a_sales->Discount_Percentage->EditValue ?>"<?php echo $a_sales->Discount_Percentage->EditAttributes() ?>>
...
<input type="text" data-field="x_Discount_Percentage" name="y_Discount_Percentage" id="y_Discount_Percentage" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Discount_Percentage->PlaceHolder) ?>" value="<?php echo $a_sales->Discount_Percentage->EditValue2 ?>"<?php echo $a_sales->Discount_Percentage->EditAttributes() ?>>
<?php if (!$a_sales->Discount_Percentage->ReadOnly && !$a_sales->Discount_Percentage->Disabled && @$a_sales->Discount_Percentage->EditAttrs["readonly"] == "" && @$a_sales->Discount_Percentage->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Discount_Amount" name="y_Discount_Amount" id="y_Discount_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Discount_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Discount_Amount->EditValue2 ?>"<?php echo $a_sales->Discount_Amount->EditAttributes() ?>>
<?php if (!$a_sales->Discount_Amount->ReadOnly && !$a_sales->Discount_Amount->Disabled && @$a_sales->Discount_Amount->EditAttrs["readonly"] == "" && @$a_sales->Discount_Amount->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_sales->Tax_Percentage->Visible) { // Tax_Percentage ?>
	<div id="r_Tax_Percentage" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Tax_Percentage" id="z_Tax_Percentage" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Tax_Percentage->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Tax_Percentage">
<input type="text" data-field="x_Tax_Percentage" name="x_Tax_Percentage" id="x_Tax_Percentage" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Tax_Percentage->PlaceHolder) ?>" value="<?php echo $a_sales->Tax_Percentage->EditValue ?>"<?php echo $a_sales->Tax_Percentage->EditAttributes() ?>>
...
<input type="text" data-field="x_Tax_Percentage" name="y_Tax_Percentage" id="y_Tax_Percentage" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Tax_Percentage->PlaceHolder) ?>" value="<?php echo $a_sales->Tax_Percentage->EditValue2 ?>"<?php echo $a_sales->Tax_Percentage->EditAttributes() ?>>
<?php if (!$a_sales->Tax_Percentage->ReadOnly && !$a_sales->Tax_Percentage->Disabled && @$a_sales->Tax_Percentage->EditAttrs["readonly"] == "" && @$a_sales->Tax_Percentage->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Tax_Amount" name="x_Tax_Amount" id="x_Tax_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Tax_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Tax_Amount->EditValue ?>"<?php echo $a_sales->Tax_Amount->EditAttributes() ?>>
...
<?php if ($a_sales->Tax_Description->Visible) { // Tax_Description ?>
	<div id="r_Tax_Description" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Tax_Description" id="z_Tax_Description" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Tax_Description->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Tax_Description">
<input type="text" data-field="x_Tax_Description" name="x_Tax_Description" id="x_Tax_Description" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_sales->Tax_Description->PlaceHolder) ?>" value="<?php echo $a_sales->Tax_Description->EditValue ?>"<?php echo $a_sales->Tax_Description->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Tax_Description" name="y_Tax_Description" id="y_Tax_Description" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_sales->Tax_Description->PlaceHolder) ?>" value="<?php echo $a_sales->Tax_Description->EditValue2 ?>"<?php echo $a_sales->Tax_Description->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_sales->Final_Total_Amount->Visible) { // Final_Total_Amount ?>
	<div id="r_Final_Total_Amount" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Final_Total_Amount" id="z_Final_Total_Amount" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Final_Total_Amount->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Final_Total_Amount">
<input type="text" data-field="x_Final_Total_Amount" name="x_Final_Total_Amount" id="x_Final_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Final_Total_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Final_Total_Amount->EditValue ?>"<?php echo $a_sales->Final_Total_Amount->EditAttributes() ?>>
...
<input type="text" data-field="x_Final_Total_Amount" name="y_Final_Total_Amount" id="y_Final_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Final_Total_Amount->PlaceHolder) ?>" value="<?php echo $a_sales->Final_Total_Amount->EditValue2 ?>"<?php echo $a_sales->Final_Total_Amount->EditAttributes() ?>>
<?php if (!$a_sales->Final_Total_Amount->ReadOnly && !$a_sales->Final_Total_Amount->Disabled && @$a_sales->Final_Total_Amount->EditAttrs["readonly"] == "" && @$a_sales->Final_Total_Amount->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_sales->Total_Payment->Visible) { // Total_Payment ?>
	<div id="r_Total_Payment" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Total_Payment" id="z_Total_Payment" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Total_Payment->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Total_Payment">
<input type="text" data-field="x_Total_Payment" name="x_Total_Payment" id="x_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Payment->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Payment->EditValue ?>"<?php echo $a_sales->Total_Payment->EditAttributes() ?>>
...
<input type="text" data-field="x_Total_Payment" name="y_Total_Payment" id="y_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Payment->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Payment->EditValue2 ?>"<?php echo $a_sales->Total_Payment->EditAttributes() ?>>
<?php if (!$a_sales->Total_Payment->ReadOnly && !$a_sales->Total_Payment->Disabled && @$a_sales->Total_Payment->EditAttrs["readonly"] == "" && @$a_sales->Total_Payment->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_sales->Total_Balance->Visible) { // Total_Balance ?>
	<div id="r_Total_Balance" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Total_Balance" id="z_Total_Balance" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Total_Balance->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Total_Balance">
<input type="text" data-field="x_Total_Balance" name="x_Total_Balance" id="x_Total_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Balance->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Balance->EditValue ?>"<?php echo $a_sales->Total_Balance->EditAttributes() ?>>
...
<input type="text" data-field="x_Total_Balance" name="y_Total_Balance" id="y_Total_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($a_sales->Total_Balance->PlaceHolder) ?>" value="<?php echo $a_sales->Total_Balance->EditValue2 ?>"<?php echo $a_sales->Total_Balance->EditAttributes() ?>>
<?php if (!$a_sales->Total_Balance->ReadOnly && !$a_sales->Total_Balance->Disabled && @$a_sales->Total_Balance->EditAttrs["readonly"] == "" && @$a_sales->Total_Balance->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($a_sales->Date_Added->Visible) { // Date_Added ?>
	<div id="r_Date_Added" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Date_Added" id="z_Date_Added" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Date_Added->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Date_Added">
<input type="text" data-field="x_Date_Added" name="x_Date_Added" id="x_Date_Added" placeholder="<?php echo ew_HtmlEncode($a_sales->Date_Added->PlaceHolder) ?>" value="<?php echo $a_sales->Date_Added->EditValue ?>"<?php echo $a_sales->Date_Added->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Date_Added" name="y_Date_Added" id="y_Date_Added" placeholder="<?php echo ew_HtmlEncode($a_sales->Date_Added->PlaceHolder) ?>" value="<?php echo $a_sales->Date_Added->EditValue2 ?>"<?php echo $a_sales->Date_Added->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_sales->Added_By->Visible) { // Added_By ?>
	<div id="r_Added_By" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Added_By" id="z_Added_By" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Added_By->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Added_By">
<input type="text" data-field="x_Added_By" name="x_Added_By" id="x_Added_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_sales->Added_By->PlaceHolder) ?>" value="<?php echo $a_sales->Added_By->EditValue ?>"<?php echo $a_sales->Added_By->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Added_By" name="y_Added_By" id="y_Added_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_sales->Added_By->PlaceHolder) ?>" value="<?php echo $a_sales->Added_By->EditValue2 ?>"<?php echo $a_sales->Added_By->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_sales->Date_Updated->Visible) { // Date_Updated ?>
	<div id="r_Date_Updated" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Date_Updated" id="z_Date_Updated" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Date_Updated->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Date_Updated">
<input type="text" data-field="x_Date_Updated" name="x_Date_Updated" id="x_Date_Updated" placeholder="<?php echo ew_HtmlEncode($a_sales->Date_Updated->PlaceHolder) ?>" value="<?php echo $a_sales->Date_Updated->EditValue ?>"<?php echo $a_sales->Date_Updated->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Date_Updated" name="y_Date_Updated" id="y_Date_Updated" placeholder="<?php echo ew_HtmlEncode($a_sales->Date_Updated->PlaceHolder) ?>" value="<?php echo $a_sales->Date_Updated->EditValue2 ?>"<?php echo $a_sales->Date_Updated->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($a_sales->Updated_By->Visible) { // Updated_By ?>
	<div id="r_Updated_By" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Updated_By" id="z_Updated_By" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($a_sales->Updated_By->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_a_sales_Updated_By">
<input type="text" data-field="x_Updated_By" name="x_Updated_By" id="x_Updated_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_sales->Updated_By->PlaceHolder) ?>" value="<?php echo $a_sales->Updated_By->EditValue ?>"<?php echo $a_sales->Updated_By->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Updated_By" name="y_Updated_By" id="y_Updated_By" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_sales->Updated_By->PlaceHolder) ?>" value="<?php echo $a_sales->Updated_By->EditValue2 ?>"<?php echo $a_sales->Updated_By->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
