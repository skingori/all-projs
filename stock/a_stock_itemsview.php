...
// Page object
var a_stock_items_view = new ew_Page("a_stock_items_view");
a_stock_items_view.PageID = "view"; // Page ID
var EW_PAGE_ID = a_stock_items_view.PageID; // For backward compatibility

// Form object
var fa_stock_itemsview = new ew_Form("fa_stock_itemsview");
...
fa_stock_itemsview.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemsview.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemsview.Lists["x_Unit_Of_Measurement"] = {"LinkField":"x_UOM_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_UOM_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($a_stock_items->Stock_ID->Visible) { // Stock_ID ?>
	<tr id="r_Stock_ID">
		...
		<td<?php echo $a_stock_items->Stock_ID->CellAttributes() ?>>
<span id="el_a_stock_items_Stock_ID" class="form-group">
...
<?php if ($a_stock_items->Category->Visible) { // Category ?>
	<tr id="r_Category">
		...
		<td<?php echo $a_stock_items->Category->CellAttributes() ?>>
<span id="el_a_stock_items_Category" class="form-group">
...
<span id="el_a_stock_items_Supplier_Number" class="form-group">
...
<span id="el_a_stock_items_Stock_Number" class="form-group">
...
<span id="el_a_stock_items_Stock_Name" class="form-group">
...
<?php if ($a_stock_items->Unit_Of_Measurement->Visible) { // Unit_Of_Measurement ?>
	<tr id="r_Unit_Of_Measurement">
		...
		<td<?php echo $a_stock_items->Unit_Of_Measurement->CellAttributes() ?>>
<span id="el_a_stock_items_Unit_Of_Measurement" class="form-group">
...
<span id="el_a_stock_items_Purchasing_Price" class="form-group">
...
<span id="el_a_stock_items_Selling_Price" class="form-group">
...
<span id="el_a_stock_items_Quantity" class="form-group">
...
<?php if ($a_stock_items->Notes->Visible) { // Notes ?>
	<tr id="r_Notes">
		...
		<td<?php echo $a_stock_items->Notes->CellAttributes() ?>>
<span id="el_a_stock_items_Notes" class="form-group">
...
<?php if ($a_stock_items->Date_Added->Visible) { // Date_Added ?>
	<tr id="r_Date_Added">
		...
		<td<?php echo $a_stock_items->Date_Added->CellAttributes() ?>>
<span id="el_a_stock_items_Date_Added" class="form-group">
...
<?php if ($a_stock_items->Added_By->Visible) { // Added_By ?>
	<tr id="r_Added_By">
		...
		<td<?php echo $a_stock_items->Added_By->CellAttributes() ?>>
<span id="el_a_stock_items_Added_By" class="form-group">
...
<?php if ($a_stock_items->Date_Updated->Visible) { // Date_Updated ?>
	<tr id="r_Date_Updated">
		...
		<td<?php echo $a_stock_items->Date_Updated->CellAttributes() ?>>
<span id="el_a_stock_items_Date_Updated" class="form-group">
...
<?php if ($a_stock_items->Updated_By->Visible) { // Updated_By ?>
	<tr id="r_Updated_By">
		...
		<td<?php echo $a_stock_items->Updated_By->CellAttributes() ?>>
<span id="el_a_stock_items_Updated_By" class="form-group">
