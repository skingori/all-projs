...
// Page object
var a_purchases_detail_edit = new ew_Page("a_purchases_detail_edit");
a_purchases_detail_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = a_purchases_detail_edit.PageID; // For backward compatibility

// Form object
var fa_purchases_detailedit = new ew_Form("fa_purchases_detailedit");
...
fa_purchases_detailedit.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_purchases_detailedit.Lists["x_Stock_Item"] = {"LinkField":"x_Stock_Number","Ajax":null,"AutoFill":true,"DisplayFields":["x_Stock_Name","","",""],"ParentFields":["x_Supplier_Number"],"FilterFields":["x_Supplier_Number"],"Options":[]};
...
<form name="fa_purchases_detailedit" id="fa_purchases_detailedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Purchase_ID" name="x_Purchase_ID" id="x_Purchase_ID" value="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_ID->CurrentValue) ?>">
...
<?php } else { ?>
<span id="el_a_purchases_detail_Purchase_Number">
<input type="text" data-field="x_Purchase_Number" name="x_Purchase_Number" id="x_Purchase_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchase_Number->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchase_Number->EditValue ?>"<?php echo $a_purchases_detail->Purchase_Number->EditAttributes() ?>>
</span>
<?php } ?>
...
<?php $a_purchases_detail->Supplier_Number->EditAttrs["onchange"] = "ew_UpdateOpt.call(this, ['x_Stock_Item']); " . @$a_purchases_detail->Supplier_Number->EditAttrs["onchange"]; ?>
<select data-field="x_Supplier_Number" id="x_Supplier_Number" name="x_Supplier_Number"<?php echo $a_purchases_detail->Supplier_Number->EditAttributes() ?>>
<?php
...
<script type="text/javascript">
fa_purchases_detailedit.Lists["x_Supplier_Number"].Options = <?php echo (is_array($a_purchases_detail->Supplier_Number->EditValue)) ? ew_ArrayToJson($a_purchases_detail->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Stock_Item" id="x_Stock_Item" name="x_Stock_Item"<?php echo $a_purchases_detail->Stock_Item->EditAttributes() ?>>
<?php
...
<script type="text/javascript">
fa_purchases_detailedit.Lists["x_Stock_Item"].Options = <?php echo (is_array($a_purchases_detail->Stock_Item->EditValue)) ? ew_ArrayToJson($a_purchases_detail->Stock_Item->EditValue, 1) : "[]" ?>;
</script>
...
<input type="text" data-field="x_Purchasing_Price" name="x_Purchasing_Price" id="x_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchasing_Price->EditValue ?>"<?php echo $a_purchases_detail->Purchasing_Price->EditAttributes() ?>>
...
<input type="text" data-field="x_Selling_Price" name="x_Selling_Price" id="x_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Selling_Price->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Selling_Price->EditValue ?>"<?php echo $a_purchases_detail->Selling_Price->EditAttributes() ?>>
...
<input type="text" data-field="x_Purchasing_Total_Amount" name="x_Purchasing_Total_Amount" id="x_Purchasing_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($a_purchases_detail->Purchasing_Total_Amount->PlaceHolder) ?>" value="<?php echo $a_purchases_detail->Purchasing_Total_Amount->EditValue ?>"<?php echo $a_purchases_detail->Purchasing_Total_Amount->EditAttributes() ?>>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fa_purchases_detailedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fa_purchases_detailedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
