...
<?php if ($userlevels->User_Level_ID->Visible) { // User_Level_ID ?>
		<th><span id="elh_userlevels_User_Level_ID" class="userlevels_User_Level_ID"><?php echo $userlevels->User_Level_ID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($userlevels->User_Level_Name->Visible) { // User_Level_Name ?>
		<th><span id="elh_userlevels_User_Level_Name" class="userlevels_User_Level_Name"><?php echo $userlevels->User_Level_Name->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_User_Level_ID" class="form-group userlevels_User_Level_ID">
...
<span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_User_Level_Name" class="form-group userlevels_User_Level_Name">
