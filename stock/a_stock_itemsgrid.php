...
// Page object
var a_stock_items_grid = new ew_Page("a_stock_items_grid");
a_stock_items_grid.PageID = "grid"; // Page ID
var EW_PAGE_ID = a_stock_items_grid.PageID; // For backward compatibility

// Form object
var fa_stock_itemsgrid = new ew_Form("fa_stock_itemsgrid");
...
fa_stock_itemsgrid.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } else { ?>
<span id="el<?php echo $a_stock_items_grid->RowCnt ?>_a_stock_items_Supplier_Number" class="form-group a_stock_items_Supplier_Number">
<select data-field="x_Supplier_Number" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Supplier_Number" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Supplier_Number"<?php echo $a_stock_items->Supplier_Number->EditAttributes() ?>>
<?php
...
<script type="text/javascript">
fa_stock_itemsgrid.Lists["x_Supplier_Number"].Options = <?php echo (is_array($a_stock_items->Supplier_Number->EditValue)) ? ew_ArrayToJson($a_stock_items->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
<input type="hidden" data-field="x_Supplier_Number" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Supplier_Number" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($a_stock_items->Supplier_Number->OldValue) ?>">
<?php } ?>
...
<input type="hidden" data-field="x_Supplier_Number" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Supplier_Number" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($a_stock_items->Supplier_Number->FormValue) ?>">
<input type="hidden" data-field="x_Supplier_Number" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Supplier_Number" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Supplier_Number" value="<?php echo ew_HtmlEncode($a_stock_items->Supplier_Number->OldValue) ?>">
<?php } ?>
<a id="<?php echo $a_stock_items_grid->PageObjName . "_row_" . $a_stock_items_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($a_stock_items->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-field="x_Stock_ID" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_ID" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_ID" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_ID->CurrentValue) ?>">
<input type="hidden" data-field="x_Stock_ID" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_ID" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_ID" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_ID->OldValue) ?>">
<?php } ?>
...
<input type="text" data-field="x_Stock_Number" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_Number->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_Number->EditValue ?>"<?php echo $a_stock_items->Stock_Number->EditAttributes() ?>>
</span>
<input type="hidden" data-field="x_Stock_Number" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_Number->OldValue) ?>">
<?php } ?>
<?php if ($a_stock_items->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_stock_items_grid->RowCnt ?>_a_stock_items_Stock_Number" class="form-group a_stock_items_Stock_Number">
<input type="text" data-field="x_Stock_Number" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_Number->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_Number->EditValue ?>"<?php echo $a_stock_items->Stock_Number->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Stock_Number" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_Number->FormValue) ?>">
<input type="hidden" data-field="x_Stock_Number" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Number" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_Number->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Stock_Name" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_Name->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_Name->EditValue ?>"<?php echo $a_stock_items->Stock_Name->EditAttributes() ?>>
</span>
<input type="hidden" data-field="x_Stock_Name" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_Name->OldValue) ?>">
<?php } ?>
<?php if ($a_stock_items->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_stock_items_grid->RowCnt ?>_a_stock_items_Stock_Name" class="form-group a_stock_items_Stock_Name">
<input type="text" data-field="x_Stock_Name" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Stock_Name->PlaceHolder) ?>" value="<?php echo $a_stock_items->Stock_Name->EditValue ?>"<?php echo $a_stock_items->Stock_Name->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Stock_Name" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_Name->FormValue) ?>">
<input type="hidden" data-field="x_Stock_Name" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Stock_Name" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_Name->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Purchasing_Price" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $a_stock_items->Purchasing_Price->EditValue ?>"<?php echo $a_stock_items->Purchasing_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Price" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($a_stock_items->Purchasing_Price->OldValue) ?>">
<?php } ?>
<?php if ($a_stock_items->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_stock_items_grid->RowCnt ?>_a_stock_items_Purchasing_Price" class="form-group a_stock_items_Purchasing_Price">
<input type="text" data-field="x_Purchasing_Price" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Purchasing_Price->PlaceHolder) ?>" value="<?php echo $a_stock_items->Purchasing_Price->EditValue ?>"<?php echo $a_stock_items->Purchasing_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Purchasing_Price" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($a_stock_items->Purchasing_Price->FormValue) ?>">
<input type="hidden" data-field="x_Purchasing_Price" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Purchasing_Price" value="<?php echo ew_HtmlEncode($a_stock_items->Purchasing_Price->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Selling_Price" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Selling_Price->PlaceHolder) ?>" value="<?php echo $a_stock_items->Selling_Price->EditValue ?>"<?php echo $a_stock_items->Selling_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Selling_Price" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" value="<?php echo ew_HtmlEncode($a_stock_items->Selling_Price->OldValue) ?>">
<?php } ?>
<?php if ($a_stock_items->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_stock_items_grid->RowCnt ?>_a_stock_items_Selling_Price" class="form-group a_stock_items_Selling_Price">
<input type="text" data-field="x_Selling_Price" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Selling_Price->PlaceHolder) ?>" value="<?php echo $a_stock_items->Selling_Price->EditValue ?>"<?php echo $a_stock_items->Selling_Price->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Selling_Price" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" value="<?php echo ew_HtmlEncode($a_stock_items->Selling_Price->FormValue) ?>">
<input type="hidden" data-field="x_Selling_Price" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Selling_Price" value="<?php echo ew_HtmlEncode($a_stock_items->Selling_Price->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-field="x_Quantity" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Quantity->PlaceHolder) ?>" value="<?php echo $a_stock_items->Quantity->EditValue ?>"<?php echo $a_stock_items->Quantity->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Quantity" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" value="<?php echo ew_HtmlEncode($a_stock_items->Quantity->OldValue) ?>">
<?php } ?>
<?php if ($a_stock_items->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $a_stock_items_grid->RowCnt ?>_a_stock_items_Quantity" class="form-group a_stock_items_Quantity">
<input type="text" data-field="x_Quantity" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" size="30" placeholder="<?php echo ew_HtmlEncode($a_stock_items->Quantity->PlaceHolder) ?>" value="<?php echo $a_stock_items->Quantity->EditValue ?>"<?php echo $a_stock_items->Quantity->EditAttributes() ?>>
...
<input type="hidden" data-field="x_Quantity" name="x<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" id="x<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" value="<?php echo ew_HtmlEncode($a_stock_items->Quantity->FormValue) ?>">
<input type="hidden" data-field="x_Quantity" name="o<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" id="o<?php echo $a_stock_items_grid->RowIndex ?>_Quantity" value="<?php echo ew_HtmlEncode($a_stock_items->Quantity->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
