...
// Page object
var a_customers_delete = new ew_Page("a_customers_delete");
a_customers_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = a_customers_delete.PageID; // For backward compatibility

// Form object
var fa_customersdelete = new ew_Form("fa_customersdelete");
...
<span id="el<?php echo $a_customers_delete->RowCnt ?>_a_customers_Customer_Number" class="form-group a_customers_Customer_Number">
...
<span id="el<?php echo $a_customers_delete->RowCnt ?>_a_customers_Customer_Name" class="form-group a_customers_Customer_Name">
...
<span id="el<?php echo $a_customers_delete->RowCnt ?>_a_customers_Contact_Person" class="form-group a_customers_Contact_Person">
...
<span id="el<?php echo $a_customers_delete->RowCnt ?>_a_customers_Phone_Number" class="form-group a_customers_Phone_Number">
...
<span id="el<?php echo $a_customers_delete->RowCnt ?>_a_customers_Mobile_Number" class="form-group a_customers_Mobile_Number">
...
<span id="el<?php echo $a_customers_delete->RowCnt ?>_a_customers_Balance" class="form-group a_customers_Balance">
