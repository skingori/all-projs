...
$view_purchases_outstandings = NULL;

//
// Table class for view_purchases_outstandings
//
class cview_purchases_outstandings extends cTable {
	var $Purchase_ID;
	var $Purchase_Number;
	var $Purchase_Date;
	var $Supplier_ID;
	...
	function __construct() {
		...
		$this->TableVar = 'view_purchases_outstandings';
		$this->TableName = 'view_purchases_outstandings';
		$this->TableType = 'VIEW';
...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Purchase_ID
		$this->Purchase_ID = new cField('view_purchases_outstandings', 'view_purchases_outstandings', 'x_Purchase_ID', 'Purchase_ID', '`Purchase_ID`', '`Purchase_ID`', 3, -1, FALSE, '`Purchase_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Purchase_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Purchase_ID'] = &$this->Purchase_ID;

		// Purchase_Number
		$this->Purchase_Number = new cField('view_purchases_outstandings', 'view_purchases_outstandings', 'x_Purchase_Number', 'Purchase_Number', '`Purchase_Number`', '`Purchase_Number`', 200, -1, FALSE, '`Purchase_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Purchase_Number'] = &$this->Purchase_Number;

		// Purchase_Date
		$this->Purchase_Date = new cField('view_purchases_outstandings', 'view_purchases_outstandings', 'x_Purchase_Date', 'Purchase_Date', '`Purchase_Date`', 'DATE_FORMAT(`Purchase_Date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Purchase_Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Supplier_ID
		$this->Supplier_ID = new cField('view_purchases_outstandings', 'view_purchases_outstandings', 'x_Supplier_ID', 'Supplier_ID', '`Supplier_ID`', '`Supplier_ID`', 200, -1, FALSE, '`Supplier_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Supplier_ID'] = &$this->Supplier_ID;

		// Notes
		$this->Notes = new cField('view_purchases_outstandings', 'view_purchases_outstandings', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 200, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Notes'] = &$this->Notes;

		// Total_Amount
		$this->Total_Amount = new cField('view_purchases_outstandings', 'view_purchases_outstandings', 'x_Total_Amount', 'Total_Amount', '`Total_Amount`', '`Total_Amount`', 5, -1, FALSE, '`Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Total_Payment
		$this->Total_Payment = new cField('view_purchases_outstandings', 'view_purchases_outstandings', 'x_Total_Payment', 'Total_Payment', '`Total_Payment`', '`Total_Payment`', 5, -1, FALSE, '`Total_Payment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Total_Balance
		$this->Total_Balance = new cField('view_purchases_outstandings', 'view_purchases_outstandings', 'x_Total_Balance', 'Total_Balance', '`Total_Balance`', '`Total_Balance`', 5, -1, FALSE, '`Total_Balance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Total_Balance->FldDefaultErrMsg = str_replace(array("%1", "%2"), array("-999999999", "999999999"), $Language->Phrase("IncorrectRange"));
	...
	function GetDetailUrl() {
		...
		if ($sDetailUrl == "") {
			$sDetailUrl = "view_purchases_outstandingslist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`view_purchases_outstandings`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`Purchase_Date` DESC";
	}
	...
	// Update Table
	var $UpdateTable = "`view_purchases_outstandings`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_purchases_outstandingslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_purchases_outstandingsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_purchases_outstandingsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_purchases_outstandingsadd.php?" . $this->UrlParm($parm);
		else
			return "view_purchases_outstandingsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_purchases_outstandingsedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_purchases_outstandingsedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_purchases_outstandingsadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_purchases_outstandingsadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("view_purchases_outstandingsdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Total_Amount->EditValue = ew_FormatCurrency($this->Total_Amount->EditValue, 0, -2, -2, -2);
		$this->Total_Amount->CellCssStyle .= "text-align: right;";
		$this->Total_Amount->ViewCustomAttributes = "";
