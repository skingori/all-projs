...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "view_sales_outstandingslist.php", "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Page object
var view_sales_outstandings_search = new ew_Page("view_sales_outstandings_search");
view_sales_outstandings_search.PageID = "search"; // Page ID
var EW_PAGE_ID = view_sales_outstandings_search.PageID; // For backward compatibility

// Form object
var fview_sales_outstandingssearch = new ew_Form("fview_sales_outstandingssearch");
...
fview_sales_outstandingssearch.Lists["x_Customer_ID"] = {"LinkField":"x_Customer_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fview_sales_outstandingssearch" id="fview_sales_outstandingssearch" class="form-horizontal ewForm ewSearchForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($view_sales_outstandings->Sales_ID->Visible) { // Sales_ID ?>
	<div id="r_Sales_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Sales_ID" id="z_Sales_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Sales_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Sales_ID">
<input type="text" data-field="x_Sales_ID" name="x_Sales_ID" id="x_Sales_ID" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Sales_ID->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Sales_ID->EditValue ?>"<?php echo $view_sales_outstandings->Sales_ID->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Sales_ID" name="y_Sales_ID" id="y_Sales_ID" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Sales_ID->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Sales_ID->EditValue2 ?>"<?php echo $view_sales_outstandings->Sales_ID->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($view_sales_outstandings->Sales_Number->Visible) { // Sales_Number ?>
	<div id="r_Sales_Number" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Sales_Number" id="z_Sales_Number" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Sales_Number->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Sales_Number">
<input type="text" data-field="x_Sales_Number" name="x_Sales_Number" id="x_Sales_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Sales_Number->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Sales_Number->EditValue ?>"<?php echo $view_sales_outstandings->Sales_Number->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Sales_Number" name="y_Sales_Number" id="y_Sales_Number" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Sales_Number->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Sales_Number->EditValue2 ?>"<?php echo $view_sales_outstandings->Sales_Number->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($view_sales_outstandings->Sales_Date->Visible) { // Sales_Date ?>
	<div id="r_Sales_Date" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Sales_Date" id="z_Sales_Date" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Sales_Date->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Sales_Date->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Sales_Date->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Sales_Date->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Sales_Date->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Sales_Date->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Sales_Date->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Sales_Date">
<input type="text" data-field="x_Sales_Date" name="x_Sales_Date" id="x_Sales_Date" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Sales_Date->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Sales_Date->EditValue ?>"<?php echo $view_sales_outstandings->Sales_Date->EditAttributes() ?>>
<?php if (!$view_sales_outstandings->Sales_Date->ReadOnly && !$view_sales_outstandings->Sales_Date->Disabled && @$view_sales_outstandings->Sales_Date->EditAttrs["readonly"] == "" && @$view_sales_outstandings->Sales_Date->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<input type="text" data-field="x_Sales_Date" name="y_Sales_Date" id="y_Sales_Date" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Sales_Date->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Sales_Date->EditValue2 ?>"<?php echo $view_sales_outstandings->Sales_Date->EditAttributes() ?>>
<?php if (!$view_sales_outstandings->Sales_Date->ReadOnly && !$view_sales_outstandings->Sales_Date->Disabled && @$view_sales_outstandings->Sales_Date->EditAttrs["readonly"] == "" && @$view_sales_outstandings->Sales_Date->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_sales_outstandings->Customer_ID->Visible) { // Customer_ID ?>
	<div id="r_Customer_ID" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Customer_ID" id="z_Customer_ID" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Customer_ID">
<select data-field="x_Customer_ID" id="x_Customer_ID" name="x_Customer_ID"<?php echo $view_sales_outstandings->Customer_ID->EditAttributes() ?>>
<?php
if (is_array($view_sales_outstandings->Customer_ID->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fview_sales_outstandingssearch.Lists["x_Customer_ID"].Options = <?php echo (is_array($view_sales_outstandings->Customer_ID->EditValue)) ? ew_ArrayToJson($view_sales_outstandings->Customer_ID->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<select data-field="x_Customer_ID" id="y_Customer_ID" name="y_Customer_ID"<?php echo $view_sales_outstandings->Customer_ID->EditAttributes() ?>>
<?php
if (is_array($view_sales_outstandings->Customer_ID->EditValue2)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_sales_outstandings->Customer_ID->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fview_sales_outstandingssearch.Lists["x_Customer_ID"].Options = <?php echo (is_array($view_sales_outstandings->Customer_ID->EditValue2)) ? ew_ArrayToJson($view_sales_outstandings->Customer_ID->EditValue2, 1) : "[]" ?>;
</script>
</span>
		</div></div>
	</div>
...
<?php if ($view_sales_outstandings->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Notes" id="z_Notes" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Notes->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Notes">
<input type="text" data-field="x_Notes" name="x_Notes" id="x_Notes" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Notes->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Notes->EditValue ?>"<?php echo $view_sales_outstandings->Notes->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Notes" name="y_Notes" id="y_Notes" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Notes->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Notes->EditValue2 ?>"<?php echo $view_sales_outstandings->Notes->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($view_sales_outstandings->Total_Amount->Visible) { // Total_Amount ?>
	<div id="r_Total_Amount" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Total_Amount" id="z_Total_Amount" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Total_Amount->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Total_Amount">
<input type="text" data-field="x_Total_Amount" name="x_Total_Amount" id="x_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Total_Amount->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Total_Amount->EditValue ?>"<?php echo $view_sales_outstandings->Total_Amount->EditAttributes() ?>>
...
<input type="text" data-field="x_Total_Amount" name="y_Total_Amount" id="y_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Total_Amount->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Total_Amount->EditValue2 ?>"<?php echo $view_sales_outstandings->Total_Amount->EditAttributes() ?>>
<?php if (!$view_sales_outstandings->Total_Amount->ReadOnly && !$view_sales_outstandings->Total_Amount->Disabled && @$view_sales_outstandings->Total_Amount->EditAttrs["readonly"] == "" && @$view_sales_outstandings->Total_Amount->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_sales_outstandings->Final_Total_Amount->Visible) { // Final_Total_Amount ?>
	<div id="r_Final_Total_Amount" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Final_Total_Amount" id="z_Final_Total_Amount" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Final_Total_Amount->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Final_Total_Amount">
<input type="text" data-field="x_Final_Total_Amount" name="x_Final_Total_Amount" id="x_Final_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Final_Total_Amount->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Final_Total_Amount->EditValue ?>"<?php echo $view_sales_outstandings->Final_Total_Amount->EditAttributes() ?>>
...
<input type="text" data-field="x_Final_Total_Amount" name="y_Final_Total_Amount" id="y_Final_Total_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Final_Total_Amount->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Final_Total_Amount->EditValue2 ?>"<?php echo $view_sales_outstandings->Final_Total_Amount->EditAttributes() ?>>
<?php if (!$view_sales_outstandings->Final_Total_Amount->ReadOnly && !$view_sales_outstandings->Final_Total_Amount->Disabled && @$view_sales_outstandings->Final_Total_Amount->EditAttrs["readonly"] == "" && @$view_sales_outstandings->Final_Total_Amount->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_sales_outstandings->Total_Payment->Visible) { // Total_Payment ?>
	<div id="r_Total_Payment" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Total_Payment" id="z_Total_Payment" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Total_Payment->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Total_Payment">
<input type="text" data-field="x_Total_Payment" name="x_Total_Payment" id="x_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Total_Payment->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Total_Payment->EditValue ?>"<?php echo $view_sales_outstandings->Total_Payment->EditAttributes() ?>>
...
<input type="text" data-field="x_Total_Payment" name="y_Total_Payment" id="y_Total_Payment" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Total_Payment->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Total_Payment->EditValue2 ?>"<?php echo $view_sales_outstandings->Total_Payment->EditAttributes() ?>>
<?php if (!$view_sales_outstandings->Total_Payment->ReadOnly && !$view_sales_outstandings->Total_Payment->Disabled && @$view_sales_outstandings->Total_Payment->EditAttrs["readonly"] == "" && @$view_sales_outstandings->Total_Payment->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_sales_outstandings->Total_Balance->Visible) { // Total_Balance ?>
	<div id="r_Total_Balance" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Total_Balance" id="z_Total_Balance" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Total_Balance->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Total_Balance">
<input type="text" data-field="x_Total_Balance" name="x_Total_Balance" id="x_Total_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Total_Balance->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Total_Balance->EditValue ?>"<?php echo $view_sales_outstandings->Total_Balance->EditAttributes() ?>>
...
<input type="text" data-field="x_Total_Balance" name="y_Total_Balance" id="y_Total_Balance" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Total_Balance->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Total_Balance->EditValue2 ?>"<?php echo $view_sales_outstandings->Total_Balance->EditAttributes() ?>>
<?php if (!$view_sales_outstandings->Total_Balance->ReadOnly && !$view_sales_outstandings->Total_Balance->Disabled && @$view_sales_outstandings->Total_Balance->EditAttrs["readonly"] == "" && @$view_sales_outstandings->Total_Balance->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_sales_outstandings->Discount_Type->Visible) { // Discount_Type ?>
	<div id="r_Discount_Type" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Discount_Type" id="z_Discount_Type" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Discount_Type">
<div id="tp_x_Discount_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_Discount_Type" id="x_Discount_Type" value="{value}"<?php echo $view_sales_outstandings->Discount_Type->EditAttributes() ?>></div>
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Discount_Type" name="x_Discount_Type" id="x_Discount_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $view_sales_outstandings->Discount_Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
...
<div id="tp_y_Discount_Type" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="y_Discount_Type" id="y_Discount_Type" value="{value}"<?php echo $view_sales_outstandings->Discount_Type->EditAttributes() ?>></div>
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($view_sales_outstandings->Discount_Type->AdvancedSearch->SearchValue2) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_Discount_Type" name="y_Discount_Type" id="y_Discount_Type_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $view_sales_outstandings->Discount_Type->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
<?php if ($view_sales_outstandings->Discount_Percentage->Visible) { // Discount_Percentage ?>
	<div id="r_Discount_Percentage" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Discount_Percentage" id="z_Discount_Percentage" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Discount_Percentage->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Discount_Percentage">
<input type="text" data-field="x_Discount_Percentage" name="x_Discount_Percentage" id="x_Discount_Percentage" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Discount_Percentage->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Discount_Percentage->EditValue ?>"<?php echo $view_sales_outstandings->Discount_Percentage->EditAttributes() ?>>
...
<input type="text" data-field="x_Discount_Amount" name="y_Discount_Amount" id="y_Discount_Amount" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Discount_Amount->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Discount_Amount->EditValue2 ?>"<?php echo $view_sales_outstandings->Discount_Amount->EditAttributes() ?>>
<?php if (!$view_sales_outstandings->Discount_Amount->ReadOnly && !$view_sales_outstandings->Discount_Amount->Disabled && @$view_sales_outstandings->Discount_Amount->EditAttrs["readonly"] == "" && @$view_sales_outstandings->Discount_Amount->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_sales_outstandings->Tax_Percentage->Visible) { // Tax_Percentage ?>
	<div id="r_Tax_Percentage" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Tax_Percentage" id="z_Tax_Percentage" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Tax_Percentage->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Tax_Percentage">
<input type="text" data-field="x_Tax_Percentage" name="x_Tax_Percentage" id="x_Tax_Percentage" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Tax_Percentage->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Tax_Percentage->EditValue ?>"<?php echo $view_sales_outstandings->Tax_Percentage->EditAttributes() ?>>
...
<input type="text" data-field="x_Tax_Percentage" name="y_Tax_Percentage" id="y_Tax_Percentage" size="30" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Tax_Percentage->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Tax_Percentage->EditValue2 ?>"<?php echo $view_sales_outstandings->Tax_Percentage->EditAttributes() ?>>
<?php if (!$view_sales_outstandings->Tax_Percentage->ReadOnly && !$view_sales_outstandings->Tax_Percentage->Disabled && @$view_sales_outstandings->Tax_Percentage->EditAttrs["readonly"] == "" && @$view_sales_outstandings->Tax_Percentage->EditAttrs["disabled"] == "") { ?>
<script type="text/javascript">
...
<?php if ($view_sales_outstandings->Tax_Description->Visible) { // Tax_Description ?>
	<div id="r_Tax_Description" class="form-group">
		...
		<span class="ewSearchOperator"><select name="z_Tax_Description" id="z_Tax_Description" class="form-control" onchange="ewForms(this).SrchOprChanged(this);"><option value="="<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("=") ?></option><option value="<>"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="<>") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<>") ?></option><option value="<"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="<") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<") ?></option><option value="<="<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="<=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("<=") ?></option><option value=">"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator==">") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">") ?></option><option value=">="<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator==">=") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase(">=") ?></option><option value="LIKE"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("LIKE") ?></option><option value="NOT LIKE"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="NOT LIKE") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("NOT LIKE") ?></option><option value="STARTS WITH"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="STARTS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("STARTS WITH") ?></option><option value="ENDS WITH"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="ENDS WITH") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("ENDS WITH") ?></option><option value="IS NULL"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="IS NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NULL") ?></option><option value="IS NOT NULL"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="IS NOT NULL") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("IS NOT NULL") ?></option><option value="BETWEEN"<?php echo ($view_sales_outstandings->Tax_Description->AdvancedSearch->SearchOperator=="BETWEEN") ? " selected=\"selected\"" : "" ?> ><?php echo $Language->Phrase("BETWEEN") ?></option></select></span>
			<span id="el_view_sales_outstandings_Tax_Description">
<input type="text" data-field="x_Tax_Description" name="x_Tax_Description" id="x_Tax_Description" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Tax_Description->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Tax_Description->EditValue ?>"<?php echo $view_sales_outstandings->Tax_Description->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_Tax_Description" name="y_Tax_Description" id="y_Tax_Description" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($view_sales_outstandings->Tax_Description->PlaceHolder) ?>" value="<?php echo $view_sales_outstandings->Tax_Description->EditValue2 ?>"<?php echo $view_sales_outstandings->Tax_Description->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
