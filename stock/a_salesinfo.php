...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Sales_ID
		$this->Sales_ID = new cField('a_sales', 'a_sales', 'x_Sales_ID', 'Sales_ID', '`Sales_ID`', '`Sales_ID`', 3, -1, FALSE, '`Sales_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sales_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sales_ID'] = &$this->Sales_ID;

		// Sales_Number
		$this->Sales_Number = new cField('a_sales', 'a_sales', 'x_Sales_Number', 'Sales_Number', '`Sales_Number`', '`Sales_Number`', 200, -1, FALSE, '`Sales_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sales_Number'] = &$this->Sales_Number;

		// Sales_Date
		$this->Sales_Date = new cField('a_sales', 'a_sales', 'x_Sales_Date', 'Sales_Date', '`Sales_Date`', 'DATE_FORMAT(`Sales_Date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`Sales_Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sales_Date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['Sales_Date'] = &$this->Sales_Date;

		// Customer_ID
		$this->Customer_ID = new cField('a_sales', 'a_sales', 'x_Customer_ID', 'Customer_ID', '`Customer_ID`', '`Customer_ID`', 200, -1, FALSE, '`Customer_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Customer_ID'] = &$this->Customer_ID;

		// Notes
		$this->Notes = new cField('a_sales', 'a_sales', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 200, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Notes'] = &$this->Notes;

		// Total_Amount
		$this->Total_Amount = new cField('a_sales', 'a_sales', 'x_Total_Amount', 'Total_Amount', '`Total_Amount`', '`Total_Amount`', 5, -1, FALSE, '`Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Total_Amount'] = &$this->Total_Amount;

		// Discount_Type
		$this->Discount_Type = new cField('a_sales', 'a_sales', 'x_Discount_Type', 'Discount_Type', '`Discount_Type`', '`Discount_Type`', 200, -1, FALSE, '`Discount_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Discount_Type'] = &$this->Discount_Type;

		// Discount_Percentage
		$this->Discount_Percentage = new cField('a_sales', 'a_sales', 'x_Discount_Percentage', 'Discount_Percentage', '`Discount_Percentage`', '`Discount_Percentage`', 5, -1, FALSE, '`Discount_Percentage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Discount_Amount
		$this->Discount_Amount = new cField('a_sales', 'a_sales', 'x_Discount_Amount', 'Discount_Amount', '`Discount_Amount`', '`Discount_Amount`', 5, -1, FALSE, '`Discount_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Discount_Amount'] = &$this->Discount_Amount;

		// Tax_Percentage
		$this->Tax_Percentage = new cField('a_sales', 'a_sales', 'x_Tax_Percentage', 'Tax_Percentage', '`Tax_Percentage`', '`Tax_Percentage`', 5, -1, FALSE, '`Tax_Percentage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Tax_Amount
		$this->Tax_Amount = new cField('a_sales', 'a_sales', 'x_Tax_Amount', 'Tax_Amount', '`Tax_Amount`', '`Tax_Amount`', 5, -1, FALSE, '`Tax_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Tax_Amount->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Tax_Amount'] = &$this->Tax_Amount;

		// Tax_Description
		$this->Tax_Description = new cField('a_sales', 'a_sales', 'x_Tax_Description', 'Tax_Description', '`Tax_Description`', '`Tax_Description`', 200, -1, FALSE, '`Tax_Description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Tax_Description'] = &$this->Tax_Description;

		// Final_Total_Amount
		$this->Final_Total_Amount = new cField('a_sales', 'a_sales', 'x_Final_Total_Amount', 'Final_Total_Amount', '`Final_Total_Amount`', '`Final_Total_Amount`', 5, -1, FALSE, '`Final_Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Total_Payment
		$this->Total_Payment = new cField('a_sales', 'a_sales', 'x_Total_Payment', 'Total_Payment', '`Total_Payment`', '`Total_Payment`', 5, -1, FALSE, '`Total_Payment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Total_Balance
		$this->Total_Balance = new cField('a_sales', 'a_sales', 'x_Total_Balance', 'Total_Balance', '`Total_Balance`', '`Total_Balance`', 5, -1, FALSE, '`Total_Balance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Total_Balance'] = &$this->Total_Balance;

		// Date_Added
		$this->Date_Added = new cField('a_sales', 'a_sales', 'x_Date_Added', 'Date_Added', '`Date_Added`', 'DATE_FORMAT(`Date_Added`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Added`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Added'] = &$this->Date_Added;

		// Added_By
		$this->Added_By = new cField('a_sales', 'a_sales', 'x_Added_By', 'Added_By', '`Added_By`', '`Added_By`', 200, -1, FALSE, '`Added_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Added_By'] = &$this->Added_By;

		// Date_Updated
		$this->Date_Updated = new cField('a_sales', 'a_sales', 'x_Date_Updated', 'Date_Updated', '`Date_Updated`', 'DATE_FORMAT(`Date_Updated`, \'%Y/%m/%d %H:%i:%s\')', 135, -1, FALSE, '`Date_Updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Date_Updated'] = &$this->Date_Updated;

		// Updated_By
		$this->Updated_By = new cField('a_sales', 'a_sales', 'x_Updated_By', 'Updated_By', '`Updated_By`', '`Updated_By`', 200, -1, FALSE, '`Updated_By`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		if ($this->getCurrentMasterTable() == "a_customers") {
			if ($this->Customer_ID->getSessionValue() <> "")
				$sMasterFilter .= "`Customer_Number`=" . ew_QuotedValue($this->Customer_ID->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "a_customers") {
			if ($this->Customer_ID->getSessionValue() <> "")
				$sDetailFilter .= "`Customer_ID`=" . ew_QuotedValue($this->Customer_ID->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "a_sales_detail") {
			$sDetailUrl = $GLOBALS["a_sales_detail"]->GetListUrl() . "?showmaster=" . $this->TableVar;
	...
	function Update(&$rs, $where = "", $rsold = NULL) {
		...
		$bCascadeUpdate = FALSE; // v11.0.4
		$rscascade = array(); // v11.0.4
		...
		if ($bCascadeUpdate) {
			...
			$GLOBALS["a_sales_detail"]->Update($rscascade, "`Sales_Number` = " . ew_QuotedValue($rsold['Sales_Number'], EW_DATATYPE_STRING));
		}
	...
	function Delete(&$rs, $where = "") {
		...
		if (!isset($GLOBALS["a_sales_detail"])) $GLOBALS["a_sales_detail"] = new ca_sales_detail();
		$rscascade = array();
		$GLOBALS["a_sales_detail"]->Delete($rscascade, "`Sales_Number` = " . ew_QuotedValue($rs['Sales_Number'], EW_DATATYPE_STRING));
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_salesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_salesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "a_salesadd.php?" . $this->UrlParm($parm);
		else
			return "a_salesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_salesedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_salesedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("a_salesadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("a_salesadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
