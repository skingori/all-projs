...
// Page object
var a_stock_items_edit = new ew_Page("a_stock_items_edit");
a_stock_items_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = a_stock_items_edit.PageID; // For backward compatibility

// Form object
var fa_stock_itemsedit = new ew_Form("fa_stock_itemsedit");
...
fa_stock_itemsedit.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemsedit.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemsedit.Lists["x_Unit_Of_Measurement"] = {"LinkField":"x_UOM_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_UOM_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<form name="fa_stock_itemsedit" id="fa_stock_itemsedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_Stock_ID" name="x_Stock_ID" id="x_Stock_ID" value="<?php echo ew_HtmlEncode($a_stock_items->Stock_ID->CurrentValue) ?>">
...
<?php } ?>
<script type="text/javascript">
fa_stock_itemsedit.Lists["x_Category"].Options = <?php echo (is_array($a_stock_items->Category->EditValue)) ? ew_ArrayToJson($a_stock_items->Category->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fa_stock_itemsedit.Lists["x_Supplier_Number"].Options = <?php echo (is_array($a_stock_items->Supplier_Number->EditValue)) ? ew_ArrayToJson($a_stock_items->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
<?php } ?>
<script type="text/javascript">
fa_stock_itemsedit.Lists["x_Unit_Of_Measurement"].Options = <?php echo (is_array($a_stock_items->Unit_Of_Measurement->EditValue)) ? ew_ArrayToJson($a_stock_items->Unit_Of_Measurement->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="hidden" data-field="x_Date_Added" name="x_Date_Added" id="x_Date_Added" value="<?php echo ew_HtmlEncode($a_stock_items->Date_Added->CurrentValue) ?>">
</span>
<span id="el_a_stock_items_Added_By">
<input type="hidden" data-field="x_Added_By" name="x_Added_By" id="x_Added_By" value="<?php echo ew_HtmlEncode($a_stock_items->Added_By->CurrentValue) ?>">
</span>
<?php
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyEdit(this)'); function alertifyEdit(obj) { <?php global $Language; ?> if (fa_stock_itemsedit.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) {	if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fa_stock_itemsedit").submit(); } else {	alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); }	}, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>");	} return false; }
</script>
<?php } ?>
