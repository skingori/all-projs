...
$breadcrumblinks_edit = NULL; // Initialize page object first

class cbreadcrumblinks_edit extends cbreadcrumblinks {
	...
	// Page object name
	var $PageObjName = 'breadcrumblinks_edit';
...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Lft
			$this->Lft->SetDbValueDef($rsnew, $this->Lft->CurrentValue, 0, $this->Lft->ReadOnly);

			// Rgt
			$this->Rgt->SetDbValueDef($rsnew, $this->Rgt->CurrentValue, 0, $this->Rgt->ReadOnly);
...
// Create page object
if (!isset($breadcrumblinks_edit)) $breadcrumblinks_edit = new cbreadcrumblinks_edit();

// Page init
$breadcrumblinks_edit->Page_Init();

// Page main
$breadcrumblinks_edit->Page_Main();
...
$breadcrumblinks_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var breadcrumblinks_edit = new ew_Page("breadcrumblinks_edit");
breadcrumblinks_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = breadcrumblinks_edit.PageID; // For backward compatibility

// Form object
var fbreadcrumblinksedit = new ew_Form("fbreadcrumblinksedit");

// Validate form
fbreadcrumblinksedit.Validate = function() {
...
fbreadcrumblinksedit.Form_CustomValidate = 
...
fbreadcrumblinksedit.ValidateRequired = true;
<?php } else { ?>
fbreadcrumblinksedit.ValidateRequired = false; 
<?php } ?>
...
<?php $breadcrumblinks_edit->ShowPageHeader(); ?>
<?php
$breadcrumblinks_edit->ShowMessage();
?>
...
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
	<?php if (MS_PAGINATION_STYLE==1) { // link ?>
		<?php if (!isset($breadcrumblinks_edit->Pager)) $breadcrumblinks_edit->Pager = new cNumericPager($breadcrumblinks_edit->StartRec, $breadcrumblinks_edit->DisplayRecs, $breadcrumblinks_edit->TotalRecs, $breadcrumblinks_edit->RecRange) ?>
		<?php if ($breadcrumblinks_edit->Pager->RecordCount > 0) { ?>
				<?php if (($breadcrumblinks_edit->Pager->PageCount==1) && ($breadcrumblinks_edit->Pager->CurrentPage == 1) && (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE)  ) { ?>
				<?php } else { // MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE ?>
				<div class="ewPager">
				<div class="ewNumericPage"><ul class="pagination">
					<?php if ($breadcrumblinks_edit->Pager->FirstButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
					<?php if ($breadcrumblinks_edit->Pager->PrevButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
					<?php } else { // else of rtl { ?>
					<li><a href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
					<?php } // end of rtl { ?>
					<?php } ?>
					<?php foreach ($breadcrumblinks_edit->Pager->Items as $PagerItem) { ?>
						<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $breadcrumblinks_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
					<?php } ?>
					<?php if ($breadcrumblinks_edit->Pager->NextButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
					<?php if ($breadcrumblinks_edit->Pager->LastButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<li><a href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
					<?php } else { // else of rtl ?>
					<li><a href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
					<?php } // end of rtl ?>
					<?php } ?>
				</ul></div>
				</div>
	...
	<?php } elseif (MS_PAGINATION_STYLE==2) { // button ?>
		<?php if (!isset($breadcrumblinks_edit->Pager)) $breadcrumblinks_edit->Pager = new cPrevNextPager($breadcrumblinks_edit->StartRec, $breadcrumblinks_edit->DisplayRecs, $breadcrumblinks_edit->TotalRecs) ?>
		<?php if ($breadcrumblinks_edit->Pager->RecordCount > 0) { ?>
				<?php if (($breadcrumblinks_edit->Pager->PageCount==1) && ($breadcrumblinks_edit->Pager->CurrentPage == 1) && (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE)  ) { ?>
				...
				<!--first page button-->
					<?php if ($breadcrumblinks_edit->Pager->FirstButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->FirstButton->Start ?>"><span class="icon-last ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--previous page button-->
					<?php if ($breadcrumblinks_edit->Pager->PrevButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->PrevButton->Start ?>"><span class="icon-next ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--current page number-->
					<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $breadcrumblinks_edit->Pager->CurrentPage ?>">
				<div class="input-group-btn">
				<!--next page button-->
					<?php if ($breadcrumblinks_edit->Pager->NextButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->NextButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<!--last page button-->
					<?php if ($breadcrumblinks_edit->Pager->LastButton->Enabled) { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->LastButton->Start ?>"><span class="icon-first ewIcon"></span></a>
					<?php } else { // else of rtl ?>
					<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $breadcrumblinks_edit->PageUrl() ?>start=<?php echo $breadcrumblinks_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
					<?php } // end of rtl ?>
					<?php } else { ?>
					<?php if ($Language->Phrase("dir") == "rtl") { // begin of rtl ?>
				...
				<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $breadcrumblinks_edit->Pager->PageCount ?></span>
				</div>
...
<form name="fbreadcrumblinksedit" id="fbreadcrumblinksedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($breadcrumblinks_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $breadcrumblinks_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $breadcrumblinks->Page_Title->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_Page_Title" name="x_Page_Title" id="x_Page_Title" value="<?php echo ew_HtmlEncode($breadcrumblinks->Page_Title->CurrentValue) ?>">
...
<script type="text/javascript">
fbreadcrumblinksedit.Init();
</script>
<?php
$breadcrumblinks_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
