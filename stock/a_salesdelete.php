...
// Page object
var a_sales_delete = new ew_Page("a_sales_delete");
a_sales_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = a_sales_delete.PageID; // For backward compatibility

// Form object
var fa_salesdelete = new ew_Form("fa_salesdelete");
...
fa_salesdelete.Lists["x_Customer_ID"] = {"LinkField":"x_Customer_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Customer_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Sales_Number" class="form-group a_sales_Sales_Number">
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Sales_Date" class="form-group a_sales_Sales_Date">
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Customer_ID" class="form-group a_sales_Customer_ID">
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Total_Amount" class="form-group a_sales_Total_Amount">
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Discount_Amount" class="form-group a_sales_Discount_Amount">
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Tax_Amount" class="form-group a_sales_Tax_Amount">
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Final_Total_Amount" class="form-group a_sales_Final_Total_Amount">
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Total_Payment" class="form-group a_sales_Total_Payment">
...
<span id="el<?php echo $a_sales_delete->RowCnt ?>_a_sales_Total_Balance" class="form-group a_sales_Total_Balance">
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyDelete(this)'); function alertifyDelete(obj) { <?php global $Language; ?> if (fa_salesdelete.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo  $Language->Phrase('AlertifyDeleteConfirm'); ?>", function (e) { if (e) {	$(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyDelete'); ?>"); $("#fa_salesdelete").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
