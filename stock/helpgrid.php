...
// Page object
var help_grid = new ew_Page("help_grid");
help_grid.PageID = "grid"; // Page ID
var EW_PAGE_ID = help_grid.PageID; // For backward compatibility

// Form object
var fhelpgrid = new ew_Form("fhelpgrid");
...
fhelpgrid.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<input type="text" data-field="x_Topic" name="x<?php echo $help_grid->RowIndex ?>_Topic" id="x<?php echo $help_grid->RowIndex ?>_Topic" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($help->Topic->PlaceHolder) ?>" value="<?php echo $help->Topic->EditValue ?>"<?php echo $help->Topic->EditAttributes() ?>>
</span>
<input type="hidden" data-field="x_Topic" name="o<?php echo $help_grid->RowIndex ?>_Topic" id="o<?php echo $help_grid->RowIndex ?>_Topic" value="<?php echo ew_HtmlEncode($help->Topic->OldValue) ?>">
<?php } ?>
...
<input type="hidden" data-field="x_Topic" name="x<?php echo $help_grid->RowIndex ?>_Topic" id="x<?php echo $help_grid->RowIndex ?>_Topic" value="<?php echo ew_HtmlEncode($help->Topic->FormValue) ?>">
<input type="hidden" data-field="x_Topic" name="o<?php echo $help_grid->RowIndex ?>_Topic" id="o<?php echo $help_grid->RowIndex ?>_Topic" value="<?php echo ew_HtmlEncode($help->Topic->OldValue) ?>">
<?php } ?>
<a id="<?php echo $help_grid->PageObjName . "_row_" . $help_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($help->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-field="x_Help_ID" name="x<?php echo $help_grid->RowIndex ?>_Help_ID" id="x<?php echo $help_grid->RowIndex ?>_Help_ID" value="<?php echo ew_HtmlEncode($help->Help_ID->CurrentValue) ?>">
<input type="hidden" data-field="x_Help_ID" name="o<?php echo $help_grid->RowIndex ?>_Help_ID" id="o<?php echo $help_grid->RowIndex ?>_Help_ID" value="<?php echo ew_HtmlEncode($help->Help_ID->OldValue) ?>">
<?php } ?>
...
<textarea data-field="x_Description" name="x<?php echo $help_grid->RowIndex ?>_Description" id="x<?php echo $help_grid->RowIndex ?>_Description" cols="50" rows="6" placeholder="<?php echo ew_HtmlEncode($help->Description->PlaceHolder) ?>"<?php echo $help->Description->EditAttributes() ?>><?php echo $help->Description->EditValue ?></textarea>
</span>
<input type="hidden" data-field="x_Description" name="o<?php echo $help_grid->RowIndex ?>_Description" id="o<?php echo $help_grid->RowIndex ?>_Description" value="<?php echo ew_HtmlEncode($help->Description->OldValue) ?>">
<?php } ?>
<?php if ($help->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $help_grid->RowCnt ?>_help_Description" class="form-group help_Description">
<textarea data-field="x_Description" name="x<?php echo $help_grid->RowIndex ?>_Description" id="x<?php echo $help_grid->RowIndex ?>_Description" cols="50" rows="6" placeholder="<?php echo ew_HtmlEncode($help->Description->PlaceHolder) ?>"<?php echo $help->Description->EditAttributes() ?>><?php echo $help->Description->EditValue ?></textarea>
...
<input type="hidden" data-field="x_Description" name="x<?php echo $help_grid->RowIndex ?>_Description" id="x<?php echo $help_grid->RowIndex ?>_Description" value="<?php echo ew_HtmlEncode($help->Description->FormValue) ?>">
<input type="hidden" data-field="x_Description" name="o<?php echo $help_grid->RowIndex ?>_Description" id="o<?php echo $help_grid->RowIndex ?>_Description" value="<?php echo ew_HtmlEncode($help->Description->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php } else { ?>
<span id="el<?php echo $help_grid->RowCnt ?>_help_Category" class="form-group help_Category">
<select data-field="x_Category" id="x<?php echo $help_grid->RowIndex ?>_Category" name="x<?php echo $help_grid->RowIndex ?>_Category"<?php echo $help->Category->EditAttributes() ?>>
<?php
...
<script type="text/javascript">
fhelpgrid.Lists["x_Category"].Options = <?php echo (is_array($help->Category->EditValue)) ? ew_ArrayToJson($help->Category->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
<input type="hidden" data-field="x_Category" name="o<?php echo $help_grid->RowIndex ?>_Category" id="o<?php echo $help_grid->RowIndex ?>_Category" value="<?php echo ew_HtmlEncode($help->Category->OldValue) ?>">
<?php } ?>
<?php if ($help->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<?php if ($help->Category->getSessionValue() <> "") { ?>
<span id="el<?php echo $help_grid->RowCnt ?>_help_Category" class="form-group help_Category">
...
<input type="hidden" data-field="x_Category" name="x<?php echo $help_grid->RowIndex ?>_Category" id="x<?php echo $help_grid->RowIndex ?>_Category" value="<?php echo ew_HtmlEncode($help->Category->FormValue) ?>">
<input type="hidden" data-field="x_Category" name="o<?php echo $help_grid->RowIndex ?>_Category" id="o<?php echo $help_grid->RowIndex ?>_Category" value="<?php echo ew_HtmlEncode($help->Category->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
