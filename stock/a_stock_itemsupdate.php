...
// Page object
var a_stock_items_update = new ew_Page("a_stock_items_update");
a_stock_items_update.PageID = "update"; // Page ID
var EW_PAGE_ID = a_stock_items_update.PageID; // For backward compatibility

// Form object
var fa_stock_itemsupdate = new ew_Form("fa_stock_itemsupdate");
...
fa_stock_itemsupdate.Lists["x_Category"] = {"LinkField":"x_Category_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Category_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemsupdate.Lists["x_Supplier_Number"] = {"LinkField":"x_Supplier_Number","Ajax":null,"AutoFill":false,"DisplayFields":["x_Supplier_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fa_stock_itemsupdate.Lists["x_Unit_Of_Measurement"] = {"LinkField":"x_UOM_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_UOM_Description","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fa_stock_itemsupdate" id="fa_stock_itemsupdate" class="form-horizontal ewForm ewUpdateForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="checkbox" name="u_Category" id="u_Category" value="1"<?php echo ($a_stock_items->Category->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
if (is_array($a_stock_items->Category->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Category->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fa_stock_itemsupdate.Lists["x_Category"].Options = <?php echo (is_array($a_stock_items->Category->EditValue)) ? ew_ArrayToJson($a_stock_items->Category->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="checkbox" name="u_Supplier_Number" id="u_Supplier_Number" value="1"<?php echo ($a_stock_items->Supplier_Number->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
if (is_array($a_stock_items->Supplier_Number->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Supplier_Number->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_stock_itemsupdate.Lists["x_Supplier_Number"].Options = <?php echo (is_array($a_stock_items->Supplier_Number->EditValue)) ? ew_ArrayToJson($a_stock_items->Supplier_Number->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
<input type="checkbox" name="u_Stock_Number" id="u_Stock_Number" value="1"<?php echo ($a_stock_items->Stock_Number->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Stock_Name" id="u_Stock_Name" value="1"<?php echo ($a_stock_items->Stock_Name->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Unit_Of_Measurement" id="u_Unit_Of_Measurement" value="1"<?php echo ($a_stock_items->Unit_Of_Measurement->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
if (is_array($a_stock_items->Unit_Of_Measurement->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($a_stock_items->Unit_Of_Measurement->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
fa_stock_itemsupdate.Lists["x_Unit_Of_Measurement"].Options = <?php echo (is_array($a_stock_items->Unit_Of_Measurement->EditValue)) ? ew_ArrayToJson($a_stock_items->Unit_Of_Measurement->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="checkbox" name="u_Purchasing_Price" id="u_Purchasing_Price" value="1"<?php echo ($a_stock_items->Purchasing_Price->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Selling_Price" id="u_Selling_Price" value="1"<?php echo ($a_stock_items->Selling_Price->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Quantity" id="u_Quantity" value="1"<?php echo ($a_stock_items->Quantity->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<input type="checkbox" name="u_Notes" id="u_Notes" value="1"<?php echo ($a_stock_items->Notes->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
...
<script type="text/javascript">
$('#btnAction').attr('onclick', 'return alertifyUpdate(this)'); function alertifyUpdate(obj) { <?php global $Language; ?> if (fa_stock_itemsupdate.Validate() == true ) { alertify.set({buttonFocus: 'cancel'});alertify.confirm("<?php echo  $Language->Phrase('AlertifyEditConfirm'); ?>", function (e) { if (e) { $(window).unbind('beforeunload'); alertify.success("<?php echo $Language->Phrase('AlertifyEdit'); ?>"); $("#fa_stock_itemsupdate").submit(); } else { alertify.error("<?php echo $Language->Phrase('AlertifyCancel'); ?>"); } }, "<?php echo $Language->Phrase('AlertifyConfirm'); ?>"); } return false; }
</script>
<?php } ?>
