...
// Page object
var settings_view = new ew_Page("settings_view");
settings_view.PageID = "view"; // Page ID
var EW_PAGE_ID = settings_view.PageID; // For backward compatibility

// Form object
var fsettingsview = new ew_Form("fsettingsview");
...
fsettingsview.Lists["x_Default_Theme"] = {"LinkField":"x_Theme_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Theme_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fsettingsview.Lists["x_Default_Language"] = {"LinkField":"x_Language_Code","Ajax":null,"AutoFill":false,"DisplayFields":["x_Language_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fsettingsview.Lists["x_Default_Timezone"] = {"LinkField":"x_Timezone","Ajax":null,"AutoFill":false,"DisplayFields":["x_Timezone","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<span id="el_settings_Option_ID" class="form-group">
...
<span id="el_settings_Option_Default" class="form-group">
...
<span id="el_settings_Default_Theme" class="form-group">
...
<?php if ($settings->Font_Name->Visible) { // Font_Name ?>
	<tr id="r_Font_Name">
		...
		<td<?php echo $settings->Font_Name->CellAttributes() ?>>
<span id="el_settings_Font_Name" class="form-group">
...
<?php if ($settings->Font_Size->Visible) { // Font_Size ?>
	<tr id="r_Font_Size">
		...
		<td<?php echo $settings->Font_Size->CellAttributes() ?>>
<span id="el_settings_Font_Size" class="form-group">
...
<span id="el_settings_Show_Border_Layout" class="form-group">
...
<span id="el_settings_Show_Shadow_Layout" class="form-group">
...
<span id="el_settings_Menu_Horizontal" class="form-group">
...
<?php if ($settings->Vertical_Menu_Width->Visible) { // Vertical_Menu_Width ?>
	<tr id="r_Vertical_Menu_Width">
		...
		<td<?php echo $settings->Vertical_Menu_Width->CellAttributes() ?>>
<span id="el_settings_Vertical_Menu_Width" class="form-group">
...
<span id="el_settings_Show_Announcement" class="form-group">
...
<?php if ($settings->Demo_Mode->Visible) { // Demo_Mode ?>
	<tr id="r_Demo_Mode">
		...
		<td<?php echo $settings->Demo_Mode->CellAttributes() ?>>
<span id="el_settings_Demo_Mode" class="form-group">
...
<?php if ($settings->Show_Page_Processing_Time->Visible) { // Show_Page_Processing_Time ?>
	<tr id="r_Show_Page_Processing_Time">
		...
		<td<?php echo $settings->Show_Page_Processing_Time->CellAttributes() ?>>
<span id="el_settings_Show_Page_Processing_Time" class="form-group">
...
<?php if ($settings->Allow_User_Preferences->Visible) { // Allow_User_Preferences ?>
	<tr id="r_Allow_User_Preferences">
		...
		<td<?php echo $settings->Allow_User_Preferences->CellAttributes() ?>>
<span id="el_settings_Allow_User_Preferences" class="form-group">
...
<?php if ($settings->SMTP_Server->Visible) { // SMTP_Server ?>
	<tr id="r_SMTP_Server">
		...
		<td<?php echo $settings->SMTP_Server->CellAttributes() ?>>
<span id="el_settings_SMTP_Server" class="form-group">
...
<?php if ($settings->SMTP_Server_Port->Visible) { // SMTP_Server_Port ?>
	<tr id="r_SMTP_Server_Port">
		...
		<td<?php echo $settings->SMTP_Server_Port->CellAttributes() ?>>
<span id="el_settings_SMTP_Server_Port" class="form-group">
...
<?php if ($settings->SMTP_Server_Username->Visible) { // SMTP_Server_Username ?>
	<tr id="r_SMTP_Server_Username">
		...
		<td<?php echo $settings->SMTP_Server_Username->CellAttributes() ?>>
<span id="el_settings_SMTP_Server_Username" class="form-group">
...
<?php if ($settings->SMTP_Server_Password->Visible) { // SMTP_Server_Password ?>
	<tr id="r_SMTP_Server_Password">
		...
		<td<?php echo $settings->SMTP_Server_Password->CellAttributes() ?>>
<span id="el_settings_SMTP_Server_Password" class="form-group">
...
<?php if ($settings->Sender_Email->Visible) { // Sender_Email ?>
	<tr id="r_Sender_Email">
		...
		<td<?php echo $settings->Sender_Email->CellAttributes() ?>>
<span id="el_settings_Sender_Email" class="form-group">
...
<?php if ($settings->Recipient_Email->Visible) { // Recipient_Email ?>
	<tr id="r_Recipient_Email">
		...
		<td<?php echo $settings->Recipient_Email->CellAttributes() ?>>
<span id="el_settings_Recipient_Email" class="form-group">
...
<?php if ($settings->Use_Default_Locale->Visible) { // Use_Default_Locale ?>
	<tr id="r_Use_Default_Locale">
		...
		<td<?php echo $settings->Use_Default_Locale->CellAttributes() ?>>
<span id="el_settings_Use_Default_Locale" class="form-group">
...
<?php if ($settings->Default_Language->Visible) { // Default_Language ?>
	<tr id="r_Default_Language">
		...
		<td<?php echo $settings->Default_Language->CellAttributes() ?>>
<span id="el_settings_Default_Language" class="form-group">
...
<?php if ($settings->Default_Timezone->Visible) { // Default_Timezone ?>
	<tr id="r_Default_Timezone">
		...
		<td<?php echo $settings->Default_Timezone->CellAttributes() ?>>
<span id="el_settings_Default_Timezone" class="form-group">
...
<?php if ($settings->Default_Thousands_Separator->Visible) { // Default_Thousands_Separator ?>
	<tr id="r_Default_Thousands_Separator">
		...
		<td<?php echo $settings->Default_Thousands_Separator->CellAttributes() ?>>
<span id="el_settings_Default_Thousands_Separator" class="form-group">
...
<?php if ($settings->Default_Decimal_Point->Visible) { // Default_Decimal_Point ?>
	<tr id="r_Default_Decimal_Point">
		...
		<td<?php echo $settings->Default_Decimal_Point->CellAttributes() ?>>
<span id="el_settings_Default_Decimal_Point" class="form-group">
...
<?php if ($settings->Default_Currency_Symbol->Visible) { // Default_Currency_Symbol ?>
	<tr id="r_Default_Currency_Symbol">
		...
		<td<?php echo $settings->Default_Currency_Symbol->CellAttributes() ?>>
<span id="el_settings_Default_Currency_Symbol" class="form-group">
...
<?php if ($settings->Default_Money_Thousands_Separator->Visible) { // Default_Money_Thousands_Separator ?>
	<tr id="r_Default_Money_Thousands_Separator">
		...
		<td<?php echo $settings->Default_Money_Thousands_Separator->CellAttributes() ?>>
<span id="el_settings_Default_Money_Thousands_Separator" class="form-group">
...
<?php if ($settings->Default_Money_Decimal_Point->Visible) { // Default_Money_Decimal_Point ?>
	<tr id="r_Default_Money_Decimal_Point">
		...
		<td<?php echo $settings->Default_Money_Decimal_Point->CellAttributes() ?>>
<span id="el_settings_Default_Money_Decimal_Point" class="form-group">
...
<?php if ($settings->Maintenance_Mode->Visible) { // Maintenance_Mode ?>
	<tr id="r_Maintenance_Mode">
		...
		<td<?php echo $settings->Maintenance_Mode->CellAttributes() ?>>
<span id="el_settings_Maintenance_Mode" class="form-group">
...
<?php if ($settings->Maintenance_Finish_DateTime->Visible) { // Maintenance_Finish_DateTime ?>
	<tr id="r_Maintenance_Finish_DateTime">
		...
		<td<?php echo $settings->Maintenance_Finish_DateTime->CellAttributes() ?>>
<span id="el_settings_Maintenance_Finish_DateTime" class="form-group">
...
<?php if ($settings->Auto_Normal_After_Maintenance->Visible) { // Auto_Normal_After_Maintenance ?>
	<tr id="r_Auto_Normal_After_Maintenance">
		...
		<td<?php echo $settings->Auto_Normal_After_Maintenance->CellAttributes() ?>>
<span id="el_settings_Auto_Normal_After_Maintenance" class="form-group">
...
<?php if ($settings->Allow_User_To_Register->Visible) { // Allow_User_To_Register ?>
	<tr id="r_Allow_User_To_Register">
		...
		<td<?php echo $settings->Allow_User_To_Register->CellAttributes() ?>>
<span id="el_settings_Allow_User_To_Register" class="form-group">
...
<?php if ($settings->Suspend_New_User_Account->Visible) { // Suspend_New_User_Account ?>
	<tr id="r_Suspend_New_User_Account">
		...
		<td<?php echo $settings->Suspend_New_User_Account->CellAttributes() ?>>
<span id="el_settings_Suspend_New_User_Account" class="form-group">
...
<?php if ($settings->User_Need_Activation_After_Registered->Visible) { // User_Need_Activation_After_Registered ?>
	<tr id="r_User_Need_Activation_After_Registered">
		...
		<td<?php echo $settings->User_Need_Activation_After_Registered->CellAttributes() ?>>
<span id="el_settings_User_Need_Activation_After_Registered" class="form-group">
...
<?php if ($settings->Show_Captcha_On_Registration_Page->Visible) { // Show_Captcha_On_Registration_Page ?>
	<tr id="r_Show_Captcha_On_Registration_Page">
		...
		<td<?php echo $settings->Show_Captcha_On_Registration_Page->CellAttributes() ?>>
<span id="el_settings_Show_Captcha_On_Registration_Page" class="form-group">
...
<?php if ($settings->Show_Terms_And_Conditions_On_Registration_Page->Visible) { // Show_Terms_And_Conditions_On_Registration_Page ?>
	<tr id="r_Show_Terms_And_Conditions_On_Registration_Page">
		...
		<td<?php echo $settings->Show_Terms_And_Conditions_On_Registration_Page->CellAttributes() ?>>
<span id="el_settings_Show_Terms_And_Conditions_On_Registration_Page" class="form-group">
...
<?php if ($settings->User_Auto_Login_After_Activation_Or_Registration->Visible) { // User_Auto_Login_After_Activation_Or_Registration ?>
	<tr id="r_User_Auto_Login_After_Activation_Or_Registration">
		...
		<td<?php echo $settings->User_Auto_Login_After_Activation_Or_Registration->CellAttributes() ?>>
<span id="el_settings_User_Auto_Login_After_Activation_Or_Registration" class="form-group">
...
<?php if ($settings->Show_Captcha_On_Login_Page->Visible) { // Show_Captcha_On_Login_Page ?>
	<tr id="r_Show_Captcha_On_Login_Page">
		...
		<td<?php echo $settings->Show_Captcha_On_Login_Page->CellAttributes() ?>>
<span id="el_settings_Show_Captcha_On_Login_Page" class="form-group">
...
<?php if ($settings->Show_Captcha_On_Forgot_Password_Page->Visible) { // Show_Captcha_On_Forgot_Password_Page ?>
	<tr id="r_Show_Captcha_On_Forgot_Password_Page">
		...
		<td<?php echo $settings->Show_Captcha_On_Forgot_Password_Page->CellAttributes() ?>>
<span id="el_settings_Show_Captcha_On_Forgot_Password_Page" class="form-group">
...
<?php if ($settings->Show_Captcha_On_Change_Password_Page->Visible) { // Show_Captcha_On_Change_Password_Page ?>
	<tr id="r_Show_Captcha_On_Change_Password_Page">
		...
		<td<?php echo $settings->Show_Captcha_On_Change_Password_Page->CellAttributes() ?>>
<span id="el_settings_Show_Captcha_On_Change_Password_Page" class="form-group">
...
<?php if ($settings->User_Auto_Logout_After_Idle_In_Minutes->Visible) { // User_Auto_Logout_After_Idle_In_Minutes ?>
	<tr id="r_User_Auto_Logout_After_Idle_In_Minutes">
		...
		<td<?php echo $settings->User_Auto_Logout_After_Idle_In_Minutes->CellAttributes() ?>>
<span id="el_settings_User_Auto_Logout_After_Idle_In_Minutes" class="form-group">
...
<?php if ($settings->User_Login_Maximum_Retry->Visible) { // User_Login_Maximum_Retry ?>
	<tr id="r_User_Login_Maximum_Retry">
		...
		<td<?php echo $settings->User_Login_Maximum_Retry->CellAttributes() ?>>
<span id="el_settings_User_Login_Maximum_Retry" class="form-group">
...
<?php if ($settings->User_Login_Retry_Lockout->Visible) { // User_Login_Retry_Lockout ?>
	<tr id="r_User_Login_Retry_Lockout">
		...
		<td<?php echo $settings->User_Login_Retry_Lockout->CellAttributes() ?>>
<span id="el_settings_User_Login_Retry_Lockout" class="form-group">
...
<?php if ($settings->Redirect_To_Last_Visited_Page_After_Login->Visible) { // Redirect_To_Last_Visited_Page_After_Login ?>
	<tr id="r_Redirect_To_Last_Visited_Page_After_Login">
		...
		<td<?php echo $settings->Redirect_To_Last_Visited_Page_After_Login->CellAttributes() ?>>
<span id="el_settings_Redirect_To_Last_Visited_Page_After_Login" class="form-group">
...
<?php if ($settings->Enable_Password_Expiry->Visible) { // Enable_Password_Expiry ?>
	<tr id="r_Enable_Password_Expiry">
		...
		<td<?php echo $settings->Enable_Password_Expiry->CellAttributes() ?>>
<span id="el_settings_Enable_Password_Expiry" class="form-group">
...
<?php if ($settings->Password_Expiry_In_Days->Visible) { // Password_Expiry_In_Days ?>
	<tr id="r_Password_Expiry_In_Days">
		...
		<td<?php echo $settings->Password_Expiry_In_Days->CellAttributes() ?>>
<span id="el_settings_Password_Expiry_In_Days" class="form-group">
...
<?php if ($settings->Show_Entire_Header->Visible) { // Show_Entire_Header ?>
	<tr id="r_Show_Entire_Header">
		...
		<td<?php echo $settings->Show_Entire_Header->CellAttributes() ?>>
<span id="el_settings_Show_Entire_Header" class="form-group">
...
<?php if ($settings->Logo_Width->Visible) { // Logo_Width ?>
	<tr id="r_Logo_Width">
		...
		<td<?php echo $settings->Logo_Width->CellAttributes() ?>>
<span id="el_settings_Logo_Width" class="form-group">
...
<?php if ($settings->Show_Site_Title_In_Header->Visible) { // Show_Site_Title_In_Header ?>
	<tr id="r_Show_Site_Title_In_Header">
		...
		<td<?php echo $settings->Show_Site_Title_In_Header->CellAttributes() ?>>
<span id="el_settings_Show_Site_Title_In_Header" class="form-group">
...
<?php if ($settings->Show_Current_User_In_Header->Visible) { // Show_Current_User_In_Header ?>
	<tr id="r_Show_Current_User_In_Header">
		...
		<td<?php echo $settings->Show_Current_User_In_Header->CellAttributes() ?>>
<span id="el_settings_Show_Current_User_In_Header" class="form-group">
...
<?php if ($settings->Text_Align_In_Header->Visible) { // Text_Align_In_Header ?>
	<tr id="r_Text_Align_In_Header">
		...
		<td<?php echo $settings->Text_Align_In_Header->CellAttributes() ?>>
<span id="el_settings_Text_Align_In_Header" class="form-group">
...
<?php if ($settings->Site_Title_Text_Style->Visible) { // Site_Title_Text_Style ?>
	<tr id="r_Site_Title_Text_Style">
		...
		<td<?php echo $settings->Site_Title_Text_Style->CellAttributes() ?>>
<span id="el_settings_Site_Title_Text_Style" class="form-group">
...
<?php if ($settings->Language_Selector_Visibility->Visible) { // Language_Selector_Visibility ?>
	<tr id="r_Language_Selector_Visibility">
		...
		<td<?php echo $settings->Language_Selector_Visibility->CellAttributes() ?>>
<span id="el_settings_Language_Selector_Visibility" class="form-group">
...
<?php if ($settings->Language_Selector_Align->Visible) { // Language_Selector_Align ?>
	<tr id="r_Language_Selector_Align">
		...
		<td<?php echo $settings->Language_Selector_Align->CellAttributes() ?>>
<span id="el_settings_Language_Selector_Align" class="form-group">
...
<?php if ($settings->Show_Entire_Footer->Visible) { // Show_Entire_Footer ?>
	<tr id="r_Show_Entire_Footer">
		...
		<td<?php echo $settings->Show_Entire_Footer->CellAttributes() ?>>
<span id="el_settings_Show_Entire_Footer" class="form-group">
...
<?php if ($settings->Show_Text_In_Footer->Visible) { // Show_Text_In_Footer ?>
	<tr id="r_Show_Text_In_Footer">
		...
		<td<?php echo $settings->Show_Text_In_Footer->CellAttributes() ?>>
<span id="el_settings_Show_Text_In_Footer" class="form-group">
...
<?php if ($settings->Show_Back_To_Top_On_Footer->Visible) { // Show_Back_To_Top_On_Footer ?>
	<tr id="r_Show_Back_To_Top_On_Footer">
		...
		<td<?php echo $settings->Show_Back_To_Top_On_Footer->CellAttributes() ?>>
<span id="el_settings_Show_Back_To_Top_On_Footer" class="form-group">
...
<?php if ($settings->Show_Terms_And_Conditions_On_Footer->Visible) { // Show_Terms_And_Conditions_On_Footer ?>
	<tr id="r_Show_Terms_And_Conditions_On_Footer">
		...
		<td<?php echo $settings->Show_Terms_And_Conditions_On_Footer->CellAttributes() ?>>
<span id="el_settings_Show_Terms_And_Conditions_On_Footer" class="form-group">
...
<?php if ($settings->Show_About_Us_On_Footer->Visible) { // Show_About_Us_On_Footer ?>
	<tr id="r_Show_About_Us_On_Footer">
		...
		<td<?php echo $settings->Show_About_Us_On_Footer->CellAttributes() ?>>
<span id="el_settings_Show_About_Us_On_Footer" class="form-group">
...
<?php if ($settings->Pagination_Position->Visible) { // Pagination_Position ?>
	<tr id="r_Pagination_Position">
		...
		<td<?php echo $settings->Pagination_Position->CellAttributes() ?>>
<span id="el_settings_Pagination_Position" class="form-group">
...
<?php if ($settings->Pagination_Style->Visible) { // Pagination_Style ?>
	<tr id="r_Pagination_Style">
		...
		<td<?php echo $settings->Pagination_Style->CellAttributes() ?>>
<span id="el_settings_Pagination_Style" class="form-group">
...
<?php if ($settings->Selectable_Records_Per_Page->Visible) { // Selectable_Records_Per_Page ?>
	<tr id="r_Selectable_Records_Per_Page">
		...
		<td<?php echo $settings->Selectable_Records_Per_Page->CellAttributes() ?>>
<span id="el_settings_Selectable_Records_Per_Page" class="form-group">
...
<?php if ($settings->Selectable_Groups_Per_Page->Visible) { // Selectable_Groups_Per_Page ?>
	<tr id="r_Selectable_Groups_Per_Page">
		...
		<td<?php echo $settings->Selectable_Groups_Per_Page->CellAttributes() ?>>
<span id="el_settings_Selectable_Groups_Per_Page" class="form-group">
...
<?php if ($settings->Default_Record_Per_Page->Visible) { // Default_Record_Per_Page ?>
	<tr id="r_Default_Record_Per_Page">
		...
		<td<?php echo $settings->Default_Record_Per_Page->CellAttributes() ?>>
<span id="el_settings_Default_Record_Per_Page" class="form-group">
...
<?php if ($settings->Default_Group_Per_Page->Visible) { // Default_Group_Per_Page ?>
	<tr id="r_Default_Group_Per_Page">
		...
		<td<?php echo $settings->Default_Group_Per_Page->CellAttributes() ?>>
<span id="el_settings_Default_Group_Per_Page" class="form-group">
...
<?php if ($settings->Maximum_Selected_Records->Visible) { // Maximum_Selected_Records ?>
	<tr id="r_Maximum_Selected_Records">
		...
		<td<?php echo $settings->Maximum_Selected_Records->CellAttributes() ?>>
<span id="el_settings_Maximum_Selected_Records" class="form-group">
...
<?php if ($settings->Maximum_Selected_Groups->Visible) { // Maximum_Selected_Groups ?>
	<tr id="r_Maximum_Selected_Groups">
		...
		<td<?php echo $settings->Maximum_Selected_Groups->CellAttributes() ?>>
<span id="el_settings_Maximum_Selected_Groups" class="form-group">
...
<?php if ($settings->Show_PageNum_If_Record_Not_Over_Pagesize->Visible) { // Show_PageNum_If_Record_Not_Over_Pagesize ?>
	<tr id="r_Show_PageNum_If_Record_Not_Over_Pagesize">
		...
		<td<?php echo $settings->Show_PageNum_If_Record_Not_Over_Pagesize->CellAttributes() ?>>
<span id="el_settings_Show_PageNum_If_Record_Not_Over_Pagesize" class="form-group">
...
<?php if ($settings->Table_Width_Style->Visible) { // Table_Width_Style ?>
	<tr id="r_Table_Width_Style">
		...
		<td<?php echo $settings->Table_Width_Style->CellAttributes() ?>>
<span id="el_settings_Table_Width_Style" class="form-group">
...
<?php if ($settings->Scroll_Table_Width->Visible) { // Scroll_Table_Width ?>
	<tr id="r_Scroll_Table_Width">
		...
		<td<?php echo $settings->Scroll_Table_Width->CellAttributes() ?>>
<span id="el_settings_Scroll_Table_Width" class="form-group">
...
<?php if ($settings->Scroll_Table_Height->Visible) { // Scroll_Table_Height ?>
	<tr id="r_Scroll_Table_Height">
		...
		<td<?php echo $settings->Scroll_Table_Height->CellAttributes() ?>>
<span id="el_settings_Scroll_Table_Height" class="form-group">
...
<?php if ($settings->Search_Panel_Collapsed->Visible) { // Search_Panel_Collapsed ?>
	<tr id="r_Search_Panel_Collapsed">
		...
		<td<?php echo $settings->Search_Panel_Collapsed->CellAttributes() ?>>
<span id="el_settings_Search_Panel_Collapsed" class="form-group">
...
<?php if ($settings->Filter_Panel_Collapsed->Visible) { // Filter_Panel_Collapsed ?>
	<tr id="r_Filter_Panel_Collapsed">
		...
		<td<?php echo $settings->Filter_Panel_Collapsed->CellAttributes() ?>>
<span id="el_settings_Filter_Panel_Collapsed" class="form-group">
...
<?php if ($settings->Show_Record_Number_On_List_Page->Visible) { // Show_Record_Number_On_List_Page ?>
	<tr id="r_Show_Record_Number_On_List_Page">
		...
		<td<?php echo $settings->Show_Record_Number_On_List_Page->CellAttributes() ?>>
<span id="el_settings_Show_Record_Number_On_List_Page" class="form-group">
...
<?php if ($settings->Show_Empty_Table_On_List_Page->Visible) { // Show_Empty_Table_On_List_Page ?>
	<tr id="r_Show_Empty_Table_On_List_Page">
		...
		<td<?php echo $settings->Show_Empty_Table_On_List_Page->CellAttributes() ?>>
<span id="el_settings_Show_Empty_Table_On_List_Page" class="form-group">
...
<?php if ($settings->Rows_Vertical_Align_Top->Visible) { // Rows_Vertical_Align_Top ?>
	<tr id="r_Rows_Vertical_Align_Top">
		...
		<td<?php echo $settings->Rows_Vertical_Align_Top->CellAttributes() ?>>
<span id="el_settings_Rows_Vertical_Align_Top" class="form-group">
...
<?php if ($settings->Action_Button_Alignment->Visible) { // Action_Button_Alignment ?>
	<tr id="r_Action_Button_Alignment">
		...
		<td<?php echo $settings->Action_Button_Alignment->CellAttributes() ?>>
<span id="el_settings_Action_Button_Alignment" class="form-group">
...
<?php if ($settings->Show_Add_Success_Message->Visible) { // Show_Add_Success_Message ?>
	<tr id="r_Show_Add_Success_Message">
		...
		<td<?php echo $settings->Show_Add_Success_Message->CellAttributes() ?>>
<span id="el_settings_Show_Add_Success_Message" class="form-group">
...
<?php if ($settings->Show_Edit_Success_Message->Visible) { // Show_Edit_Success_Message ?>
	<tr id="r_Show_Edit_Success_Message">
		...
		<td<?php echo $settings->Show_Edit_Success_Message->CellAttributes() ?>>
<span id="el_settings_Show_Edit_Success_Message" class="form-group">
...
<?php if ($settings->jQuery_Auto_Hide_Success_Message->Visible) { // jQuery_Auto_Hide_Success_Message ?>
	<tr id="r_jQuery_Auto_Hide_Success_Message">
		...
		<td<?php echo $settings->jQuery_Auto_Hide_Success_Message->CellAttributes() ?>>
<span id="el_settings_jQuery_Auto_Hide_Success_Message" class="form-group">
...
<?php if ($settings->Use_Javascript_Message->Visible) { // Use_Javascript_Message ?>
	<tr id="r_Use_Javascript_Message">
		...
		<td<?php echo $settings->Use_Javascript_Message->CellAttributes() ?>>
<span id="el_settings_Use_Javascript_Message" class="form-group">
...
<?php if ($settings->Login_Window_Type->Visible) { // Login_Window_Type ?>
	<tr id="r_Login_Window_Type">
		...
		<td<?php echo $settings->Login_Window_Type->CellAttributes() ?>>
<span id="el_settings_Login_Window_Type" class="form-group">
...
<?php if ($settings->Forgot_Password_Window_Type->Visible) { // Forgot_Password_Window_Type ?>
	<tr id="r_Forgot_Password_Window_Type">
		...
		<td<?php echo $settings->Forgot_Password_Window_Type->CellAttributes() ?>>
<span id="el_settings_Forgot_Password_Window_Type" class="form-group">
...
<?php if ($settings->Change_Password_Window_Type->Visible) { // Change_Password_Window_Type ?>
	<tr id="r_Change_Password_Window_Type">
		...
		<td<?php echo $settings->Change_Password_Window_Type->CellAttributes() ?>>
<span id="el_settings_Change_Password_Window_Type" class="form-group">
...
<?php if ($settings->Registration_Window_Type->Visible) { // Registration_Window_Type ?>
	<tr id="r_Registration_Window_Type">
		...
		<td<?php echo $settings->Registration_Window_Type->CellAttributes() ?>>
<span id="el_settings_Registration_Window_Type" class="form-group">
...
<?php if ($settings->Show_Record_Number_On_Detail_Preview->Visible) { // Show_Record_Number_On_Detail_Preview ?>
	<tr id="r_Show_Record_Number_On_Detail_Preview">
		...
		<td<?php echo $settings->Show_Record_Number_On_Detail_Preview->CellAttributes() ?>>
<span id="el_settings_Show_Record_Number_On_Detail_Preview" class="form-group">
...
<?php if ($settings->Show_Empty_Table_In_Detail_Preview->Visible) { // Show_Empty_Table_In_Detail_Preview ?>
	<tr id="r_Show_Empty_Table_In_Detail_Preview">
		...
		<td<?php echo $settings->Show_Empty_Table_In_Detail_Preview->CellAttributes() ?>>
<span id="el_settings_Show_Empty_Table_In_Detail_Preview" class="form-group">
...
<?php if ($settings->Detail_Preview_Table_Width->Visible) { // Detail_Preview_Table_Width ?>
	<tr id="r_Detail_Preview_Table_Width">
		...
		<td<?php echo $settings->Detail_Preview_Table_Width->CellAttributes() ?>>
<span id="el_settings_Detail_Preview_Table_Width" class="form-group">
...
<?php if ($settings->Password_Minimum_Length->Visible) { // Password_Minimum_Length ?>
	<tr id="r_Password_Minimum_Length">
		...
		<td<?php echo $settings->Password_Minimum_Length->CellAttributes() ?>>
<span id="el_settings_Password_Minimum_Length" class="form-group">
...
<?php if ($settings->Password_Maximum_Length->Visible) { // Password_Maximum_Length ?>
	<tr id="r_Password_Maximum_Length">
		...
		<td<?php echo $settings->Password_Maximum_Length->CellAttributes() ?>>
<span id="el_settings_Password_Maximum_Length" class="form-group">
...
<?php if ($settings->Password_Must_Contain_At_Least_One_Lower_Case->Visible) { // Password_Must_Contain_At_Least_One_Lower_Case ?>
	<tr id="r_Password_Must_Contain_At_Least_One_Lower_Case">
		...
		<td<?php echo $settings->Password_Must_Contain_At_Least_One_Lower_Case->CellAttributes() ?>>
<span id="el_settings_Password_Must_Contain_At_Least_One_Lower_Case" class="form-group">
...
<?php if ($settings->Password_Must_Comply_With_Minumum_Length->Visible) { // Password_Must_Comply_With_Minumum_Length ?>
	<tr id="r_Password_Must_Comply_With_Minumum_Length">
		...
		<td<?php echo $settings->Password_Must_Comply_With_Minumum_Length->CellAttributes() ?>>
<span id="el_settings_Password_Must_Comply_With_Minumum_Length" class="form-group">
...
<?php if ($settings->Password_Must_Comply_With_Maximum_Length->Visible) { // Password_Must_Comply_With_Maximum_Length ?>
	<tr id="r_Password_Must_Comply_With_Maximum_Length">
		...
		<td<?php echo $settings->Password_Must_Comply_With_Maximum_Length->CellAttributes() ?>>
<span id="el_settings_Password_Must_Comply_With_Maximum_Length" class="form-group">
...
<?php if ($settings->Password_Must_Contain_At_Least_One_Upper_Case->Visible) { // Password_Must_Contain_At_Least_One_Upper_Case ?>
	<tr id="r_Password_Must_Contain_At_Least_One_Upper_Case">
		...
		<td<?php echo $settings->Password_Must_Contain_At_Least_One_Upper_Case->CellAttributes() ?>>
<span id="el_settings_Password_Must_Contain_At_Least_One_Upper_Case" class="form-group">
...
<?php if ($settings->Password_Must_Contain_At_Least_One_Numeric->Visible) { // Password_Must_Contain_At_Least_One_Numeric ?>
	<tr id="r_Password_Must_Contain_At_Least_One_Numeric">
		...
		<td<?php echo $settings->Password_Must_Contain_At_Least_One_Numeric->CellAttributes() ?>>
<span id="el_settings_Password_Must_Contain_At_Least_One_Numeric" class="form-group">
...
<?php if ($settings->Password_Must_Contain_At_Least_One_Symbol->Visible) { // Password_Must_Contain_At_Least_One_Symbol ?>
	<tr id="r_Password_Must_Contain_At_Least_One_Symbol">
		...
		<td<?php echo $settings->Password_Must_Contain_At_Least_One_Symbol->CellAttributes() ?>>
<span id="el_settings_Password_Must_Contain_At_Least_One_Symbol" class="form-group">
...
<?php if ($settings->Password_Must_Be_Difference_Between_Old_And_New->Visible) { // Password_Must_Be_Difference_Between_Old_And_New ?>
	<tr id="r_Password_Must_Be_Difference_Between_Old_And_New">
		...
		<td<?php echo $settings->Password_Must_Be_Difference_Between_Old_And_New->CellAttributes() ?>>
<span id="el_settings_Password_Must_Be_Difference_Between_Old_And_New" class="form-group">
...
<?php if ($settings->Reset_Password_Field_Options->Visible) { // Reset_Password_Field_Options ?>
	<tr id="r_Reset_Password_Field_Options">
		...
		<td<?php echo $settings->Reset_Password_Field_Options->CellAttributes() ?>>
<span id="el_settings_Reset_Password_Field_Options" class="form-group">
...
<?php if ($settings->Export_Record_Options->Visible) { // Export_Record_Options ?>
	<tr id="r_Export_Record_Options">
		...
		<td<?php echo $settings->Export_Record_Options->CellAttributes() ?>>
<span id="el_settings_Export_Record_Options" class="form-group">
...
<?php if ($settings->Show_Record_Number_On_Exported_List_Page->Visible) { // Show_Record_Number_On_Exported_List_Page ?>
	<tr id="r_Show_Record_Number_On_Exported_List_Page">
		...
		<td<?php echo $settings->Show_Record_Number_On_Exported_List_Page->CellAttributes() ?>>
<span id="el_settings_Show_Record_Number_On_Exported_List_Page" class="form-group">
...
<?php if ($settings->Use_Table_Setting_For_Export_Field_Caption->Visible) { // Use_Table_Setting_For_Export_Field_Caption ?>
	<tr id="r_Use_Table_Setting_For_Export_Field_Caption">
		...
		<td<?php echo $settings->Use_Table_Setting_For_Export_Field_Caption->CellAttributes() ?>>
<span id="el_settings_Use_Table_Setting_For_Export_Field_Caption" class="form-group">
...
<?php if ($settings->Use_Table_Setting_For_Export_Original_Value->Visible) { // Use_Table_Setting_For_Export_Original_Value ?>
	<tr id="r_Use_Table_Setting_For_Export_Original_Value">
		...
		<td<?php echo $settings->Use_Table_Setting_For_Export_Original_Value->CellAttributes() ?>>
<span id="el_settings_Use_Table_Setting_For_Export_Original_Value" class="form-group">
