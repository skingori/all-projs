...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Sales_ID
		$this->Sales_ID = new cField('view_sales_details', 'view_sales_details', 'x_Sales_ID', 'Sales_ID', '`Sales_ID`', '`Sales_ID`', 3, -1, FALSE, '`Sales_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sales_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sales_ID'] = &$this->Sales_ID;

		// Sales_Number
		$this->Sales_Number = new cField('view_sales_details', 'view_sales_details', 'x_Sales_Number', 'Sales_Number', '`Sales_Number`', '`Sales_Number`', 200, -1, FALSE, '`Sales_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sales_Number'] = &$this->Sales_Number;

		// Supplier_Number
		$this->Supplier_Number = new cField('view_sales_details', 'view_sales_details', 'x_Supplier_Number', 'Supplier_Number', '`Supplier_Number`', '`Supplier_Number`', 200, -1, FALSE, '`Supplier_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Supplier_Number'] = &$this->Supplier_Number;

		// Stock_Item
		$this->Stock_Item = new cField('view_sales_details', 'view_sales_details', 'x_Stock_Item', 'Stock_Item', '`Stock_Item`', '`Stock_Item`', 200, -1, FALSE, '`Stock_Item`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Stock_Item'] = &$this->Stock_Item;

		// Sales_Quantity
		$this->Sales_Quantity = new cField('view_sales_details', 'view_sales_details', 'x_Sales_Quantity', 'Sales_Quantity', '`Sales_Quantity`', '`Sales_Quantity`', 5, -1, FALSE, '`Sales_Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sales_Quantity'] = &$this->Sales_Quantity;

		// Purchasing_Price
		$this->Purchasing_Price = new cField('view_sales_details', 'view_sales_details', 'x_Purchasing_Price', 'Purchasing_Price', '`Purchasing_Price`', '`Purchasing_Price`', 5, -1, FALSE, '`Purchasing_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Purchasing_Price'] = &$this->Purchasing_Price;

		// Sales_Price
		$this->Sales_Price = new cField('view_sales_details', 'view_sales_details', 'x_Sales_Price', 'Sales_Price', '`Sales_Price`', '`Sales_Price`', 5, -1, FALSE, '`Sales_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sales_Price'] = &$this->Sales_Price;

		// Sales_Total_Amount
		$this->Sales_Total_Amount = new cField('view_sales_details', 'view_sales_details', 'x_Sales_Total_Amount', 'Sales_Total_Amount', '`Sales_Total_Amount`', '`Sales_Total_Amount`', 5, -1, FALSE, '`Sales_Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`view_sales_details`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_sales_detailsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_sales_detailsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_sales_detailsadd.php?" . $this->UrlParm($parm);
		else
			return "view_sales_detailsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("view_sales_detailsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("view_sales_detailsadd.php", $this->UrlParm($parm));
	}
