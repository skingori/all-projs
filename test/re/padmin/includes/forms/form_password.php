...
/**
* Creates a password field in html
* @author   IT Elazos SL
* @version  1.0
* @package  Forms
*/
class form_password extends form_field {
    ...
    function form_password( $form_name, $method, $field, $title, $size, $maxlength )
    {
    ...
    function get_string()
    {
        ...
        return "<input type=\"password\" class=\"{$this->cssclass}\" name=\"{$this->key}\" size=\"{$this->size}\" $maxlength value=\"".htmlspecialchars($this->value)."\" $javascript {$this->tag_extra}/>\n";
    }
