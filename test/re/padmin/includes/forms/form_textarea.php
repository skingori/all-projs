...
class form_textarea extends form_field {
    ...
    function form_textarea( $form_name, $method, $field, $title, $cols, $rows )
    {
        ...
        return "<textarea class=\"{$this->cssclass}\" name=\"$this->key\" cols=\"$this->cols\""
