...
$link[0]["href"]="pg=immo&id_immo=$id_immo&nm="._IMMO;
$link[0]["txt"]=_TOEND;

$this->html_out .= $this->pgtitle(_ADDPOINT,false,$link);

$form = new xmlform("form1",LK_HOME_ADM, "post",_SAVE);
