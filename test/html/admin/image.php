...
echo" <center>"
  ...
  . "   <img height=\"149\" name=\"imagen21\" src=\"$big\" width=\"224\">"
  . "        </a>"
  . "               </td>"
...
?>
  <script>
                        function cambiaimagen(intv)
                        {
                                if (intv==1)
                                {
                                        document.frmimg.imagen21.src="<?php echo "$big";?>"
                                        document.frmimg.valx.value=1
                                }
                                if (intv==2)
                                {
                                        document.frmimg.imagen21.src="<?php echo "$img2";?>"
                                        document.frmimg.valx.value=2
                                }
                                if (intv==3)
                                {
                                        document.frmimg.imagen21.src="<?php echo "$img3";?>"
                                        document.frmimg.valx.value=3
                                }
                                 if (intv==4)
                                {
                                        document.frmimg.imagen21.src="<?php echo "$img4";?>"
                                        document.frmimg.valx.value=4
                                }
                                 if (intv==5)
                                {
                                        document.frmimg.imagen21.src="<?php echo "$img5";?>"
                                        document.frmimg.valx.value=5
                                }
                                 if (intv==6)
                                {
                                        document.frmimg.imagen21.src="<?php echo "$img6";?>"
