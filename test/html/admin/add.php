...
<form name="theForm" enctype="multipart/form-data" action="upload.php" method="POST" onsubmit="return submitForm();">
...
<noscript><p><b>Actualize su computadora, no soporta java scripts.</b></p></noscript>
        <font face="Arial Black" size="4">Agregar una propiedad</font>/<a href="editpart.php"> Borrar una propiedad</a><fieldset style="padding: 2">
...
?></select>&nbsp; <font size="2"> </font>
        <input type="text" name="dir" size="20" value="Calle"><font size="2"> #</font><input type="text" name="numero" size="6"> <a href="loadTable.php?tbl=ColTbl">Modificar/Agregar Colonias</a></font></fieldset><font size="2" face="Verdana"><br>
...
writeRichText('description', '', 520, 200, true, false);
</script>
       </font></fieldset><fieldset style="padding: 2">
        ...
        Precio:<input type="text" name="precio" value="$" align="left"><br>
        Metros Construcción:<input type="text" name="M2c" value="" align="center"><br>
        Metros Terreno:<input type="text" name="M2t" value="" align="center">
        </fieldset>
        </font></font><p align="center">
        <font face="Verdana"><font size="2">&nbsp;</font><input type="submit" value="Agregar propiedad" /><font size="2">
        </font></font></p>
