...
<header class="header clearfix">
    ...
    <div class="shapes">
<h1 class="headline" data-left="51.57%">bookpage</h1>
...
<div class="sheet clearfix">
    ...
    <li><b>
	  ...
	  <li>
	    All projets are provided for free to public and registered members</li>
      <li>Never delete a project if you don't own it.</li>
      <li>Use valid email adress for contact purposes </li>
      </p>
