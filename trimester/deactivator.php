...
<ul class="vmenu"><li><a href="#" class="active">Manage Users</a><ul class="active"><li><a href="activator.php" >Activate </a></li><li><a href="#" class="active">De-Activate</a></li><li><a href="deleter.php">Delete</a></li></ul></li><li><a href="#" >Others</a><ul class="active"><li><a href="viewmsgs.php">View Communications </a></li><li><a href="cases.php">Solved Cases </a></li></ul></li></ul>
	 ...
	 $query="SELECT * FROM users WHERE category<>'3' AND  status='active'";
		...
		<tr>
		<td><b>Names</b></td><td><b>Email</b></td> <td><b>Categoty.</b></td></td><td><b>Action</b></td></tr> ";
while($result=mysql_fetch_array($resource))
	{ 
	echo "<tr><td>".$result[4]."&nbsp".$result[5]."</td><td>".$result[8]."</td><td>".$result[1]."</td><td>
