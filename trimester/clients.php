                ...
                <div class="content-layout">
					...
					<div class="vmenublock clearfix">
                      <div class="vmenublockcontent">
                       <ul class="vmenu">
                         <li><a href="#" class="active">Available Consultants </a></li><li><a href="#">Submit Querry </a></li><li><a href="client_received.php">Unread Messages</a></l></ul>
...
while($result=mysql_fetch_array($resource))
	...
	<a href=\"reader.php?mesid=".$result[0]."\"><img border=\"0\" src=\"images/connect.png\"/></a>
	</td></tr>";
	} echo "</table>";
	 ?>
