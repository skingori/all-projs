...
<nav class="nav clearfix">
    <ul class="hmenu"><li><a href="client.php">Home</a></li><li><a href="#" class="active">Reply</a></li><li><a href="log_out.php"><img src=images/quit_1.png></a></li></ul> 
    </nav>
...
<script type="text/javascript">
	...
	window.location="consultants.php";
	</script>
