...
// Download AppGini for free from http://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV=array(   
		...
		"CONCAT('Ksh', FORMAT(`applicants_and_tenants`.`monthly_gross_pay`, 2))" => "monthly_gross_pay",
		"CONCAT('Ksh', FORMAT(`applicants_and_tenants`.`additional_income`, 2))" => "additional_income",
		"CONCAT('Ksh', FORMAT(`applicants_and_tenants`.`assets`, 2))" => "assets",
