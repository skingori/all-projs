		...
		<form  method="post" name="form" >
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<input class="form-control" placeholder="" name="fullname" type="text" readonly="" autofocus="" value="<?php echo $result[4] ." ". $result[5]  ?>">
				</div>
				<div class="form-group">
					<label>Farmer Username:</label>
					<input class="form-control" placeholder="" name="username" type="text" readonly="" autofocus="" value="<?php echo $result[2] ?>">
				</div>
				<div class="form-group">
			...
			if (isset($_POST['de'])){
				...
				$query=mysql_query("INSERT INTO payments(`farmer_name` ,`farmer_username`,`total_collected`,`total_cash`,`status`,`date`)
