	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <!-- Logo -->
	              <div class="logo">
	                 <h1><a href="home.php">Ushirika Sacco</a></h1>
	              </div>
	           </div>
	           <div class="col-md-5">
	              <div class="row">
		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href=""><i class="glyphicon glyphicon-stats"></i> View Earnings</a></li>

                    <li class="submenu">
                         <a href="#">
                            <i class="glyphicon glyphicon-list"></i> Message(s)
		  		...
		  		<div class="col-md-6">
		  			<div class="content-box-large">
		  				<div class="panel-heading">
							<div class="panel-title"> <a href="">New vs Returning Visitors</a></div>
    ...
    <footer>
         <div class="container">
            ...
            <div class="copy text-center">
               Copyright 2014 <a href='tarclink'> App by tarclink</a>
            </div>
