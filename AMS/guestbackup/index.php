 ...
 <li >
   ...
   <table id="aparts" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
    ...
    <div class="modal-header">
      ...
      <h2><center>Please confirm registration </center></h2>
    </div>
    <div class="modal-body">
   
   <div class="panel-body" style="overflow:auto;">
   
   <form action="confirmRegistration.php" method="post" enctype="multipart/form-data" name="form7" id="form7">
...
<td>
<input type="submit" id="save" name="save" class="buttoncustom btn " value="Confirm registration" />
<a href="#" class="btn-info" data-dismiss="modal">Close</a>
  ...
  <div id="payModal<?php echo $i; ?>" class="modal fade in" role="dialog" ria-labelledby="myModals" aria-hidden="true">
   ...
   <form action="confirmRegistration.php" method="post" enctype="multipart/form-data" name="form8" id="form8">
...
<a href="#" class="btn-info" data-dismiss="modal">Close</a>
    ...
    $("#form1").submit(function(event) {
     ...
     $("#form4").submit(function(event) {
      ...
      /* Send the data using post with element id name and name2**/
       var posting = $.post( url, {username: $('#username').val()} );
      ...
      posting.done(function( data ) {
       ...
       // window.location.replace('http://localhost:8080/AMS/admin/propertymanagement.php?username='+$('#username').val());
        window.location.replace('http://www.mavazistuff.com/AMS/normal/properties.php?username='+$('#username').val());
