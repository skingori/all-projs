...
if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if($amntowed < $amntrem){
    ...
    //echo 'Please pay the full balance owed of Ksh: ' .$amntrem;
              ...
              header("Location:manageBooking.php?username=$username&rem=$bal&success=1");
      ...
      while($row = mysqli_fetch_assoc($result)){
        ...
        if(mysqli_query($db, $update)){
          ...
          if($amntowed > $amntrem){
            ...
            header("Location:manageBooking.php?username=$username&rem=$overpay&success=2");

          }else{
           header("Location:manageBooking.php?username=$username&rem=0&success=3");
          }
