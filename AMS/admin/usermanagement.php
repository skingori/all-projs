                 ...
                 <!-- /. ROW  --> 
                  <div>
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a href="#profile" data-toggle="tab">Employees</a>
                            </li>
                            <li class=""><a href="#messages" data-toggle="tab">Guests</a>
							 <li class=""><a href="#messages" data-toggle="tab">Propery Owners</a>
                            </li>
...
<td>
 <select id="role" name="role" style="color: #000">
      ...
      <option value="normal" id = "normal">Employees</option>
      <option value="guest" id = "guest">Guest</option>
	  <option value="guest" id = "guest">Property Owners</option>
                                        </select>  
