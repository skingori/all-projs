...
<body>
 ...
 <li >
                    ...
                    <li class="active-link">
                        <a href="#"><i class="fa fa-edit "></i>Booking  <span class="badge"></span></a>
                    </li>
                    <li>
...
if($_REQUEST['success']==1){
  ...
  ?>
                         ...
                         <ul class="nav nav-tabs">
                            ...
                            <li class=""><a href="#profile" data-toggle="tab">Show My Bookings</a>
                            </li>
    ...
    include('../config/dbConfig.php');
        ...
        $query="SELECT *  FROM houses h INNER JOIN booking b ON h.house_id = b.apartment_id  where b.check_out =0 AND b.status <> 'cancelled' AND b.status <> 'paid' AND b.username = '$userid' ";
