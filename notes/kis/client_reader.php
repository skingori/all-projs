...
<nav class="nav clearfix">
    <ul class="hmenu"><li><a href="client.php" >Home</a></li><li><a href="#" class="active">Unread Messages</a></li><li><a href="log_out.php"><img src=images/quit_1.png></a></li></ul> 
    </nav>
<div class="sheet clearfix">
                ...
                <div class="content-layout">
					...
					<div class="vmenublock clearfix">
                      <div class="vmenublockcontent">
                       <ul class="vmenu">
                         <li><a href="consultants.php" >Available Consultants</a></li><li><a href="#">Submit Query </a></li><li><a href="client_received.php">Unread Messages</a></l></ul>
	...
	echo "<tr><td>
	<a href=\"Client_reply.php?to=".$row[1]."\"><img border=\"0\" src=\"images/reply.png\"/></a>
	</td><td>
