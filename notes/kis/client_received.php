                ...
                <div class="content-layout">
					...
					<div class="vmenublock clearfix">
                      <div class="vmenublockcontent">
                       <ul class="vmenu">
                         <li><a href="consultants.php" >Available Consultants </a></li><li><a href="query.php">Submit Query </a></li><li><a href="client_received.php" class="active">Unread Messages</a></l></ul>
