        ...
        <div id="tooplate_sidebar">
            ...
            <div id="menu">
                <ul class="navigation">
					...
					<li><a href="/notes/" class="menu_05">Main Page</a></li>
          ...
          <div class="scroll">
            <div class="scrollContainer">
              <div class="panel" id="home">
               ...
               <h2>DIGITAL FARMER NOTEBOOK</h2><hr></hr>
                <img src ="images/farm/cv.png" width="100%" height="">
                </div>
                <div class="content_section last_section">
                  <h3><b>Huduma Zetu</b></h3>
              ...
              <table width="100%" border="0" cellpadding="1" cellspacing="1">
                  <tr> 
                        <td width="358" height="20" valign="middle" bgcolor="#8FC4F7"> 
                         <div align="center"><b><font color="#FFFFFF">Fungua akaunti</font></b></div>
                        </td>
                  </tr>
               </table>	 
      <form class="cmxform" id="signupForm" method="POST" action="">
	
		<legend><b>Fuata maagizo sahihi</b></legend>
		<table width="356" align="center">
		<tr>
		   <td width="75">
			<label for="firstname">Jina-i:</label>
		   </td>
			<td width="232">
		...
		<tr>
		    <td>
			<label for="lastname">Jina-ii:</label>
			</td>
			<td>
		...
		<tr>
		   <td>
			  <label for="username">Jina(0):</label>
			</td>
			<td>
                ...
                <div class="content_section last_section">
                  ...
                  <blockquote>
                   <!--  <p>Fusce nec felis id lacus sollicitudin vulputate. Proin tincidunt, arcu id pellentesque accumsan, neque dolor imperdiet ligula, quis viverra tellus nulla a odio. Curabitur vitae enim risus, at placerat turpis. Mauris feugiat suscipit tempus fringilla, felis in velit. Aliquam a leo nec massa pharetra pulvinar.</p>
                    <cite>Thomas - <span>Designer</span></cite>  -->
                    <img src="images/farm/mix.png" width="100%" height="150" alt="">
		...
		<tr>
		  ...
		  <hr>
                  ...
                  <blockquote>
                    ...
                    <!-- <p>Fusce nec felis id lacus sollicitudin vulputate. Proin tincidunt, arcu id pellentesque accumsan, neque dolor imperdiet ligula, quis viverra tellus nulla a odio. Curabitur vitae enim risus, at placerat turpis. Mauris feugiat suscipit tempus fringilla, felis in velit. Aliquam a leo nec massa pharetra pulvinar.</p>
                    <cite>Thomas - <span>Designer</span></cite>  -->
					  <h4> Not registered yet? You can begin registration here. </h4>
                   <a href="#caccount"> <img src ="images/farm/register_n.png" width="250" height=""></a>
