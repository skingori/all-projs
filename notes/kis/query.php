                ...
                <div class="content-layout">
					...
					<div class="vmenublock clearfix">
                      <div class="vmenublockcontent">
                       <ul class="vmenu">
                         <li><a href="consultants.php" >Available Consultant</a></li>
   <li><a href="upload.php">Upload/Download File</a></li>                       
                         <li><a href="#" class="active">Submit Query </a></li><li><a href="client_received.php" >Unread Messages</a></l></ul>
	 ...
	 <form class="cmxform" id="deleteloc" method="POST" action="">
		...
		<tr>
		   <td>
			  <label for="loc"><b>Consultant :</b></label>
			</td>
		   <td>
