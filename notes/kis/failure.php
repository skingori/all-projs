...
<div id="slider">
	<div id="tooplate_wrapper">
        <div id="tooplate_sidebar">
            ...
            <div id="header">
                <h1><a href="#"><img src="images/tooplate_logo.png" title="app by tarclink" alt="app by tarclink" /></a></h1>
            </div>    
			
            <div id="menu">
                <ul class="navigation">
                   <!--  <li><a href="" class="selected menu_01">Create account</a></li>
                    <li><a href="" class="menu_02">Try again</a></li>
  ...
  <div id="content">
            ...
            <div class="scrollContainer">
              <div class="panel" id="home">
                <!--<div class="content_section">
                  <h2>Welcome</h2> <i>Logged in as:&nbsp</i>
	...
	<div class="layout-cell layout-item-2" style="width: 100%" >
		...
		<h4>or</h4>
		<p><a href="index.php" class="button">Reset your password</a></p>
	</div>
   </div>
