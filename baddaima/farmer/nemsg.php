			...
			<form class="cmxform" id="deleteloc" method="POST" action="">
				...
				<table align="">
						...
						<td>
							<select name="client" required class="form-control">
								...
								while($row = mysql_fetch_array($result))
								{
									...
									$employee_username = $row[7];
									echo "<option>$employee_firstname &nbsp $employee_lastname</option>";
								}
					...
					<tr>
						...
						<td><input type="hidden" value="<?php echo "$employee_username";?>" name="uname" ></td>
					</tr>
					<tr>
