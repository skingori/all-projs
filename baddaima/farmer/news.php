...
<!-- 000 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">News (welcome <?php echo "$username" ;?>)</li>
			</ol>
		</div><!--/.row-->
        <div class="row">
			<div class="col-lg-12">
    ...
    <div class="row">
			...
			$query="SELECT * FROM  daima_news WHERE `news_date` > timestampadd(day, -1, now());";
			...
			<div class="col-md-4">
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						<?php
			include("..connection/connector.php");
			$query="SELECT * FROM  daima_news WHERE `news_date` > timestampadd(day, -14, now());";
			...
			<div class="col-md-4">
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						<?php
                        include("..connection/connector.php");
                        $query="SELECT * FROM  daima_news WHERE `news_date` < date_sub(now(), interval 1 month);";
