...
<!-- 111 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
                            ...
                            <div class="text-success"><a href="total_milk.php">Total Milk</a></div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="text-muted"><?php echo date("D,M,Y");?></div>
							<div class="text-success"><a href="news.php"> Latest News</a></div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="text-muted"><?php echo date("D,M,Y");?></div>
							<div class="text-success"><a href="bonus.php"> Bonus</a></div>
						</div>
					</div>
				</div>
			</div>
		...
		$query="SELECT * FROM record_table WHERE record_farmer_username='$username' AND record_status='Paid' ";

		$resource=mysql_query($query,$conn);
		echo "
		<table align=\"center\" border=\"0\" width=\"90%\" class=\"table table-bordered table-striped\" data-pagination=\"true\" data-sort-name=\"name\" id=\"printTable\">
		<tr>
