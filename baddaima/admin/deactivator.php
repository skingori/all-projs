...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		$query="SELECT * FROM login_table WHERE login_username='$usname'";
		...
		<form id="form1" name="form1" method="post" action="">
			...
			<input type="submit" name="de" class="button" value="De-activate" />
		...
		if (isset($_POST['de'])){
			include("../connection/connector.php");
			$uname=$_POST['uname'];
			$query="UPDATE login_table SET login_status='inactive' WHERE login_username='$uname'";
            //$query="UPDATE farmer_table SET farmer_status='Disabled' WHERE farmer_username='$username'";
			//$query="UPDATE employee_table SET employee_status='Disabled' WHERE employee_username='$username'";
