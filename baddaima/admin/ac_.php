...
111 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<form id="form1" name="form1" method="post" action="">
			...
			<div class="form-group">
				<input  type="text" name="uname" id="textfield" class="form-control" value="<?php echo $result[1] ?>" readonly />
			</div>
		...
		if (isset($_POST['de'])){
			include("../connection/connector.php");
			$uname=$_POST['uname'];
			$query="UPDATE login_table SET login_status='active' WHERE login_username='$uname'";
            //$query="UPDATE farmer_table SET farmer_status='Enabled' WHERE farmer_username='$username'";
