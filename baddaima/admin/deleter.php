...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<table width="100%" border="0" cellpadding="1" cellspacing="1">
			<tr>
				<td width="358" height="20" valign="middle" bgcolor="#8FC4F7">
					<div align="center"><b><font color="#FFFFFF">Delete User <?php echo $_SESSION['username'];?></font></b></div>
				</td>
			</tr>
		...
		<form id="form1" name="form1" method="post" action="">
			...
			<div class="form-group">
				<input name="username" type="text" id="textfield" class="form-control" value="<?php echo $result[1] ?>" readonly />
			</div>
		...
		if (isset($_POST['de'])){
			...
			$query="DELETE FROM login_table WHERE login_username='$username'";
            //$query="DELETE FROM farmer_table WHERE farmer_username='$username'";
			//$query="DELETE FROM employee_table WHERE employee_username='$username'";
