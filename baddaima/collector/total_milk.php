...
<!-- 111 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<th><b>ID</b></th><th><b>Full Name</b></th><th><b>Milk(in ltrs)</b></th> <th><b>Delivery Date</b></th><th><b>Total</b></th></th><th><b>Status</b></th></tr></thread> ";
            ...
            $tmilk=mysql_query("select SUM( record_total_milk) AS totalmilk FROM record_table");
                $fetch1=mysql_fetch_array($tmilk);

            $oamount=mysql_query("select SUM( record_total_cash) AS tamount FROM record_table");
