...
<!-- 000 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="content">
			...
			$query="SELECT * FROM  daima_messages WHERE message_recipient ='$username' and message_status='UNREAD'";

			$resource=mysql_query($query,$conn);
			echo "
		<table align=\"\" border=\"0\" width=\"90%\">
		<tr>
		<td><b>Message</b></td> <td><b>Sender.</b></td></td><td><b>Time & Date</b></td><td><b>Action</b></td></tr> ";
			while($result=mysql_fetch_array($resource))
			{
				echo "<tr><td>".$result[1]."</td><td>".$result[3]."</td><td>".$result[5]."</td><td>
