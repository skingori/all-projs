...
<!-- 000 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="content">
			...
			<p><h4><font color="#a52a2a">Read News</font></h4></p>

			<?php
			include("..connection/connector.php");
			$query="SELECT * FROM  daima_news";

			$resource=mysql_query($query,$conn);
			echo "
		<table align=\"\" border=\"0\" width=\"100%\">
		<tr>
		<td><b>News</b></td></td><td><b>Time & Date</b></td></tr> ";
			while($result=mysql_fetch_array($resource))
			{
				echo "<tr><td>".$result[2]."</td><td>".$result[1]."</td></tr>";
			} echo "</table>";
			?>
