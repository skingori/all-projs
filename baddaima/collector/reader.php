...
<!-- 000 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="content">
			...
			<p><h4><font color="#a52a2a">Read Message</font></h4></p>

			<?php

			$id=$_REQUEST['mesid'];
			include("incls/connector.php");
			mysql_query ("UPDATE daima_messages SET message_status = 'READ' WHERE message_id = '$id' ") or die (mysql_error()."failed");
			$query="SELECT * FROM daima_messages WHERE message_id='".$id."'";
			...
			<form id="form1" name="form1" method="post" action="">
				<table align="" width="400" border="0" class="">
					<tr>

						<td><textarea class="" autofocus rows="10" cols="80" required  name="msg" required readonly ><?php echo $result[1] ?></textarea> </td>
					</tr>
