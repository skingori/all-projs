...
<!-- 000
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		echo "
                                ...
                                <tr>
                                <td><b>Farmer Name</b></td><td><b>Mobile Number</b></td><td><b>Username</b></td><td><b>Email</b></td><td><b>Collect</b></td></tr> ";
		while($result=mysql_fetch_array($resource))
		{
			echo "<tr><td>".$result[1]."&nbsp".$result[2]."</td><td>".$result[7]."<td>".$result[3]."</td><td>".$result[4]."</td><td>
                          <a href=\"collect.php?username=".$result[3]."\"><img border=\"0\" src=\"../images/collect.png\"/></a></td></tr>";
