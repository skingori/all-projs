...
<!-- 111 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="content">
			...
			echo "<b><u><h4><font color=\"skyblue\">Farmers</font></u></h4></b>
		<table align=\"center\" border=\"0\" width=\"90%\" class=\"table table-bordered table-striped\" data-pagination=\"true\" data-sort-name=\"name\" id=\"farmer\">
		<tr>
		<td><b>Names</b></td><td><b>Email</b></td> <td><b>Phone Number</b></td></td></tr> ";
			while($result=mysql_fetch_array($resource))
			{
				echo "<tr><td>".$result[1]."&nbsp".$result[2]."</td><td>".$result[4]."</td><td>".$result[7]."</td></tr>";
			} echo "</table>";
			?>
			...
			echo "<b><u><h4><font color=\"skyblue\">Employees</font></u></h4></b>
		<table align=\"center\" border=\"0\" width=\"90%\" class=\"table table-bordered table-striped\" data-pagination=\"true\" data-sort-name=\"employee\" id=\"employee\">
		<tr>
