	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				...
				$result = mysqli_query($mysqli, "INSERT INTO employee_table(employee_firstname , employee_lastname, employee_username ,employee_title ,employee_contact ,employee_address ,employee_dateemployed ,employee_password , employee_regdate) 
VALUES('$efirstname','$elastname','$eusername' ,'$etitle' ,'$ephone' ,'$employee_address' ,'$employee_dateemployed' ,'$epassword' ,now())");
