...
<div class="wrapper">
	 ...
	 ?> 
        ...
        <form id="" name="cancel" method="POST" action="">
            ...
            <div class="form-group has-feedback">
             ...
             <label> Amount Paid : </label><input type="text" name="payment"  class="form-control" value="" /> 
            ...
            <?php
                ...
                $ss=$_POST['bid'];
                $pay=$_POST['payment'];
                      $query="UPDATE booking SET  book_status='paid', bal_paid='$pay' WHERE id='".$ss."'";
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="http://tarclink.com">By samson</a>.</strong> All rights
    reserved.
  </footer>
