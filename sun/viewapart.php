  ...
  <div class="content-wrapper">
    ...
    <!--- Add content here -->
       ...
       <div class="panel" id="activate">
                ...
                <h3> <b>Cancel/Pay Booked Property</b></h3>
                <hr>
                ...
                <?php 
                         ...
                         $query="SELECT * FROM booking WHERE book_status<>'paid' AND  book_status='applied'";
                                  ...
                                  echo "
                                <table align=\"center\" border=\"\" width=\"80%\" class=\"panel\">
                                <tr>
                ...
                while($result=mysql_fetch_array($resource))
                        ...
                        <a href=\"cancel.php?id=".$result[10]."\"><img border=\"0\" src=\"images/cancel.png\"/></a></td><td><a href=\"payment.php?id=".$result[10]."\"><img border=\"0\" src=\"images/pay.png\"/></a></td></tr>";
