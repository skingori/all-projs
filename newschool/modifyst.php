        ...
        <ul>
          ...
          <li><a href="#">Update</a>
            <ul>
              ...
              <li><a href='home.php?action=studentmoney'>entercpupil pay</a></li>
            </ul>
          </li>
          <li><a href="#">View records</a>
            <ul>
              ...
              <li><a href='home.php?action=report'> ppl report card</a></li>
          ...
          <li><a href="#">School Clubs</a>
            <ul>
              ...
              <li><a href='home.php?action=member'>enter pupilss</a></li>
          ...
          <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
            <tr>
              ...
              <td ><input type="hidden" name="id" value="<?php echo $fetch[0] ?>"  />
                <input type="text" name="fname" size="30" id='fname' value="<?php echo $fetch[1] ?>"  />
                	 <script>
	  ...
	  echo '<option value="'.$fetch['AGE'].'">'.$fetch['AGE'].'</option>';
	   echo $op; ?>
            ...
            <tr>
              <td>district</td>
              <td>&nbsp;</td>
              <td><input type="text" name="dis" size="30" id='dist' value="<?php echo $fetch[4] ?>"  />
              	 <script>
                                  $(document).ready(function(){
            ...
            <tr>
              <td>parent</td>
              <td>&nbsp;</td>
              <td><input type="text" name="pname" size="30" id='par' value="<?php echo $fetch[5] ?>"  />
              	 <script>
                                  $(document).ready(function(){
                      $("#par").keypress(function(event){
                          var inputValue = event.charCode;
                          if(!(inputValue >= 65 && inputValue <= 120) && (inputValue != 32 && inputValue != 0)){
                              event.preventDefault();
                          }
            ...
            <tr>
              ...
              <?php     echo '<option value="'.$fetch['STATUS'].'">'.$fetch['STATUS'].'</option>';
