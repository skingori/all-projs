...
<div id="school_wrapper">
	...
	<div id="school_header">
		<div id="site_title"> <a href="#">NDIUNI PRIMARY SCHOOL</a> </div>
<!-- end of site_title -->
...
$fetch=mysql_fetch_array($sel)
 ...
 <tr><td height="63" colspan="3"  >student copy  
   <center>
	 ...
	 NDIUNI PRIMARY SCHOOL<br></font><font size="+0" style="letter-spacing:0px;">
	 	P.O BOX 96 Katangi Machakos<br>
		Tel:0721-458-528<hr>
   ...
   <tr>
     <td height="46" colspan="3" align="center"><p>This is an official manuscript</p>
       </td>
...
<?php
    ...
    <div id="school_footer">
    	      <div align=center> Copyright &copy; 2016 Ndiuni primary school </div>
