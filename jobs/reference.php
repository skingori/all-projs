...
if(isset($_POST["submit"])){
	...
	case "Save & add another":
		...
		$msg[0]="Sorry referee not added";
		$msg[1]="Referee successfull added";
	...
	case "Update & Continue":
		...
		$results=query($sql,$conn);
		$msg[0]="Sorry referee details not updated";
	...
	case "Delete":
		...
		$results=query($sql,$conn);
		$msg[0]="Sorry referee details not deleted";
...
<title>tarclink - references</title>
...
<table>
 ...
 <td colspan="2" valign="top" align="left"><table border="0" width="100%">
    <tr>
      <th colspan="3" bgcolor="#CCCCCC"><strong>REFERENCES</strong></th>
    </tr>
    <tr>
...
<?php $conn=db_connect(HOST,USER,PASS,DB,PORT);
	...
	echo "<tr class=\"boldtext\"><td>Name</td><td>Organization</td><td>Email</td><td>Action</td></tr>";
	while ($ref = fetch_object($results)){
		...
		if($j%2==1){
			...
			echo "<td align=\"left\"><input name=\"id\" type=\"hidden\" value=\"$ref->id\">$ref->name</td>
				<td align=\"left\">$ref->organization</td>
				<td align=\"left\">$ref->email</td>
				<td align=\"left\"><a name=\"editreferee\" href=\"reference.php?search=$ref->id&action=Find\">Edit </a>|
				<a name=\"deletereferee\" href=\"reference.php?search=$ref->id&action=Delete\" onClick=\"Javascript:return confirm('Are you sure you want Delete this Record?','Confirm Delete')\">Delete</a></td>
			</tr>";
	}
	echo "</table>";
?></td>
